var Pp=Object.defineProperty;var Op=(e,t,n)=>t in e?Pp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var me=(e,t,n)=>Op(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();/**
* @vue/shared v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Ki(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const ee={},Bt=[],Qe=()=>{},lo=()=>!1,Jn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Zn=e=>e.startsWith("onUpdate:"),fe=Object.assign,qi=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},Rp=Object.prototype.hasOwnProperty,W=(e,t)=>Rp.call(e,t),D=Array.isArray,Ht=e=>Ln(e)==="[object Map]",po=e=>Ln(e)==="[object Set]",xs=e=>Ln(e)==="[object Date]",j=e=>typeof e=="function",ae=e=>typeof e=="string",et=e=>typeof e=="symbol",z=e=>e!==null&&typeof e=="object",uo=e=>(z(e)||j(e))&&j(e.then)&&j(e.catch),_o=Object.prototype.toString,Ln=e=>_o.call(e),Sp=e=>Ln(e).slice(8,-1),fo=e=>Ln(e)==="[object Object]",Wi=e=>ae(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,nn=Ki(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qn=e=>{const t=Object.create(null);return n=>t[n]||(t[n]=e(n))},Ep=/-\w/g,Be=Qn(e=>e.replace(Ep,t=>t.slice(1).toUpperCase())),Ip=/\B([A-Z])/g,Mt=Qn(e=>e.replace(Ip,"-$1").toLowerCase()),go=Qn(e=>e.charAt(0).toUpperCase()+e.slice(1)),gi=Qn(e=>e?`on${go(e)}`:""),Ze=(e,t)=>!Object.is(e,t),Cn=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},mo=(e,t,n,i=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:i,value:n})},zi=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Cp=e=>{const t=ae(e)?Number(e):NaN;return isNaN(t)?e:t};let ks;const ei=()=>ks||(ks=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Ve(e){if(D(e)){const t={};for(let n=0;n<e.length;n++){const i=e[n],s=ae(i)?Fp(i):Ve(i);if(s)for(const o in s)t[o]=s[o]}return t}else if(ae(e)||z(e))return e}const Mp=/;(?![^(]*\))/g,$p=/:([^]+)/,Np=/\/\*[^]*?\*\//g;function Fp(e){const t={};return e.replace(Np,"").split(Mp).forEach(n=>{if(n){const i=n.split($p);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function he(e){let t="";if(ae(e))t=e;else if(D(e))for(let n=0;n<e.length;n++){const i=he(e[n]);i&&(t+=i+" ")}else if(z(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const Dp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Bp=Ki(Dp);function vo(e){return!!e||e===""}function Hp(e,t){if(e.length!==t.length)return!1;let n=!0;for(let i=0;n&&i<e.length;i++)n=Xi(e[i],t[i]);return n}function Xi(e,t){if(e===t)return!0;let n=xs(e),i=xs(t);if(n||i)return n&&i?e.getTime()===t.getTime():!1;if(n=et(e),i=et(t),n||i)return e===t;if(n=D(e),i=D(t),n||i)return n&&i?Hp(e,t):!1;if(n=z(e),i=z(t),n||i){if(!n||!i)return!1;const s=Object.keys(e).length,o=Object.keys(t).length;if(s!==o)return!1;for(const r in e){const c=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(c&&!a||!c&&a||!Xi(e[r],t[r]))return!1}}return String(e)===String(t)}const ho=e=>!!(e&&e.__v_isRef===!0),M=e=>ae(e)?e:e==null?"":D(e)||z(e)&&(e.toString===_o||!j(e.toString))?ho(e)?M(e.value):JSON.stringify(e,xo,2):String(e),xo=(e,t)=>ho(t)?xo(e,t.value):Ht(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[i,s],o)=>(n[mi(i,o)+" =>"]=s,n),{})}:po(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>mi(n))}:et(t)?mi(t):z(t)&&!D(t)&&!fo(t)?String(t):t,mi=(e,t="")=>{var n;return et(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ye;class Vp{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ye&&(ye.active?(this.parent=ye,this.index=(ye.scopes||(ye.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes){const i=this.scopes.slice();for(t=0,n=i.length;t<n;t++)i[t].pause()}for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes){const s=this.scopes.slice();for(t=0,n=s.length;t<n;t++)s[t].resume()}const i=this.effects.slice();for(t=0,n=i.length;t<n;t++)i[t].resume()}}run(t){if(this._active){const n=ye;try{return ye=this,t()}finally{ye=n}}}on(){++this._on===1&&(this.prevScope=ye,ye=this)}off(){if(this._on>0&&--this._on===0){if(ye===this)ye=this.prevScope;else{let t=ye;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(this.effects.length=0,n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){const s=this.scopes.slice();for(n=0,i=s.length;n<i;n++)s[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Gp(){return ye}let ne;const vi=new WeakSet;class ko{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ye&&(ye.active?ye.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,vi.has(this)&&(vi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Ao(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,ys(this),Lo(this);const t=ne,n=He;ne=this,He=!0;try{return this.fn()}finally{To(this),ne=t,He=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Qi(t);this.deps=this.depsTail=void 0,ys(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?vi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Si(this)&&this.run()}get dirty(){return Si(this)}}let yo=0,sn,on;function Ao(e,t=!1){if(e.flags|=8,t){e.next=on,on=e;return}e.next=sn,sn=e}function Ji(){yo++}function Zi(){if(--yo>0)return;if(on){let t=on;for(on=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;sn;){let t=sn;for(sn=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(i){e||(e=i)}t=n}}if(e)throw e}function Lo(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function To(e){let t,n=e.depsTail,i=n;for(;i;){const s=i.prevDep;i.version===-1?(i===n&&(n=s),Qi(i),jp(i)):t=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=t,e.depsTail=n}function Si(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(bo(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function bo(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===pn)||(e.globalVersion=pn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Si(e))))return;e.flags|=2;const t=e.dep,n=ne,i=He;ne=e,He=!0;try{Lo(e);const s=e.fn(e._value);(t.version===0||Ze(s,e._value))&&(e.flags|=128,e._value=s,t.version++)}catch(s){throw t.version++,s}finally{ne=n,He=i,To(e),e.flags&=-3}}function Qi(e,t=!1){const{dep:n,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),n.subs===e&&(n.subs=i,!i&&n.computed)){n.computed.flags&=-5;for(let o=n.computed.deps;o;o=o.nextDep)Qi(o,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function jp(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let He=!0;const wo=[];function at(){wo.push(He),He=!1}function lt(){const e=wo.pop();He=e===void 0?!0:e}function ys(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=ne;ne=void 0;try{t()}finally{ne=n}}}let pn=0;class Up{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class es{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ne||!He||ne===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==ne)n=this.activeLink=new Up(ne,this),ne.deps?(n.prevDep=ne.depsTail,ne.depsTail.nextDep=n,ne.depsTail=n):ne.deps=ne.depsTail=n,Po(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const i=n.nextDep;i.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=i),n.prevDep=ne.depsTail,n.nextDep=void 0,ne.depsTail.nextDep=n,ne.depsTail=n,ne.deps===n&&(ne.deps=i)}return n}trigger(t){this.version++,pn++,this.notify(t)}notify(t){Ji();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{Zi()}}}function Po(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let i=t.deps;i;i=i.nextDep)Po(i)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const Ei=new WeakMap,Rt=Symbol(""),Ii=Symbol(""),un=Symbol("");function Le(e,t,n){if(He&&ne){let i=Ei.get(e);i||Ei.set(e,i=new Map);let s=i.get(n);s||(i.set(n,s=new es),s.map=i,s.key=n),s.track()}}function rt(e,t,n,i,s,o){const r=Ei.get(e);if(!r){pn++;return}const c=a=>{a&&a.trigger()};if(Ji(),t==="clear")r.forEach(c);else{const a=D(e),p=a&&Wi(n);if(a&&n==="length"){const l=Number(i);r.forEach((d,h)=>{(h==="length"||h===un||!et(h)&&h>=l)&&c(d)})}else switch((n!==void 0||r.has(void 0))&&c(r.get(n)),p&&c(r.get(un)),t){case"add":a?p&&c(r.get("length")):(c(r.get(Rt)),Ht(e)&&c(r.get(Ii)));break;case"delete":a||(c(r.get(Rt)),Ht(e)&&c(r.get(Ii)));break;case"set":Ht(e)&&c(r.get(Rt));break}}Zi()}function $t(e){const t=K(e);return t===e?t:(Le(t,"iterate",un),Fe(e)?t:t.map(Ge))}function ti(e){return Le(e=K(e),"iterate",un),e}function Xe(e,t){return pt(e)?jt(St(e)?Ge(t):t):Ge(t)}const Yp={__proto__:null,[Symbol.iterator](){return hi(this,Symbol.iterator,e=>Xe(this,e))},concat(...e){return $t(this).concat(...e.map(t=>D(t)?$t(t):t))},entries(){return hi(this,"entries",e=>(e[1]=Xe(this,e[1]),e))},every(e,t){return nt(this,"every",e,t,void 0,arguments)},filter(e,t){return nt(this,"filter",e,t,n=>n.map(i=>Xe(this,i)),arguments)},find(e,t){return nt(this,"find",e,t,n=>Xe(this,n),arguments)},findIndex(e,t){return nt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return nt(this,"findLast",e,t,n=>Xe(this,n),arguments)},findLastIndex(e,t){return nt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return nt(this,"forEach",e,t,void 0,arguments)},includes(...e){return xi(this,"includes",e)},indexOf(...e){return xi(this,"indexOf",e)},join(e){return $t(this).join(e)},lastIndexOf(...e){return xi(this,"lastIndexOf",e)},map(e,t){return nt(this,"map",e,t,void 0,arguments)},pop(){return Xt(this,"pop")},push(...e){return Xt(this,"push",e)},reduce(e,...t){return As(this,"reduce",e,t)},reduceRight(e,...t){return As(this,"reduceRight",e,t)},shift(){return Xt(this,"shift")},some(e,t){return nt(this,"some",e,t,void 0,arguments)},splice(...e){return Xt(this,"splice",e)},toReversed(){return $t(this).toReversed()},toSorted(e){return $t(this).toSorted(e)},toSpliced(...e){return $t(this).toSpliced(...e)},unshift(...e){return Xt(this,"unshift",e)},values(){return hi(this,"values",e=>Xe(this,e))}};function hi(e,t,n){const i=ti(e),s=i[t]();return i!==e&&!Fe(e)&&(s._next=s.next,s.next=()=>{const o=s._next();return o.done||(o.value=n(o.value)),o}),s}const Kp=Array.prototype;function nt(e,t,n,i,s,o){const r=ti(e),c=r!==e&&!Fe(e),a=r[t];if(a!==Kp[t]){const d=a.apply(e,o);return c?Ge(d):d}let p=n;r!==e&&(c?p=function(d,h){return n.call(this,Xe(e,d),h,e)}:n.length>2&&(p=function(d,h){return n.call(this,d,h,e)}));const l=a.call(r,p,i);return c&&s?s(l):l}function As(e,t,n,i){const s=ti(e),o=s!==e&&!Fe(e);let r=n,c=!1;s!==e&&(o?(c=i.length===0,r=function(p,l,d){return c&&(c=!1,p=Xe(e,p)),n.call(this,p,Xe(e,l),d,e)}):n.length>3&&(r=function(p,l,d){return n.call(this,p,l,d,e)}));const a=s[t](r,...i);return c?Xe(e,a):a}function xi(e,t,n){const i=K(e);Le(i,"iterate",un);const s=i[t](...n);return(s===-1||s===!1)&&ss(n[0])?(n[0]=K(n[0]),i[t](...n)):s}function Xt(e,t,n=[]){at(),Ji();const i=K(e)[t].apply(e,n);return Zi(),lt(),i}const qp=Ki("__proto__,__v_isRef,__isVue"),Oo=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(et));function Wp(e){et(e)||(e=String(e));const t=K(this);return Le(t,"has",e),t.hasOwnProperty(e)}class Ro{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,i){if(n==="__v_skip")return t.__v_skip;const s=this._isReadonly,o=this._isShallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return o;if(n==="__v_raw")return i===(s?o?su:Co:o?Io:Eo).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(i)?t:void 0;const r=D(t);if(!s){let a;if(r&&(a=Yp[n]))return a;if(n==="hasOwnProperty")return Wp}const c=Reflect.get(t,n,Te(t)?t:i);if((et(n)?Oo.has(n):qp(n))||(s||Le(t,"get",n),o))return c;if(Te(c)){const a=r&&Wi(n)?c:c.value;return s&&z(a)?Mi(a):a}return z(c)?s?Mi(c):ns(c):c}}class So extends Ro{constructor(t=!1){super(!1,t)}set(t,n,i,s){let o=t[n];const r=D(t)&&Wi(n);if(!this._isShallow){const p=pt(o);if(!Fe(i)&&!pt(i)&&(o=K(o),i=K(i)),!r&&Te(o)&&!Te(i))return p||(o.value=i),!0}const c=r?Number(n)<t.length:W(t,n),a=Reflect.set(t,n,i,Te(t)?t:s);return t===K(s)&&a&&(c?Ze(i,o)&&rt(t,"set",n,i):rt(t,"add",n,i)),a}deleteProperty(t,n){const i=W(t,n);t[n];const s=Reflect.deleteProperty(t,n);return s&&i&&rt(t,"delete",n,void 0),s}has(t,n){const i=Reflect.has(t,n);return(!et(n)||!Oo.has(n))&&Le(t,"has",n),i}ownKeys(t){return Le(t,"iterate",D(t)?"length":Rt),Reflect.ownKeys(t)}}class zp extends Ro{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const Xp=new So,Jp=new zp,Zp=new So(!0);const Ci=e=>e,On=e=>Reflect.getPrototypeOf(e);function Qp(e,t,n){return function(...i){const s=this.__v_raw,o=K(s),r=Ht(o),c=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,p=s[e](...i),l=n?Ci:t?jt:Ge;return!t&&Le(o,"iterate",a?Ii:Rt),fe(Object.create(p),{next(){const{value:d,done:h}=p.next();return h?{value:d,done:h}:{value:c?[l(d[0]),l(d[1])]:l(d),done:h}}})}}function Rn(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function eu(e,t){const n={get(s){const o=this.__v_raw,r=K(o),c=K(s);e||(Ze(s,c)&&Le(r,"get",s),Le(r,"get",c));const{has:a}=On(r),p=t?Ci:e?jt:Ge;if(a.call(r,s))return p(o.get(s));if(a.call(r,c))return p(o.get(c));o!==r&&o.get(s)},get size(){const s=this.__v_raw;return!e&&Le(K(s),"iterate",Rt),s.size},has(s){const o=this.__v_raw,r=K(o),c=K(s);return e||(Ze(s,c)&&Le(r,"has",s),Le(r,"has",c)),s===c?o.has(s):o.has(s)||o.has(c)},forEach(s,o){const r=this,c=r.__v_raw,a=K(c),p=t?Ci:e?jt:Ge;return!e&&Le(a,"iterate",Rt),c.forEach((l,d)=>s.call(o,p(l),p(d),r))}};return fe(n,e?{add:Rn("add"),set:Rn("set"),delete:Rn("delete"),clear:Rn("clear")}:{add(s){const o=K(this),r=On(o),c=K(s),a=!t&&!Fe(s)&&!pt(s)?c:s;return r.has.call(o,a)||Ze(s,a)&&r.has.call(o,s)||Ze(c,a)&&r.has.call(o,c)||(o.add(a),rt(o,"add",a,a)),this},set(s,o){!t&&!Fe(o)&&!pt(o)&&(o=K(o));const r=K(this),{has:c,get:a}=On(r);let p=c.call(r,s);p||(s=K(s),p=c.call(r,s));const l=a.call(r,s);return r.set(s,o),p?Ze(o,l)&&rt(r,"set",s,o):rt(r,"add",s,o),this},delete(s){const o=K(this),{has:r,get:c}=On(o);let a=r.call(o,s);a||(s=K(s),a=r.call(o,s)),c&&c.call(o,s);const p=o.delete(s);return a&&rt(o,"delete",s,void 0),p},clear(){const s=K(this),o=s.size!==0,r=s.clear();return o&&rt(s,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(s=>{n[s]=Qp(s,e,t)}),n}function ts(e,t){const n=eu(e,t);return(i,s,o)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(W(n,s)&&s in i?n:i,s,o)}const tu={get:ts(!1,!1)},nu={get:ts(!1,!0)},iu={get:ts(!0,!1)};const Eo=new WeakMap,Io=new WeakMap,Co=new WeakMap,su=new WeakMap;function ou(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ns(e){return pt(e)?e:is(e,!1,Xp,tu,Eo)}function ru(e){return is(e,!1,Zp,nu,Io)}function Mi(e){return is(e,!0,Jp,iu,Co)}function is(e,t,n,i,s){if(!z(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const o=s.get(e);if(o)return o;const r=ou(Sp(e));if(r===0)return e;const c=new Proxy(e,r===2?i:n);return s.set(e,c),c}function St(e){return pt(e)?St(e.__v_raw):!!(e&&e.__v_isReactive)}function pt(e){return!!(e&&e.__v_isReadonly)}function Fe(e){return!!(e&&e.__v_isShallow)}function ss(e){return e?!!e.__v_raw:!1}function K(e){const t=e&&e.__v_raw;return t?K(t):e}function cu(e){return!W(e,"__v_skip")&&Object.isExtensible(e)&&mo(e,"__v_skip",!0),e}const Ge=e=>z(e)?ns(e):e,jt=e=>z(e)?Mi(e):e;function Te(e){return e?e.__v_isRef===!0:!1}function pe(e){return Mo(e,!1)}function ni(e){return Mo(e,!0)}function Mo(e,t){return Te(e)?e:new au(e,t)}class au{constructor(t,n){this.dep=new es,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:K(t),this._value=n?t:Ge(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,i=this.__v_isShallow||Fe(t)||pt(t);t=i?t:K(t),Ze(t,n)&&(this._rawValue=t,this._value=i?t:Ge(t),this.dep.trigger())}}function w(e){return Te(e)?e.value:e}const lu={get:(e,t,n)=>t==="__v_raw"?e:w(Reflect.get(e,t,n)),set:(e,t,n,i)=>{const s=e[t];return Te(s)&&!Te(n)?(s.value=n,!0):Reflect.set(e,t,n,i)}};function $o(e){return St(e)?e:new Proxy(e,lu)}class pu{constructor(t,n,i){this.fn=t,this.setter=n,this._value=void 0,this.dep=new es(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=pn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&ne!==this)return Ao(this,!0),!0}get value(){const t=this.dep.track();return bo(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function uu(e,t,n=!1){let i,s;return j(e)?i=e:(i=e.get,s=e.set),new pu(i,s,n)}const Sn={},Dn=new WeakMap;let Pt;function _u(e,t=!1,n=Pt){if(n){let i=Dn.get(n);i||Dn.set(n,i=[]),i.push(e)}}function du(e,t,n=ee){const{immediate:i,deep:s,once:o,scheduler:r,augmentJob:c,call:a}=n,p=E=>s?E:Fe(E)||s===!1||s===0?ct(E,1):ct(E);let l,d,h,y,$=!1,P=!1;if(Te(e)?(d=()=>e.value,$=Fe(e)):St(e)?(d=()=>p(e),$=!0):D(e)?(P=!0,$=e.some(E=>St(E)||Fe(E)),d=()=>e.map(E=>{if(Te(E))return E.value;if(St(E))return p(E);if(j(E))return a?a(E,2):E()})):j(e)?t?d=a?()=>a(e,2):e:d=()=>{if(h){at();try{h()}finally{lt()}}const E=Pt;Pt=l;try{return a?a(e,3,[y]):e(y)}finally{Pt=E}}:d=Qe,t&&s){const E=d,q=s===!0?1/0:s;d=()=>ct(E(),q)}const T=Gp(),R=()=>{l.stop(),T&&T.active&&qi(T.effects,l)};if(o&&t){const E=t;t=(...q)=>{const U=E(...q);return R(),U}}let N=P?new Array(e.length).fill(Sn):Sn;const B=E=>{if(!(!(l.flags&1)||!l.dirty&&!E))if(t){const q=l.run();if(E||s||$||(P?q.some((U,ie)=>Ze(U,N[ie])):Ze(q,N))){h&&h();const U=Pt;Pt=l;try{const ie=[q,N===Sn?void 0:P&&N[0]===Sn?[]:N,y];N=q,a?a(t,3,ie):t(...ie)}finally{Pt=U}}}else l.run()};return c&&c(B),l=new ko(d),l.scheduler=r?()=>r(B,!1):B,y=E=>_u(E,!1,l),h=l.onStop=()=>{const E=Dn.get(l);if(E){if(a)a(E,4);else for(const q of E)q();Dn.delete(l)}},t?i?B(!0):N=l.run():r?r(B.bind(null,!0),!0):l.run(),R.pause=l.pause.bind(l),R.resume=l.resume.bind(l),R.stop=R,R}function ct(e,t=1/0,n){if(t<=0||!z(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,Te(e))ct(e.value,t,n);else if(D(e))for(let i=0;i<e.length;i++)ct(e[i],t,n);else if(po(e)||Ht(e))e.forEach(i=>{ct(i,t,n)});else if(fo(e)){for(const i in e)ct(e[i],t,n);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&ct(e[i],t,n)}return e}/**
* @vue/runtime-core v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Tn(e,t,n,i){try{return i?e(...i):e()}catch(s){ii(s,t,n)}}function De(e,t,n,i){if(j(e)){const s=Tn(e,t,n,i);return s&&uo(s)&&s.catch(o=>{ii(o,t,n)}),s}if(D(e)){const s=[];for(let o=0;o<e.length;o++)s.push(De(e[o],t,n,i));return s}}function ii(e,t,n,i=!0){const s=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||ee;if(t){let c=t.parent;const a=t.proxy,p=`https://vuejs.org/error-reference/#runtime-${n}`;for(;c;){const l=c.ec;if(l){for(let d=0;d<l.length;d++)if(l[d](e,a,p)===!1)return}c=c.parent}if(o){at(),Tn(o,null,10,[e,a,p]),lt();return}}fu(e,n,s,i,r)}function fu(e,t,n,i=!0,s=!1){if(s)throw e;console.error(e)}const we=[];let ze=-1;const Vt=[];let gt=null,Nt=0;const No=Promise.resolve();let Bn=null;function gu(e){const t=Bn||No;return e?t.then(this?e.bind(this):e):t}function mu(e){let t=ze+1,n=we.length;for(;t<n;){const i=t+n>>>1,s=we[i],o=_n(s);o<e||o===e&&s.flags&2?t=i+1:n=i}return t}function os(e){if(!(e.flags&1)){const t=_n(e),n=we[we.length-1];!n||!(e.flags&2)&&t>=_n(n)?we.push(e):we.splice(mu(t),0,e),e.flags|=1,Fo()}}function Fo(){Bn||(Bn=No.then(Bo))}function vu(e){if(!D(e))gt&&e.id===-1?gt.splice(Nt+1,0,e):e.flags&1||(Vt.push(e),e.flags|=1);else for(let t=0;t<e.length;t++)Vt.push(e[t]);Fo()}function Ls(e,t,n=ze+1){for(;n<we.length;n++){const i=we[n];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;we.splice(n,1),n--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Do(e){if(Vt.length){const t=[...new Set(Vt)].sort((n,i)=>_n(n)-_n(i));if(Vt.length=0,gt){for(let n=0;n<t.length;n++)gt.push(t[n]);return}for(gt=t,Nt=0;Nt<gt.length;Nt++){const n=gt[Nt];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}gt=null,Nt=0}}const _n=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Bo(e){try{for(ze=0;ze<we.length;ze++){const t=we[ze];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Tn(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;ze<we.length;ze++){const t=we[ze];t&&(t.flags&=-2)}ze=-1,we.length=0,Do(),Bn=null,(we.length||Vt.length)&&Bo()}}let Ne=null,Ho=null;function Hn(e){const t=Ne;return Ne=e,Ho=e&&e.type.__scopeId||null,t}function rs(e,t=Ne,n){if(!t||e._n)return e;const i=(...s)=>{i._d&&Un(-1);const o=Hn(t),r=Et.length;let c;try{c=e(...s)}finally{for(let a=Et.length;a>r;a--)gr();Hn(o),i._d&&Un(1)}return c};return i._n=!0,i._c=!0,i._d=!0,i}function hu(e,t){if(Ne===null)return e;const n=pi(Ne),i=e.dirs||(e.dirs=[]);for(let s=0;s<t.length;s++){let[o,r,c,a=ee]=t[s];o&&(j(o)&&(o={mounted:o,updated:o}),o.deep&&ct(r),i.push({dir:o,instance:n,value:r,oldValue:void 0,arg:c,modifiers:a}))}return e}function At(e,t,n,i){const s=e.dirs,o=t&&t.dirs;for(let r=0;r<s.length;r++){const c=s[r];o&&(c.oldValue=o[r].value);let a=c.dir[i];a&&(at(),De(a,n,8,[e.el,c,e,t]),lt())}}function xu(e,t){if(Oe){let n=Oe.provides;const i=Oe.parent&&Oe.parent.provides;i===n&&(n=Oe.provides=Object.create(i)),n[e]=t}}function Mn(e,t,n=!1){const i=ps();if(i||Gt){let s=Gt?Gt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return n&&j(t)?t.call(i&&i.proxy):t}}const ku=Symbol.for("v-scx"),yu=()=>Mn(ku);function Ce(e,t,n){return Vo(e,t,n)}function Vo(e,t,n=ee){const{immediate:i,deep:s,flush:o,once:r}=n,c=fe({},n),a=t&&i||!t&&o!=="post";let p;if(mn){if(o==="sync"){const y=yu();p=y.__watcherHandles||(y.__watcherHandles=[])}else if(!a){const y=()=>{};return y.stop=Qe,y.resume=Qe,y.pause=Qe,y}}const l=Oe;c.call=(y,$,P)=>De(y,l,$,P);let d=!1;o==="post"?c.scheduler=y=>{Re(y,l&&l.suspense)}:o!=="sync"&&(d=!0,c.scheduler=(y,$)=>{$?y():os(y)}),c.augmentJob=y=>{t&&(y.flags|=4),d&&(y.flags|=2,l&&(y.id=l.uid,y.i=l))};const h=du(e,t,c);return mn&&(p?p.push(h):a&&h()),h}function Au(e,t,n){const i=this.proxy,s=ae(e)?e.includes(".")?Go(i,e):()=>i[e]:e.bind(i,i);let o;j(t)?o=t:(o=t.handler,n=t);const r=bn(this),c=Vo(s,o.bind(i),n);return r(),c}function Go(e,t){const n=t.split(".");return()=>{let i=e;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}const Lu=Symbol("_vte"),si=e=>e.__isTeleport,$e=Symbol("_leaveCb"),Jt=Symbol("_enterCb");function jo(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ci(()=>{e.isMounted=!0}),Jo(()=>{e.isUnmounting=!0}),e}const Me=[Function,Array],Uo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Me,onEnter:Me,onAfterEnter:Me,onEnterCancelled:Me,onBeforeLeave:Me,onLeave:Me,onAfterLeave:Me,onLeaveCancelled:Me,onBeforeAppear:Me,onAppear:Me,onAfterAppear:Me,onAppearCancelled:Me},Yo=e=>{const t=e.subTree;return t.component?Yo(t.component):t},Tu={name:"BaseTransition",props:Uo,setup(e,{slots:t}){const n=ps(),i=jo();return()=>{const s=t.default&&cs(t.default(),!0),o=s&&s.length?Ko(s):n.subTree?de():void 0;if(!o)return;const r=K(e),{mode:c}=r;if(i.isLeaving)return ki(o);const a=Vn(o);if(!a)return ki(o);let p=dn(a,r,i,n,d=>p=d);a.type!==Pe&&It(a,p);let l=n.subTree&&Vn(n.subTree);if(l&&l.type!==Pe&&!Ot(l,a)&&Yo(n).type!==Pe){let d=dn(l,r,i,n);if(It(l,d),c==="out-in"&&a.type!==Pe)return i.isLeaving=!0,d.afterLeave=()=>{i.isLeaving=!1,n.job.flags&8||n.update(),delete d.afterLeave,l=void 0},ki(o);c==="in-out"&&a.type!==Pe?d.delayLeave=(h,y,$)=>{const P=qo(i,l);P[String(l.key)]=l,h[$e]=()=>{y(),h[$e]=void 0,delete p.delayedLeave,l=void 0},p.delayedLeave=()=>{$(),delete p.delayedLeave,l=void 0}}:l=void 0}else l&&(l=void 0);return o}}};function Ko(e){let t=e[0];if(e.length>1){for(const n of e)if(n.type!==Pe){t=n;break}}return t}const bu=Tu;function qo(e,t){const{leavingVNodes:n}=e;let i=n.get(t.type);return i||(i=Object.create(null),n.set(t.type,i)),i}function dn(e,t,n,i,s){const{appear:o,mode:r,persisted:c=!1,onBeforeEnter:a,onEnter:p,onAfterEnter:l,onEnterCancelled:d,onBeforeLeave:h,onLeave:y,onAfterLeave:$,onLeaveCancelled:P,onBeforeAppear:T,onAppear:R,onAfterAppear:N,onAppearCancelled:B}=t,E=String(e.key),q=qo(n,e),U=(G,J)=>{G&&De(G,i,9,J)},ie=(G,J)=>{const oe=J[1];U(G,J),D(G)?G.every(S=>S.length<=1)&&oe():G.length<=1&&oe()},X={mode:r,persisted:c,beforeEnter(G){let J=a;if(!n.isMounted)if(o)J=T||a;else return;G[$e]&&G[$e](!0);const oe=q[E];oe&&Ot(e,oe)&&oe.el[$e]&&oe.el[$e](),U(J,[G])},enter(G){if(q[E]===e)return;let J=p,oe=l,S=d;if(!n.isMounted)if(o)J=R||p,oe=N||l,S=B||d;else return;let se=!1;G[Jt]=tt=>{se||(se=!0,tt?U(S,[G]):U(oe,[G]),X.delayedLeave&&X.delayedLeave(),G[Jt]=void 0)};const Ae=G[Jt].bind(null,!1);J?ie(J,[G,Ae]):Ae()},leave(G,J){const oe=String(e.key);if(G[Jt]&&G[Jt](!0),n.isUnmounting)return J();U(h,[G]);let S=!1;G[$e]=Ae=>{S||(S=!0,J(),Ae?U(P,[G]):U($,[G]),G[$e]=void 0,q[oe]===e&&delete q[oe])};const se=G[$e].bind(null,!1);q[oe]=e,y?ie(y,[G,se]):se()},clone(G){const J=dn(G,t,n,i,s);return s&&s(J),J}};return X}function ki(e){if(oi(e))return e=mt(e),e.children=null,e}function Vn(e){if(!oi(e))return si(e.type)&&e.children?Ko(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:n}=e;if(n){if(t&16)return n[0];if(t&32&&j(n.default))return n.default()}}function It(e,t){if(e.shapeFlag&6&&e.component){e.transition=t;const n=e.component.subTree;It(si(n.type)&&Vn(n)||n,t)}else e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function cs(e,t=!1,n){let i=[],s=0;for(let o=0;o<e.length;o++){let r=e[o];const c=n==null?r.key:String(n)+String(r.key!=null?r.key:o);r.type===ve?(r.patchFlag&128&&s++,i=i.concat(cs(r.children,t,c))):(t||r.type!==Pe)&&i.push(c!=null?mt(r,{key:c}):r)}if(s>1)for(let o=0;o<i.length;o++)i[o].patchFlag=-2;return i}function ut(e,t){return j(e)?fe({name:e.name},t,{setup:e}):e}function Wo(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Ts(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const Gn=new WeakMap;function rn(e,t,n,i,s=!1){if(D(e)){e.forEach((P,T)=>rn(P,t&&(D(t)?t[T]:t),n,i,s));return}if(cn(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&rn(e,t,n,i.component.subTree);return}const o=i.shapeFlag&4?pi(i.component):i.el,r=s?null:o,{i:c,r:a}=e,p=t&&t.r,l=c.refs===ee?c.refs={}:c.refs,d=c.setupState,h=K(d),y=d===ee?lo:P=>Ts(l,P)?!1:W(h,P),$=(P,T)=>!(T&&Ts(l,T));if(p!=null&&p!==a){if(bs(t),ae(p))l[p]=null,y(p)&&(d[p]=null);else if(Te(p)){const P=t;$(p,P.k)&&(p.value=null),P.k&&(l[P.k]=null)}}if(j(a))Tn(a,c,12,[r,l]);else{const P=ae(a),T=Te(a);if(P||T){const R=()=>{if(e.f){const N=P?y(a)?d[a]:l[a]:$()||!e.k?a.value:l[e.k];if(s)D(N)&&qi(N,o);else if(D(N))N.includes(o)||N.push(o);else if(P)l[a]=[o],y(a)&&(d[a]=l[a]);else{const B=[o];$(a,e.k)&&(a.value=B),e.k&&(l[e.k]=B)}}else P?(l[a]=r,y(a)&&(d[a]=r)):T&&($(a,e.k)&&(a.value=r),e.k&&(l[e.k]=r))};if(r){const N=()=>{R(),Gn.delete(e)};N.id=-1,Gn.set(e,N),Re(N,n)}else bs(e),R()}}}function bs(e){const t=Gn.get(e);t&&(t.flags|=8,Gn.delete(e))}ei().requestIdleCallback;ei().cancelIdleCallback;const cn=e=>!!e.type.__asyncLoader,oi=e=>e.type.__isKeepAlive;function wu(e,t){zo(e,"a",t)}function Pu(e,t){zo(e,"da",t)}function zo(e,t,n=Oe){const i=e.__wdc||(e.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(ri(t,i,n),n){let s=n.parent;for(;s&&s.parent;)oi(s.parent.vnode)&&Ou(i,t,n,s),s=s.parent}}function Ou(e,t,n,i){const s=ri(t,e,i,!0);Kt(()=>{qi(i[t],s)},n)}function ri(e,t,n=Oe,i=!1){if(n){const s=n[e]||(n[e]=[]),o=t.__weh||(t.__weh=(...r)=>{at();const c=bn(n),a=De(t,n,e,r);return c(),lt(),a});return i?s.unshift(o):s.push(o),o}}const _t=e=>(t,n=Oe)=>{(!mn||e==="sp")&&ri(e,(...i)=>t(...i),n)},Ru=_t("bm"),ci=_t("m"),Su=_t("bu"),Xo=_t("u"),Jo=_t("bum"),Kt=_t("um"),Eu=_t("sp"),Iu=_t("rtg"),Cu=_t("rtc");function Mu(e,t=Oe){ri("ec",e,t)}const $u=Symbol.for("v-ndc");function Ut(e,t,n,i){let s;const o=n,r=D(e);if(r||ae(e)){const c=r&&St(e);let a=!1,p=!1;c&&(a=!Fe(e),p=pt(e),e=ti(e)),s=new Array(e.length);for(let l=0,d=e.length;l<d;l++)s[l]=t(a?p?jt(Ge(e[l])):Ge(e[l]):e[l],l,void 0,o)}else if(typeof e=="number"){s=new Array(e);for(let c=0;c<e;c++)s[c]=t(c+1,c,void 0,o)}else if(z(e))if(e[Symbol.iterator])s=Array.from(e,(c,a)=>t(c,a,void 0,o));else{const c=Object.keys(e);s=new Array(c.length);for(let a=0,p=c.length;a<p;a++){const l=c[a];s[a]=t(e[l],l,a,o)}}else s=[];return s}const $i=e=>e?xr(e)?pi(e):$i(e.parent):null,an=fe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>$i(e.parent),$root:e=>$i(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Qo(e),$forceUpdate:e=>e.f||(e.f=()=>{os(e.update)}),$nextTick:e=>e.n||(e.n=gu.bind(e.proxy)),$watch:e=>Au.bind(e)}),yi=(e,t)=>e!==ee&&!e.__isScriptSetup&&W(e,t),Nu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:i,data:s,props:o,accessCache:r,type:c,appContext:a}=e;if(t[0]!=="$"){const h=r[t];if(h!==void 0)switch(h){case 1:return i[t];case 2:return s[t];case 4:return n[t];case 3:return o[t]}else{if(yi(i,t))return r[t]=1,i[t];if(s!==ee&&W(s,t))return r[t]=2,s[t];if(W(o,t))return r[t]=3,o[t];if(n!==ee&&W(n,t))return r[t]=4,n[t];Ni&&(r[t]=0)}}const p=an[t];let l,d;if(p)return t==="$attrs"&&Le(e.attrs,"get",""),p(e);if((l=c.__cssModules)&&(l=l[t]))return l;if(n!==ee&&W(n,t))return r[t]=4,n[t];if(d=a.config.globalProperties,W(d,t))return d[t]},set({_:e},t,n){const{data:i,setupState:s,ctx:o}=e;return yi(s,t)?(s[t]=n,!0):i!==ee&&W(i,t)?(i[t]=n,!0):W(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:i,appContext:s,props:o,type:r}},c){let a;return!!(n[c]||e!==ee&&c[0]!=="$"&&W(e,c)||yi(t,c)||W(o,c)||W(i,c)||W(an,c)||W(s.config.globalProperties,c)||(a=r.__cssModules)&&a[c])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:W(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function ws(e){return D(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}let Ni=!0;function Fu(e){const t=Qo(e),n=e.proxy,i=e.ctx;Ni=!1,t.beforeCreate&&Ps(t.beforeCreate,e,"bc");const{data:s,computed:o,methods:r,watch:c,provide:a,inject:p,created:l,beforeMount:d,mounted:h,beforeUpdate:y,updated:$,activated:P,deactivated:T,beforeDestroy:R,beforeUnmount:N,destroyed:B,unmounted:E,render:q,renderTracked:U,renderTriggered:ie,errorCaptured:X,serverPrefetch:G,expose:J,inheritAttrs:oe,components:S,directives:se,filters:Ae}=t;if(p&&Du(p,i,null),r)for(const re in r){const te=r[re];j(te)&&(i[re]=te.bind(n))}if(s){const re=s.call(n,n);z(re)&&(e.data=ns(re))}if(Ni=!0,o)for(const re in o){const te=o[re],kt=j(te)?te.bind(n,n):j(te.get)?te.get.bind(n,n):Qe,wn=!j(te)&&j(te.set)?te.set.bind(n):Qe,yt=ce({get:kt,set:wn});Object.defineProperty(i,re,{enumerable:!0,configurable:!0,get:()=>yt.value,set:je=>yt.value=je})}if(c)for(const re in c)Zo(c[re],i,n,re);if(a){const re=j(a)?a.call(n):a;Reflect.ownKeys(re).forEach(te=>{xu(te,re[te])})}l&&Ps(l,e,"c");function ge(re,te){D(te)?te.forEach(kt=>re(kt.bind(n))):te&&re(te.bind(n))}if(ge(Ru,d),ge(ci,h),ge(Su,y),ge(Xo,$),ge(wu,P),ge(Pu,T),ge(Mu,X),ge(Cu,U),ge(Iu,ie),ge(Jo,N),ge(Kt,E),ge(Eu,G),D(J))if(J.length){const re=e.exposed||(e.exposed={});J.forEach(te=>{Object.defineProperty(re,te,{get:()=>n[te],set:kt=>n[te]=kt,enumerable:!0})})}else e.exposed||(e.exposed={});q&&e.render===Qe&&(e.render=q),oe!=null&&(e.inheritAttrs=oe),S&&(e.components=S),se&&(e.directives=se),G&&Wo(e)}function Du(e,t,n=Qe){D(e)&&(e=Fi(e));for(const i in e){const s=e[i];let o;z(s)?"default"in s?o=Mn(s.from||i,s.default,!0):o=Mn(s.from||i):o=Mn(s),Te(o)?Object.defineProperty(t,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[i]=o}}function Ps(e,t,n){De(D(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,n)}function Zo(e,t,n,i){let s=i.includes(".")?Go(n,i):()=>n[i];if(ae(e)){const o=t[e];j(o)&&Ce(s,o)}else if(j(e))Ce(s,e.bind(n));else if(z(e))if(D(e))e.forEach(o=>Zo(o,t,n,i));else{const o=j(e.handler)?e.handler.bind(n):t[e.handler];j(o)&&Ce(s,o,e)}}function Qo(e){const t=e.type,{mixins:n,extends:i}=t,{mixins:s,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,c=o.get(t);let a;return c?a=c:!s.length&&!n&&!i?a=t:(a={},s.length&&s.forEach(p=>jn(a,p,r,!0)),jn(a,t,r)),z(t)&&o.set(t,a),a}function jn(e,t,n,i=!1){const{mixins:s,extends:o}=t;o&&jn(e,o,n,!0),s&&s.forEach(r=>jn(e,r,n,!0));for(const r in t)if(!(i&&r==="expose")){const c=Bu[r]||n&&n[r];e[r]=c?c(e[r],t[r]):t[r]}return e}const Bu={data:Os,props:Rs,emits:Rs,methods:en,computed:en,beforeCreate:be,created:be,beforeMount:be,mounted:be,beforeUpdate:be,updated:be,beforeDestroy:be,beforeUnmount:be,destroyed:be,unmounted:be,activated:be,deactivated:be,errorCaptured:be,serverPrefetch:be,components:en,directives:en,watch:Vu,provide:Os,inject:Hu};function Os(e,t){return t?e?function(){return fe(j(e)?e.call(this,this):e,j(t)?t.call(this,this):t)}:t:e}function Hu(e,t){return en(Fi(e),Fi(t))}function Fi(e){if(D(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function be(e,t){return e?[...new Set([].concat(e,t))]:t}function en(e,t){return e?fe(Object.create(null),e,t):t}function Rs(e,t){return e?D(e)&&D(t)?[...new Set([...e,...t])]:fe(Object.create(null),ws(e),ws(t??{})):t}function Vu(e,t){if(!e)return t;if(!t)return e;const n=fe(Object.create(null),e);for(const i in t)n[i]=be(e[i],t[i]);return n}function er(){return{app:null,config:{isNativeTag:lo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Gu=0;function ju(e,t){return function(i,s=null){j(i)||(i=fe({},i)),s!=null&&!z(s)&&(s=null);const o=er(),r=new WeakSet,c=[];let a=!1;const p=o.app={_uid:Gu++,_component:i,_props:s,_container:null,_context:o,_instance:null,version:k_,get config(){return o.config},set config(l){},use(l,...d){return r.has(l)||(l&&j(l.install)?(r.add(l),l.install(p,...d)):j(l)&&(r.add(l),l(p,...d))),p},mixin(l){return o.mixins.includes(l)||o.mixins.push(l),p},component(l,d){return d?(o.components[l]=d,p):o.components[l]},directive(l,d){return d?(o.directives[l]=d,p):o.directives[l]},mount(l,d,h){if(!a){const y=p._ceVNode||xe(i,s);return y.appContext=o,h===!0?h="svg":h===!1&&(h=void 0),e(y,l,h),a=!0,p._container=l,l.__vue_app__=p,pi(y.component)}},onUnmount(l){c.push(l)},unmount(){a&&(De(c,p._instance,16),e(null,p._container),delete p._container.__vue_app__)},provide(l,d){return o.provides[l]=d,p},runWithContext(l){const d=Gt;Gt=p;try{return l()}finally{Gt=d}}};return p}}let Gt=null;const Uu=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Be(t)}Modifiers`]||e[`${Mt(t)}Modifiers`];function Yu(e,t,...n){if(e.isUnmounted)return;const i=e.vnode.props||ee;let s=n;const o=t.startsWith("update:"),r=o&&Uu(i,t.slice(7));r&&(r.trim&&(s=n.map(l=>ae(l)?l.trim():l)),r.number&&(s=n.map(zi)));let c,a=i[c=gi(t)]||i[c=gi(Be(t))];!a&&o&&(a=i[c=gi(Mt(t))]),a&&De(a,e,6,s);const p=i[c+"Once"];if(p){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,De(p,e,6,s)}}const Ku=new WeakMap;function tr(e,t,n=!1){const i=n?Ku:t.emitsCache,s=i.get(e);if(s!==void 0)return s;const o=e.emits;let r={},c=!1;if(!j(e)){const a=p=>{const l=tr(p,t,!0);l&&(c=!0,fe(r,l))};!n&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!c?(z(e)&&i.set(e,null),null):(D(o)?o.forEach(a=>r[a]=null):fe(r,o),z(e)&&i.set(e,r),r)}function ai(e,t){return!e||!Jn(t)?!1:(t=t.slice(2),t=t==="Once"?t:t.replace(/Once$/,""),W(e,t[0].toLowerCase()+t.slice(1))||W(e,Mt(t))||W(e,t))}function Ss(e){const{type:t,vnode:n,proxy:i,withProxy:s,propsOptions:[o],slots:r,attrs:c,emit:a,render:p,renderCache:l,props:d,data:h,setupState:y,ctx:$,inheritAttrs:P}=e,T=Hn(e);let R,N;try{if(n.shapeFlag&4){const E=s||i,q=E;R=Je(p.call(q,E,l,d,y,h,$)),N=c}else{const E=t;R=Je(E.length>1?E(d,{attrs:c,slots:r,emit:a}):E(d,null)),N=t.props?c:qu(c)}}catch(E){Et.length=0,ii(E,e,1),R=xe(Pe)}let B=R;if(N&&P!==!1){const E=Object.keys(N),{shapeFlag:q}=B;E.length&&q&7&&(o&&E.some(Zn)&&(N=Wu(N,o)),B=mt(B,N,!1,!0))}if(n.dirs&&(B=mt(B,null,!1,!0),B.dirs=B.dirs?B.dirs.concat(n.dirs):n.dirs),n.transition){const E=si(B.type)&&Vn(B)||B;It(E,n.transition)}return R=B,Hn(T),R}const qu=e=>{let t;for(const n in e)(n==="class"||n==="style"||Jn(n))&&((t||(t={}))[n]=e[n]);return t},Wu=(e,t)=>{const n={};for(const i in e)(!Zn(i)||!(i.slice(9)in t))&&(n[i]=e[i]);return n};function zu(e,t,n){const{props:i,children:s,component:o}=e,{props:r,children:c,patchFlag:a}=t,p=o.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?Es(i,r,p):!!r;if(a&8){const l=t.dynamicProps;for(let d=0;d<l.length;d++){const h=l[d];if(nr(r,i,h)&&!ai(p,h))return!0}}}else return(s||c)&&(!c||!c.$stable)?!0:i===r?!1:i?r?Es(i,r,p):!0:!!r;return!1}function Es(e,t,n){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const o=i[s];if(nr(t,e,o)&&!ai(n,o))return!0}return!1}function nr(e,t,n){const i=e[n],s=t[n];return n==="style"&&z(i)&&z(s)?!Xi(i,s):i!==s}function Xu({vnode:e,parent:t,suspense:n},i){for(;t;){const s=t.subTree;if(s.suspense&&s.suspense.activeBranch===e&&(s.suspense.vnode.el=s.el=i,e=s),s===e)(e=t.vnode).el=i,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=i)}const ir={},sr=()=>Object.create(ir),or=e=>Object.getPrototypeOf(e)===ir;function Ju(e,t,n,i=!1){const s={},o=sr();e.propsDefaults=Object.create(null),rr(e,t,s,o);for(const r in e.propsOptions[0])r in s||(s[r]=void 0);n?e.props=i?s:ru(s):e.type.props?e.props=s:e.props=o,e.attrs=o}function Zu(e,t,n,i){const{props:s,attrs:o,vnode:{patchFlag:r}}=e,c=K(s),[a]=e.propsOptions;let p=!1;if((i||r>0)&&!(r&16)){if(r&8){const l=e.vnode.dynamicProps;for(let d=0;d<l.length;d++){let h=l[d];if(ai(e.emitsOptions,h))continue;const y=t[h];if(a)if(W(o,h))y!==o[h]&&(o[h]=y,p=!0);else{const $=Be(h);s[$]=Di(a,c,$,y,e,!1)}else y!==o[h]&&(o[h]=y,p=!0)}}}else{rr(e,t,s,o)&&(p=!0);let l;for(const d in c)(!t||!W(t,d)&&((l=Mt(d))===d||!W(t,l)))&&(a?n&&(n[d]!==void 0||n[l]!==void 0)&&(s[d]=Di(a,c,d,void 0,e,!0)):delete s[d]);if(o!==c)for(const d in o)(!t||!W(t,d))&&(delete o[d],p=!0)}p&&rt(e.attrs,"set","")}function rr(e,t,n,i){const[s,o]=e.propsOptions;let r=!1,c;if(t)for(let a in t){if(nn(a))continue;const p=t[a];let l;s&&W(s,l=Be(a))?!o||!o.includes(l)?n[l]=p:(c||(c={}))[l]=p:ai(e.emitsOptions,a)||(!(a in i)||p!==i[a])&&(i[a]=p,r=!0)}if(o){const a=K(n),p=c||ee;for(let l=0;l<o.length;l++){const d=o[l];n[d]=Di(s,a,d,p[d],e,!W(p,d))}}return r}function Di(e,t,n,i,s,o){const r=e[n];if(r!=null){const c=W(r,"default");if(c&&i===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&j(a)){const{propsDefaults:p}=s;if(n in p)i=p[n];else{const l=bn(s);i=p[n]=a.call(null,t),l()}}else i=a;s.ce&&s.ce._setProp(n,i)}r[0]&&(o&&!c?i=!1:r[1]&&(i===""||i===Mt(n))&&(i=!0))}return i}const Qu=new WeakMap;function cr(e,t,n=!1){const i=n?Qu:t.propsCache,s=i.get(e);if(s)return s;const o=e.props,r={},c=[];let a=!1;if(!j(e)){const l=d=>{a=!0;const[h,y]=cr(d,t,!0);fe(r,h),y&&c.push(...y)};!n&&t.mixins.length&&t.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}if(!o&&!a)return z(e)&&i.set(e,Bt),Bt;if(D(o))for(let l=0;l<o.length;l++){const d=Be(o[l]);Is(d)&&(r[d]=ee)}else if(o)for(const l in o){const d=Be(l);if(Is(d)){const h=o[l],y=r[d]=D(h)||j(h)?{type:h}:fe({},h),$=y.type;let P=!1,T=!0;if(D($))for(let R=0;R<$.length;++R){const N=$[R],B=j(N)&&N.name;if(B==="Boolean"){P=!0;break}else B==="String"&&(T=!1)}else P=j($)&&$.name==="Boolean";y[0]=P,y[1]=T,(P||W(y,"default"))&&c.push(d)}}const p=[r,c];return z(e)&&i.set(e,p),p}function Is(e){return e[0]!=="$"&&!nn(e)}const as=e=>e==="_"||e==="_ctx"||e==="$stable",ls=e=>D(e)?e.map(Je):[Je(e)],e_=(e,t,n)=>{if(t._n)return t;const i=rs((...s)=>ls(t(...s)),n);return i._c=!1,i},ar=(e,t,n)=>{const i=e._ctx;for(const s in e){if(as(s))continue;const o=e[s];if(j(o))t[s]=e_(s,o,i);else if(o!=null){const r=ls(o);t[s]=()=>r}}},lr=(e,t)=>{const n=ls(t);e.slots.default=()=>n},pr=(e,t,n)=>{for(const i in t)(n||!as(i))&&(e[i]=t[i])},t_=(e,t,n)=>{const i=e.slots=sr();if(e.vnode.shapeFlag&32){const s=t._;s?(pr(i,t,n),n&&mo(i,"_",s,!0)):ar(t,i)}else t&&lr(e,t)},n_=(e,t,n)=>{const{vnode:i,slots:s}=e;let o=!0,r=ee;if(i.shapeFlag&32){const c=t._;c?n&&c===1?o=!1:pr(s,t,n):(o=!t.$stable,ar(t,s)),r=t}else t&&(lr(e,t),r={default:1});if(o)for(const c in s)!as(c)&&r[c]==null&&delete s[c]},Re=c_;function i_(e){return s_(e)}function s_(e,t){const n=ei();n.__VUE__=!0;const{insert:i,remove:s,patchProp:o,createElement:r,createText:c,createComment:a,setText:p,setElementText:l,parentNode:d,nextSibling:h,setScopeId:y=Qe,insertStaticContent:$}=e,P=(u,_,f,k=null,v=null,g=null,b=void 0,L=null,A=!!_.dynamicChildren)=>{if(u===_)return;u&&!Ot(u,_)&&(k=Pn(u),je(u,v,g,!0),u=null),_.patchFlag===-2&&(A=!1,_.dynamicChildren=null);const{type:m,ref:F,shapeFlag:O}=_;switch(m){case li:T(u,_,f,k);break;case Pe:R(u,_,f,k);break;case $n:u==null&&N(_,f,k,b);break;case ve:S(u,_,f,k,v,g,b,L,A);break;default:O&1?q(u,_,f,k,v,g,b,L,A):O&6?se(u,_,f,k,v,g,b,L,A):(O&64||O&128)&&m.process(u,_,f,k,v,g,b,L,A,Wt)}F!=null&&v?rn(F,u&&u.ref,g,_||u,!_):F==null&&u&&u.ref!=null&&rn(u.ref,null,g,u,!0)},T=(u,_,f,k)=>{if(u==null)i(_.el=c(_.children),f,k);else{const v=_.el=u.el;_.children!==u.children&&p(v,_.children)}},R=(u,_,f,k)=>{u==null?i(_.el=a(_.children||""),f,k):_.el=u.el},N=(u,_,f,k)=>{[u.el,u.anchor]=$(u.children,_,f,k,u.el,u.anchor)},B=({el:u,anchor:_},f,k)=>{let v;for(;u&&u!==_;)v=h(u),i(u,f,k),u=v;i(_,f,k)},E=({el:u,anchor:_})=>{let f;for(;u&&u!==_;)f=h(u),s(u),u=f;s(_)},q=(u,_,f,k,v,g,b,L,A)=>{if(_.type==="svg"?b="svg":_.type==="math"&&(b="mathml"),u==null)U(_,f,k,v,g,b,L,A);else{const m=u.el&&u.el._isVueCE?u.el:null;try{m&&m._beginPatch(),G(u,_,v,g,b,L,A)}finally{m&&m._endPatch()}}},U=(u,_,f,k,v,g,b,L)=>{let A,m;const{props:F,shapeFlag:O,transition:C,dirs:V}=u;if(A=u.el=r(u.type,g,F&&F.is,F),O&8?l(A,u.children):O&16&&X(u.children,A,null,k,v,Ai(u,g),b,L),V&&At(u,null,k,"created"),ie(A,u,u.scopeId,b,k),F){for(const Q in F)Q!=="value"&&!nn(Q)&&o(A,Q,null,F[Q],g,k);"value"in F&&o(A,"value",null,F.value,g),(m=F.onVnodeBeforeMount)&&qe(m,k,u)}V&&At(u,null,k,"beforeMount");const Y=o_(v,C);Y&&C.beforeEnter(A),i(A,_,f),((m=F&&F.onVnodeMounted)||Y||V)&&Re(()=>{try{m&&qe(m,k,u),Y&&C.enter(A),V&&At(u,null,k,"mounted")}finally{}},v)},ie=(u,_,f,k,v)=>{if(f&&y(u,f),k)for(let g=0;g<k.length;g++)y(u,k[g]);if(v){let g=v.subTree;if(_===g||fr(g.type)&&(g.ssContent===_||g.ssFallback===_)){const b=v.vnode;ie(u,b,b.scopeId,b.slotScopeIds,v.parent)}}},X=(u,_,f,k,v,g,b,L,A=0)=>{for(let m=A;m<u.length;m++){const F=u[m]=L?ot(u[m]):Je(u[m]);P(null,F,_,f,k,v,g,b,L)}},G=(u,_,f,k,v,g,b)=>{const L=_.el=u.el;let{patchFlag:A,dynamicChildren:m,dirs:F}=_;A|=u.patchFlag&16;const O=u.props||ee,C=_.props||ee;let V;if(f&&Lt(f,!1),(V=C.onVnodeBeforeUpdate)&&qe(V,f,_,u),F&&At(_,u,f,"beforeUpdate"),f&&Lt(f,!0),m&&(!u.dynamicChildren||u.dynamicChildren.length!==m.length)&&(A=0,b=!1,m=null),(O.innerHTML&&C.innerHTML==null||O.textContent&&C.textContent==null)&&l(L,""),m?J(u.dynamicChildren,m,L,f,k,Ai(_,v),g):b||te(u,_,L,null,f,k,Ai(_,v),g,!1),A>0){if(A&16)oe(L,O,C,f,v);else if(A&2&&O.class!==C.class&&o(L,"class",null,C.class,v),A&4&&o(L,"style",O.style,C.style,v),A&8){const Y=_.dynamicProps;for(let Q=0;Q<Y.length;Q++){const Z=Y[Q],_e=O[Z],ke=C[Z];(ke!==_e||Z==="value")&&o(L,Z,_e,ke,v,f)}}A&1&&u.children!==_.children&&l(L,_.children)}else!b&&m==null&&oe(L,O,C,f,v);((V=C.onVnodeUpdated)||F)&&Re(()=>{V&&qe(V,f,_,u),F&&At(_,u,f,"updated")},k)},J=(u,_,f,k,v,g,b)=>{for(let L=0;L<_.length;L++){const A=u[L],m=_[L],F=A.el&&(A.type===ve||!Ot(A,m)||A.shapeFlag&198)?d(A.el):f;P(A,m,F,null,k,v,g,b,!0)}},oe=(u,_,f,k,v)=>{if(_!==f){if(_!==ee)for(const g in _)!nn(g)&&!(g in f)&&o(u,g,_[g],null,v,k);for(const g in f){if(nn(g))continue;const b=f[g],L=_[g];b!==L&&g!=="value"&&o(u,g,L,b,v,k)}"value"in f&&o(u,"value",_.value,f.value,v)}},S=(u,_,f,k,v,g,b,L,A)=>{const m=_.el=u?u.el:c(""),F=_.anchor=u?u.anchor:c("");let{patchFlag:O,dynamicChildren:C,slotScopeIds:V}=_;V&&(L=L?L.concat(V):V),u==null?(i(m,f,k),i(F,f,k),X(_.children||[],f,F,v,g,b,L,A)):O>0&&O&64&&C&&u.dynamicChildren&&u.dynamicChildren.length===C.length?(J(u.dynamicChildren,C,f,v,g,b,L),(_.key!=null||v&&_===v.subTree)&&ur(u,_,!0)):te(u,_,f,F,v,g,b,L,A)},se=(u,_,f,k,v,g,b,L,A)=>{_.slotScopeIds=L,u==null?_.shapeFlag&512?v.ctx.activate(_,f,k,b,A):Ae(_,f,k,v,g,b,A):tt(u,_,A)},Ae=(u,_,f,k,v,g,b)=>{const L=u.component=d_(u,k,v);if(oi(u)&&(L.ctx.renderer=Wt),f_(L,!1,b),L.asyncDep){if(v&&v.registerDep(L,ge,b),!u.el){const A=L.subTree=xe(Pe);R(null,A,_,f),u.placeholder=A.el}}else ge(L,u,_,f,v,g,b)},tt=(u,_,f)=>{const k=_.component=u.component;if(zu(u,_,f))if(k.asyncDep&&!k.asyncResolved){re(k,_,f);return}else k.next=_,k.update();else _.el=u.el,k.vnode=_},ge=(u,_,f,k,v,g,b)=>{const L=()=>{if(u.isMounted){let{next:O,bu:C,u:V,parent:Y,vnode:Q}=u;{const Ye=_r(u);if(Ye){O&&(O.el=Q.el,re(u,O,b)),Ye.asyncDep.then(()=>{Re(()=>{u.isUnmounted||m()},v)});return}}let Z=O,_e;Lt(u,!1),O?(O.el=Q.el,re(u,O,b)):O=Q,C&&Cn(C),(_e=O.props&&O.props.onVnodeBeforeUpdate)&&qe(_e,Y,O,Q),Lt(u,!0);const ke=Ss(u),Ue=u.subTree;u.subTree=ke,P(Ue,ke,d(Ue.el),Pn(Ue),u,v,g),O.el=ke.el,Z===null&&Xu(u,ke.el),V&&Re(V,v),(_e=O.props&&O.props.onVnodeUpdated)&&Re(()=>qe(_e,Y,O,Q),v)}else{let O;const{el:C,props:V}=_,{bm:Y,m:Q,parent:Z,root:_e,type:ke}=u,Ue=cn(_);Lt(u,!1),Y&&Cn(Y),!Ue&&(O=V&&V.onVnodeBeforeMount)&&qe(O,Z,_),Lt(u,!0);{_e.ce&&_e.ce._hasShadowRoot()&&_e.ce._injectChildStyle(ke,u.parent?u.parent.type:void 0);const Ye=u.subTree=Ss(u);P(null,Ye,f,k,u,v,g),_.el=Ye.el}if(Q&&Re(Q,v),!Ue&&(O=V&&V.onVnodeMounted)){const Ye=_;Re(()=>qe(O,Z,Ye),v)}(_.shapeFlag&256||Z&&cn(Z.vnode)&&Z.vnode.shapeFlag&256)&&u.a&&Re(u.a,v),u.isMounted=!0,_=f=k=null}};u.scope.on();const A=u.effect=new ko(L);u.scope.off();const m=u.update=A.run.bind(A),F=u.job=A.runIfDirty.bind(A);F.i=u,F.id=u.uid,A.scheduler=()=>os(F),Lt(u,!0),m()},re=(u,_,f)=>{_.component=u;const k=u.vnode.props;u.vnode=_,u.next=null,Zu(u,_.props,k,f),n_(u,_.children,f),at(),Ls(u),lt()},te=(u,_,f,k,v,g,b,L,A=!1)=>{const m=u&&u.children,F=u?u.shapeFlag:0,O=_.children,{patchFlag:C,shapeFlag:V}=_;if(C>0){if(C&128){wn(m,O,f,k,v,g,b,L,A);return}else if(C&256){kt(m,O,f,k,v,g,b,L,A);return}}V&8?(F&16&&qt(m,v,g),O!==m&&l(f,O)):F&16?V&16?wn(m,O,f,k,v,g,b,L,A):qt(m,v,g,!0):(F&8&&l(f,""),V&16&&X(O,f,k,v,g,b,L,A))},kt=(u,_,f,k,v,g,b,L,A)=>{u=u||Bt,_=_||Bt;const m=u.length,F=_.length,O=Math.min(m,F);let C;for(C=0;C<O;C++){const V=_[C]=A?ot(_[C]):Je(_[C]);P(u[C],V,f,null,v,g,b,L,A)}m>F?qt(u,v,g,!0,!1,O):X(_,f,k,v,g,b,L,A,O)},wn=(u,_,f,k,v,g,b,L,A)=>{let m=0;const F=_.length;let O=u.length-1,C=F-1;for(;m<=O&&m<=C;){const V=u[m],Y=_[m]=A?ot(_[m]):Je(_[m]);if(Ot(V,Y))P(V,Y,f,null,v,g,b,L,A);else break;m++}for(;m<=O&&m<=C;){const V=u[O],Y=_[C]=A?ot(_[C]):Je(_[C]);if(Ot(V,Y))P(V,Y,f,null,v,g,b,L,A);else break;O--,C--}if(m>O){if(m<=C){const V=C+1,Y=V<F?_[V].el:k;for(;m<=C;)P(null,_[m]=A?ot(_[m]):Je(_[m]),f,Y,v,g,b,L,A),m++}}else if(m>C)for(;m<=O;)je(u[m],v,g,!0),m++;else{const V=m,Y=m,Q=new Map;for(m=Y;m<=C;m++){const Se=_[m]=A?ot(_[m]):Je(_[m]);Se.key!=null&&Q.set(Se.key,m)}let Z,_e=0;const ke=C-Y+1;let Ue=!1,Ye=0;const zt=new Array(ke);for(m=0;m<ke;m++)zt[m]=0;for(m=V;m<=O;m++){const Se=u[m];if(_e>=ke){je(Se,v,g,!0);continue}let Ke;if(Se.key!=null)Ke=Q.get(Se.key);else for(Z=Y;Z<=C;Z++)if(zt[Z-Y]===0&&Ot(Se,_[Z])){Ke=Z;break}Ke===void 0?je(Se,v,g,!0):(zt[Ke-Y]=m+1,Ke>=Ye?Ye=Ke:Ue=!0,P(Se,_[Ke],f,null,v,g,b,L,A),_e++)}const ms=Ue?r_(zt):Bt;for(Z=ms.length-1,m=ke-1;m>=0;m--){const Se=Y+m,Ke=_[Se],vs=_[Se+1],hs=Se+1<F?vs.el||dr(vs):k;zt[m]===0?P(null,Ke,f,hs,v,g,b,L,A):Ue&&(Z<0||m!==ms[Z]?yt(Ke,f,hs,2):Z--)}}},yt=(u,_,f,k,v=null)=>{const{el:g,type:b,transition:L,children:A,shapeFlag:m}=u;if(m&6){yt(u.component.subTree,_,f,k);return}if(m&128){u.suspense.move(_,f,k);return}if(m&64){b.move(u,_,f,Wt);return}if(b===ve){i(g,_,f);for(let O=0;O<A.length;O++)yt(A[O],_,f,k);i(u.anchor,_,f);return}if(b===$n){B(u,_,f);return}if(k!==2&&m&1&&L)if(k===0)L.persisted&&!g[$e]?i(g,_,f):(L.beforeEnter(g),i(g,_,f),Re(()=>L.enter(g),v));else{const{leave:O,delayLeave:C,afterLeave:V}=L,Y=()=>{u.ctx.isUnmounted?s(g):i(g,_,f)},Q=()=>{const Z=g._isLeaving||!!g[$e];g._isLeaving&&g[$e](!0),L.persisted&&!Z?Y():O(g,()=>{Y(),V&&V()})};C?C(g,Y,Q):Q()}else i(g,_,f)},je=(u,_,f,k=!1,v=!1)=>{const{type:g,props:b,ref:L,children:A,dynamicChildren:m,shapeFlag:F,patchFlag:O,dirs:C,cacheIndex:V,memo:Y}=u;if(O===-2&&(v=!1),L!=null&&(at(),rn(L,null,f,u,!0),lt()),V!=null&&(_.renderCache[V]=void 0),F&256){_.ctx.deactivate(u);return}const Q=F&1&&C,Z=!cn(u);let _e;if(Z&&(_e=b&&b.onVnodeBeforeUnmount)&&qe(_e,_,u),F&6)wp(u.component,f,k);else{if(F&128){u.suspense.unmount(f,k);return}Q&&At(u,null,_,"beforeUnmount"),F&64?u.type.remove(u,_,f,Wt,k):m&&!m.hasOnce&&(g!==ve||O>0&&O&64)?qt(m,_,f,!1,!0):(g===ve&&O&384||!v&&F&16)&&qt(A,_,f),k&&fs(u)}const ke=Y!=null&&V==null;(Z&&(_e=b&&b.onVnodeUnmounted)||Q||ke)&&Re(()=>{_e&&qe(_e,_,u),Q&&At(u,null,_,"unmounted"),ke&&(u.el=null)},f)},fs=u=>{const{type:_,el:f,anchor:k,transition:v}=u;if(_===ve){bp(f,k);return}if(_===$n){E(u);return}const g=()=>{s(f),v&&!v.persisted&&v.afterLeave&&v.afterLeave()};if(u.shapeFlag&1&&v&&!v.persisted){const{leave:b,delayLeave:L}=v,A=()=>b(f,g);L?L(u.el,g,A):A()}else g()},bp=(u,_)=>{let f;for(;u!==_;)f=h(u),s(u),u=f;s(_)},wp=(u,_,f)=>{const{bum:k,scope:v,job:g,subTree:b,um:L,m:A,a:m}=u;Cs(A),Cs(m),k&&Cn(k),v.stop(),g&&(g.flags|=8,je(b,u,_,f)),L&&Re(L,_),Re(()=>{u.isUnmounted=!0},_)},qt=(u,_,f,k=!1,v=!1,g=0)=>{for(let b=g;b<u.length;b++)je(u[b],_,f,k,v)},Pn=u=>{if(u.shapeFlag&6)return Pn(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const _=h(u.anchor||u.el),f=_&&_[Lu];return f?h(f):_};let fi=!1;const gs=(u,_,f)=>{let k;u==null?_._vnode&&(je(_._vnode,null,null,!0),k=_._vnode.component):P(_._vnode||null,u,_,null,null,null,f),_._vnode=u,fi||(fi=!0,Ls(k),Do(),fi=!1)},Wt={p:P,um:je,m:yt,r:fs,mt:Ae,mc:X,pc:te,pbc:J,n:Pn,o:e};return{render:gs,hydrate:void 0,createApp:ju(gs)}}function Ai({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function Lt({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function o_(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function ur(e,t,n=!1){const i=e.children,s=t.children;if(D(i)&&D(s))for(let o=0;o<i.length;o++){const r=i[o];let c=s[o];c.shapeFlag&1&&!c.dynamicChildren&&((c.patchFlag<=0||c.patchFlag===32)&&(c=s[o]=ot(s[o]),c.el=r.el),!n&&c.patchFlag!==-2&&ur(r,c)),c.type===li&&(c.patchFlag===-1&&(c=s[o]=ot(c)),c.el=r.el),c.type===Pe&&!c.el&&(c.el=r.el)}}function r_(e){const t=e.slice(),n=[0];let i,s,o,r,c;const a=e.length;for(i=0;i<a;i++){const p=e[i];if(p!==0){if(s=n[n.length-1],e[s]<p){t[i]=s,n.push(i);continue}for(o=0,r=n.length-1;o<r;)c=o+r>>1,e[n[c]]<p?o=c+1:r=c;p<e[n[o]]&&(o>0&&(t[i]=n[o-1]),n[o]=i)}}for(o=n.length,r=n[o-1];o-- >0;)n[o]=r,r=t[r];return n}function _r(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:_r(t)}function Cs(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function dr(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?dr(t.subTree):null}const fr=e=>e.__isSuspense;function c_(e,t){t&&t.pendingBranch?D(e)?t.effects.push(...e):t.effects.push(e):vu(e)}const ve=Symbol.for("v-fgt"),li=Symbol.for("v-txt"),Pe=Symbol.for("v-cmt"),$n=Symbol.for("v-stc"),Et=[];let Ie=null;function I(e=!1){Et.push(Ie=e?null:[])}function gr(){Et.pop(),Ie=Et[Et.length-1]||null}let fn=1;function Un(e,t=!1){fn+=e,e<0&&Ie&&t&&(Ie.hasOnce=!0)}function mr(e){return e.dynamicChildren=fn>0?Ie||Bt:null,gr(),fn>0&&Ie&&Ie.push(e),e}function H(e,t,n,i,s,o){return mr(x(e,t,n,i,s,o,!0))}function it(e,t,n,i,s){return mr(xe(e,t,n,i,s,!0))}function Yn(e){return e?e.__v_isVNode===!0:!1}function Ot(e,t){return e.type===t.type&&e.key===t.key}const vr=({key:e})=>e??null,Nn=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?ae(e)||Te(e)||j(e)?{i:Ne,r:e,k:t,f:!!n}:e:null);function x(e,t=null,n=null,i=0,s=null,o=e===ve?0:1,r=!1,c=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&vr(t),ref:t&&Nn(t),scopeId:Ho,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:Ne};return c?(Kn(a,n),o&128&&e.normalize(a)):n&&(a.shapeFlag|=ae(n)?8:16),fn>0&&!r&&Ie&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Ie.push(a),a}const xe=a_;function a_(e,t=null,n=null,i=0,s=null,o=!1){if((!e||e===$u)&&(e=Pe),Yn(e)){const c=mt(e,t,!0);return n&&Kn(c,n),fn>0&&!o&&Ie&&(c.shapeFlag&6?Ie[Ie.indexOf(e)]=c:Ie.push(c)),c.patchFlag=-2,c}if(h_(e)&&(e=e.__vccOpts),t){t=l_(t);let{class:c,style:a}=t;c&&!ae(c)&&(t.class=he(c)),z(a)&&(ss(a)&&!D(a)&&(a=fe({},a)),t.style=Ve(a))}const r=ae(e)?1:fr(e)?128:si(e)?64:z(e)?4:j(e)?2:0;return x(e,t,n,i,s,r,o,!0)}function l_(e){return e?ss(e)||or(e)?fe({},e):e:null}function mt(e,t,n=!1,i=!1){const{props:s,ref:o,patchFlag:r,children:c,transition:a}=e,p=t?p_(s||{},t):s,l={__v_isVNode:!0,__v_skip:!0,type:e.type,props:p,key:p&&vr(p),ref:t&&t.ref?n&&o?D(o)?o.concat(Nn(t)):[o,Nn(t)]:Nn(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:c,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ve?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&mt(e.ssContent),ssFallback:e.ssFallback&&mt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&i&&It(l,a.clone(l)),l}function hr(e=" ",t=0){return xe(li,null,e,t)}function Li(e,t){const n=xe($n,null,e);return n.staticCount=t,n}function de(e="",t=!1){return t?(I(),it(Pe,null,e)):xe(Pe,null,e)}function Je(e){return e==null||typeof e=="boolean"?xe(Pe):D(e)?xe(ve,null,e.slice()):Yn(e)?ot(e):xe(li,null,String(e))}function ot(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:mt(e)}function Kn(e,t){let n=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(D(t))n=16;else if(typeof t=="object")if(i&65){const s=t.default;s&&(s._c&&(s._d=!1),Kn(e,s()),s._c&&(s._d=!0));return}else{n=32;const s=t._;!s&&!or(t)?t._ctx=Ne:s===3&&Ne&&(Ne.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else if(j(t)){if(i&65){Kn(e,{default:t});return}t={default:t,_ctx:Ne},n=32}else t=String(t),i&64?(n=16,t=[hr(t)]):n=8;e.children=t,e.shapeFlag|=n}function p_(...e){const t={};for(let n=0;n<e.length;n++){const i=e[n];for(const s in i)if(s==="class")t.class!==i.class&&(t.class=he([t.class,i.class]));else if(s==="style")t.style=Ve([t.style,i.style]);else if(Jn(s)){const o=t[s],r=i[s];r&&o!==r&&!(D(o)&&o.includes(r))?t[s]=o?[].concat(o,r):r:r==null&&o==null&&!Zn(s)&&(t[s]=r)}else s!==""&&(t[s]=i[s])}return t}function qe(e,t,n,i=null){De(e,t,7,[n,i])}const u_=er();let __=0;function d_(e,t,n){const i=e.type,s=(t?t.appContext:e.appContext)||u_,o={uid:__++,vnode:e,type:i,parent:t,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Vp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(s.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:cr(i,s),emitsOptions:tr(i,s),emit:null,emitted:null,propsDefaults:ee,inheritAttrs:i.inheritAttrs,ctx:ee,data:ee,props:ee,attrs:ee,slots:ee,refs:ee,setupState:ee,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=Yu.bind(null,o),e.ce&&e.ce(o),o}let Oe=null;const ps=()=>Oe||Ne;let qn,gn;{const e=ei(),t=(n,i)=>{let s;return(s=e[n])||(s=e[n]=[]),s.push(i),o=>{s.length>1?s.forEach(r=>r(o)):s[0](o)}};qn=t("__VUE_INSTANCE_SETTERS__",n=>Oe=n),gn=t("__VUE_SSR_SETTERS__",n=>mn=n)}const bn=e=>{const t=Oe;return qn(e),e.scope.on(),()=>{e.scope.off(),qn(t)}},Ms=()=>{Oe&&Oe.scope.off(),qn(null)};function xr(e){return e.vnode.shapeFlag&4}let mn=!1;function f_(e,t=!1,n=!1){t&&gn(t);const{props:i,children:s}=e.vnode,o=xr(e);Ju(e,i,o,t),t_(e,s,n||t);const r=o?g_(e,t):void 0;return t&&gn(!1),r}function g_(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Nu);const{setup:i}=n;if(i){at();const s=e.setupContext=i.length>1?v_(e):null,o=bn(e),r=Tn(i,e,0,[e.props,s]),c=uo(r);if(lt(),o(),(c||e.sp)&&!cn(e)&&Wo(e),c){if(r.then(Ms,Ms),t)return r.then(a=>{gn(!0);try{$s(e,a,t)}finally{gn(!1)}}).catch(a=>{ii(a,e,0)});e.asyncDep=r}else $s(e,r)}else kr(e)}function $s(e,t,n){j(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:z(t)&&(e.setupState=$o(t)),kr(e)}function kr(e,t,n){const i=e.type;e.render||(e.render=i.render||Qe);{const s=bn(e);at();try{Fu(e)}finally{lt(),s()}}}const m_={get(e,t){return Le(e,"get",""),e[t]}};function v_(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,m_),slots:e.slots,emit:e.emit,expose:t}}function pi(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy($o(cu(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in an)return an[n](e)},has(t,n){return n in t||n in an}})):e.proxy}function h_(e){return j(e)&&"__vccOpts"in e}const ce=(e,t)=>uu(e,t,mn);function x_(e,t,n){try{Un(-1);const i=arguments.length;return i===2?z(t)&&!D(t)?Yn(t)?xe(e,null,[t]):xe(e,t):xe(e,null,t):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&Yn(n)&&(n=[n]),xe(e,t,n))}finally{Un(1)}}const k_="3.5.41";/**
* @vue/runtime-dom v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Bi;const Ns=typeof window<"u"&&window.trustedTypes;if(Ns)try{Bi=Ns.createPolicy("vue",{createHTML:e=>e})}catch{}const yr=Bi?e=>Bi.createHTML(e):e=>e,y_="http://www.w3.org/2000/svg",A_="http://www.w3.org/1998/Math/MathML",st=typeof document<"u"?document:null,Fs=st&&st.createElement("template"),L_={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,i)=>{const s=t==="svg"?st.createElementNS(y_,e):t==="mathml"?st.createElementNS(A_,e):n?st.createElement(e,{is:n}):st.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>st.createTextNode(e),createComment:e=>st.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>st.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,i,s,o){const r=n?n.previousSibling:t.lastChild;if(s&&(s===o||s.nextSibling))for(;t.insertBefore(s.cloneNode(!0),n),!(s===o||!(s=s.nextSibling)););else{Fs.innerHTML=yr(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const c=Fs.content;if(i==="svg"||i==="mathml"){const a=c.firstChild;for(;a.firstChild;)c.appendChild(a.firstChild);c.removeChild(a)}t.insertBefore(c,n)}return[r?r.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},dt="transition",Zt="animation",Yt=Symbol("_vtc"),Ar={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Lr=fe({},Uo,Ar),T_=e=>(e.displayName="Transition",e.props=Lr,e),b_=T_((e,{slots:t})=>x_(bu,Tr(e),t)),Tt=(e,t=[])=>{D(e)?e.forEach(n=>n(...t)):e&&e(...t)},Ds=e=>e?D(e)?e.some(t=>t.length>1):e.length>1:!1;function Tr(e){const t={};for(const S in e)S in Ar||(t[S]=e[S]);if(e.css===!1)return t;const{name:n="v",type:i,duration:s,enterFromClass:o=`${n}-enter-from`,enterActiveClass:r=`${n}-enter-active`,enterToClass:c=`${n}-enter-to`,appearFromClass:a=o,appearActiveClass:p=r,appearToClass:l=c,leaveFromClass:d=`${n}-leave-from`,leaveActiveClass:h=`${n}-leave-active`,leaveToClass:y=`${n}-leave-to`}=e,$=w_(s),P=$&&$[0],T=$&&$[1],{onBeforeEnter:R,onEnter:N,onEnterCancelled:B,onLeave:E,onLeaveCancelled:q,onBeforeAppear:U=R,onAppear:ie=N,onAppearCancelled:X=B}=t,G=(S,se,Ae,tt)=>{S._enterCancelled=tt,ft(S,se?l:c),ft(S,se?p:r),Ae&&Ae()},J=(S,se)=>{S._isLeaving=!1,ft(S,d),ft(S,y),ft(S,h),se&&se()},oe=S=>(se,Ae)=>{const tt=S?ie:N,ge=()=>G(se,S,Ae);Tt(tt,[se,ge]),Bs(()=>{ft(se,S?a:o),We(se,S?l:c),Ds(tt)||Hs(se,i,P,ge)})};return fe(t,{onBeforeEnter(S){Tt(R,[S]),We(S,o),We(S,r)},onBeforeAppear(S){Tt(U,[S]),We(S,a),We(S,p)},onEnter:oe(!1),onAppear:oe(!0),onLeave(S,se){S._isLeaving=!0;const Ae=()=>J(S,se);We(S,d),S._enterCancelled?(We(S,h),Hi(S)):(Hi(S),We(S,h)),Bs(()=>{S._isLeaving&&(ft(S,d),We(S,y),Ds(E)||Hs(S,i,T,Ae))}),Tt(E,[S,Ae])},onEnterCancelled(S){G(S,!1,void 0,!0),Tt(B,[S])},onAppearCancelled(S){G(S,!0,void 0,!0),Tt(X,[S])},onLeaveCancelled(S){J(S),Tt(q,[S])}})}function w_(e){if(e==null)return null;if(z(e))return[Ti(e.enter),Ti(e.leave)];{const t=Ti(e);return[t,t]}}function Ti(e){return Cp(e)}function We(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[Yt]||(e[Yt]=new Set)).add(t)}function ft(e,t){t.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const n=e[Yt];n&&(n.delete(t),n.size||(e[Yt]=void 0))}function Bs(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let P_=0;function Hs(e,t,n,i){const s=e._endId=++P_,o=()=>{s===e._endId&&i()};if(n!=null)return setTimeout(o,n);const{type:r,timeout:c,propCount:a}=br(e,t);if(!r)return i();const p=r+"end";let l=0;const d=()=>{e.removeEventListener(p,h),o()},h=y=>{y.target===e&&++l>=a&&d()};setTimeout(()=>{l<a&&d()},c+1),e.addEventListener(p,h)}function br(e,t){const n=window.getComputedStyle(e),i=$=>(n[$]||"").split(", "),s=i(`${dt}Delay`),o=i(`${dt}Duration`),r=Vs(s,o),c=i(`${Zt}Delay`),a=i(`${Zt}Duration`),p=Vs(c,a);let l=null,d=0,h=0;t===dt?r>0&&(l=dt,d=r,h=o.length):t===Zt?p>0&&(l=Zt,d=p,h=a.length):(d=Math.max(r,p),l=d>0?r>p?dt:Zt:null,h=l?l===dt?o.length:a.length:0);const y=l===dt&&/\b(?:transform|all)(?:,|$)/.test(i(`${dt}Property`).toString());return{type:l,timeout:d,propCount:h,hasTransform:y}}function Vs(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((n,i)=>Gs(n)+Gs(e[i])))}function Gs(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Hi(e){return(e?e.ownerDocument:document).body.offsetHeight}function O_(e,t,n){const i=e[Yt];i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const js=Symbol("_vod"),wr=Symbol("_vsh"),R_=Symbol(""),S_=/(?:^|;)\s*display\s*:/;function E_(e,t,n){const i=e.style,s=ae(n);let o=!1;if(n&&!s){if(t)if(ae(t))for(const r of t.split(";")){const c=r.slice(0,r.indexOf(":")).trim();n[c]==null&&tn(i,c,"")}else for(const r in t)n[r]==null&&tn(i,r,"");for(const r in n){r==="display"&&(o=!0);const c=n[r];c!=null?C_(e,r,!ae(t)&&t?t[r]:void 0,c)||tn(i,r,c):tn(i,r,"")}}else if(s){if(t!==n){const r=i[R_];r&&(n+=";"+r),i.cssText=n,o=S_.test(n)}}else t&&e.removeAttribute("style");js in e&&(e[js]=o?i.display:"",e[wr]&&(i.display="none"))}const Us=/\s*!important$/;function tn(e,t,n){if(D(n))n.forEach(i=>tn(e,t,i));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const i=I_(e,t);Us.test(n)?e.setProperty(Mt(i),n.replace(Us,""),"important"):e[i]=n}}const Ys=["Webkit","Moz","ms"],bi={};function I_(e,t){const n=bi[t];if(n)return n;let i=Be(t);if(i!=="filter"&&i in e)return bi[t]=i;i=go(i);for(let s=0;s<Ys.length;s++){const o=Ys[s]+i;if(o in e)return bi[t]=o}return t}function C_(e,t,n,i){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&ae(i)&&n===i}const Ks="http://www.w3.org/1999/xlink";function qs(e,t,n,i,s,o=Bp(t)){i&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(Ks,t.slice(6,t.length)):e.setAttributeNS(Ks,t,n):n==null||o&&!vo(n)?e.removeAttribute(t):e.setAttribute(t,o?"":et(n)?String(n):n)}function Ws(e,t,n,i,s){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?yr(n):n);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const c=o==="OPTION"?e.getAttribute("value")||"":e.value,a=n==null?e.type==="checkbox"?"on":"":String(n);(c!==a||!("_value"in e))&&(e.value=a),n==null&&e.removeAttribute(t),e._value=n;return}let r=!1;if(n===""||n==null){const c=typeof e[t];c==="boolean"?n=vo(n):n==null&&c==="string"?(n="",r=!0):c==="number"&&(n=0,r=!0)}try{e[t]=n}catch{}r&&e.removeAttribute(s||t)}function Ft(e,t,n,i){e.addEventListener(t,n,i)}function M_(e,t,n,i){e.removeEventListener(t,n,i)}const zs=Symbol("_vei");function $_(e,t,n,i,s=null){const o=e[zs]||(e[zs]={}),r=o[t];if(i&&r)r.value=i;else{const[c,a]=D_(t);if(i){const p=o[t]=V_(i,s);Ft(e,c,p,a)}else r&&(M_(e,c,r,a),o[t]=void 0)}}const N_=/(Once|Passive|Capture)$/,F_=/^on:?(?:Once|Passive|Capture)$/;function D_(e){let t,n;for(;(n=e.match(N_))&&!F_.test(e);)t||(t={}),e=e.slice(0,e.length-n[1].length),t[n[1].toLowerCase()]=!0;return[e[2]===":"?e.slice(3):Mt(e.slice(2)),t]}let wi=0;const B_=Promise.resolve(),H_=()=>wi||(B_.then(()=>wi=0),wi=Date.now());function V_(e,t){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;const s=n.value;if(D(s)){const o=i.stopImmediatePropagation;i.stopImmediatePropagation=()=>{o.call(i),i._stopped=!0};const r=s.slice(),c=[i];for(let a=0;a<r.length&&!i._stopped;a++){const p=r[a];p&&De(p,t,5,c)}}else De(s,t,5,[i])};return n.value=e,n.attached=H_(),n}const Xs=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,G_=(e,t,n,i,s,o)=>{const r=s==="svg";t==="class"?O_(e,i,r):t==="style"?E_(e,n,i):Jn(t)?Zn(t)||$_(e,t,n,i,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):j_(e,t,i,r))?(Ws(e,t,i),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&qs(e,t,i,r,o,t!=="value")):e._isVueCE&&(U_(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!ae(i)))?Ws(e,Be(t),i,o,t):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),qs(e,t,i,r))};function j_(e,t,n,i){if(i)return!!(t==="innerHTML"||t==="textContent"||t in e&&Xs(t)&&j(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return Xs(t)&&ae(n)?!1:t in e}function U_(e,t){const n=e._def.props;if(!n)return!1;const i=Be(t);return Array.isArray(n)?n.some(s=>Be(s)===i):Object.keys(n).some(s=>Be(s)===i)}const Pr=new WeakMap,Or=new WeakMap,Wn=Symbol("_moveCb"),Js=Symbol("_enterCb"),Y_=e=>(delete e.props.mode,e),K_=Y_({name:"TransitionGroup",props:fe({},Lr,{tag:String,moveClass:String}),setup(e,{slots:t}){const n=ps(),i=jo();let s,o;return Xo(()=>{if(!s.length)return;const r=e.moveClass||`${e.name||"v"}-move`;if(!J_(s[0].el,n.vnode.el,r)){s=[];return}s.forEach(W_),s.forEach(z_);const c=s.filter(X_);Hi(n.vnode.el),c.forEach(a=>{const p=a.el,l=p.style;We(p,r),l.transform=l.webkitTransform=l.transitionDuration="";const d=p[Wn]=h=>{h&&h.target!==p||(!h||h.propertyName.endsWith("transform"))&&(p.removeEventListener("transitionend",d),p[Wn]=null,ft(p,r))};p.addEventListener("transitionend",d)}),s=[]}),()=>{const r=K(e),c=Tr(r);let a=r.tag||ve;if(s=[],o)for(let p=0;p<o.length;p++){const l=o[p];l.el&&l.el instanceof Element&&!l.el[wr]&&(s.push(l),It(l,dn(l,c,i,n)),Pr.set(l,Rr(l.el)))}o=t.default?cs(t.default()):[];for(let p=0;p<o.length;p++){const l=o[p];l.key!=null&&It(l,dn(l,c,i,n))}return xe(a,null,o)}}}),q_=K_;function W_(e){const t=e.el;t[Wn]&&t[Wn](),t[Js]&&t[Js]()}function z_(e){Or.set(e,Rr(e.el))}function X_(e){const t=Pr.get(e),n=Or.get(e),i=t.left-n.left,s=t.top-n.top;if(i||s){const o=e.el,r=o.style,c=o.getBoundingClientRect();let a=1,p=1;return o.offsetWidth&&(a=c.width/o.offsetWidth),o.offsetHeight&&(p=c.height/o.offsetHeight),(!Number.isFinite(a)||a===0)&&(a=1),(!Number.isFinite(p)||p===0)&&(p=1),Math.abs(a-1)<.01&&(a=1),Math.abs(p-1)<.01&&(p=1),r.transform=r.webkitTransform=`translate(${i/a}px,${s/p}px)`,r.transitionDuration="0s",e}}function Rr(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function J_(e,t,n){const i=e.cloneNode(),s=e[Yt];s&&s.forEach(c=>{c.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(c=>c&&i.classList.add(c)),i.style.display="none";const o=t.nodeType===1?t:t.parentNode;o.appendChild(i);const{hasTransform:r}=br(i);return o.removeChild(i),r}const Zs=e=>{const t=e.props["onUpdate:modelValue"]||!1;return D(t)?n=>Cn(t,n):t};function Z_(e){e.target.composing=!0}function Qs(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const En=Symbol("_assign"),In=Symbol("_initialValue");function Pi(e,t,n){return t&&(e=e.trim()),n&&(e=zi(e)),e}const Q_={created(e,{modifiers:{lazy:t,trim:n,number:i}},s){e.parentNode&&(e.type==="text"?e[In]=e.defaultValue.replace(/[\r\n]/g,""):e.type==="textarea"&&(e[In]=e.defaultValue.replace(/\r\n?/g,`
`))),e[En]=Zs(s);const o=i||s.props&&s.props.type==="number";Ft(e,t?"change":"input",r=>{r.target.composing||e[En](Pi(e.value,n,o))}),(n||o)&&Ft(e,"change",()=>{e.value=Pi(e.value,n,o)}),t||(Ft(e,"compositionstart",Z_),Ft(e,"compositionend",Qs),Ft(e,"change",Qs))},mounted(e,{value:t,modifiers:{trim:n,number:i}}){const s=t??"",o=e[In];delete e[In],o!==void 0&&(e.type==="text"||e.type==="textarea")&&e.value!==o?e[En](Pi(e.value,n,i)):e.value=s},beforeUpdate(e,{value:t,oldValue:n,modifiers:{lazy:i,trim:s,number:o}},r){if(e[En]=Zs(r),e.composing)return;const c=(o||e.type==="number")&&!/^0\d/.test(e.value)?zi(e.value):e.value,a=t??"";if(c===a)return;const p=e.getRootNode();(p instanceof Document||p instanceof ShadowRoot)&&p.activeElement===e&&e.type!=="range"&&(i&&t===n||s&&e.value.trim()===a)||(e.value=a)}},ed=["ctrl","shift","alt","meta"],td={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>ed.some(n=>e[`${n}Key`]&&!t.includes(n))},bt=(e,t)=>{if(!e)return e;const n=e._withMods||(e._withMods={}),i=t.join(".");return n[i]||(n[i]=(s,...o)=>{for(let r=0;r<t.length;r++){const c=td[t[r]];if(c&&c(s,t))return}return e(s,...o)})},nd=fe({patchProp:G_},L_);let eo;function id(){return eo||(eo=i_(nd))}const sd=(...e)=>{const t=id().createApp(...e),{mount:n}=t;return t.mount=i=>{const s=rd(i);if(!s)return;const o=t._component;!j(o)&&!o.render&&!o.template&&(o.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const r=n(s,!1,od(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),r},t};function od(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function rd(e){return ae(e)?document.querySelector(e):e}const vn={MIN:0,MAX:100},ln={BASE_DECAY:3,PRESSURE_COEF:2,RECORDER_RELIEF:3,INITIATIVE_COST_BASE:1,INITIATIVE_COST_STEP:1},Fn={T1:50,T2:30,T3:15},to={DEFAULT:8,PANIC:4},Vi={DESTROY_EVIDENCE_CAP:-20,HUSH_MONEY_EVIDENCE_CAP:30},Oi={PLAYBOOK_EVIDENCE:5,NOTARY_RISK:-5,CALM_BREATH_COMPOSURE:30};function Sr(e){return Math.min(vn.MAX,Math.max(vn.MIN,e))}function us(e){return{...e,flags:new Set(e.flags),items:new Set(e.items)}}function cd(e,t,n,i){let s=n;return t.items.has("item_calm_breathing")&&e.tag==="BREATH"&&(s={...s,composure:Oi.CALM_BREATH_COMPOSURE}),t.items.has("item_hr_playbook")&&i===3&&e.initiative===3&&(s={...s,evidence:(s.evidence??0)+Oi.PLAYBOOK_EVIDENCE}),t.items.has("item_notary_habit")&&i===4&&e.initiative===3&&(s={...s,risk:(s.risk??0)+Oi.NOTARY_RISK}),s}function ad(e){return e.tag==="PHYSICAL"?{forcedEnding:e.next}:null}function ld(e,t){switch(t){case"G_NEG_DESTROYED_EVIDENCE":e.evidenceCap=vn.MAX+Vi.DESTROY_EVIDENCE_CAP;break;case"G_NEG_HUSH_MONEY":e.evidence=Math.min(e.evidence,Vi.HUSH_MONEY_EVIDENCE_CAP);break}}function no(e,t,n=1,i=0){const s=us(e),o=cd(t,s,t.effects??{},n),r=["evidence","opinion","composure","risk"];for(const c of r){const a=o[c];a!==void 0&&(s[c]+=a)}if(t.initiative>=2&&t.tag!=="BREATH"){const c=(t.initiative-1)*(ln.INITIATIVE_COST_BASE+ln.INITIATIVE_COST_STEP*Math.floor(i/2));s.composure-=c}s.evidence>s.evidenceCap&&(s.evidence=s.evidenceCap);for(const c of r)s[c]=Sr(s[c]);for(const c of o.addFlags??[])s.flags.add(c),ld(s,c);for(const c of o.removeFlags??[])s.flags.delete(c);for(const c of o.addItems??[])s.items.add(c);return s.turn+=1,s}function pd(e,t){const n=us(e),i=ln.BASE_DECAY+t.pressure*ln.PRESSURE_COEF,s=n.items.has("item_recorder")?ln.RECORDER_RELIEF:0;return n.composure=Sr(n.composure-i+s),n}class le extends Error{constructor(t){super(t),this.name="ContentError"}}function Er(e,t){return{evidence:e.evidence,opinion:e.opinion,composure:e.composure,risk:e.risk,dEvidence:e.evidence-t.evidence,dOpinion:e.opinion-t.opinion,dComposure:e.composure-t.composure,dRisk:e.risk-t.risk,flags:e.flags,items:e.items,turn:e.turn}}const ud=new Set(["evidence","opinion","composure","risk","dEvidence","dOpinion","dComposure","dRisk","turn"]);function _d(e){const t=[];let n=0;for(;n<e.length;){const i=e[n];if(i===" "||i==="	"||i===`
`||i==="\r"){n+=1;continue}if(i>="0"&&i<="9"){let r=n;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:Number(e.slice(n,r))}),n=r;continue}if(/[A-Za-z_]/.test(i)){let r=n;for(;r<e.length&&/[A-Za-z0-9_]/.test(e[r]);)r+=1;t.push({t:"id",v:e.slice(n,r)}),n=r;continue}if(i==="'"||i==='"'){let r=n+1;for(;r<e.length&&e[r]!==i;)r+=1;if(r>=e.length)throw new le(`unterminated string in condition: ${e}`);t.push({t:"str",v:e.slice(n+1,r)}),n=r+1;continue}const s=e.slice(n,n+2);if(s==="&&"||s==="||"||s===">="||s==="<="||s==="=="||s==="!="){t.push({t:"op",v:s}),n+=2;continue}const o=e[n+1];if(i==="-"&&o!==void 0&&o>="0"&&o<="9"&&(t.length===0||t[t.length-1].t==="op")){let r=n+1;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:-Number(e.slice(n+1,r))}),n=r;continue}if(i===">"||i==="<"||i==="!"||i==="("||i===")"){t.push({t:"op",v:i}),n+=1;continue}throw new le(`illegal character '${i}' in condition: ${e}`)}return t}class dd{constructor(t){me(this,"pos",0);this.tokens=t}peek(){return this.tokens[this.pos]}next(){const t=this.tokens[this.pos];if(t===void 0)throw new le("unexpected end of condition");return this.pos+=1,t}eatOp(t){const n=this.next();if(n.t!=="op"||n.v!==t)throw new le(`expected '${t}', got '${n.t==="op"?n.v:n.t}'`)}parse(){const t=this.parseOr();if(this.pos!==this.tokens.length){const n=this.peek();throw new le(`unexpected trailing token '${n?n.t==="op"?n.v:n.t:"?"}'`)}return t}parseOr(){let t=this.parseAnd();for(;this.matchOp("||");)t={kind:"binary",op:"||",left:t,right:this.parseAnd()};return t}parseAnd(){let t=this.parseCompare();for(;this.matchOp("&&");)t={kind:"binary",op:"&&",left:t,right:this.parseCompare()};return t}parseCompare(){const t=this.parseUnary(),n=this.peek();return n!==void 0&&n.t==="op"&&[">=",">","<=","<","==","!="].includes(n.v)?(this.pos+=1,{kind:"compare",op:n.v,left:t,right:this.parseUnary()}):t}parseUnary(){return this.matchOp("!")?{kind:"unary",op:"!",operand:this.parseUnary()}:this.parseAtom()}parseAtom(){const t=this.next();if(t.t==="num")return{kind:"num",value:t.v};if(t.t==="str")throw new le("string literal only allowed as function argument");if(t.t==="op"&&t.v==="("){const n=this.parseOr();return this.eatOp(")"),n}if(t.t==="id"){if(t.v==="has"||t.v==="hasItem"){this.eatOp("(");const n=this.next();if(n.t!=="str")throw new le(`'${t.v}' expects a quoted string argument`);return this.eatOp(")"),{kind:"call",fn:t.v,arg:n.v}}if(!ud.has(t.v))throw new le(`unknown identifier '${t.v}' in condition`);return{kind:"var",name:t.v}}throw new le(`unexpected operator '${t.v}' in condition`)}matchOp(t){const n=this.peek();return n!==void 0&&n.t==="op"&&n.v===t?(this.pos+=1,!0):!1}}const io=new Map;function fd(e){const t=io.get(e);if(t!==void 0)return t;const n=new dd(_d(e)).parse();return io.set(e,n),n}function Dt(e,t){switch(e.kind){case"num":return e.value!==0;case"var":return Ir(e.name,t)!==0;case"call":return e.fn==="has"?t.flags.has(e.arg):t.items.has(e.arg);case"unary":return!Dt(e.operand,t);case"binary":return e.op==="&&"?Dt(e.left,t)&&Dt(e.right,t):Dt(e.left,t)||Dt(e.right,t);case"compare":{const n=so(e.left,t),i=so(e.right,t);switch(e.op){case">=":return n>=i;case">":return n>i;case"<=":return n<=i;case"<":return n<i;case"==":return n===i;case"!=":return n!==i}}}}function so(e,t){if(e.kind==="num")return e.value;if(e.kind==="var")return Ir(e.name,t);throw new le("comparison operands must be numbers")}function Ir(e,t){switch(e){case"evidence":return t.evidence;case"opinion":return t.opinion;case"composure":return t.composure;case"risk":return t.risk;case"dEvidence":return t.dEvidence;case"dOpinion":return t.dOpinion;case"dComposure":return t.dComposure;case"dRisk":return t.dRisk;case"turn":return t.turn;default:throw new le(`unknown identifier '${e}'`)}}function Cr(e,t){return e.trim()==="true"?!0:Dt(fd(e),t)}function gd(e){return e<Fn.T3||e<Fn.T2?2:e<Fn.T1?1:0}function md(e,t){const n=i=>{let s=0;const o=`${t}/${i}`;for(let r=0;r<o.length;r+=1)s=Math.imul(s,31)+o.charCodeAt(r)|0;return(s>>>1&2147483647)/2147483648};return[...e].sort((i,s)=>n(i.id)-n(s.id))}function oo(e,t,n=new Set){const i=e.options.filter(c=>c.oncePerNode===!0&&n.has(c.id)?!1:c.requires===void 0?!0:Cr(c.requires,Er(t,vd))),s=gd(t.composure),r=e.impulsePool.filter(c=>t.composure<c.unlockBelow).slice(0,s);return md([...i,...r],e.id)}const vd={evidence:0,opinion:0,composure:0,risk:0};function hd(e,t){return t.composure<Fn.T3?to.PANIC:e.timer??to.DEFAULT}function xd(e,t,n){if(t.flags.has("FORCED_F")){const s=e.endings.find(o=>o.condition==="FORCED");if(s===void 0)throw new le(`level ${e.id} has FORCED_F state but no FORCED ending`);return s}const i=Er(t,n);for(const s of e.endings)if(s.condition!=="FORCED"&&Cr(s.condition,i))return s;throw new le(`level ${e.id}: no ending condition matched (missing 'true' fallback?)`)}const kd="__END__";function Ri(e){return e.type==="choice"}class _s{constructor(t,n){me(this,"nodeMap");me(this,"endingMap");me(this,"initMeter");me(this,"current");me(this,"currentNodeId");me(this,"usedThisVisit",new Set);this.level=t,this.nodeMap=new Map(t.nodes.map(i=>[i.id,i])),this.endingMap=new Map(t.endings.map(i=>[i.id,i])),this.initMeter=t.initState,this.current=this.buildInitialState(n),this.currentNodeId=t.entryNode}buildInitialState(t){const n=new Set([...t.flags].filter(o=>o.startsWith("G_"))),i=n.has("G_NEG_DESTROYED_EVIDENCE")?vn.MAX+Vi.DESTROY_EVIDENCE_CAP:vn.MAX,s=n.has("G_NEG_ASSAULT")?15:0;return{evidence:this.level.initState.evidence,opinion:this.level.initState.opinion,composure:this.level.initState.composure,risk:this.level.initState.risk+s,flags:n,items:new Set(t.items),turn:0,evidenceCap:i}}get state(){return this.current}start(){return this.advanceFrom(this.currentNodeId)}choose(t){const n=this.getNode(this.currentNodeId);if(!Ri(n))throw new le(`choose() called on non-choice node ${n.id} in level ${this.level.id}`);const s=oo(n,this.current,this.usedThisVisit).find(o=>o.id===t);if(s===void 0)throw new le(`option '${t}' not available at node ${n.id} (level ${this.level.id})`);return this.applyChoice(n,s)}timeout(){const t=this.getNode(this.currentNodeId);if(!Ri(t))throw new le(`timeout() called on non-choice node ${t.id} in level ${this.level.id}`);const n=t.options.find(i=>i.id===t.timeoutOption);if(n===void 0)throw new le(`timeoutOption '${t.timeoutOption}' not found in node ${t.id}`);return this.applyChoice(t,n)}getNode(t){const n=this.nodeMap.get(t);if(n===void 0)throw new le(`node not found: ${t} (level ${this.level.id})`);return n}applyChoice(t,n){const i=ad(n);return i!==null?(this.current=no(this.current,n,this.level.act,t.pressure),this.current.flags.add("FORCED_F"),this.current.flags.add("G_NEG_ASSAULT"),this.finishWith(i.forcedEnding)):(n.oncePerNode===!0&&this.usedThisVisit.add(n.id),this.current=no(this.current,n,this.level.act,t.pressure),this.current=pd(this.current,t),this.advanceFrom(n.next))}advanceFrom(t){if(t===kd)return this.finishWith(null);let n=t;for(let i=0;i<yd;i+=1){const s=this.endingMap.get(n);if(s!==void 0)return this.finishWith(s.id);const o=this.getNode(n);return Ri(o)?(n!==this.currentNodeId&&(this.usedThisVisit=new Set),this.currentNodeId=o.id,{type:"options",options:oo(o,this.current,this.usedThisVisit),timer:hd(o,this.current),timeoutOptionId:o.timeoutOption,prompt:o.prompt,pressure:o.pressure,nodeId:o.id}):(this.currentNodeId=o.id,{type:"node",node:o})}throw new le(`node chain too deep at ${n} (level ${this.level.id})`)}proceed(){const t=this.getNode(this.currentNodeId);if(t.next===void 0)throw new le(`node ${t.id} has no next (level ${this.level.id})`);return this.advanceFrom(t.next)}finishWith(t){const n=t!==null?this.endingMap.get(t):void 0;if(t!==null&&n===void 0)throw new le(`ending not found: ${t} (level ${this.level.id})`);const i=us(this.current);return{type:"ending",ending:n!==void 0?n:xd(this.level,this.current,this.initMeter),state:i}}static simulate(t,n,i){const s=new _s(t,n);let o=s.start(),r=0;for(;;){if(o.type==="ending")return{rank:o.ending.rank,state:o.state};if(o.type==="node"){o=s.proceed();continue}if(o.type==="options"){const c=i[r];if(r+=1,c===void 0)throw new le(`simulate path exhausted at node in level ${t.id}`);o=s.choose(c);continue}}}}const yd=200,Mr="poju_shilu_save_v1";function Gi(){return{version:1,flags:[],items:[],levelResults:{},cards:[],settings:{mode:"NORMAL",sound:!0}}}const zn=globalThis.localStorage,$r=typeof zn<"u"&&zn!==null;function Ad(){if(!$r)return Gi();const e=zn.getItem(Mr);return e===null?Gi():JSON.parse(e)}function Ld(e){$r&&zn.setItem(Mr,JSON.stringify(e))}const Td={L01:{flag:"G_EV_SUBWAY",minRank:["S","A"]},L02:{flag:"G_EV_ELEVATOR",minRank:["S","A"]},L03:{flag:"G_EV_MALL",minRank:["S","A"]},L04:{flag:"G_EV_NIGHTWALK",minRank:["S","A"]},L05:{flag:"G_EV_GYM",minRank:["S","A"]},L06:{flag:"G_EV_BETROTHAL",minRank:["S","A"]},L07:{flag:"G_EV_TRANSFER",minRank:["S","A"]},L08:{flag:"G_EV_PATERNITY",minRank:["S","A"]},L09:{flag:"G_EV_PRESERVATION",minRank:["S","A"]},L10:{flag:"G_EV_PROTECTION_ORDER",minRank:["S","A"]},L11:{flag:"G_EV_HR_WRITTEN",minRank:["S","A"]},L12:{flag:"G_EV_EMAIL_CHAIN",minRank:["S","A"]},L13:{flag:"G_EV_FULL_AUDIO",minRank:["S","A"]},L14:{flag:"G_EV_SUSPENSION",minRank:["S","A"]},L15:{flag:"G_EV_EXTORTION",minRank:["S","A"]},L16:{flag:"G_EV_ORIGINAL_CLIP",minRank:["S","A"]},L17:{flag:"G_EV_DOXX_NOTARY",minRank:["S","A"]},L18:{flag:"G_EV_LIVE_RECORD",minRank:["S","A"]},L19:{flag:"G_EV_PLATFORM",minRank:["S","A"]}},bd={L02:"G_NEG_DESTROYED_EVIDENCE",L07:"G_NEG_HUSH_MONEY",L10:"L10_VIOLATED",L13:"G_NEG_APOLOGY_LETTER",L17:"G_NEG_DOXXED_BACK"};function wd(e,t){switch(e){case"L01":return t==="S"||t==="A"?["item_recorder"]:[];case"L02":return["item_shen_card"];case"L08":return t==="S"?["item_calm_breathing"]:[];case"L11":return t==="S"||t==="A"?["item_hr_playbook"]:[];case"L16":return t==="S"||t==="A"?["item_notary_habit"]:[];default:return[]}}function Pd(e,t,n,i,s){const o={...e,flags:[...e.flags],items:[...e.items],levelResults:{...e.levelResults},cards:[...e.cards]},r=new Set(o.flags);for(const d of i.flags)d.startsWith("G_")&&r.add(d);const c=Td[t];if(c!==void 0&&c.minRank.includes(n.rank)){const d=bd[t];d!==void 0&&(r.has(d)||i.flags.has(d))||r.add(c.flag)}const a=wd(t,n.rank),p=new Set(o.items);for(const d of a)p.add(d);n.unlock!==void 0&&!o.cards.includes(n.unlock)&&o.cards.push(n.unlock);const l=s==null?void 0:s.now;return o.levelResults[t]={rank:n.rank,endingId:n.id,ts:l},o.flags=[...r].filter(d=>d.startsWith("G_")),o.items=[...p],o}const Nr="L01",Fr="第01关 · 地铁三分钟",Dr=1,Br={evidence:20,opinion:50,composure:80,risk:10},Hr=["hero","npc_l01_woman","crowd","officer_lin"],Vr="n_01",Gr="card_law_L01",jr=["T1","T2"],Ur=[{id:"n_01",type:"cutscene",pressure:1,script:`三点十四分，三号线。车厢是满的，不算挤。
列车进站前一次急刹，所有人往前倾了半步。
...
林昭把进度条往回拖了三分钟。`,next:"__END__"}],Yr=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 互殴",script:`你的手推在她身上。她后退半步，尖叫。
二十个镜头同时转向你。
...
——情绪也是一种预算。这一次，你在它身上透支了。`}],Od={id:Nr,title:Fr,act:Dr,initState:Br,cast:Hr,entryNode:Vr,lawyerCard:Gr,satireTargets:jr,nodes:Ur,endings:Yr},Rd=Object.freeze(Object.defineProperty({__proto__:null,act:Dr,cast:Hr,default:Od,endings:Yr,entryNode:Vr,id:Nr,initState:Br,lawyerCard:Gr,nodes:Ur,satireTargets:jr,title:Fr},Symbol.toStringTag,{value:"Module"})),Kr="L02",qr="第02关 · 电梯里的镜头",Wr=1,zr={evidence:25,opinion:45,composure:75,risk:10},Xr=["hero","npc_l02_woman","crowd","shen_li","officer_lin"],Jr="n_01",Zr="card_law_L02",Qr=["T1","T2"],ec=[{id:"n_01",type:"cutscene",pressure:1,script:`写字楼，十八层下行。
...
烫金的字，边角很硬。`,next:"__END__"}],tc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 你先动的手",script:`大堂的监控拍得很清楚：她站着，你伸的手。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L02_F"}],Sd={id:Kr,title:qr,act:Wr,initState:zr,cast:Xr,entryNode:Jr,lawyerCard:Zr,satireTargets:Qr,nodes:ec,endings:tc},Ed=Object.freeze(Object.defineProperty({__proto__:null,act:Wr,cast:Xr,default:Sd,endings:tc,entryNode:Jr,id:Kr,initState:zr,lawyerCard:Zr,nodes:ec,satireTargets:Qr,title:qr},Symbol.toStringTag,{value:"Module"})),nc="L03",ic="第03关 · 爸爸和女儿",sc=1,oc={evidence:15,opinion:25,composure:60,risk:30},rc=["hero","npc_l03_daughter","npc_l03_woman","crowd","officer_lin"],cc="n_01",ac="card_law_L03",lc=["T1","T2","T3"],pc=[{id:"n_01",type:"cutscene",pressure:1,script:`周六下午，商场三楼，玩具区门口。
...
那三个字很小，但离得近的人都听见了。`,next:"__END__"}],uc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 她摔在扶梯口",script:`你推开了挡路的人。人群晃了一下。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L03_F"}],Id={id:nc,title:ic,act:sc,initState:oc,cast:rc,entryNode:cc,lawyerCard:ac,satireTargets:lc,nodes:pc,endings:uc},Cd=Object.freeze(Object.defineProperty({__proto__:null,act:sc,cast:rc,default:Id,endings:uc,entryNode:cc,id:nc,initState:oc,lawyerCard:ac,nodes:pc,satireTargets:lc,title:ic},Symbol.toStringTag,{value:"Module"})),_c="L04",dc="第04关 · 深夜同行",fc=1,gc={evidence:20,opinion:35,composure:55,risk:35},mc=["hero","npc_l04_woman","officer_lin","crowd"],vc="n_01",hc="card_law_L04",xc=["T1","T3"],kc=[{id:"n_01",type:"cutscene",pressure:1,script:`十一点四十，出地铁 C 口。加了四个小时班，你只想快点到家。
...
多走了十一分钟。`,next:"__END__"}],yc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 你推的是警察",script:`执法记录仪全程都在录。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L04_F"}],Md={id:_c,title:dc,act:fc,initState:gc,cast:mc,entryNode:vc,lawyerCard:hc,satireTargets:xc,nodes:kc,endings:yc},$d=Object.freeze(Object.defineProperty({__proto__:null,act:fc,cast:mc,default:Md,endings:yc,entryNode:vc,id:_c,initState:gc,lawyerCard:hc,nodes:kc,satireTargets:xc,title:dc},Symbol.toStringTag,{value:"Module"})),Ac="L05",Lc="第05关 · 托杠铃的那一下",Tc=1,bc={evidence:20,opinion:30,composure:50,risk:40},wc=["hero","npc_l05_woman","npc_l05_manager","npc_l05_witness","crowd"],Pc="n_01",Oc="card_law_L05",Rc=["T1","T5"],Sc=[{id:"n_01",type:"cutscene",pressure:1,script:`自由重量区，晚上八点半。
...
器械区有七八个人。所有人都看见了。
没有人过去。`,next:"__END__"}],Ec=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那一巴掌",script:`手机摔在地胶上，屏幕裂成蛛网。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L05_F"}],Nd={id:Ac,title:Lc,act:Tc,initState:bc,cast:wc,entryNode:Pc,lawyerCard:Oc,satireTargets:Rc,nodes:Sc,endings:Ec},Fd=Object.freeze(Object.defineProperty({__proto__:null,act:Tc,cast:wc,default:Nd,endings:Ec,entryNode:Pc,id:Ac,initState:bc,lawyerCard:Oc,nodes:Sc,satireTargets:Rc,title:Lc},Symbol.toStringTag,{value:"Module"})),Ic="L06",Cc="第06关 · 三十八万八",Mc=2,$c={evidence:30,opinion:50,composure:48,risk:20},Nc=["hero","npc_l06_girlfriend","npc_l06_mother","crowd"],Fc="n_01",Dc="card_law_L06",Bc=["T1","T3"],Hc=[{id:"n_01",type:"cutscene",pressure:1,script:`女方家客厅。茶几上摆着切好的果盘，没人动。
...
你说不用。
她说：「我知道不用。我就是想让你知道，我们出得起。」`,next:"__END__"}],Vc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口那一下",script:`你推开她的时候，她的后腰撞在鞋柜角上。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L06_F"}],Dd={id:Ic,title:Cc,act:Mc,initState:$c,cast:Nc,entryNode:Fc,lawyerCard:Dc,satireTargets:Bc,nodes:Hc,endings:Vc},Bd=Object.freeze(Object.defineProperty({__proto__:null,act:Mc,cast:Nc,default:Dd,endings:Vc,entryNode:Fc,id:Ic,initState:$c,lawyerCard:Dc,nodes:Hc,satireTargets:Bc,title:Cc},Symbol.toStringTag,{value:"Module"})),Gc="L07",jc="第07关 · 青春损失费",Uc=2,Yc={evidence:35,opinion:45,composure:45,risk:30},Kc=["hero","npc_l07_ex","shen_li"],qc="n_01",Wc="card_law_L07",zc=["T1","T4"],Xc=[{id:"n_01",type:"cutscene",pressure:1,script:`分手第九天。她约你在常去的那家咖啡馆。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L07_F"}],Hd={id:Gc,title:jc,act:Uc,initState:Yc,cast:Kc,entryNode:qc,lawyerCard:Wc,satireTargets:zc,nodes:Xc,endings:Jc},Vd=Object.freeze(Object.defineProperty({__proto__:null,act:Uc,cast:Kc,default:Hd,endings:Jc,entryNode:qc,id:Gc,initState:Yc,lawyerCard:Wc,nodes:Xc,satireTargets:zc,title:jc},Symbol.toStringTag,{value:"Module"})),Zc="L08",Qc="第08关 · 孩子不是你的",ea=2,ta={evidence:25,opinion:40,composure:40,risk:25},na=["hero","npc_l08_wife","npc_l08_mother","npc_l08_child","shen_li"],ia="n_01",sa="card_law_L08",oa=["T1","T3"],ra=[{id:"n_01",type:"cutscene",pressure:1,script:`念念三岁体检，血型 AB。
你 O 型，她妈妈 O 型。
...
那三年是真的。这一点，报告上没写。`,next:"__END__"}],ca=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口那一推",script:`你推开挡在门口的她。她撞到门框，额角青了一块。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L08_F"}],Gd={id:Zc,title:Qc,act:ea,initState:ta,cast:na,entryNode:ia,lawyerCard:sa,satireTargets:oa,nodes:ra,endings:ca},jd=Object.freeze(Object.defineProperty({__proto__:null,act:ea,cast:na,default:Gd,endings:ca,entryNode:ia,id:Zc,initState:ta,lawyerCard:sa,nodes:ra,satireTargets:oa,title:Qc},Symbol.toStringTag,{value:"Module"})),aa="L09",la="第09关 · 冷静期",pa=2,ua={evidence:40,opinion:45,composure:42,risk:35},_a=["hero","npc_l09_wife","npc_l09_cousin","shen_li"],da="n_01",fa="card_law_L09",ga=["T2","T4"],ma=[{id:"n_01",type:"cutscene",pressure:1,script:`民政局。离婚登记申请交上去了，三十天冷静期。
工作人员说：三十天后你们再一起来一趟。
...
她那句「这三十天，咱们都别为难对方」——
你后来想了很久。她说的是真心话。
她只是没打算把「为难」这两个字算在自己头上。`,next:"__END__"}],va=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 玄关那一下",script:`抢行李箱的时候她摔在鞋柜上，手腕骨裂。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L09_F"}],Ud={id:aa,title:la,act:pa,initState:ua,cast:_a,entryNode:da,lawyerCard:fa,satireTargets:ga,nodes:ma,endings:va},Yd=Object.freeze(Object.defineProperty({__proto__:null,act:pa,cast:_a,default:Ud,endings:va,entryNode:da,id:aa,initState:ua,lawyerCard:fa,nodes:ma,satireTargets:ga,title:la},Symbol.toStringTag,{value:"Module"})),ha="L10",xa="第10关 · 二十米",ka=2,ya={evidence:30,opinion:35,composure:38,risk:45},Aa=["hero","npc_l10_exwife","npc_l10_child","npc_l10_teacher","shen_li"],La="n_01",Ta="card_law_L10",ba=["T1","T2"],wa=[{id:"n_01",type:"cutscene",pressure:2,script:`抚养费返还的判决生效了。执行立案的第三天，
法院的人把另一份裁定书送到了公司前台。
...
她顿了一下。
「但你自己得记着。」`,next:"__END__"}],Pa=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那扇门",script:`凌晨两点，你砸开了那扇门。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L10_F"}],Kd={id:ha,title:xa,act:ka,initState:ya,cast:Aa,entryNode:La,lawyerCard:Ta,satireTargets:ba,nodes:wa,endings:Pa},qd=Object.freeze(Object.defineProperty({__proto__:null,act:ka,cast:Aa,default:Kd,endings:Pa,entryNode:La,id:ha,initState:ya,lawyerCard:Ta,nodes:wa,satireTargets:ba,title:xa},Symbol.toStringTag,{value:"Module"})),Oa="L11",Ra="第11关 · 面试第七问",Sa=3,Ea={evidence:20,opinion:40,composure:45,risk:20},Ia=["hero","npc_l11_hr","shen_li"],Ca="n_01",Ma="card_law_L11",$a=["T3","T5"],Na=[{id:"n_01",type:"cutscene",pressure:1,script:`终面，第四十分钟。前六个问题答得都不错。
...
你说谢谢，不用了。
挂了电话，你把回执拍照存进云盘，文件名写的是日期。`,next:"__END__"}],Fa=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 会议室",script:`你掀了桌子。笔记本电脑砸在他小腿上。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L11_F"}],Wd={id:Oa,title:Ra,act:Sa,initState:Ea,cast:Ia,entryNode:Ca,lawyerCard:Ma,satireTargets:$a,nodes:Na,endings:Fa},zd=Object.freeze(Object.defineProperty({__proto__:null,act:Sa,cast:Ia,default:Wd,endings:Fa,entryNode:Ca,id:Oa,initState:Ea,lawyerCard:Ma,nodes:Na,satireTargets:$a,title:Ra},Symbol.toStringTag,{value:"Module"})),Da="L12",Ba="第12关 · 署名顺序",Ha=3,Va={evidence:45,opinion:42,composure:42,risk:25},Ga=["hero","npc_l12_colleague","npc_l12_boss","zhou_you"],ja="n_01",Ua="card_law_L12",Ya=["T1","T3"],Ka=[{id:"n_01",type:"cutscene",pressure:1,script:`项目做了十一个月。方案是你出的，架构是你搭的，上线那周你在公司睡了四天。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L12_F"}],Xd={id:Da,title:Ba,act:Ha,initState:Va,cast:Ga,entryNode:ja,lawyerCard:Ua,satireTargets:Ya,nodes:Ka,endings:qa},Jd=Object.freeze(Object.defineProperty({__proto__:null,act:Ha,cast:Ga,default:Xd,endings:qa,entryNode:ja,id:Da,initState:Va,lawyerCard:Ua,nodes:Ka,satireTargets:Ya,title:Ba},Symbol.toStringTag,{value:"Module"})),Wa="L13",za="第13关 · 团建那句玩笑",Xa=3,Ja={evidence:25,opinion:35,composure:36,risk:40},Za=["hero","npc_l13_hr","npc_l13_complainant","zhou_you","shen_li"],Qa="n_01",el="card_law_L13",tl=["T1","T5"],nl=[{id:"n_01",type:"cutscene",pressure:1,script:`三周前，部门团建，KTV 包厢。
十一个人，两箱啤酒，唱到十一点半。
...
你回：不用。你那天问我那句话，问得对。`,next:"__END__"}],il=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 小会议室",script:`杯子摔了，笔记本飞到墙上。HR 的手背划破了。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L13_F"}],Zd={id:Wa,title:za,act:Xa,initState:Ja,cast:Za,entryNode:Qa,lawyerCard:el,satireTargets:tl,nodes:nl,endings:il},Qd=Object.freeze(Object.defineProperty({__proto__:null,act:Xa,cast:Za,default:Zd,endings:il,entryNode:Qa,id:Wa,initState:Ja,lawyerCard:el,nodes:nl,satireTargets:tl,title:za},Symbol.toStringTag,{value:"Module"})),sl="L14",ol="第14关 · 匿名举报",rl=3,cl={evidence:30,opinion:35,composure:34,risk:45},al=["hero","npc_l14_hr","npc_l14_director","zhou_you","shen_li"],ll="n_01",pl="card_law_L14",ul=["T1","T5"],_l=[{id:"n_01",type:"cutscene",pressure:2,script:`晋升公示第七天，最后一天。
...
周攸看到那条，截图发给你：「第三条。」
你回：「嗯。」`,next:"__END__"}],dl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口",script:`你推开了他。他手里的咖啡洒了一身，人撞在门框上。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L14_F"}],ef={id:sl,title:ol,act:rl,initState:cl,cast:al,entryNode:ll,lawyerCard:pl,satireTargets:ul,nodes:_l,endings:dl},tf=Object.freeze(Object.defineProperty({__proto__:null,act:rl,cast:al,default:ef,endings:dl,entryNode:ll,id:sl,initState:cl,lawyerCard:pl,nodes:_l,satireTargets:ul,title:ol},Symbol.toStringTag,{value:"Module"})),fl="L15",gl="第15关 · 最后一张牌",ml=3,vl={evidence:40,opinion:40,composure:32,risk:50},hl=["hero","npc_l15_broker","npc_l15_hr","shen_li"],xl="n_01",kl="card_law_L15",yl=["T4"],Al=[{id:"n_01",type:"cutscene",pressure:2,script:`裁员名单下来了，你在上面。
...
沈骊在路边等你，车窗摇下来：「上车吧，堵着呢。」`,next:"__END__"}],Ll=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那一拳",script:`你在楼下堵住他，一拳打在他脸上。鼻梁骨折。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L15_F"}],nf={id:fl,title:gl,act:ml,initState:vl,cast:hl,entryNode:xl,lawyerCard:kl,satireTargets:yl,nodes:Al,endings:Ll},sf=Object.freeze(Object.defineProperty({__proto__:null,act:ml,cast:hl,default:nf,endings:Ll,entryNode:xl,id:fl,initState:vl,lawyerCard:kl,nodes:Al,satireTargets:yl,title:gl},Symbol.toStringTag,{value:"Module"})),Tl="L16",bl="第16关 · 三十秒剪辑",wl=4,Pl={evidence:35,opinion:20,composure:40,risk:40},Ol=["hero","npc_l16_account","shen_li","zhou_you","crowd"],Rl="n_01",Sl="card_law_L16",El=["T2","T4"],Il=[{id:"n_01",type:"cutscene",pressure:3,script:`周一早上七点，你在地铁上刷到自己。
...
沈骊把那张工商信息截图放大，看了很久。
「这个人，我见过两次。」
「两次都在别人的案子里。」`,next:"__END__"}],Cl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 找上门",script:`你找到了那家公司的地址，冲进去把设备砸了。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L16_F"}],of={id:Tl,title:bl,act:wl,initState:Pl,cast:Ol,entryNode:Rl,lawyerCard:Sl,satireTargets:El,nodes:Il,endings:Cl},rf=Object.freeze(Object.defineProperty({__proto__:null,act:wl,cast:Ol,default:of,endings:Cl,entryNode:Rl,id:Tl,initState:Pl,lawyerCard:Sl,nodes:Il,satireTargets:El,title:bl},Symbol.toStringTag,{value:"Module"})),Ml="L17",$l="第17关 · 人肉",Nl=4,Fl={evidence:40,opinion:10,composure:28,risk:45},Dl=["hero","npc_l17_father","npc_l17_hr","shen_li","crowd"],Bl="n_01",Hl="card_law_L17",Vl=["T2","T4"],Gl=[{id:"n_01",type:"cutscene",pressure:4,script:`周四凌晨两点，一个文档在群里传开了。
...
「小屿，」他说，「你别恨她们。」
「你就把这事办完。」`,next:"__END__"}],jl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 你找过去了",script:`你按扒到的地址找过去，砸了门，打了人。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L17_F"}],cf={id:Ml,title:$l,act:Nl,initState:Fl,cast:Dl,entryNode:Bl,lawyerCard:Hl,satireTargets:Vl,nodes:Gl,endings:jl},af=Object.freeze(Object.defineProperty({__proto__:null,act:Nl,cast:Dl,default:cf,endings:jl,entryNode:Bl,id:Ml,initState:Fl,lawyerCard:Hl,nodes:Gl,satireTargets:Vl,title:$l},Symbol.toStringTag,{value:"Module"})),Ul="L18",Yl="第18关 · 直播间的生意",Kl=4,ql={evidence:55,opinion:30,composure:38,risk:35},Wl=["hero","npc_l18_streamer","shen_li","crowd"],zl="n_01",Xl="card_law_L18",Jl=["T4"],Zl=[{id:"n_01",type:"cutscene",pressure:2,script:`一个百万粉的账号发来连线邀请。
...
「还有十六个。」她说。
「不过没关系。这十七个后面只有一个人。」`,next:"__END__"}],Ql=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 直播事故",script:`你在连线里失控了，摔了东西，骂了整整四十秒。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L18_F"}],lf={id:Ul,title:Yl,act:Kl,initState:ql,cast:Wl,entryNode:zl,lawyerCard:Xl,satireTargets:Jl,nodes:Zl,endings:Ql},pf=Object.freeze(Object.defineProperty({__proto__:null,act:Kl,cast:Wl,default:lf,endings:Ql,entryNode:zl,id:Ul,initState:ql,lawyerCard:Xl,nodes:Zl,satireTargets:Jl,title:Yl},Symbol.toStringTag,{value:"Module"})),ep="L19",tp="第19关 · 各执一词",np=4,ip={evidence:60,opinion:45,composure:42,risk:30},sp=["hero","npc_l19_moderator","npc_l19_pr","shen_li"],op="n_01",rp="card_law_L19",cp=["T5"],ap=[{id:"n_01",type:"cutscene",pressure:2,script:`平台申诉结果：不予处理。
...
沈骊把回执递给你：「立案了。」
「开庭大概在三个月后。」`,next:"__END__"}],lp=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 会议室",script:`你把材料摔了，推翻了椅子，一个工作人员的手被划伤。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L19_F"}],uf={id:ep,title:tp,act:np,initState:ip,cast:sp,entryNode:op,lawyerCard:rp,satireTargets:cp,nodes:ap,endings:lp},_f=Object.freeze(Object.defineProperty({__proto__:null,act:np,cast:sp,default:uf,endings:lp,entryNode:op,id:ep,initState:ip,lawyerCard:rp,nodes:ap,satireTargets:cp,title:tp},Symbol.toStringTag,{value:"Module"})),pp="L20",up="第20关 · 对簿",_p=4,dp={evidence:60,opinion:50,composure:60,risk:30},fp=["hero","he_song","zhou_you","shen_li","crowd"],gp="n_01",mp="card_law_L20",vp=["T2","T4","T5"],hp=[{id:"n_01",type:"cutscene",pressure:3,script:`开庭。第三法庭，旁听席坐满了。
...
划掉了。`,next:"__END__"}],xp=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 最后一步",script:`你越过栏杆冲了过去。法警拦下你的时候，你已经碰到了他。
...
划掉了。`,unlock:"card_L20_F"}],df={id:pp,title:up,act:_p,initState:dp,cast:fp,entryNode:gp,lawyerCard:mp,satireTargets:vp,nodes:hp,endings:xp},ff=Object.freeze(Object.defineProperty({__proto__:null,act:_p,cast:fp,default:df,endings:xp,entryNode:gp,id:pp,initState:dp,lawyerCard:mp,nodes:hp,satireTargets:vp,title:up},Symbol.toStringTag,{value:"Module"})),gf=Object.assign({"../../content/levels/L01.json":Rd,"../../content/levels/L02.json":Ed,"../../content/levels/L03.json":Cd,"../../content/levels/L04.json":$d,"../../content/levels/L05.json":Fd,"../../content/levels/L06.json":Bd,"../../content/levels/L07.json":Vd,"../../content/levels/L08.json":jd,"../../content/levels/L09.json":Yd,"../../content/levels/L10.json":qd,"../../content/levels/L11.json":zd,"../../content/levels/L12.json":Jd,"../../content/levels/L13.json":Qd,"../../content/levels/L14.json":tf,"../../content/levels/L15.json":sf,"../../content/levels/L16.json":rf,"../../content/levels/L17.json":af,"../../content/levels/L18.json":pf,"../../content/levels/L19.json":_f,"../../content/levels/L20.json":ff}),hn=Object.values(gf).map(e=>e.default).sort((e,t)=>e.id.localeCompare(t.id)),mf="破局实录",vf="开发预览 · M3 前置切片",hf={evidence:"证据",opinion:"舆论",composure:"情绪",risk:"风险"},xf={hero:"陈屿",shen_li:"沈骊",officer_lin:"林昭",zhou_you:"周攸",he_song:"贺松",crowd:"围观者",narrator:"",npc_l01_woman:"红衣女子",npc_l02_woman:"住户女子",npc_l03_woman:"路人女子",npc_l03_daughter:"念念",npc_l04_woman:"报警人",npc_l05_woman:"女子",npc_l05_manager:"值班经理",npc_l05_witness:"目击大哥",npc_l06_girlfriend:"前女友",npc_l06_mother:"她母亲",npc_l07_ex:"前女友",npc_l08_wife:"妻子",npc_l08_mother:"岳母",npc_l08_child:"孩子",npc_l09_wife:"妻子",npc_l09_cousin:"表哥",npc_l10_exwife:"前妻",npc_l10_child:"女儿",npc_l10_teacher:"班主任",npc_l11_hr:"HR",npc_l12_colleague:"同事",npc_l12_boss:"部门老板",npc_l13_hr:"HR",npc_l13_complainant:"投诉人",npc_l14_hr:"HR 总监",npc_l14_director:"总监",npc_l15_broker:"中介",npc_l15_hr:"HR",npc_l16_account:"商务",npc_l17_father:"父亲",npc_l17_hr:"HR",npc_l18_streamer:"主播",npc_l19_moderator:"版务",npc_l19_pr:"公关",npc_l20_judge:"审判长",npc_l20_lawyer:"对方律师"},kf={1:"第一幕 · 流量即真相",2:"第二幕 · 亲密关系的账",3:"第三幕 · 职场的规则",4:"第四幕 · 收网"},yf={tapToContinue:"点击继续",secondsUnit:"s",endingTitle:"结局",restart:"再玩一次",nextLevel:"下一关",levelSelect:"选择关卡",lockedLevel:"未解锁",rankNames:{S:"名场面",A:"稳住了",B:"有惊无险",C:"勉强收场",F:"翻车"},finalMeters:"最终仪表",disclaimer:"本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。",progressLabel:"进度",soundToggle:"M",studyIntro:"测试开始前\\n请输入现场编号（如 P01）\\n\\n然后独立游玩前五关\\n过程中不会有任何提示\\n做完自动出现数据回收",studyPidPlaceholder:"现场编号",studyStart:"开始",studyDoneTitle:"第一幕完成",studyCopy:"导出数据（JSON）",studySummaryHeader:"参与者 {p} · {n} 次游玩",studySummaryLine:"{lv}: {rank}「{title}」 用时{s}秒 抉择{c}次 重玩{r}",stanceLow:"稳住",stanceHigh:"顶回去",pileALabel:"这条",pileBLabel:"那条",pileListHint:"选一个",swipeHint:"左右滑动选择 · 点按也可以",settlePhase1:"结算中",settleStampS:"教科书式破局",settleStampA:"稳稳落地",settleStampB:"有惊无险",settleStampC:"伤敌自伤",settleStampF:"满盘皆输",settleMetersTitle:"终局面",settleReplay:"本关重打",settleNext:"下一关",lawyerCardTitle:"【沈骊说】案情法律与应对实务复盘",lawyerCardBadge:"核心普法",lawyerCardBtn:"查看沈律师专业点评与法条依据",lawyerModalHeader:"沈骊律师 · 案情实务备忘录",lawyerModalRisk:"合规风险等级",lawyerModalClose:"已掌握破局要点",appTagline:"你不需要嘴更毒，你只需要比对手更懂规则",startAdventure:"开始破局",continueAdventure:"继续破局",recapTitle:"关键因果复盘",costComposure:"耗心力",gainBreath:"平复呼吸",dangerImpulse:"冲动失控风险",containsOptions:"内含 {n} 项应对"},Af={L01:{label:"地铁三号线",hue:205,motif:"subway"},L02:{label:"住宅电梯",hue:220,motif:"elevator"},L03:{label:"商场中庭",hue:35,motif:"mall"},L04:{label:"深夜街道",hue:235,motif:"street"},L05:{label:"健身房",hue:15,motif:"gym"},L06:{label:"两家饭桌",hue:28,motif:"table"},L07:{label:"出租屋",hue:200,motif:"room"},L08:{label:"客厅",hue:40,motif:"room"},L09:{label:"民政局外",hue:210,motif:"office"},L10:{label:"学校门口",hue:45,motif:"street"},L11:{label:"面试间",hue:215,motif:"office"},L12:{label:"开放工位",hue:210,motif:"office"},L13:{label:"会议室",hue:220,motif:"office"},L14:{label:"总监办公室",hue:225,motif:"office"},L15:{label:"写字楼楼下",hue:200,motif:"street"},L16:{label:"剪辑室",hue:260,motif:"studio"},L17:{label:"家中",hue:30,motif:"room"},L18:{label:"直播间后台",hue:320,motif:"studio"},L19:{label:"平台工单页",hue:190,motif:"office"},L20:{label:"法院走廊",hue:210,motif:"court"}},Lf={calm:["前排","吃瓜","蹲后续","录下来了","别急，等反转","让子弹飞一会儿"],tense:["什么情况？?","有人认识吗","这女的厉害","这男的稳住啊","报警了吗","快报警","别拍了先帮个忙啊","主播别切","全网都在看"],hot:["热搜第一预定","已经录屏了","传到群里了","反转了反转了","坐等打脸","这瓜保熟","直播间炸了","三分钟了还在吵"]},Tf={hero:210,shen_li:280,officer_lin:195,zhou_you:150,he_song:350,npc_l01_woman:350,npc_l02_woman:330,npc_l03_woman:320,npc_l03_daughter:45,npc_l04_woman:160,npc_l05_woman:340,npc_l05_manager:30,npc_l05_witness:200,npc_l06_girlfriend:315,npc_l06_mother:280,npc_l07_ex:300,npc_l08_wife:330,npc_l08_mother:275,npc_l08_child:50,npc_l09_wife:320,npc_l09_cousin:25,npc_l10_exwife:310,npc_l10_child:55,npc_l10_teacher:165,npc_l11_hr:220,npc_l12_colleague:145,npc_l12_boss:25,npc_l13_hr:215,npc_l13_complainant:345,npc_l14_hr:225,npc_l14_director:20,npc_l15_broker:40,npc_l15_hr:218,npc_l16_account:35,npc_l17_father:205,npc_l17_hr:222,npc_l18_streamer:325,npc_l19_moderator:195,npc_l19_pr:285,crowd:0},bf={appTitle:mf,appSub:vf,meters:hf,speakerNames:xf,actNames:kf,ui:yf,scenes:Af,danmaku:Lf,speakerHues:Tf},ue=bf;function Qt(e){const t=ue.ui[e];return typeof t=="string"?t:""}function wf(e){return ue.speakerNames[e]??e}function ji(e){return ue.speakerHues[e]??220}function kp(e){return ue.scenes[e]??{label:"",hue:210,motif:"room"}}const Pf={class:"hud"},Of={class:"label"},Rf={class:"bar"},Sf={class:"val-wrap"},Ef={class:"num"},If=ut({__name:"MeterHud",props:{state:{}},setup(e){const t=e;let n=0;const i=pe({evidence:null,opinion:null,composure:null,risk:null}),s={};Ce(()=>({...t.state}),(r,c)=>{if(!c)return;const a=["evidence","opinion","composure","risk"];for(const p of a){const l=r[p]-c[p];if(l!==0){n+=1;const d=p==="risk"?l<0:l>0;i.value[p]={text:(l>0?"+":"")+l,dir:d?"pos":"neg",key:n},s[p]!==void 0&&clearTimeout(s[p]),s[p]=setTimeout(()=>{i.value[p]=null},1400)}}});const o=ce(()=>[{k:"evidence",kind:"good"},{k:"opinion",kind:"good"},{k:"composure",kind:"good"},{k:"risk",kind:"bad"}].map(({k:c,kind:a})=>({key:c,label:ue.meters[c],value:t.state[c],kind:a})));return(r,c)=>(I(),H("div",Pf,[(I(!0),H(ve,null,Ut(o.value,a=>(I(),H("div",{key:a.key,class:he(["meter",[a.key,a.kind,{"is-tense":a.key==="composure"&&a.value<30}]])},[x("span",Of,M(a.label),1),x("div",Rf,[x("div",{class:"fill",style:Ve({width:Math.min(100,Math.max(0,a.value))+"%"})},null,4)]),x("div",Sf,[x("span",Ef,M(a.value),1),xe(b_,{name:"float"},{default:rs(()=>[i.value[a.key]?(I(),H("span",{key:i.value[a.key].key,class:he(["delta",i.value[a.key].dir])},M(i.value[a.key].text),3)):de("",!0)]),_:2},1024)])],2))),128))]))}}),ht=(e,t)=>{const n=e.__vccOpts||e;for(const[i,s]of t)n[i]=s;return n},Cf=ht(If,[["__scopeId","data-v-08cce053"]]),Mf={key:0,class:"name"},$f={class:"text"},Nf={class:"cue"},Ff=ut({__name:"StoryBox",props:{speaker:{},text:{},kind:{}},emits:["advance"],setup(e,{emit:t}){const n=e,i=t,s=l=>l===void 0?"":ue.speakerNames[l]??l,o=l=>l===void 0?220:ji(l),r=pe("");let c;function a(l){if(r.value="",c!==void 0&&clearInterval(c),typeof setInterval!="function"){r.value=l;return}let d=0;c=setInterval(()=>{d+=2,r.value=l.slice(0,d),d>=l.length&&c!==void 0&&(clearInterval(c),c=void 0)},28)}Ce(()=>n.text,l=>a(l),{immediate:!0}),Kt(()=>{c!==void 0&&clearInterval(c)});function p(){r.value.length<n.text.length?(r.value=n.text,c!==void 0&&(clearInterval(c),c=void 0)):i("advance")}return(l,d)=>(I(),H("div",{class:he(["box",e.kind]),style:Ve({"--h":o(e.speaker)}),onClick:p},[e.kind==="dialogue"&&e.speaker?(I(),H("div",Mf,M(s(e.speaker)),1)):de("",!0),x("p",$f,M(r.value),1),x("div",Nf,M(w(ue).ui.tapToContinue),1)],6))}}),ro=ht(Ff,[["__scopeId","data-v-716d70d8"]]),Df={class:"choice-layer"},Bf={key:0,class:"scene-prompt"},Hf=["disabled","onClick"],Vf={class:"opt-text"},Gf={key:0,class:"opt-tag breath"},jf={key:1,class:"opt-tag warn"},Uf={key:2,class:"opt-tag cost"},Yf=["aria-label"],Kf=ut({__name:"ChoiceLayer",props:{options:{},timer:{},timeoutOptionId:{},prompt:{}},emits:["choose"],setup(e,{expose:t,emit:n}){const i=e,s=n,o=ue.ui,r=ce(()=>i.prompt??""),c=pe(!1);Ce(()=>i.options,U=>{var ie,X,G;c.value=!1,String(U.__round??"")+U.length+(((ie=U[0])==null?void 0:ie.id)??""),(G=(X=q.value)==null?void 0:X.scrollTo)==null||G.call(X,{top:0})});function a(U){c.value||(c.value=!0,P(),s("choose",U.id))}const p=pe(i.timer);let l,d=!1,h;function y(){if(!d&&(p.value-=1,p.value<=0&&(P(),!c.value))){c.value=!0;const U=i.options.find(ie=>ie.id===i.timeoutOptionId);U!==void 0&&s("choose",U.id)}}function $(){P(),typeof setInterval=="function"&&(l=setInterval(y,1e3))}function P(){l!==void 0&&(clearInterval(l),l=void 0)}function T(){d=!0}function R(){d=!1}t({pause:T,resume:R}),ci(()=>{$(),h=()=>{d=document.hidden},document.addEventListener("visibilitychange",h)}),Kt(()=>{P(),document.removeEventListener("visibilitychange",h)}),Ce(()=>i.timer,U=>{p.value=U});function N(U){return U.unlockBelow!==void 0||U.tag==="PHYSICAL"}function B(U){return U.tag==="BREATH"}function E(U){const ie=U.initiative??0;return ie>=2?ie-1:0}const q=pe(null);return(U,ie)=>(I(),H("div",Df,[x("div",{ref_key:"listEl",ref:q,class:"scroll"},[r.value?(I(),H("p",Bf,M(r.value),1)):de("",!0),(I(!0),H(ve,null,Ut(e.options,X=>(I(),H("button",{key:X.id,type:"button",class:he(["opt",{impulse:N(X),breath:B(X)}]),disabled:c.value,onClick:G=>a(X)},[x("span",Vf,M(X.text),1),B(X)?(I(),H("span",Gf,"🧘 "+M(w(o).gainBreath),1)):N(X)?(I(),H("span",jf,"⚠️ "+M(w(o).dangerImpulse),1)):E(X)>0?(I(),H("span",Uf,"⚡️ "+M(w(o).costComposure)+" "+M(E(X)),1)):de("",!0)],10,Hf))),128))],512),x("div",{class:he(["time",{panic:p.value<=4}]),role:"timer","aria-label":`剩余 ${p.value} 秒`},[x("span",null,M(p.value),1)],10,Yf)]))}}),qf=ht(Kf,[["__scopeId","data-v-fe4deb2c"]]),Wf=""+new URL("rank_A-Buk7knaJ.mp4",import.meta.url).href,zf=""+new URL("rank_B-MEHXL8TX.mp4",import.meta.url).href,Xf=""+new URL("rank_C-DOkhQSQI.mp4",import.meta.url).href,Jf=""+new URL("rank_F-DPh74h1I.mp4",import.meta.url).href,Zf=""+new URL("rank_S-BXJbetyP.mp4",import.meta.url).href,Qf=[{id:"card_law_L01",level:"L01",body:`【沈骊说】
...
（本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。）`,disclaimer:"ui.lawyer.disclaimer",riskLevel:"MAX",reviewStatus:"APPROVED",reviewedBy:"外部执业律师（所有者 2026-08-28 转达通过）",reviewedAt:"2026-08-28",citations:[]}],e0=["data-rank"],t0=["src"],n0={class:"stamp"},i0={class:"rk"},s0={class:"word"},o0={class:"title"},r0={class:"script"},c0={class:"lb-left"},a0={class:"lb-badge"},l0={class:"lb-title"},p0={class:"lb-btn"},u0={class:"meters-card"},_0={class:"mc-title"},d0={class:"bars"},f0={class:"lbl"},g0={class:"track"},m0={class:"num"},v0={class:"disclaimer"},h0={class:"acts"},x0={class:"ld-head"},k0={class:"ld-title-group"},y0={class:"ld-badge"},A0={class:"ld-title"},L0={class:"ld-body"},T0={class:"ld-text"},b0={class:"ld-foot"},w0={class:"ld-risk"},P0={class:"ld-rk-lbl"},O0=ut({__name:"EndingCard",props:{ending:{},state:{},levelId:{default:""}},emits:["restart","next"],setup(e,{emit:t}){const n=e,i=pe(1),s=pe(!1),o=pe(!1),r=ue.ui,c=ce(()=>r["settleStamp"+n.ending.rank]??""),a=ce(()=>{const T=Object.entries(Object.assign({"../../../content/art/endings/rank_A.mp4":Wf,"../../../content/art/endings/rank_B.mp4":zf,"../../../content/art/endings/rank_C.mp4":Xf,"../../../content/art/endings/rank_F.mp4":Jf,"../../../content/art/endings/rank_S.mp4":Zf})).find(([R])=>R.endsWith("/rank_"+n.ending.rank+".mp4"));return(T==null?void 0:T[1])??""}),p=ce(()=>{const P=Qf;if(n.levelId){const T=P.find(R=>R.level===n.levelId);if(T!==void 0)return T}return P.find(T=>n.ending.id.includes(T.level))??P[0]});let l,d;ci(()=>{if(typeof setTimeout!="function"){i.value=3;return}l=setTimeout(()=>{i.value=2},1200),d=setTimeout(()=>{i.value=3},2600)}),Kt(()=>{l!==void 0&&clearTimeout(l),d!==void 0&&clearTimeout(d)});function h(){l!==void 0&&(clearTimeout(l),l=void 0),d!==void 0&&(clearTimeout(d),d=void 0),i.value=3}function y(P){P.stopPropagation(),o.value=!0}function $(P){P.stopPropagation(),o.value=!1}return(P,T)=>(I(),H("div",{class:"cinema","data-rank":e.ending.rank,onClick:h},[a.value?(I(),H("video",{key:0,class:"bgvid",src:a.value,autoplay:"",muted:"",loop:"",playsinline:"",onCanplay:T[0]||(T[0]=R=>s.value=!0)},null,40,t0)):de("",!0),x("div",{class:he(["dim",{deeper:i.value>=2}])},null,2),x("div",{class:he(["stamp-wrap",{show:i.value>=2}])},[x("div",n0,[x("span",i0,M(e.ending.rank),1),x("span",s0,M(c.value),1)])],2),x("div",{class:he(["sheet",{show:i.value>=3}])},[x("h2",o0,M(e.ending.title),1),x("p",r0,M(e.ending.script),1),p.value?(I(),H("div",{key:0,class:"lawyer-bar",onClick:bt(y,["stop"])},[x("div",c0,[x("span",a0,M(w(r).lawyerCardBadge),1),x("span",l0,M(w(r).lawyerCardTitle),1)]),x("span",p0,[hr(M(w(r).lawyerCardBtn)+" ",1),T[4]||(T[4]=x("i",{class:"arr"},"›",-1))])])):de("",!0),x("div",u0,[x("div",_0,M(w(r).settleMetersTitle),1),x("div",d0,[(I(),H(ve,null,Ut(["evidence","opinion","composure","risk"],R=>x("div",{key:R,class:"bar"},[x("span",f0,M(w(ue).meters[R]),1),x("span",g0,[x("i",{style:Ve({width:Math.min(100,e.state[R])+"%"}),class:he(R)},null,6)]),x("span",m0,M(e.state[R]),1)])),64))])]),x("p",v0,M(w(ue).ui.disclaimer),1),x("div",h0,[x("button",{onClick:T[1]||(T[1]=bt(R=>P.$emit("restart"),["stop"]))},M(w(r).settleReplay),1),x("button",{class:"primary",onClick:T[2]||(T[2]=bt(R=>P.$emit("next"),["stop"]))},M(w(r).settleNext),1)])],2),o.value&&p.value?(I(),H("div",{key:1,class:"lawyer-mask",onClick:bt($,["stop"])},[x("div",{class:"lawyer-drawer",onClick:T[3]||(T[3]=bt(()=>{},["stop"]))},[x("header",x0,[x("div",k0,[x("span",y0,M(w(r).lawyerCardBadge),1),x("span",A0,M(w(r).lawyerModalHeader),1)]),x("button",{class:"ld-close",onClick:bt($,["stop"])},"✕")]),x("div",L0,[x("div",T0,M(p.value.body),1)]),x("footer",b0,[x("div",w0,[x("span",P0,M(w(r).lawyerModalRisk)+":",1),x("span",{class:he(["ld-rk-val",p.value.riskLevel])},M(p.value.riskLevel??"MEDIUM"),3)]),x("button",{class:"ld-ok",onClick:bt($,["stop"])},M(w(r).lawyerModalClose),1)])])])):de("",!0)],8,e0))}}),R0=ht(O0,[["__scopeId","data-v-a7c7954c"]]),S0={class:"select"},E0={class:"sel-header"},I0={class:"header-top"},C0={class:"app-title"},M0={class:"tagline"},$0={class:"hero-cta-wrap"},N0={class:"cta-left"},F0={class:"cta-txt-group"},D0={class:"cta-action"},B0={class:"cta-sub"},H0={class:"list"},V0={key:0,class:"act-title"},G0={class:"act-levels"},j0=["onClick"],U0={class:"tid"},Y0={class:"ttitle"},K0={class:"foot"},q0=ut({__name:"LevelSelect",props:{levels:{},best:{}},emits:["pick"],setup(e){const t=e,n=ue.ui,i=c=>c===void 0?"":"r"+c,s=ce(()=>{var c;for(const a of t.levels)if(!t.best[a.id])return a.id;return((c=t.levels[0])==null?void 0:c.id)??"L01"}),o=ce(()=>Object.keys(t.best).length>0),r=ce(()=>{const c={};for(const a of t.levels)(c[a.act]??(c[a.act]=[])).push(a);return Object.entries(c).map(([a,p])=>({act:Number(a),name:ue.actNames[a]??"",levels:p}))});return(c,a)=>(I(),H("div",S0,[x("header",E0,[x("div",I0,[x("h1",C0,M(w(ue).appTitle),1),a[1]||(a[1]=x("span",{class:"version-tag"},"M3 切片",-1))]),x("p",M0,M(w(n).appTagline),1),x("div",$0,[x("button",{class:"hero-cta",onClick:a[0]||(a[0]=p=>c.$emit("pick",s.value))},[x("div",N0,[a[2]||(a[2]=x("span",{class:"play-btn"},"▶",-1)),x("div",F0,[x("span",D0,M(o.value?w(n).continueAdventure:w(n).startAdventure),1),x("span",B0,"进入 "+M(s.value),1)])]),a[3]||(a[3]=x("span",{class:"cta-arrow"},"›",-1))])])]),x("div",H0,[(I(!0),H(ve,null,Ut(r.value,p=>(I(),H("div",{key:p.act,class:"act-section"},[p.name?(I(),H("div",V0,M(p.name),1)):de("",!0),x("div",G0,[(I(!0),H(ve,null,Ut(p.levels,l=>(I(),H("button",{key:l.id,class:"level-btn",onClick:d=>c.$emit("pick",l.id)},[x("span",U0,M(l.id),1),x("span",Y0,M(l.title),1),x("span",{class:he(["badge",i(e.best[l.id])])},M(e.best[l.id]??"·"),3)],8,j0))),128))])]))),128))]),x("footer",K0,M(w(ue).ui.disclaimer),1)]))}}),W0=ht(q0,[["__scopeId","data-v-e1c5f01f"]]),z0=""+new URL("L01-BJmHDizO.png",import.meta.url).href,X0=""+new URL("L02-Cgrrfiit.png",import.meta.url).href,J0=""+new URL("L03-Dhb-92UY.png",import.meta.url).href,Z0=""+new URL("L04-Dxn6iz_R.png",import.meta.url).href,Q0=""+new URL("L05-BCX3gD5-.png",import.meta.url).href,eg=""+new URL("L06-DPfiJfY4.png",import.meta.url).href,tg=""+new URL("L07-DgpRWPjk.png",import.meta.url).href,ng=""+new URL("L08-HGz_P2cJ.png",import.meta.url).href,ig=""+new URL("L09-VpgvEvrb.png",import.meta.url).href,sg=""+new URL("L10-D_mOdB4H.png",import.meta.url).href,og=""+new URL("L11-BXLJJDeb.png",import.meta.url).href,rg=""+new URL("L12-DemYAPsM.png",import.meta.url).href,cg=""+new URL("L13-Dn-DLBYO.png",import.meta.url).href,ag=""+new URL("L14-BLDD-heh.png",import.meta.url).href,lg=""+new URL("L15-BVYsTDdi.png",import.meta.url).href,pg=""+new URL("L16-kHk4EBk-.png",import.meta.url).href,ug=""+new URL("L17-BomGMZbR.png",import.meta.url).href,_g=""+new URL("L18-B2bLjWIc.png",import.meta.url).href,dg=""+new URL("L19-DHpwxvAB.png",import.meta.url).href,fg=""+new URL("L20-CyAYX9HG.png",import.meta.url).href,gg=["src"],mg={key:1,class:"photo-shade"},vg={key:2,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},hg={key:3,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},xg={key:4,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},kg={key:5,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},yg={key:6,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Ag={key:7,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Lg={class:"tag"},Tg=ut({__name:"SceneBackdrop",props:{levelId:{},pressure:{}},setup(e){const t=e,n=Object.assign({"../../../content/art/scenes/L01.png":z0,"../../../content/art/scenes/L02.png":X0,"../../../content/art/scenes/L03.png":J0,"../../../content/art/scenes/L04.png":Z0,"../../../content/art/scenes/L05.png":Q0,"../../../content/art/scenes/L06.png":eg,"../../../content/art/scenes/L07.png":tg,"../../../content/art/scenes/L08.png":ng,"../../../content/art/scenes/L09.png":ig,"../../../content/art/scenes/L10.png":sg,"../../../content/art/scenes/L11.png":og,"../../../content/art/scenes/L12.png":rg,"../../../content/art/scenes/L13.png":cg,"../../../content/art/scenes/L14.png":ag,"../../../content/art/scenes/L15.png":lg,"../../../content/art/scenes/L16.png":pg,"../../../content/art/scenes/L17.png":ug,"../../../content/art/scenes/L18.png":_g,"../../../content/art/scenes/L19.png":dg,"../../../content/art/scenes/L20.png":fg}),i=pe("");Ce(()=>t.levelId,c=>{const a=Object.entries(n).find(([p])=>p.endsWith("/"+c+".png"));i.value=a!==void 0?a[1]:""},{immediate:!0});const s=ce(()=>kp(t.levelId)),o=ce(()=>{const c=s.value.hue,a=8+Math.round(t.pressure*.8);return{background:`radial-gradient(120% 70% at 50% 18%, hsl(${c} 32% ${a+10}%) 0%, hsl(${c} 38% ${a}%) 45%, hsl(${c} 45% ${Math.max(4,a-4)}%) 100%)`}}),r=ce(()=>s.value.motif);return(c,a)=>(I(),H("div",{class:"backdrop",style:Ve(o.value)},[i.value?(I(),H("img",{key:0,class:"photo",src:i.value,alt:""},null,8,gg)):de("",!0),i.value?(I(),H("div",mg)):de("",!0),r.value==="subway"?(I(),H("svg",vg,[...a[0]||(a[0]=[Li('<rect x="40" y="80" width="320" height="180" rx="14" class="win" data-v-b08529d1></rect><rect x="52" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="132" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="212" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="292" y="92" width="56" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="0" y="300" width="400" height="10" class="rail" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',7)])])):r.value==="elevator"?(I(),H("svg",hg,[...a[1]||(a[1]=[x("rect",{x:"120",y:"60",width:"160",height:"440",rx:"6",class:"door"},null,-1),x("line",{x1:"200",y1:"60",x2:"200",y2:"500",class:"seam"},null,-1),x("circle",{cx:"200",cy:"530",r:"12",class:"lamp"},null,-1),x("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="street"?(I(),H("svg",xg,[...a[2]||(a[2]=[Li('<line x1="60" y1="0" x2="60" y2="380" class="pole" data-v-b08529d1></line><rect x="48" y="380" width="24" height="8" rx="3" class="lamp" data-v-b08529d1></rect><rect x="0" y="430" width="400" height="6" class="rail" data-v-b08529d1></rect><rect x="0" y="470" width="400" height="4" class="rail dim" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):r.value==="court"?(I(),H("svg",kg,[...a[3]||(a[3]=[x("rect",{x:"80",y:"120",width:"240",height:"90",rx:"4",class:"win"},null,-1),x("rect",{x:"100",y:"300",width:"200",height:"14",rx:"3",class:"desk"},null,-1),x("rect",{x:"60",y:"380",width:"280",height:"10",rx:"3",class:"desk dim"},null,-1),x("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="studio"?(I(),H("svg",yg,[...a[4]||(a[4]=[Li('<rect x="40" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><rect x="230" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><circle cx="200" cy="260" r="8" class="lamp" data-v-b08529d1></circle><line x1="200" y1="0" x2="200" y2="252" class="pole thin" data-v-b08529d1></line><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):(I(),H("svg",Ag,[...a[5]||(a[5]=[x("rect",{x:"50",y:"110",width:"140",height:"100",rx:"6",class:"win"},null,-1),x("rect",{x:"220",y:"110",width:"130",height:"70",rx:"6",class:"win dim"},null,-1),x("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])),x("div",Lg,M(s.value.label),1)],4))}}),bg=ht(Tg,[["__scopeId","data-v-b08529d1"]]),wg={class:"danmaku","aria-hidden":"true"},Pg=ut({__name:"DanmakuLayer",props:{pressure:{},active:{type:Boolean}},setup(e){const t=e,n=pe([]);let i=0,s;function o(){return t.pressure>=4?ue.danmaku.hot:t.pressure>=3?ue.danmaku.tense:ue.danmaku.calm}function r(){if(!t.active)return;const c=o();if(c.length===0)return;const a=c[Math.floor(Math.random()*c.length)]??"";n.value.push({id:i+=1,text:a,lane:Math.floor(Math.random()*4),speed:t.pressure>=4?7+Math.random()*3:10+Math.random()*4,bold:Math.random()<.25}),n.value.length>14&&(n.value=n.value.slice(-14))}return typeof setInterval=="function"&&(s=setInterval(r,t.pressure>=4?900:1800),Ce(()=>t.pressure,()=>{})),Kt(()=>{s!==void 0&&clearInterval(s)}),(c,a)=>(I(),H("div",wg,[xe(q_,{name:"fly"},{default:rs(()=>[(I(!0),H(ve,null,Ut(n.value,p=>(I(),H("span",{key:p.id,class:he(["line",{bold:p.bold}]),style:Ve({top:12+p.lane*34+"px","--dur":p.speed+"s"})},M(p.text),7))),128))]),_:1})]))}}),Og=ht(Pg,[["__scopeId","data-v-55cd0013"]]),Rg=""+new URL("he_song-DAGlX_4O.png",import.meta.url).href,Sg=""+new URL("hero-BAfbz0Vs.png",import.meta.url).href,Eg=""+new URL("npc_l01_woman-DSDWwEL8.png",import.meta.url).href,Ig=""+new URL("npc_l02_woman-qXhWvPKu.png",import.meta.url).href,Cg=""+new URL("npc_l03_daughter-Dt2TiO8f.png",import.meta.url).href,Mg=""+new URL("npc_l03_woman-BQ3wIsYH.png",import.meta.url).href,$g=""+new URL("npc_l04_woman-CZQbIvDG.png",import.meta.url).href,Ng=""+new URL("npc_l05_manager-Ce6F9DQj.png",import.meta.url).href,Fg=""+new URL("npc_l05_woman-BXLOsOGn.png",import.meta.url).href,Dg=""+new URL("npc_l06_girlfriend-CrncpSA3.png",import.meta.url).href,Bg=""+new URL("npc_l06_mother-BJuBbFLU.png",import.meta.url).href,Hg=""+new URL("npc_l07_ex-CEJAEgFV.png",import.meta.url).href,Vg=""+new URL("npc_l08_child-Bm0Rde6F.png",import.meta.url).href,Gg=""+new URL("npc_l08_mother-tu98VogT.png",import.meta.url).href,jg=""+new URL("npc_l08_wife-Cy9DZe9m.png",import.meta.url).href,Ug=""+new URL("npc_l09_wife-CJUlJISq.png",import.meta.url).href,Yg=""+new URL("npc_l10_exwife-D0NJtWQK.png",import.meta.url).href,Kg=""+new URL("npc_l11_hr-Dqx_GpDt.png",import.meta.url).href,qg=""+new URL("npc_l12_boss-nYTyR_X5.png",import.meta.url).href,Wg=""+new URL("npc_l12_colleague-BD3ntBZW.png",import.meta.url).href,zg=""+new URL("npc_l13_hr-Dovjb9V8.png",import.meta.url).href,Xg=""+new URL("npc_l14_director-B-efKLNg.png",import.meta.url).href,Jg=""+new URL("npc_l14_hr-DRiqQqX2.png",import.meta.url).href,Zg=""+new URL("npc_l15_broker-CqY8iI1Q.png",import.meta.url).href,Qg=""+new URL("npc_l15_hr-CSF8zzWx.png",import.meta.url).href,e1=""+new URL("npc_l16_account-D825uOC6.png",import.meta.url).href,t1=""+new URL("npc_l17_father-jYHQ9zlG.png",import.meta.url).href,n1=""+new URL("npc_l17_hr-D3pAIKo4.png",import.meta.url).href,i1=""+new URL("npc_l18_streamer-CYlpG6aq.png",import.meta.url).href,s1=""+new URL("npc_l19_moderator-CoZr2C0k.png",import.meta.url).href,o1=""+new URL("npc_l19_pr-Do-3PPx1.png",import.meta.url).href,r1=""+new URL("officer_lin-Bduk5y-m.png",import.meta.url).href,c1=""+new URL("shen_li-Bd_DLpmj.png",import.meta.url).href,a1=""+new URL("zhou_you-DSERK5v3.png",import.meta.url).href,l1={key:0,class:"duo","aria-hidden":"true"},p1=["src"],u1={key:1,class:"pt",viewBox:"0 0 120 160"},_1=["src","alt"],d1={key:1,class:"pt",viewBox:"0 0 120 160"},f1={class:"nm"},g1=ut({__name:"PortraitSlot",props:{speaker:{},visible:{type:Boolean}},setup(e){const t=e,n=Object.assign({"../../../content/art/characters/he_song.png":Rg,"../../../content/art/characters/hero.png":Sg,"../../../content/art/characters/npc_l01_woman.png":Eg,"../../../content/art/characters/npc_l02_woman.png":Ig,"../../../content/art/characters/npc_l03_daughter.png":Cg,"../../../content/art/characters/npc_l03_woman.png":Mg,"../../../content/art/characters/npc_l04_woman.png":$g,"../../../content/art/characters/npc_l05_manager.png":Ng,"../../../content/art/characters/npc_l05_woman.png":Fg,"../../../content/art/characters/npc_l06_girlfriend.png":Dg,"../../../content/art/characters/npc_l06_mother.png":Bg,"../../../content/art/characters/npc_l07_ex.png":Hg,"../../../content/art/characters/npc_l08_child.png":Vg,"../../../content/art/characters/npc_l08_mother.png":Gg,"../../../content/art/characters/npc_l08_wife.png":jg,"../../../content/art/characters/npc_l09_wife.png":Ug,"../../../content/art/characters/npc_l10_exwife.png":Yg,"../../../content/art/characters/npc_l11_hr.png":Kg,"../../../content/art/characters/npc_l12_boss.png":qg,"../../../content/art/characters/npc_l12_colleague.png":Wg,"../../../content/art/characters/npc_l13_hr.png":zg,"../../../content/art/characters/npc_l14_director.png":Xg,"../../../content/art/characters/npc_l14_hr.png":Jg,"../../../content/art/characters/npc_l15_broker.png":Zg,"../../../content/art/characters/npc_l15_hr.png":Qg,"../../../content/art/characters/npc_l16_account.png":e1,"../../../content/art/characters/npc_l17_father.png":t1,"../../../content/art/characters/npc_l17_hr.png":n1,"../../../content/art/characters/npc_l18_streamer.png":i1,"../../../content/art/characters/npc_l19_moderator.png":s1,"../../../content/art/characters/npc_l19_pr.png":o1,"../../../content/art/characters/officer_lin.png":r1,"../../../content/art/characters/shen_li.png":c1,"../../../content/art/characters/zhou_you.png":a1});function i(h){if(h===null)return{url:"",ok:!1};const y=Object.entries(n).find(([$])=>$.endsWith("/"+h+".png"));return y!==void 0?{url:y[1],ok:!0}:{url:"",ok:!1}}const s=i("hero"),o=ji("hero"),r=ce(()=>t.speaker===null||t.speaker==="hero"?null:t.speaker),c=ce(()=>i(r.value)),a=ce(()=>ji(r.value??"")),p=ce(()=>r.value===null?"":wf(r.value)),l=pe(!1);Ce(()=>t.speaker,()=>{l.value=!1});const d=ce(()=>t.speaker==="hero");return(h,y)=>e.visible?(I(),H("div",l1,[x("div",{class:he(["who hero",{talking:d.value}]),style:Ve({"--h":w(o)})},[w(s).ok?(I(),H("img",{key:0,class:"pt art",src:w(s).url,alt:""},null,8,p1)):(I(),H("svg",u1,[...y[1]||(y[1]=[x("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])]))],6),r.value?(I(),H("div",{key:0,class:he(["who guest",{talking:!0}]),style:Ve({"--h":a.value})},[c.value.ok&&!l.value?(I(),H("img",{key:0,class:"pt art",src:c.value.url,alt:p.value,onError:y[0]||(y[0]=$=>l.value=!0)},null,40,_1)):(I(),H("svg",d1,[...y[2]||(y[2]=[x("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])])),x("span",f1,M(p.value),1)],4)):de("",!0)])):de("",!0)}}),m1=ht(g1,[["__scopeId","data-v-77cf8af7"]]);function v1(e,t){const n=220*Math.pow(2,Math.round(e/30)%12/12);return t==="tense"?{root:n,steps:[0,2,3,5,7,8,10]}:t==="panic"?{root:n,steps:[0,1,3,6,7,9,10]}:{root:n*1.5,steps:[0,2,4,7,9,12,14]}}function co(e,t){const n=Math.floor(t/e.steps.length),i=(t%e.steps.length+e.steps.length)%e.steps.length;return e.root*Math.pow(2,(e.steps[i]??0)/12+n)}function ao(e){let t=e|0;return()=>(t=Math.imul(t,1664525)+1013904223|0,(t>>>8&16777215)/16777216)}class h1{constructor(){me(this,"ctx",null);me(this,"master",null);me(this,"bgmGain",null);me(this,"sfxGain",null);me(this,"bgmTimer",null);me(this,"mood","calm");me(this,"hue",210);me(this,"step",0);me(this,"rnd",ao(42));me(this,"muted",!1)}unlock(){if(this.ctx===null){const t=globalThis.AudioContext;if(t===void 0)return;this.ctx=new t,this.master=this.ctx.createGain(),this.master.gain.value=this.muted?0:.55,this.master.connect(this.ctx.destination),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.5,this.bgmGain.connect(this.master),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.9,this.sfxGain.connect(this.master)}this.ctx.state==="suspended"&&this.ctx.resume()}setMuted(t){this.muted=t,this.master!==null&&this.ctx!==null&&this.master.gain.setTargetAtTime(t?0:.55,this.ctx.currentTime,.05)}tone(t,n,i,s,o,r=0){if(this.ctx===null)return;const c=this.ctx.currentTime+r,a=this.ctx.createOscillator(),p=this.ctx.createGain();a.type=s,a.frequency.value=t,p.gain.setValueAtTime(0,c),p.gain.linearRampToValueAtTime(i,c+.012),p.gain.exponentialRampToValueAtTime(1e-4,c+n),a.connect(p),p.connect(o),a.start(c),a.stop(c+n+.05)}pad(t,n){if(this.bgmGain===null||this.ctx===null)return;const i=this.ctx.currentTime,s=this.ctx.createOscillator(),o=this.ctx.createGain(),r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=900,s.type="sawtooth",s.frequency.value=t/2,o.gain.setValueAtTime(0,i),o.gain.linearRampToValueAtTime(.05,i+n*.3),o.gain.linearRampToValueAtTime(1e-4,i+n),s.connect(r),r.connect(o),o.connect(this.bgmGain),s.start(i),s.stop(i+n+.1)}scene(t,n,i,s){const o=s<15||i>=4?"panic":i>=3||s<40?"tense":"calm";let r=0;for(let c=0;c<t.length;c+=1)r=r*31+t.charCodeAt(c)|0;(o!==this.mood||n!==this.hue)&&(this.mood=o,this.hue=n,this.rnd=ao(r),this.step=0)}tick(){if(this.ctx===null||this.bgmGain===null||this.muted)return;const t=v1(this.hue,this.mood),n=this.step%8,i=this.mood==="calm"?.35:this.mood==="tense"?.55:.75;if(this.rnd()<i){const s=Math.floor(this.rnd()*8),o=co(t,s);this.tone(o,this.mood==="calm"?.9:.45,.06,this.mood==="calm"?"sine":"triangle",this.bgmGain)}n===0&&this.pad(co(t,0),this.mood==="calm"?6.4:3.2),this.mood==="panic"&&(n===0||n===4)&&(this.tone(52,.14,.16,"sine",this.bgmGain),this.tone(52,.12,.12,"sine",this.bgmGain,.18)),this.step+=1}sfx(t){if(!(this.ctx===null||this.sfxGain===null||this.muted))switch(t){case"click":this.tone(880,.06,.1,"sine",this.sfxGain);break;case"options":this.tone(523,.08,.09,"sine",this.sfxGain),this.tone(784,.1,.09,"sine",this.sfxGain,.07);break;case"tick":this.tone(1245,.04,.07,"square",this.sfxGain);break;case"ending":{const n=this.sfxGain;n!==null&&[523,659,784,1047].forEach((i,s)=>this.tone(i,.5,.08,"sine",n,s*.13));break}case"bad":{const n=this.sfxGain;n!==null&&[330,294,262,196].forEach((i,s)=>this.tone(i,.35,.09,"triangle",n,s*.15));break}}}startLoop(){if(this.bgmTimer!==null)return;const t=800;typeof setInterval=="function"&&(this.bgmTimer=setInterval(()=>this.tick(),t))}stopLoop(){this.bgmTimer!==void 0&&this.bgmTimer!==null&&(clearInterval(this.bgmTimer),this.bgmTimer=null)}}const wt=new h1,x1={class:"stage"},k1={key:2,class:"topbar"},y1={class:"lv-title"},A1={key:3,class:"study-entry"},L1={class:"sub"},T1=["placeholder"],b1=["disabled"],w1={key:4,class:"study-done"},P1={class:"sum"},O1={class:"story"},R1={name:"App"},S1=ut({...R1,props:{ctx:{}},setup(e){const n=e.ctx;Ce(n.event,T=>{T!==null&&T.type==="ending"&&(n.settle(),wt.sfx(T.ending.rank==="S"||T.ending.rank==="A"?"ending":"bad"))}),Ce(n.event,T=>{var N,B,E;if(T===null)return;const R=kp(((N=n.current.value)==null?void 0:N.id)??"L01").hue;T.type==="node"?wt.scene(((B=n.current.value)==null?void 0:B.id)??"L01",R,T.node.pressure??0,n.meters.value.composure):T.type==="options"&&(wt.sfx("options"),wt.scene(((E=n.current.value)==null?void 0:E.id)??"L01",R,3,n.meters.value.composure))});const i=pe(0),s=pe(null),o=pe(null);Ce(n.event,T=>{if(T===null){i.value=0,s.value=null,o.value=null;return}T.type==="node"?(i.value=T.node.pressure??0,s.value="speaker"in T.node?String(T.node.speaker):null,s.value!==null&&(o.value=s.value)):T.type==="options"&&(i.value=T.options.length>0?i.value:0,s.value=null)});const r=ce(()=>{const T=n.meters.value.composure;return T>=50||n.screen.value!=="level"?{opacity:0}:{opacity:(.25+(50-T)/50*.55).toFixed(2),animation:T<15?"throb 1.1s ease-in-out infinite":"none"}}),c=ce(()=>n.screen.value==="level"),a=pe(""),p=ce(()=>n.STUDY_LEVELS.every(T=>{try{return n.studySummary().includes(T)}catch{return!1}}));function l(){const T=n.studyExport();typeof navigator<"u"&&navigator.clipboard!==void 0&&navigator.clipboard.writeText(T);const R=new Blob([T],{type:"application/json"}),N=document.createElement("a");N.href=URL.createObjectURL(R),N.download=`study-${a.value||"anon"}.json`,N.click()}const d=pe(!1),h=ce(()=>d.value?"x":"m");function y(){d.value=!d.value,wt.setMuted(d.value)}function $(){wt.unlock(),wt.startLoop()}document.addEventListener("pointerdown",$,{once:!0});const P=ce(()=>n.current.value?n.current.value.id:"L01");return(T,R)=>{var N;return I(),H("div",x1,[c.value?(I(),it(bg,{key:0,"level-id":P.value,pressure:i.value},null,8,["level-id","pressure"])):de("",!0),c.value&&((N=w(n).event.value)==null?void 0:N.type)!=="ending"?(I(),it(Og,{key:1,pressure:i.value,active:c.value},null,8,["pressure","active"])):de("",!0),c.value?(I(),H("header",k1,[x("button",{class:"back",onClick:R[0]||(R[0]=B=>w(n).toSelect())},"‹"),x("span",y1,M(w(n).banner.value),1),x("button",{class:he(["mute",{off:d.value}]),onClick:R[1]||(R[1]=B=>y())},M(h.value),3)])):de("",!0),w(n).studyOn&&w(n).studyScreen.value==="entry"?(I(),H("div",A1,[x("h1",null,M(w(ue).appTitle),1),x("p",L1,M(w(Qt)("studyIntro")),1),hu(x("input",{"onUpdate:modelValue":R[2]||(R[2]=B=>a.value=B),class:"pid",placeholder:w(Qt)("studyPidPlaceholder"),maxlength:"8"},null,8,T1),[[Q_,a.value]]),x("button",{class:"go",disabled:a.value.trim().length===0,onClick:R[3]||(R[3]=B=>w(n).studyBegin(a.value.trim()))},M(w(Qt)("studyStart")),9,b1)])):w(n).studyOn&&w(n).studyScreen.value==="done"&&p.value?(I(),H("div",w1,[x("h2",null,M(w(Qt)("studyDoneTitle")),1),x("pre",P1,M(w(n).studySummary()),1),x("button",{class:"go",onClick:l},M(w(Qt)("studyCopy")),1)])):w(n).screen.value==="select"?(I(),it(W0,{key:5,levels:w(n).studyOn?w(hn).filter(B=>w(n).STUDY_LEVELS.includes(B.id)):w(hn),best:w(n).best.value,onPick:w(n).startLevel},null,8,["levels","best","onPick"])):w(n).event.value?(I(),H(ve,{key:6},[w(n).event.value.type!=="ending"?(I(),it(Cf,{key:0,state:w(n).meters.value},null,8,["state"])):de("",!0),xe(m1,{speaker:s.value??o.value,visible:w(n).event.value.type!=="ending"&&(s.value??o.value)!==null},null,8,["speaker","visible"]),x("div",O1,[w(n).event.value.type==="node"&&"script"in w(n).event.value.node?(I(),it(ro,{key:0,kind:"cutscene",text:String(w(n).event.value.node.script??""),onAdvance:R[4]||(R[4]=B=>w(n).advance())},null,8,["text"])):w(n).event.value.type==="node"&&"speaker"in w(n).event.value.node?(I(),it(ro,{key:1,kind:"dialogue",speaker:String(w(n).event.value.node.speaker??""),text:String(w(n).event.value.node.text??""),onAdvance:R[5]||(R[5]=B=>w(n).advance())},null,8,["speaker","text"])):w(n).event.value.type==="options"?(I(),it(qf,{key:2,options:w(n).event.value.options,timer:w(n).event.value.timer,"timeout-option-id":w(n).event.value.timeoutOptionId,prompt:w(n).event.value.prompt??"",onChoose:w(n).choose},null,8,["options","timer","timeout-option-id","prompt","onChoose"])):w(n).event.value.type==="ending"?(I(),it(R0,{key:3,"level-id":P.value,ending:w(n).event.value.ending,state:w(n).event.value.state,onRestart:w(n).restart,onNext:w(n).nextLevel},null,8,["level-id","ending","state","onRestart","onNext"])):de("",!0)])],64)):de("",!0),c.value?(I(),H("div",{key:7,class:"vignette",style:Ve(r.value)},null,4)):de("",!0)])}}}),yp="poju-study-v1",E1=()=>typeof location<"u"&&new URLSearchParams(location.search).get("study")==="1";function xt(){if(typeof localStorage>"u")return{sessionId:"",participant:"",startedAt:0,runs:[]};const e=localStorage.getItem(yp);return e===null?{sessionId:"",participant:"",startedAt:0,runs:[]}:JSON.parse(e)}function ui(e){typeof localStorage<"u"&&localStorage.setItem(yp,JSON.stringify(e))}function I1(e){const t={sessionId:`S-${performance.now().toString(36)}`,participant:e,startedAt:performance.now(),runs:[]};return _i=t,ui(t),t}function C1(e,t,n){const i={level:t,startedAt:performance.now(),endedAt:0,totalMs:0,choices:[],endingRank:"",endingTitle:"",finalMeters:{evidence:0,opinion:0,composure:0,risk:0},replayed:n},s=_i??xt();return s.runs.push(i),ui(s),i}let Ui=0,Ap="",_i=null;function Xn(e){Ui=performance.now(),Ap=e}function M1(e,t,n,i,s){e.choices.push({level:n,nodeId:Ap,optionId:i,ms:Ui>0?performance.now()-Ui:0,meters:{...s}});const o=_i??xt();ui(o)}function $1(e,t,n,i,s){e.endedAt=performance.now(),e.totalMs=e.endedAt-e.startedAt,e.endingRank=n,e.endingTitle=i,e.finalMeters={...s},ui(_i??xt())}function N1(){return JSON.stringify(xt(),null,2)}function F1(){const e=xt(),n=[ue.ui.studySummaryHeader.replace("{p}",e.participant).replace("{n}",String(e.runs.length))],i=new Map;for(const s of e.runs){const o=i.get(s.level)??[];o.push(s),i.set(s.level,o)}for(const[s,o]of[...i.entries()].sort()){const r=o[0],c=Math.round(r.totalMs/1e3),a=ue.ui.studySummaryLine;n.push(a.replace("{lv}",s).replace("{rank}",r.endingRank).replace("{title}",r.endingTitle).replace("{s}",String(c)).replace("{c}",String(r.choices.length)).replace("{r}",o.length>1?"Y":"N"))}return n.join(`
`)}const xn=pe("select"),vt=ni(null),Ee=ni(null),kn=pe(Ad()),Lp=pe(""),di=ni(null),ds=pe({evidence:0,opinion:0,composure:0,risk:0}),Ct=E1(),Yi=["L01","L02","L03","L04","L05"],Tp=pe("entry"),yn=ni(null),D1=pe(0);function B1(e){kn.value=Gi(),I1(e),Tp.value="done",An("L01")}function An(e){const t=hn.find(i=>i.id===e)??null;if(t===null)return;vt.value=t,Lp.value=t.title;const n=new _s(t,kn.value);if(di.value=n,Ee.value=n.start(),ds.value={...n.state},xn.value="level",Ct){const i=xt(),s=i.runs.some(o=>o.level===e&&o.endingRank!=="");yn.value=C1(i,e,s),Xn("entry")}}function H1(){const e=di.value;e!==null&&(Ee.value=e.proceed(),Ct&&Ee.value.type==="node"&&Xn(String(Ee.value.node.id)),Ct&&Ee.value.type==="options"&&Ee.value.nodeId!==void 0&&Xn(Ee.value.nodeId))}function V1(e){const t=di.value;t!==null&&(Ee.value=t.choose(e),ds.value={...t.state},Ct&&yn.value!==null&&vt.value!==null&&(M1(yn.value,xt(),vt.value.id,e,t.state),Ee.value.type==="options"&&Ee.value.nodeId!==void 0&&Xn(Ee.value.nodeId)))}function G1(){const e=di.value,t=vt.value,n=Ee.value;if(e===null||t===null||n===null||n.type!=="ending")return;if(Ct){yn.value!==null&&$1(yn.value,xt(),n.ending.rank,n.ending.title,e.state),D1.value+=1;return}const i=Pd(kn.value,t.id,n.ending,n.state,{now:0});kn.value=i,Ld(i)}function j1(){vt.value!==null&&An(vt.value.id)}function U1(){const e=vt.value;if(e===null)return;if(Ct){const i=Yi.indexOf(e.id),s=i>=0?Yi[i+1]:void 0;if(s===void 0){xn.value="select";return}An(s);return}const t=hn.findIndex(i=>i.id===e.id),n=hn[t+1];if(n===void 0){xn.value="select";return}An(n.id)}function Y1(){xn.value="select"}const K1=ce(()=>{const e={};for(const[t,n]of Object.entries(kn.value.levelResults))e[t]=n.rank;return e}),q1={screen:xn,current:vt,event:Ee,banner:Lp,best:K1,meters:ds,startLevel:An,advance:H1,choose:V1,settle:G1,restart:j1,nextLevel:U1,toSelect:Y1,studyOn:Ct,STUDY_LEVELS:Yi,studyScreen:Tp,studyBegin:B1,studyExport:()=>N1(),studySummary:()=>F1()},W1=sd(S1,{ctx:q1});W1.mount("#app");
