var Ep=Object.defineProperty;var Cp=(e,t,n)=>t in e?Ep(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var xe=(e,t,n)=>Cp(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const r of o.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(s){if(s.ep)return;s.ep=!0;const o=n(s);fetch(s.href,o)}})();/**
* @vue/shared v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Qi(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const oe={},Kt=[],tt=()=>{},mo=()=>!1,ei=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),ti=e=>e.startsWith("onUpdate:"),he=Object.assign,es=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},Ip=Object.prototype.hasOwnProperty,J=(e,t)=>Ip.call(e,t),H=Array.isArray,qt=e=>Pn(e)==="[object Map]",vo=e=>Pn(e)==="[object Set]",As=e=>Pn(e)==="[object Date]",j=e=>typeof e=="function",pe=e=>typeof e=="string",nt=e=>typeof e=="symbol",Z=e=>e!==null&&typeof e=="object",ho=e=>(Z(e)||j(e))&&j(e.then)&&j(e.catch),xo=Object.prototype.toString,Pn=e=>xo.call(e),$p=e=>Pn(e).slice(8,-1),ko=e=>Pn(e)==="[object Object]",ts=e=>pe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,cn=Qi(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ni=e=>{const t=Object.create(null);return n=>t[n]||(t[n]=e(n))},Mp=/-\w/g,Ue=ni(e=>e.replace(Mp,t=>t.slice(1).toUpperCase())),Np=/\B([A-Z])/g,Ft=ni(e=>e.replace(Np,"-$1").toLowerCase()),yo=ni(e=>e.charAt(0).toUpperCase()+e.slice(1)),ki=ni(e=>e?`on${yo(e)}`:""),et=(e,t)=>!Object.is(e,t),Nn=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},To=(e,t,n,i=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:i,value:n})},ns=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Dp=e=>{const t=pe(e)?Number(e):NaN;return isNaN(t)?e:t};let Ls;const ii=()=>Ls||(Ls=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function He(e){if(H(e)){const t={};for(let n=0;n<e.length;n++){const i=e[n],s=pe(i)?Gp(i):He(i);if(s)for(const o in s)t[o]=s[o]}return t}else if(pe(e)||Z(e))return e}const Fp=/;(?![^(]*\))/g,Bp=/:([^]+)/,Hp=/\/\*[^]*?\*\//g;function Gp(e){const t={};return e.replace(Hp,"").split(Fp).forEach(n=>{if(n){const i=n.split(Bp);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function le(e){let t="";if(pe(e))t=e;else if(H(e))for(let n=0;n<e.length;n++){const i=le(e[n]);i&&(t+=i+" ")}else if(Z(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const jp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Up=Qi(jp);function bo(e){return!!e||e===""}function Vp(e,t){if(e.length!==t.length)return!1;let n=!0;for(let i=0;n&&i<e.length;i++)n=is(e[i],t[i]);return n}function is(e,t){if(e===t)return!0;let n=As(e),i=As(t);if(n||i)return n&&i?e.getTime()===t.getTime():!1;if(n=nt(e),i=nt(t),n||i)return e===t;if(n=H(e),i=H(t),n||i)return n&&i?Vp(e,t):!1;if(n=Z(e),i=Z(t),n||i){if(!n||!i)return!1;const s=Object.keys(e).length,o=Object.keys(t).length;if(s!==o)return!1;for(const r in e){const c=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(c&&!a||!c&&a||!is(e[r],t[r]))return!1}}return String(e)===String(t)}const Ao=e=>!!(e&&e.__v_isRef===!0),O=e=>pe(e)?e:e==null?"":H(e)||Z(e)&&(e.toString===xo||!j(e.toString))?Ao(e)?O(e.value):JSON.stringify(e,Lo,2):String(e),Lo=(e,t)=>Ao(t)?Lo(e,t.value):qt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[i,s],o)=>(n[yi(i,o)+" =>"]=s,n),{})}:vo(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>yi(n))}:nt(t)?yi(t):Z(t)&&!H(t)&&!ko(t)?String(t):t,yi=(e,t="")=>{var n;return nt(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Te;class Yp{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&Te&&(Te.active?(this.parent=Te,this.index=(Te.scopes||(Te.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes){const i=this.scopes.slice();for(t=0,n=i.length;t<n;t++)i[t].pause()}for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes){const s=this.scopes.slice();for(t=0,n=s.length;t<n;t++)s[t].resume()}const i=this.effects.slice();for(t=0,n=i.length;t<n;t++)i[t].resume()}}run(t){if(this._active){const n=Te;try{return Te=this,t()}finally{Te=n}}}on(){++this._on===1&&(this.prevScope=Te,Te=this)}off(){if(this._on>0&&--this._on===0){if(Te===this)Te=this.prevScope;else{let t=Te;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(this.effects.length=0,n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){const s=this.scopes.slice();for(n=0,i=s.length;n<i;n++)s[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function Kp(){return Te}let ce;const Ti=new WeakSet;class wo{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Te&&(Te.active?Te.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,Ti.has(this)&&(Ti.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Oo(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,ws(this),Ro(this);const t=ce,n=Ve;ce=this,Ve=!0;try{return this.fn()}finally{So(this),ce=t,Ve=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)rs(t);this.deps=this.depsTail=void 0,ws(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?Ti.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Di(this)&&this.run()}get dirty(){return Di(this)}}let Po=0,an,ln;function Oo(e,t=!1){if(e.flags|=8,t){e.next=ln,ln=e;return}e.next=an,an=e}function ss(){Po++}function os(){if(--Po>0)return;if(ln){let t=ln;for(ln=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;an;){let t=an;for(an=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(i){e||(e=i)}t=n}}if(e)throw e}function Ro(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function So(e){let t,n=e.depsTail,i=n;for(;i;){const s=i.prevDep;i.version===-1?(i===n&&(n=s),rs(i),qp(i)):t=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=t,e.depsTail=n}function Di(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Eo(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Eo(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===fn)||(e.globalVersion=fn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Di(e))))return;e.flags|=2;const t=e.dep,n=ce,i=Ve;ce=e,Ve=!0;try{Ro(e);const s=e.fn(e._value);(t.version===0||et(s,e._value))&&(e.flags|=128,e._value=s,t.version++)}catch(s){throw t.version++,s}finally{ce=n,Ve=i,So(e),e.flags&=-3}}function rs(e,t=!1){const{dep:n,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),n.subs===e&&(n.subs=i,!i&&n.computed)){n.computed.flags&=-5;for(let o=n.computed.deps;o;o=o.nextDep)rs(o,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function qp(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let Ve=!0;const Co=[];function dt(){Co.push(Ve),Ve=!1}function _t(){const e=Co.pop();Ve=e===void 0?!0:e}function ws(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=ce;ce=void 0;try{t()}finally{ce=n}}}let fn=0;class Wp{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class cs{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ce||!Ve||ce===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==ce)n=this.activeLink=new Wp(ce,this),ce.deps?(n.prevDep=ce.depsTail,ce.depsTail.nextDep=n,ce.depsTail=n):ce.deps=ce.depsTail=n,Io(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const i=n.nextDep;i.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=i),n.prevDep=ce.depsTail,n.nextDep=void 0,ce.depsTail.nextDep=n,ce.depsTail=n,ce.deps===n&&(ce.deps=i)}return n}trigger(t){this.version++,fn++,this.notify(t)}notify(t){ss();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{os()}}}function Io(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let i=t.deps;i;i=i.nextDep)Io(i)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const Fi=new WeakMap,Ct=Symbol(""),Bi=Symbol(""),gn=Symbol("");function be(e,t,n){if(Ve&&ce){let i=Fi.get(e);i||Fi.set(e,i=new Map);let s=i.get(n);s||(i.set(n,s=new cs),s.map=i,s.key=n),s.track()}}function pt(e,t,n,i,s,o){const r=Fi.get(e);if(!r){fn++;return}const c=a=>{a&&a.trigger()};if(ss(),t==="clear")r.forEach(c);else{const a=H(e),p=a&&ts(n);if(a&&n==="length"){const l=Number(i);r.forEach((_,T)=>{(T==="length"||T===gn||!nt(T)&&T>=l)&&c(_)})}else switch((n!==void 0||r.has(void 0))&&c(r.get(n)),p&&c(r.get(gn)),t){case"add":a?p&&c(r.get("length")):(c(r.get(Ct)),qt(e)&&c(r.get(Bi)));break;case"delete":a||(c(r.get(Ct)),qt(e)&&c(r.get(Bi)));break;case"set":qt(e)&&c(r.get(Ct));break}}os()}function jt(e){const t=z(e);return t===e?t:(be(t,"iterate",gn),Fe(e)?t:t.map(Ye))}function si(e){return be(e=z(e),"iterate",gn),e}function Ze(e,t){return ft(e)?Xt(It(e)?Ye(t):t):Ye(t)}const zp={__proto__:null,[Symbol.iterator](){return bi(this,Symbol.iterator,e=>Ze(this,e))},concat(...e){return jt(this).concat(...e.map(t=>H(t)?jt(t):t))},entries(){return bi(this,"entries",e=>(e[1]=Ze(this,e[1]),e))},every(e,t){return rt(this,"every",e,t,void 0,arguments)},filter(e,t){return rt(this,"filter",e,t,n=>n.map(i=>Ze(this,i)),arguments)},find(e,t){return rt(this,"find",e,t,n=>Ze(this,n),arguments)},findIndex(e,t){return rt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return rt(this,"findLast",e,t,n=>Ze(this,n),arguments)},findLastIndex(e,t){return rt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return rt(this,"forEach",e,t,void 0,arguments)},includes(...e){return Ai(this,"includes",e)},indexOf(...e){return Ai(this,"indexOf",e)},join(e){return jt(this).join(e)},lastIndexOf(...e){return Ai(this,"lastIndexOf",e)},map(e,t){return rt(this,"map",e,t,void 0,arguments)},pop(){return en(this,"pop")},push(...e){return en(this,"push",e)},reduce(e,...t){return Ps(this,"reduce",e,t)},reduceRight(e,...t){return Ps(this,"reduceRight",e,t)},shift(){return en(this,"shift")},some(e,t){return rt(this,"some",e,t,void 0,arguments)},splice(...e){return en(this,"splice",e)},toReversed(){return jt(this).toReversed()},toSorted(e){return jt(this).toSorted(e)},toSpliced(...e){return jt(this).toSpliced(...e)},unshift(...e){return en(this,"unshift",e)},values(){return bi(this,"values",e=>Ze(this,e))}};function bi(e,t,n){const i=si(e),s=i[t]();return i!==e&&!Fe(e)&&(s._next=s.next,s.next=()=>{const o=s._next();return o.done||(o.value=n(o.value)),o}),s}const Xp=Array.prototype;function rt(e,t,n,i,s,o){const r=si(e),c=r!==e&&!Fe(e),a=r[t];if(a!==Xp[t]){const _=a.apply(e,o);return c?Ye(_):_}let p=n;r!==e&&(c?p=function(_,T){return n.call(this,Ze(e,_),T,e)}:n.length>2&&(p=function(_,T){return n.call(this,_,T,e)}));const l=a.call(r,p,i);return c&&s?s(l):l}function Ps(e,t,n,i){const s=si(e),o=s!==e&&!Fe(e);let r=n,c=!1;s!==e&&(o?(c=i.length===0,r=function(p,l,_){return c&&(c=!1,p=Ze(e,p)),n.call(this,p,Ze(e,l),_,e)}):n.length>3&&(r=function(p,l,_){return n.call(this,p,l,_,e)}));const a=s[t](r,...i);return c?Ze(e,a):a}function Ai(e,t,n){const i=z(e);be(i,"iterate",gn);const s=i[t](...n);return(s===-1||s===!1)&&us(n[0])?(n[0]=z(n[0]),i[t](...n)):s}function en(e,t,n=[]){dt(),ss();const i=z(e)[t].apply(e,n);return os(),_t(),i}const Jp=Qi("__proto__,__v_isRef,__isVue"),$o=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(nt));function Zp(e){nt(e)||(e=String(e));const t=z(this);return be(t,"has",e),t.hasOwnProperty(e)}class Mo{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,i){if(n==="__v_skip")return t.__v_skip;const s=this._isReadonly,o=this._isShallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return o;if(n==="__v_raw")return i===(s?o?au:Bo:o?Fo:Do).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(i)?t:void 0;const r=H(t);if(!s){let a;if(r&&(a=zp[n]))return a;if(n==="hasOwnProperty")return Zp}const c=Reflect.get(t,n,Ae(t)?t:i);if((nt(n)?$o.has(n):Jp(n))||(s||be(t,"get",n),o))return c;if(Ae(c)){const a=r&&ts(n)?c:c.value;return s&&Z(a)?Gi(a):a}return Z(c)?s?Gi(c):ls(c):c}}class No extends Mo{constructor(t=!1){super(!1,t)}set(t,n,i,s){let o=t[n];const r=H(t)&&ts(n);if(!this._isShallow){const p=ft(o);if(!Fe(i)&&!ft(i)&&(o=z(o),i=z(i)),!r&&Ae(o)&&!Ae(i))return p||(o.value=i),!0}const c=r?Number(n)<t.length:J(t,n),a=Reflect.set(t,n,i,Ae(t)?t:s);return t===z(s)&&a&&(c?et(i,o)&&pt(t,"set",n,i):pt(t,"add",n,i)),a}deleteProperty(t,n){const i=J(t,n);t[n];const s=Reflect.deleteProperty(t,n);return s&&i&&pt(t,"delete",n,void 0),s}has(t,n){const i=Reflect.has(t,n);return(!nt(n)||!$o.has(n))&&be(t,"has",n),i}ownKeys(t){return be(t,"iterate",H(t)?"length":Ct),Reflect.ownKeys(t)}}class Qp extends Mo{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const eu=new No,tu=new Qp,nu=new No(!0);const Hi=e=>e,En=e=>Reflect.getPrototypeOf(e);function iu(e,t,n){return function(...i){const s=this.__v_raw,o=z(s),r=qt(o),c=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,p=s[e](...i),l=n?Hi:t?Xt:Ye;return!t&&be(o,"iterate",a?Bi:Ct),he(Object.create(p),{next(){const{value:_,done:T}=p.next();return T?{value:_,done:T}:{value:c?[l(_[0]),l(_[1])]:l(_),done:T}}})}}function Cn(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function su(e,t){const n={get(s){const o=this.__v_raw,r=z(o),c=z(s);e||(et(s,c)&&be(r,"get",s),be(r,"get",c));const{has:a}=En(r),p=t?Hi:e?Xt:Ye;if(a.call(r,s))return p(o.get(s));if(a.call(r,c))return p(o.get(c));o!==r&&o.get(s)},get size(){const s=this.__v_raw;return!e&&be(z(s),"iterate",Ct),s.size},has(s){const o=this.__v_raw,r=z(o),c=z(s);return e||(et(s,c)&&be(r,"has",s),be(r,"has",c)),s===c?o.has(s):o.has(s)||o.has(c)},forEach(s,o){const r=this,c=r.__v_raw,a=z(c),p=t?Hi:e?Xt:Ye;return!e&&be(a,"iterate",Ct),c.forEach((l,_)=>s.call(o,p(l),p(_),r))}};return he(n,e?{add:Cn("add"),set:Cn("set"),delete:Cn("delete"),clear:Cn("clear")}:{add(s){const o=z(this),r=En(o),c=z(s),a=!t&&!Fe(s)&&!ft(s)?c:s;return r.has.call(o,a)||et(s,a)&&r.has.call(o,s)||et(c,a)&&r.has.call(o,c)||(o.add(a),pt(o,"add",a,a)),this},set(s,o){!t&&!Fe(o)&&!ft(o)&&(o=z(o));const r=z(this),{has:c,get:a}=En(r);let p=c.call(r,s);p||(s=z(s),p=c.call(r,s));const l=a.call(r,s);return r.set(s,o),p?et(o,l)&&pt(r,"set",s,o):pt(r,"add",s,o),this},delete(s){const o=z(this),{has:r,get:c}=En(o);let a=r.call(o,s);a||(s=z(s),a=r.call(o,s)),c&&c.call(o,s);const p=o.delete(s);return a&&pt(o,"delete",s,void 0),p},clear(){const s=z(this),o=s.size!==0,r=s.clear();return o&&pt(s,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(s=>{n[s]=iu(s,e,t)}),n}function as(e,t){const n=su(e,t);return(i,s,o)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(J(n,s)&&s in i?n:i,s,o)}const ou={get:as(!1,!1)},ru={get:as(!1,!0)},cu={get:as(!0,!1)};const Do=new WeakMap,Fo=new WeakMap,Bo=new WeakMap,au=new WeakMap;function lu(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function ls(e){return ft(e)?e:ps(e,!1,eu,ou,Do)}function pu(e){return ps(e,!1,nu,ru,Fo)}function Gi(e){return ps(e,!0,tu,cu,Bo)}function ps(e,t,n,i,s){if(!Z(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const o=s.get(e);if(o)return o;const r=lu($p(e));if(r===0)return e;const c=new Proxy(e,r===2?i:n);return s.set(e,c),c}function It(e){return ft(e)?It(e.__v_raw):!!(e&&e.__v_isReactive)}function ft(e){return!!(e&&e.__v_isReadonly)}function Fe(e){return!!(e&&e.__v_isShallow)}function us(e){return e?!!e.__v_raw:!1}function z(e){const t=e&&e.__v_raw;return t?z(t):e}function uu(e){return!J(e,"__v_skip")&&Object.isExtensible(e)&&To(e,"__v_skip",!0),e}const Ye=e=>Z(e)?ls(e):e,Xt=e=>Z(e)?Gi(e):e;function Ae(e){return e?e.__v_isRef===!0:!1}function ae(e){return Ho(e,!1)}function oi(e){return Ho(e,!0)}function Ho(e,t){return Ae(e)?e:new du(e,t)}class du{constructor(t,n){this.dep=new cs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:z(t),this._value=n?t:Ye(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,i=this.__v_isShallow||Fe(t)||ft(t);t=i?t:z(t),et(t,n)&&(this._rawValue=t,this._value=i?t:Ye(t),this.dep.trigger())}}function w(e){return Ae(e)?e.value:e}const _u={get:(e,t,n)=>t==="__v_raw"?e:w(Reflect.get(e,t,n)),set:(e,t,n,i)=>{const s=e[t];return Ae(s)&&!Ae(n)?(s.value=n,!0):Reflect.set(e,t,n,i)}};function Go(e){return It(e)?e:new Proxy(e,_u)}class fu{constructor(t,n,i){this.fn=t,this.setter=n,this._value=void 0,this.dep=new cs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=fn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&ce!==this)return Oo(this,!0),!0}get value(){const t=this.dep.track();return Eo(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function gu(e,t,n=!1){let i,s;return j(e)?i=e:(i=e.get,s=e.set),new fu(i,s,n)}const In={},Gn=new WeakMap;let St;function mu(e,t=!1,n=St){if(n){let i=Gn.get(n);i||Gn.set(n,i=[]),i.push(e)}}function vu(e,t,n=oe){const{immediate:i,deep:s,once:o,scheduler:r,augmentJob:c,call:a}=n,p=$=>s?$:Fe($)||s===!1||s===0?ut($,1):ut($);let l,_,T,L,M=!1,b=!1;if(Ae(e)?(_=()=>e.value,M=Fe(e)):It(e)?(_=()=>p(e),M=!0):H(e)?(b=!0,M=e.some($=>It($)||Fe($)),_=()=>e.map($=>{if(Ae($))return $.value;if(It($))return p($);if(j($))return a?a($,2):$()})):j(e)?t?_=a?()=>a(e,2):e:_=()=>{if(T){dt();try{T()}finally{_t()}}const $=St;St=l;try{return a?a(e,3,[L]):e(L)}finally{St=$}}:_=tt,t&&s){const $=_,Y=s===!0?1/0:s;_=()=>ut($(),Y)}const I=Kp(),N=()=>{l.stop(),I&&I.active&&es(I.effects,l)};if(o&&t){const $=t;t=(...Y)=>{const ie=$(...Y);return N(),ie}}let F=b?new Array(e.length).fill(In):In;const U=$=>{if(!(!(l.flags&1)||!l.dirty&&!$))if(t){const Y=l.run();if($||s||M||(b?Y.some((ie,ue)=>et(ie,F[ue])):et(Y,F))){T&&T();const ie=St;St=l;try{const ue=[Y,F===In?void 0:b&&F[0]===In?[]:F,L];F=Y,a?a(t,3,ue):t(...ue)}finally{St=ie}}}else l.run()};return c&&c(U),l=new wo(_),l.scheduler=r?()=>r(U,!1):U,L=$=>mu($,!1,l),T=l.onStop=()=>{const $=Gn.get(l);if($){if(a)a($,4);else for(const Y of $)Y();Gn.delete(l)}},t?i?U(!0):F=l.run():r?r(U.bind(null,!0),!0):l.run(),N.pause=l.pause.bind(l),N.resume=l.resume.bind(l),N.stop=N,N}function ut(e,t=1/0,n){if(t<=0||!Z(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,Ae(e))ut(e.value,t,n);else if(H(e))for(let i=0;i<e.length;i++)ut(e[i],t,n);else if(vo(e)||qt(e))e.forEach(i=>{ut(i,t,n)});else if(ko(e)){for(const i in e)ut(e[i],t,n);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&ut(e[i],t,n)}return e}/**
* @vue/runtime-core v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function On(e,t,n,i){try{return i?e(...i):e()}catch(s){ri(s,t,n)}}function Ge(e,t,n,i){if(j(e)){const s=On(e,t,n,i);return s&&ho(s)&&s.catch(o=>{ri(o,t,n)}),s}if(H(e)){const s=[];for(let o=0;o<e.length;o++)s.push(Ge(e[o],t,n,i));return s}}function ri(e,t,n,i=!0){const s=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||oe;if(t){let c=t.parent;const a=t.proxy,p=`https://vuejs.org/error-reference/#runtime-${n}`;for(;c;){const l=c.ec;if(l){for(let _=0;_<l.length;_++)if(l[_](e,a,p)===!1)return}c=c.parent}if(o){dt(),On(o,null,10,[e,a,p]),_t();return}}hu(e,n,s,i,r)}function hu(e,t,n,i=!0,s=!1){if(s)throw e;console.error(e)}const we=[];let Je=-1;const Wt=[];let xt=null,Ut=0;const jo=Promise.resolve();let jn=null;function xu(e){const t=jn||jo;return e?t.then(this?e.bind(this):e):t}function ku(e){let t=Je+1,n=we.length;for(;t<n;){const i=t+n>>>1,s=we[i],o=mn(s);o<e||o===e&&s.flags&2?t=i+1:n=i}return t}function ds(e){if(!(e.flags&1)){const t=mn(e),n=we[we.length-1];!n||!(e.flags&2)&&t>=mn(n)?we.push(e):we.splice(ku(t),0,e),e.flags|=1,Uo()}}function Uo(){jn||(jn=jo.then(Yo))}function yu(e){if(!H(e))xt&&e.id===-1?xt.splice(Ut+1,0,e):e.flags&1||(Wt.push(e),e.flags|=1);else for(let t=0;t<e.length;t++)Wt.push(e[t]);Uo()}function Os(e,t,n=Je+1){for(;n<we.length;n++){const i=we[n];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;we.splice(n,1),n--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Vo(e){if(Wt.length){const t=[...new Set(Wt)].sort((n,i)=>mn(n)-mn(i));if(Wt.length=0,xt){for(let n=0;n<t.length;n++)xt.push(t[n]);return}for(xt=t,Ut=0;Ut<xt.length;Ut++){const n=xt[Ut];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}xt=null,Ut=0}}const mn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Yo(e){try{for(Je=0;Je<we.length;Je++){const t=we[Je];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),On(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Je<we.length;Je++){const t=we[Je];t&&(t.flags&=-2)}Je=-1,we.length=0,Vo(),jn=null,(we.length||Wt.length)&&Yo()}}let De=null,Ko=null;function Un(e){const t=De;return De=e,Ko=e&&e.type.__scopeId||null,t}function _s(e,t=De,n){if(!t||e._n)return e;const i=(...s)=>{i._d&&qn(-1);const o=Un(t),r=$t.length;let c;try{c=e(...s)}finally{for(let a=$t.length;a>r;a--)yr();Un(o),i._d&&qn(1)}return c};return i._n=!0,i._c=!0,i._d=!0,i}function Tu(e,t){if(De===null)return e;const n=_i(De),i=e.dirs||(e.dirs=[]);for(let s=0;s<t.length;s++){let[o,r,c,a=oe]=t[s];o&&(j(o)&&(o={mounted:o,updated:o}),o.deep&&ut(r),i.push({dir:o,instance:n,value:r,oldValue:void 0,arg:c,modifiers:a}))}return e}function wt(e,t,n,i){const s=e.dirs,o=t&&t.dirs;for(let r=0;r<s.length;r++){const c=s[r];o&&(c.oldValue=o[r].value);let a=c.dir[i];a&&(dt(),Ge(a,n,8,[e.el,c,e,t]),_t())}}function bu(e,t){if(Oe){let n=Oe.provides;const i=Oe.parent&&Oe.parent.provides;i===n&&(n=Oe.provides=Object.create(i)),n[e]=t}}function Dn(e,t,n=!1){const i=vs();if(i||zt){let s=zt?zt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return n&&j(t)?t.call(i&&i.proxy):t}}const Au=Symbol.for("v-scx"),Lu=()=>Dn(Au);function Be(e,t,n){return qo(e,t,n)}function qo(e,t,n=oe){const{immediate:i,deep:s,flush:o,once:r}=n,c=he({},n),a=t&&i||!t&&o!=="post";let p;if(kn){if(o==="sync"){const L=Lu();p=L.__watcherHandles||(L.__watcherHandles=[])}else if(!a){const L=()=>{};return L.stop=tt,L.resume=tt,L.pause=tt,L}}const l=Oe;c.call=(L,M,b)=>Ge(L,l,M,b);let _=!1;o==="post"?c.scheduler=L=>{Se(L,l&&l.suspense)}:o!=="sync"&&(_=!0,c.scheduler=(L,M)=>{M?L():ds(L)}),c.augmentJob=L=>{t&&(L.flags|=4),_&&(L.flags|=2,l&&(L.id=l.uid,L.i=l))};const T=vu(e,t,c);return kn&&(p?p.push(T):a&&T()),T}function wu(e,t,n){const i=this.proxy,s=pe(e)?e.includes(".")?Wo(i,e):()=>i[e]:e.bind(i,i);let o;j(t)?o=t:(o=t.handler,n=t);const r=Rn(this),c=qo(s,o.bind(i),n);return r(),c}function Wo(e,t){const n=t.split(".");return()=>{let i=e;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}const Pu=Symbol("_vte"),ci=e=>e.__isTeleport,Ne=Symbol("_leaveCb"),tn=Symbol("_enterCb");function zo(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return pi(()=>{e.isMounted=!0}),ir(()=>{e.isUnmounting=!0}),e}const Me=[Function,Array],Xo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Me,onEnter:Me,onAfterEnter:Me,onEnterCancelled:Me,onBeforeLeave:Me,onLeave:Me,onAfterLeave:Me,onLeaveCancelled:Me,onBeforeAppear:Me,onAppear:Me,onAfterAppear:Me,onAppearCancelled:Me},Jo=e=>{const t=e.subTree;return t.component?Jo(t.component):t},Ou={name:"BaseTransition",props:Xo,setup(e,{slots:t}){const n=vs(),i=zo();return()=>{const s=t.default&&fs(t.default(),!0),o=s&&s.length?Zo(s):n.subTree?Q():void 0;if(!o)return;const r=z(e),{mode:c}=r;if(i.isLeaving)return Li(o);const a=Vn(o);if(!a)return Li(o);let p=vn(a,r,i,n,_=>p=_);a.type!==Pe&&Mt(a,p);let l=n.subTree&&Vn(n.subTree);if(l&&l.type!==Pe&&!Et(l,a)&&Jo(n).type!==Pe){let _=vn(l,r,i,n);if(Mt(l,_),c==="out-in"&&a.type!==Pe)return i.isLeaving=!0,_.afterLeave=()=>{i.isLeaving=!1,n.job.flags&8||n.update(),delete _.afterLeave,l=void 0},Li(o);c==="in-out"&&a.type!==Pe?_.delayLeave=(T,L,M)=>{const b=Qo(i,l);b[String(l.key)]=l,T[Ne]=()=>{L(),T[Ne]=void 0,delete p.delayedLeave,l=void 0},p.delayedLeave=()=>{M(),delete p.delayedLeave,l=void 0}}:l=void 0}else l&&(l=void 0);return o}}};function Zo(e){let t=e[0];if(e.length>1){for(const n of e)if(n.type!==Pe){t=n;break}}return t}const Ru=Ou;function Qo(e,t){const{leavingVNodes:n}=e;let i=n.get(t.type);return i||(i=Object.create(null),n.set(t.type,i)),i}function vn(e,t,n,i,s){const{appear:o,mode:r,persisted:c=!1,onBeforeEnter:a,onEnter:p,onAfterEnter:l,onEnterCancelled:_,onBeforeLeave:T,onLeave:L,onAfterLeave:M,onLeaveCancelled:b,onBeforeAppear:I,onAppear:N,onAfterAppear:F,onAppearCancelled:U}=t,$=String(e.key),Y=Qo(n,e),ie=(B,X)=>{B&&Ge(B,i,9,X)},ue=(B,X)=>{const re=X[1];ie(B,X),H(B)?B.every(P=>P.length<=1)&&re():B.length<=1&&re()},ge={mode:r,persisted:c,beforeEnter(B){let X=a;if(!n.isMounted)if(o)X=I||a;else return;B[Ne]&&B[Ne](!0);const re=Y[$];re&&Et(e,re)&&re.el[Ne]&&re.el[Ne](),ie(X,[B])},enter(B){if(Y[$]===e)return;let X=p,re=l,P=_;if(!n.isMounted)if(o)X=N||p,re=F||l,P=U||_;else return;let K=!1;B[tn]=Re=>{K||(K=!0,Re?ie(P,[B]):ie(re,[B]),ge.delayedLeave&&ge.delayedLeave(),B[tn]=void 0)};const ee=B[tn].bind(null,!1);X?ue(X,[B,ee]):ee()},leave(B,X){const re=String(e.key);if(B[tn]&&B[tn](!0),n.isUnmounting)return X();ie(T,[B]);let P=!1;B[Ne]=ee=>{P||(P=!0,X(),ee?ie(b,[B]):ie(M,[B]),B[Ne]=void 0,Y[re]===e&&delete Y[re])};const K=B[Ne].bind(null,!1);Y[re]=e,L?ue(L,[B,K]):K()},clone(B){const X=vn(B,t,n,i,s);return s&&s(X),X}};return ge}function Li(e){if(ai(e))return e=yt(e),e.children=null,e}function Vn(e){if(!ai(e))return ci(e.type)&&e.children?Zo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:n}=e;if(n){if(t&16)return n[0];if(t&32&&j(n.default))return n.default()}}function Mt(e,t){if(e.shapeFlag&6&&e.component){e.transition=t;const n=e.component.subTree;Mt(ci(n.type)&&Vn(n)||n,t)}else e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function fs(e,t=!1,n){let i=[],s=0;for(let o=0;o<e.length;o++){let r=e[o];const c=n==null?r.key:String(n)+String(r.key!=null?r.key:o);r.type===ve?(r.patchFlag&128&&s++,i=i.concat(fs(r.children,t,c))):(t||r.type!==Pe)&&i.push(c!=null?yt(r,{key:c}):r)}if(s>1)for(let o=0;o<i.length;o++)i[o].patchFlag=-2;return i}function gt(e,t){return j(e)?he({name:e.name},t,{setup:e}):e}function er(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Rs(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const Yn=new WeakMap;function pn(e,t,n,i,s=!1){if(H(e)){e.forEach((b,I)=>pn(b,t&&(H(t)?t[I]:t),n,i,s));return}if(un(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&pn(e,t,n,i.component.subTree);return}const o=i.shapeFlag&4?_i(i.component):i.el,r=s?null:o,{i:c,r:a}=e,p=t&&t.r,l=c.refs===oe?c.refs={}:c.refs,_=c.setupState,T=z(_),L=_===oe?mo:b=>Rs(l,b)?!1:J(T,b),M=(b,I)=>!(I&&Rs(l,I));if(p!=null&&p!==a){if(Ss(t),pe(p))l[p]=null,L(p)&&(_[p]=null);else if(Ae(p)){const b=t;M(p,b.k)&&(p.value=null),b.k&&(l[b.k]=null)}}if(j(a))On(a,c,12,[r,l]);else{const b=pe(a),I=Ae(a);if(b||I){const N=()=>{if(e.f){const F=b?L(a)?_[a]:l[a]:M()||!e.k?a.value:l[e.k];if(s)H(F)&&es(F,o);else if(H(F))F.includes(o)||F.push(o);else if(b)l[a]=[o],L(a)&&(_[a]=l[a]);else{const U=[o];M(a,e.k)&&(a.value=U),e.k&&(l[e.k]=U)}}else b?(l[a]=r,L(a)&&(_[a]=r)):I&&(M(a,e.k)&&(a.value=r),e.k&&(l[e.k]=r))};if(r){const F=()=>{N(),Yn.delete(e)};F.id=-1,Yn.set(e,F),Se(F,n)}else Ss(e),N()}}}function Ss(e){const t=Yn.get(e);t&&(t.flags|=8,Yn.delete(e))}ii().requestIdleCallback;ii().cancelIdleCallback;const un=e=>!!e.type.__asyncLoader,ai=e=>e.type.__isKeepAlive;function Su(e,t){tr(e,"a",t)}function Eu(e,t){tr(e,"da",t)}function tr(e,t,n=Oe){const i=e.__wdc||(e.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(li(t,i,n),n){let s=n.parent;for(;s&&s.parent;)ai(s.parent.vnode)&&Cu(i,t,n,s),s=s.parent}}function Cu(e,t,n,i){const s=li(t,e,i,!0);Nt(()=>{es(i[t],s)},n)}function li(e,t,n=Oe,i=!1){if(n){const s=n[e]||(n[e]=[]),o=t.__weh||(t.__weh=(...r)=>{dt();const c=Rn(n),a=Ge(t,n,e,r);return c(),_t(),a});return i?s.unshift(o):s.push(o),o}}const mt=e=>(t,n=Oe)=>{(!kn||e==="sp")&&li(e,(...i)=>t(...i),n)},Iu=mt("bm"),pi=mt("m"),$u=mt("bu"),nr=mt("u"),ir=mt("bum"),Nt=mt("um"),Mu=mt("sp"),Nu=mt("rtg"),Du=mt("rtc");function Fu(e,t=Oe){li("ec",e,t)}const Bu=Symbol.for("v-ndc");function kt(e,t,n,i){let s;const o=n,r=H(e);if(r||pe(e)){const c=r&&It(e);let a=!1,p=!1;c&&(a=!Fe(e),p=ft(e),e=si(e)),s=new Array(e.length);for(let l=0,_=e.length;l<_;l++)s[l]=t(a?p?Xt(Ye(e[l])):Ye(e[l]):e[l],l,void 0,o)}else if(typeof e=="number"){s=new Array(e);for(let c=0;c<e;c++)s[c]=t(c+1,c,void 0,o)}else if(Z(e))if(e[Symbol.iterator])s=Array.from(e,(c,a)=>t(c,a,void 0,o));else{const c=Object.keys(e);s=new Array(c.length);for(let a=0,p=c.length;a<p;a++){const l=c[a];s[a]=t(e[l],l,a,o)}}else s=[];return s}const ji=e=>e?Lr(e)?_i(e):ji(e.parent):null,dn=he(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>ji(e.parent),$root:e=>ji(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>or(e),$forceUpdate:e=>e.f||(e.f=()=>{ds(e.update)}),$nextTick:e=>e.n||(e.n=xu.bind(e.proxy)),$watch:e=>wu.bind(e)}),wi=(e,t)=>e!==oe&&!e.__isScriptSetup&&J(e,t),Hu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:i,data:s,props:o,accessCache:r,type:c,appContext:a}=e;if(t[0]!=="$"){const T=r[t];if(T!==void 0)switch(T){case 1:return i[t];case 2:return s[t];case 4:return n[t];case 3:return o[t]}else{if(wi(i,t))return r[t]=1,i[t];if(s!==oe&&J(s,t))return r[t]=2,s[t];if(J(o,t))return r[t]=3,o[t];if(n!==oe&&J(n,t))return r[t]=4,n[t];Ui&&(r[t]=0)}}const p=dn[t];let l,_;if(p)return t==="$attrs"&&be(e.attrs,"get",""),p(e);if((l=c.__cssModules)&&(l=l[t]))return l;if(n!==oe&&J(n,t))return r[t]=4,n[t];if(_=a.config.globalProperties,J(_,t))return _[t]},set({_:e},t,n){const{data:i,setupState:s,ctx:o}=e;return wi(s,t)?(s[t]=n,!0):i!==oe&&J(i,t)?(i[t]=n,!0):J(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:i,appContext:s,props:o,type:r}},c){let a;return!!(n[c]||e!==oe&&c[0]!=="$"&&J(e,c)||wi(t,c)||J(o,c)||J(i,c)||J(dn,c)||J(s.config.globalProperties,c)||(a=r.__cssModules)&&a[c])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:J(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function Es(e){return H(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}let Ui=!0;function Gu(e){const t=or(e),n=e.proxy,i=e.ctx;Ui=!1,t.beforeCreate&&Cs(t.beforeCreate,e,"bc");const{data:s,computed:o,methods:r,watch:c,provide:a,inject:p,created:l,beforeMount:_,mounted:T,beforeUpdate:L,updated:M,activated:b,deactivated:I,beforeDestroy:N,beforeUnmount:F,destroyed:U,unmounted:$,render:Y,renderTracked:ie,renderTriggered:ue,errorCaptured:ge,serverPrefetch:B,expose:X,inheritAttrs:re,components:P,directives:K,filters:ee}=t;if(p&&ju(p,i,null),r)for(const te in r){const W=r[te];j(W)&&(i[te]=W.bind(n))}if(s){const te=s.call(n,n);Z(te)&&(e.data=ls(te))}if(Ui=!0,o)for(const te in o){const W=o[te],it=j(W)?W.bind(n,n):j(W.get)?W.get.bind(n,n):tt,Bt=!j(W)&&j(W.set)?W.set.bind(n):tt,st=V({get:it,set:Bt});Object.defineProperty(i,te,{enumerable:!0,configurable:!0,get:()=>st.value,set:$e=>st.value=$e})}if(c)for(const te in c)sr(c[te],i,n,te);if(a){const te=j(a)?a.call(n):a;Reflect.ownKeys(te).forEach(W=>{bu(W,te[W])})}l&&Cs(l,e,"c");function _e(te,W){H(W)?W.forEach(it=>te(it.bind(n))):W&&te(W.bind(n))}if(_e(Iu,_),_e(pi,T),_e($u,L),_e(nr,M),_e(Su,b),_e(Eu,I),_e(Fu,ge),_e(Du,ie),_e(Nu,ue),_e(ir,F),_e(Nt,$),_e(Mu,B),H(X))if(X.length){const te=e.exposed||(e.exposed={});X.forEach(W=>{Object.defineProperty(te,W,{get:()=>n[W],set:it=>n[W]=it,enumerable:!0})})}else e.exposed||(e.exposed={});Y&&e.render===tt&&(e.render=Y),re!=null&&(e.inheritAttrs=re),P&&(e.components=P),K&&(e.directives=K),B&&er(e)}function ju(e,t,n=tt){H(e)&&(e=Vi(e));for(const i in e){const s=e[i];let o;Z(s)?"default"in s?o=Dn(s.from||i,s.default,!0):o=Dn(s.from||i):o=Dn(s),Ae(o)?Object.defineProperty(t,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[i]=o}}function Cs(e,t,n){Ge(H(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,n)}function sr(e,t,n,i){let s=i.includes(".")?Wo(n,i):()=>n[i];if(pe(e)){const o=t[e];j(o)&&Be(s,o)}else if(j(e))Be(s,e.bind(n));else if(Z(e))if(H(e))e.forEach(o=>sr(o,t,n,i));else{const o=j(e.handler)?e.handler.bind(n):t[e.handler];j(o)&&Be(s,o,e)}}function or(e){const t=e.type,{mixins:n,extends:i}=t,{mixins:s,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,c=o.get(t);let a;return c?a=c:!s.length&&!n&&!i?a=t:(a={},s.length&&s.forEach(p=>Kn(a,p,r,!0)),Kn(a,t,r)),Z(t)&&o.set(t,a),a}function Kn(e,t,n,i=!1){const{mixins:s,extends:o}=t;o&&Kn(e,o,n,!0),s&&s.forEach(r=>Kn(e,r,n,!0));for(const r in t)if(!(i&&r==="expose")){const c=Uu[r]||n&&n[r];e[r]=c?c(e[r],t[r]):t[r]}return e}const Uu={data:Is,props:$s,emits:$s,methods:on,computed:on,beforeCreate:Le,created:Le,beforeMount:Le,mounted:Le,beforeUpdate:Le,updated:Le,beforeDestroy:Le,beforeUnmount:Le,destroyed:Le,unmounted:Le,activated:Le,deactivated:Le,errorCaptured:Le,serverPrefetch:Le,components:on,directives:on,watch:Yu,provide:Is,inject:Vu};function Is(e,t){return t?e?function(){return he(j(e)?e.call(this,this):e,j(t)?t.call(this,this):t)}:t:e}function Vu(e,t){return on(Vi(e),Vi(t))}function Vi(e){if(H(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function Le(e,t){return e?[...new Set([].concat(e,t))]:t}function on(e,t){return e?he(Object.create(null),e,t):t}function $s(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:he(Object.create(null),Es(e),Es(t??{})):t}function Yu(e,t){if(!e)return t;if(!t)return e;const n=he(Object.create(null),e);for(const i in t)n[i]=Le(e[i],t[i]);return n}function rr(){return{app:null,config:{isNativeTag:mo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ku=0;function qu(e,t){return function(i,s=null){j(i)||(i=he({},i)),s!=null&&!Z(s)&&(s=null);const o=rr(),r=new WeakSet,c=[];let a=!1;const p=o.app={_uid:Ku++,_component:i,_props:s,_container:null,_context:o,_instance:null,version:Ad,get config(){return o.config},set config(l){},use(l,..._){return r.has(l)||(l&&j(l.install)?(r.add(l),l.install(p,..._)):j(l)&&(r.add(l),l(p,..._))),p},mixin(l){return o.mixins.includes(l)||o.mixins.push(l),p},component(l,_){return _?(o.components[l]=_,p):o.components[l]},directive(l,_){return _?(o.directives[l]=_,p):o.directives[l]},mount(l,_,T){if(!a){const L=p._ceVNode||ke(i,s);return L.appContext=o,T===!0?T="svg":T===!1&&(T=void 0),e(L,l,T),a=!0,p._container=l,l.__vue_app__=p,_i(L.component)}},onUnmount(l){c.push(l)},unmount(){a&&(Ge(c,p._instance,16),e(null,p._container),delete p._container.__vue_app__)},provide(l,_){return o.provides[l]=_,p},runWithContext(l){const _=zt;zt=p;try{return l()}finally{zt=_}}};return p}}let zt=null;const Wu=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Ue(t)}Modifiers`]||e[`${Ft(t)}Modifiers`];function zu(e,t,...n){if(e.isUnmounted)return;const i=e.vnode.props||oe;let s=n;const o=t.startsWith("update:"),r=o&&Wu(i,t.slice(7));r&&(r.trim&&(s=n.map(l=>pe(l)?l.trim():l)),r.number&&(s=n.map(ns)));let c,a=i[c=ki(t)]||i[c=ki(Ue(t))];!a&&o&&(a=i[c=ki(Ft(t))]),a&&Ge(a,e,6,s);const p=i[c+"Once"];if(p){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,Ge(p,e,6,s)}}const Xu=new WeakMap;function cr(e,t,n=!1){const i=n?Xu:t.emitsCache,s=i.get(e);if(s!==void 0)return s;const o=e.emits;let r={},c=!1;if(!j(e)){const a=p=>{const l=cr(p,t,!0);l&&(c=!0,he(r,l))};!n&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!c?(Z(e)&&i.set(e,null),null):(H(o)?o.forEach(a=>r[a]=null):he(r,o),Z(e)&&i.set(e,r),r)}function ui(e,t){return!e||!ei(t)?!1:(t=t.slice(2),t=t==="Once"?t:t.replace(/Once$/,""),J(e,t[0].toLowerCase()+t.slice(1))||J(e,Ft(t))||J(e,t))}function Ms(e){const{type:t,vnode:n,proxy:i,withProxy:s,propsOptions:[o],slots:r,attrs:c,emit:a,render:p,renderCache:l,props:_,data:T,setupState:L,ctx:M,inheritAttrs:b}=e,I=Un(e);let N,F;try{if(n.shapeFlag&4){const $=s||i,Y=$;N=Qe(p.call(Y,$,l,_,L,T,M)),F=c}else{const $=t;N=Qe($.length>1?$(_,{attrs:c,slots:r,emit:a}):$(_,null)),F=t.props?c:Ju(c)}}catch($){$t.length=0,ri($,e,1),N=ke(Pe)}let U=N;if(F&&b!==!1){const $=Object.keys(F),{shapeFlag:Y}=U;$.length&&Y&7&&(o&&$.some(ti)&&(F=Zu(F,o)),U=yt(U,F,!1,!0))}if(n.dirs&&(U=yt(U,null,!1,!0),U.dirs=U.dirs?U.dirs.concat(n.dirs):n.dirs),n.transition){const $=ci(U.type)&&Vn(U)||U;Mt($,n.transition)}return N=U,Un(I),N}const Ju=e=>{let t;for(const n in e)(n==="class"||n==="style"||ei(n))&&((t||(t={}))[n]=e[n]);return t},Zu=(e,t)=>{const n={};for(const i in e)(!ti(i)||!(i.slice(9)in t))&&(n[i]=e[i]);return n};function Qu(e,t,n){const{props:i,children:s,component:o}=e,{props:r,children:c,patchFlag:a}=t,p=o.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?Ns(i,r,p):!!r;if(a&8){const l=t.dynamicProps;for(let _=0;_<l.length;_++){const T=l[_];if(ar(r,i,T)&&!ui(p,T))return!0}}}else return(s||c)&&(!c||!c.$stable)?!0:i===r?!1:i?r?Ns(i,r,p):!0:!!r;return!1}function Ns(e,t,n){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const o=i[s];if(ar(t,e,o)&&!ui(n,o))return!0}return!1}function ar(e,t,n){const i=e[n],s=t[n];return n==="style"&&Z(i)&&Z(s)?!is(i,s):i!==s}function ed({vnode:e,parent:t,suspense:n},i){for(;t;){const s=t.subTree;if(s.suspense&&s.suspense.activeBranch===e&&(s.suspense.vnode.el=s.el=i,e=s),s===e)(e=t.vnode).el=i,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=i)}const lr={},pr=()=>Object.create(lr),ur=e=>Object.getPrototypeOf(e)===lr;function td(e,t,n,i=!1){const s={},o=pr();e.propsDefaults=Object.create(null),dr(e,t,s,o);for(const r in e.propsOptions[0])r in s||(s[r]=void 0);n?e.props=i?s:pu(s):e.type.props?e.props=s:e.props=o,e.attrs=o}function nd(e,t,n,i){const{props:s,attrs:o,vnode:{patchFlag:r}}=e,c=z(s),[a]=e.propsOptions;let p=!1;if((i||r>0)&&!(r&16)){if(r&8){const l=e.vnode.dynamicProps;for(let _=0;_<l.length;_++){let T=l[_];if(ui(e.emitsOptions,T))continue;const L=t[T];if(a)if(J(o,T))L!==o[T]&&(o[T]=L,p=!0);else{const M=Ue(T);s[M]=Yi(a,c,M,L,e,!1)}else L!==o[T]&&(o[T]=L,p=!0)}}}else{dr(e,t,s,o)&&(p=!0);let l;for(const _ in c)(!t||!J(t,_)&&((l=Ft(_))===_||!J(t,l)))&&(a?n&&(n[_]!==void 0||n[l]!==void 0)&&(s[_]=Yi(a,c,_,void 0,e,!0)):delete s[_]);if(o!==c)for(const _ in o)(!t||!J(t,_))&&(delete o[_],p=!0)}p&&pt(e.attrs,"set","")}function dr(e,t,n,i){const[s,o]=e.propsOptions;let r=!1,c;if(t)for(let a in t){if(cn(a))continue;const p=t[a];let l;s&&J(s,l=Ue(a))?!o||!o.includes(l)?n[l]=p:(c||(c={}))[l]=p:ui(e.emitsOptions,a)||(!(a in i)||p!==i[a])&&(i[a]=p,r=!0)}if(o){const a=z(n),p=c||oe;for(let l=0;l<o.length;l++){const _=o[l];n[_]=Yi(s,a,_,p[_],e,!J(p,_))}}return r}function Yi(e,t,n,i,s,o){const r=e[n];if(r!=null){const c=J(r,"default");if(c&&i===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&j(a)){const{propsDefaults:p}=s;if(n in p)i=p[n];else{const l=Rn(s);i=p[n]=a.call(null,t),l()}}else i=a;s.ce&&s.ce._setProp(n,i)}r[0]&&(o&&!c?i=!1:r[1]&&(i===""||i===Ft(n))&&(i=!0))}return i}const id=new WeakMap;function _r(e,t,n=!1){const i=n?id:t.propsCache,s=i.get(e);if(s)return s;const o=e.props,r={},c=[];let a=!1;if(!j(e)){const l=_=>{a=!0;const[T,L]=_r(_,t,!0);he(r,T),L&&c.push(...L)};!n&&t.mixins.length&&t.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}if(!o&&!a)return Z(e)&&i.set(e,Kt),Kt;if(H(o))for(let l=0;l<o.length;l++){const _=Ue(o[l]);Ds(_)&&(r[_]=oe)}else if(o)for(const l in o){const _=Ue(l);if(Ds(_)){const T=o[l],L=r[_]=H(T)||j(T)?{type:T}:he({},T),M=L.type;let b=!1,I=!0;if(H(M))for(let N=0;N<M.length;++N){const F=M[N],U=j(F)&&F.name;if(U==="Boolean"){b=!0;break}else U==="String"&&(I=!1)}else b=j(M)&&M.name==="Boolean";L[0]=b,L[1]=I,(b||J(L,"default"))&&c.push(_)}}const p=[r,c];return Z(e)&&i.set(e,p),p}function Ds(e){return e[0]!=="$"&&!cn(e)}const gs=e=>e==="_"||e==="_ctx"||e==="$stable",ms=e=>H(e)?e.map(Qe):[Qe(e)],sd=(e,t,n)=>{if(t._n)return t;const i=_s((...s)=>ms(t(...s)),n);return i._c=!1,i},fr=(e,t,n)=>{const i=e._ctx;for(const s in e){if(gs(s))continue;const o=e[s];if(j(o))t[s]=sd(s,o,i);else if(o!=null){const r=ms(o);t[s]=()=>r}}},gr=(e,t)=>{const n=ms(t);e.slots.default=()=>n},mr=(e,t,n)=>{for(const i in t)(n||!gs(i))&&(e[i]=t[i])},od=(e,t,n)=>{const i=e.slots=pr();if(e.vnode.shapeFlag&32){const s=t._;s?(mr(i,t,n),n&&To(i,"_",s,!0)):fr(t,i)}else t&&gr(e,t)},rd=(e,t,n)=>{const{vnode:i,slots:s}=e;let o=!0,r=oe;if(i.shapeFlag&32){const c=t._;c?n&&c===1?o=!1:mr(s,t,n):(o=!t.$stable,fr(t,s)),r=t}else t&&(gr(e,t),r={default:1});if(o)for(const c in s)!gs(c)&&r[c]==null&&delete s[c]},Se=ud;function cd(e){return ad(e)}function ad(e,t){const n=ii();n.__VUE__=!0;const{insert:i,remove:s,patchProp:o,createElement:r,createText:c,createComment:a,setText:p,setElementText:l,parentNode:_,nextSibling:T,setScopeId:L=tt,insertStaticContent:M}=e,b=(u,d,g,y=null,x=null,v=null,f=void 0,k=null,A=!!d.dynamicChildren)=>{if(u===d)return;u&&!Et(u,d)&&(y=Ht(u),$e(u,x,v,!0),u=null),d.patchFlag===-2&&(A=!1,d.dynamicChildren=null);const{type:h,ref:S,shapeFlag:E}=d;switch(h){case di:I(u,d,g,y);break;case Pe:N(u,d,g,y);break;case Fn:u==null&&F(d,g,y,f);break;case ve:P(u,d,g,y,x,v,f,k,A);break;default:E&1?Y(u,d,g,y,x,v,f,k,A):E&6?K(u,d,g,y,x,v,f,k,A):(E&64||E&128)&&h.process(u,d,g,y,x,v,f,k,A,ot)}S!=null&&x?pn(S,u&&u.ref,v,d||u,!d):S==null&&u&&u.ref!=null&&pn(u.ref,null,v,u,!0)},I=(u,d,g,y)=>{if(u==null)i(d.el=c(d.children),g,y);else{const x=d.el=u.el;d.children!==u.children&&p(x,d.children)}},N=(u,d,g,y)=>{u==null?i(d.el=a(d.children||""),g,y):d.el=u.el},F=(u,d,g,y)=>{[u.el,u.anchor]=M(u.children,d,g,y,u.el,u.anchor)},U=({el:u,anchor:d},g,y)=>{let x;for(;u&&u!==d;)x=T(u),i(u,g,y),u=x;i(d,g,y)},$=({el:u,anchor:d})=>{let g;for(;u&&u!==d;)g=T(u),s(u),u=g;s(d)},Y=(u,d,g,y,x,v,f,k,A)=>{if(d.type==="svg"?f="svg":d.type==="math"&&(f="mathml"),u==null)ie(d,g,y,x,v,f,k,A);else{const h=u.el&&u.el._isVueCE?u.el:null;try{h&&h._beginPatch(),B(u,d,x,v,f,k,A)}finally{h&&h._endPatch()}}},ie=(u,d,g,y,x,v,f,k)=>{let A,h;const{props:S,shapeFlag:E,transition:D,dirs:G}=u;if(A=u.el=r(u.type,v,S&&S.is,S),E&8?l(A,u.children):E&16&&ge(u.children,A,null,y,x,Pi(u,v),f,k),G&&wt(u,null,y,"created"),ue(A,u,u.scopeId,f,y),S){for(const se in S)se!=="value"&&!cn(se)&&o(A,se,null,S[se],v,y);"value"in S&&o(A,"value",null,S.value,v),(h=S.onVnodeBeforeMount)&&ze(h,y,u)}G&&wt(u,null,y,"beforeMount");const q=ld(x,D);q&&D.beforeEnter(A),i(A,d,g),((h=S&&S.onVnodeMounted)||q||G)&&Se(()=>{try{h&&ze(h,y,u),q&&D.enter(A),G&&wt(u,null,y,"mounted")}finally{}},x)},ue=(u,d,g,y,x)=>{if(g&&L(u,g),y)for(let v=0;v<y.length;v++)L(u,y[v]);if(x){let v=x.subTree;if(d===v||kr(v.type)&&(v.ssContent===d||v.ssFallback===d)){const f=x.vnode;ue(u,f,f.scopeId,f.slotScopeIds,x.parent)}}},ge=(u,d,g,y,x,v,f,k,A=0)=>{for(let h=A;h<u.length;h++){const S=u[h]=k?lt(u[h]):Qe(u[h]);b(null,S,d,g,y,x,v,f,k)}},B=(u,d,g,y,x,v,f)=>{const k=d.el=u.el;let{patchFlag:A,dynamicChildren:h,dirs:S}=d;A|=u.patchFlag&16;const E=u.props||oe,D=d.props||oe;let G;if(g&&Pt(g,!1),(G=D.onVnodeBeforeUpdate)&&ze(G,g,d,u),S&&wt(d,u,g,"beforeUpdate"),g&&Pt(g,!0),h&&(!u.dynamicChildren||u.dynamicChildren.length!==h.length)&&(A=0,f=!1,h=null),(E.innerHTML&&D.innerHTML==null||E.textContent&&D.textContent==null)&&l(k,""),h?X(u.dynamicChildren,h,k,g,y,Pi(d,x),v):f||W(u,d,k,null,g,y,Pi(d,x),v,!1),A>0){if(A&16)re(k,E,D,g,x);else if(A&2&&E.class!==D.class&&o(k,"class",null,D.class,x),A&4&&o(k,"style",E.style,D.style,x),A&8){const q=d.dynamicProps;for(let se=0;se<q.length;se++){const ne=q[se],me=E[ne],ye=D[ne];(ye!==me||ne==="value")&&o(k,ne,me,ye,x,g)}}A&1&&u.children!==d.children&&l(k,d.children)}else!f&&h==null&&re(k,E,D,g,x);((G=D.onVnodeUpdated)||S)&&Se(()=>{G&&ze(G,g,d,u),S&&wt(d,u,g,"updated")},y)},X=(u,d,g,y,x,v,f)=>{for(let k=0;k<d.length;k++){const A=u[k],h=d[k],S=A.el&&(A.type===ve||!Et(A,h)||A.shapeFlag&198)?_(A.el):g;b(A,h,S,null,y,x,v,f,!0)}},re=(u,d,g,y,x)=>{if(d!==g){if(d!==oe)for(const v in d)!cn(v)&&!(v in g)&&o(u,v,d[v],null,x,y);for(const v in g){if(cn(v))continue;const f=g[v],k=d[v];f!==k&&v!=="value"&&o(u,v,k,f,x,y)}"value"in g&&o(u,"value",d.value,g.value,x)}},P=(u,d,g,y,x,v,f,k,A)=>{const h=d.el=u?u.el:c(""),S=d.anchor=u?u.anchor:c("");let{patchFlag:E,dynamicChildren:D,slotScopeIds:G}=d;G&&(k=k?k.concat(G):G),u==null?(i(h,g,y),i(S,g,y),ge(d.children||[],g,S,x,v,f,k,A)):E>0&&E&64&&D&&u.dynamicChildren&&u.dynamicChildren.length===D.length?(X(u.dynamicChildren,D,g,x,v,f,k),(d.key!=null||x&&d===x.subTree)&&vr(u,d,!0)):W(u,d,g,S,x,v,f,k,A)},K=(u,d,g,y,x,v,f,k,A)=>{d.slotScopeIds=k,u==null?d.shapeFlag&512?x.ctx.activate(d,g,y,f,A):ee(d,g,y,x,v,f,A):Re(u,d,A)},ee=(u,d,g,y,x,v,f)=>{const k=u.component=vd(u,y,x);if(ai(u)&&(k.ctx.renderer=ot),hd(k,!1,f),k.asyncDep){if(x&&x.registerDep(k,_e,f),!u.el){const A=k.subTree=ke(Pe);N(null,A,d,g),u.placeholder=A.el}}else _e(k,u,d,g,x,v,f)},Re=(u,d,g)=>{const y=d.component=u.component;if(Qu(u,d,g))if(y.asyncDep&&!y.asyncResolved){te(y,d,g);return}else y.next=d,y.update();else d.el=u.el,y.vnode=d},_e=(u,d,g,y,x,v,f)=>{const k=()=>{if(u.isMounted){let{next:E,bu:D,u:G,parent:q,vnode:se}=u;{const qe=hr(u);if(qe){E&&(E.el=se.el,te(u,E,f)),qe.asyncDep.then(()=>{Se(()=>{u.isUnmounted||h()},x)});return}}let ne=E,me;Pt(u,!1),E?(E.el=se.el,te(u,E,f)):E=se,D&&Nn(D),(me=E.props&&E.props.onVnodeBeforeUpdate)&&ze(me,q,E,se),Pt(u,!0);const ye=Ms(u),Ke=u.subTree;u.subTree=ye,b(Ke,ye,_(Ke.el),Ht(Ke),u,x,v),E.el=ye.el,ne===null&&ed(u,ye.el),G&&Se(G,x),(me=E.props&&E.props.onVnodeUpdated)&&Se(()=>ze(me,q,E,se),x)}else{let E;const{el:D,props:G}=d,{bm:q,m:se,parent:ne,root:me,type:ye}=u,Ke=un(d);Pt(u,!1),q&&Nn(q),!Ke&&(E=G&&G.onVnodeBeforeMount)&&ze(E,ne,d),Pt(u,!0);{me.ce&&me.ce._hasShadowRoot()&&me.ce._injectChildStyle(ye,u.parent?u.parent.type:void 0);const qe=u.subTree=Ms(u);b(null,qe,g,y,u,x,v),d.el=qe.el}if(se&&Se(se,x),!Ke&&(E=G&&G.onVnodeMounted)){const qe=d;Se(()=>ze(E,ne,qe),x)}(d.shapeFlag&256||ne&&un(ne.vnode)&&ne.vnode.shapeFlag&256)&&u.a&&Se(u.a,x),u.isMounted=!0,d=g=y=null}};u.scope.on();const A=u.effect=new wo(k);u.scope.off();const h=u.update=A.run.bind(A),S=u.job=A.runIfDirty.bind(A);S.i=u,S.id=u.uid,A.scheduler=()=>ds(S),Pt(u,!0),h()},te=(u,d,g)=>{d.component=u;const y=u.vnode.props;u.vnode=d,u.next=null,nd(u,d.props,y,g),rd(u,d.children,g),dt(),Os(u),_t()},W=(u,d,g,y,x,v,f,k,A=!1)=>{const h=u&&u.children,S=u?u.shapeFlag:0,E=d.children,{patchFlag:D,shapeFlag:G}=d;if(D>0){if(D&128){Bt(h,E,g,y,x,v,f,k,A);return}else if(D&256){it(h,E,g,y,x,v,f,k,A);return}}G&8?(S&16&&Lt(h,x,v),E!==h&&l(g,E)):S&16?G&16?Bt(h,E,g,y,x,v,f,k,A):Lt(h,x,v,!0):(S&8&&l(g,""),G&16&&ge(E,g,y,x,v,f,k,A))},it=(u,d,g,y,x,v,f,k,A)=>{u=u||Kt,d=d||Kt;const h=u.length,S=d.length,E=Math.min(h,S);let D;for(D=0;D<E;D++){const G=d[D]=A?lt(d[D]):Qe(d[D]);b(u[D],G,g,null,x,v,f,k,A)}h>S?Lt(u,x,v,!0,!1,E):ge(d,g,y,x,v,f,k,A,E)},Bt=(u,d,g,y,x,v,f,k,A)=>{let h=0;const S=d.length;let E=u.length-1,D=S-1;for(;h<=E&&h<=D;){const G=u[h],q=d[h]=A?lt(d[h]):Qe(d[h]);if(Et(G,q))b(G,q,g,null,x,v,f,k,A);else break;h++}for(;h<=E&&h<=D;){const G=u[E],q=d[D]=A?lt(d[D]):Qe(d[D]);if(Et(G,q))b(G,q,g,null,x,v,f,k,A);else break;E--,D--}if(h>E){if(h<=D){const G=D+1,q=G<S?d[G].el:y;for(;h<=D;)b(null,d[h]=A?lt(d[h]):Qe(d[h]),g,q,x,v,f,k,A),h++}}else if(h>D)for(;h<=E;)$e(u[h],x,v,!0),h++;else{const G=h,q=h,se=new Map;for(h=q;h<=D;h++){const Ee=d[h]=A?lt(d[h]):Qe(d[h]);Ee.key!=null&&se.set(Ee.key,h)}let ne,me=0;const ye=D-q+1;let Ke=!1,qe=0;const Qt=new Array(ye);for(h=0;h<ye;h++)Qt[h]=0;for(h=G;h<=E;h++){const Ee=u[h];if(me>=ye){$e(Ee,x,v,!0);continue}let We;if(Ee.key!=null)We=se.get(Ee.key);else for(ne=q;ne<=D;ne++)if(Qt[ne-q]===0&&Et(Ee,d[ne])){We=ne;break}We===void 0?$e(Ee,x,v,!0):(Qt[We-q]=h+1,We>=qe?qe=We:Ke=!0,b(Ee,d[We],g,null,x,v,f,k,A),me++)}const ys=Ke?pd(Qt):Kt;for(ne=ys.length-1,h=ye-1;h>=0;h--){const Ee=q+h,We=d[Ee],Ts=d[Ee+1],bs=Ee+1<S?Ts.el||xr(Ts):y;Qt[h]===0?b(null,We,g,bs,x,v,f,k,A):Ke&&(ne<0||h!==ys[ne]?st(We,g,bs,2):ne--)}}},st=(u,d,g,y,x=null)=>{const{el:v,type:f,transition:k,children:A,shapeFlag:h}=u;if(h&6){st(u.component.subTree,d,g,y);return}if(h&128){u.suspense.move(d,g,y);return}if(h&64){f.move(u,d,g,ot);return}if(f===ve){i(v,d,g);for(let E=0;E<A.length;E++)st(A[E],d,g,y);i(u.anchor,d,g);return}if(f===Fn){U(u,d,g);return}if(y!==2&&h&1&&k)if(y===0)k.persisted&&!v[Ne]?i(v,d,g):(k.beforeEnter(v),i(v,d,g),Se(()=>k.enter(v),x));else{const{leave:E,delayLeave:D,afterLeave:G}=k,q=()=>{u.ctx.isUnmounted?s(v):i(v,d,g)},se=()=>{const ne=v._isLeaving||!!v[Ne];v._isLeaving&&v[Ne](!0),k.persisted&&!ne?q():E(v,()=>{q(),G&&G()})};D?D(v,q,se):se()}else i(v,d,g)},$e=(u,d,g,y=!1,x=!1)=>{const{type:v,props:f,ref:k,children:A,dynamicChildren:h,shapeFlag:S,patchFlag:E,dirs:D,cacheIndex:G,memo:q}=u;if(E===-2&&(x=!1),k!=null&&(dt(),pn(k,null,g,u,!0),_t()),G!=null&&(d.renderCache[G]=void 0),S&256){d.ctx.deactivate(u);return}const se=S&1&&D,ne=!un(u);let me;if(ne&&(me=f&&f.onVnodeBeforeUnmount)&&ze(me,d,u),S&6)hi(u.component,g,y);else{if(S&128){u.suspense.unmount(g,y);return}se&&wt(u,null,d,"beforeUnmount"),S&64?u.type.remove(u,d,g,ot,y):h&&!h.hasOnce&&(v!==ve||E>0&&E&64)?Lt(h,d,g,!1,!0):(v===ve&&E&384||!x&&S&16)&&Lt(A,d,g),y&&Sn(u)}const ye=q!=null&&G==null;(ne&&(me=f&&f.onVnodeUnmounted)||se||ye)&&Se(()=>{me&&ze(me,d,u),se&&wt(u,null,d,"unmounted"),ye&&(u.el=null)},g)},Sn=u=>{const{type:d,el:g,anchor:y,transition:x}=u;if(d===ve){vi(g,y);return}if(d===Fn){$(u);return}const v=()=>{s(g),x&&!x.persisted&&x.afterLeave&&x.afterLeave()};if(u.shapeFlag&1&&x&&!x.persisted){const{leave:f,delayLeave:k}=x,A=()=>f(g,v);k?k(u.el,v,A):A()}else v()},vi=(u,d)=>{let g;for(;u!==d;)g=T(u),s(u),u=g;s(d)},hi=(u,d,g)=>{const{bum:y,scope:x,job:v,subTree:f,um:k,m:A,a:h}=u;Fs(A),Fs(h),y&&Nn(y),x.stop(),v&&(v.flags|=8,$e(f,u,d,g)),k&&Se(k,d),Se(()=>{u.isUnmounted=!0},d)},Lt=(u,d,g,y=!1,x=!1,v=0)=>{for(let f=v;f<u.length;f++)$e(u[f],d,g,y,x)},Ht=u=>{if(u.shapeFlag&6)return Ht(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const d=T(u.anchor||u.el),g=d&&d[Pu];return g?T(g):d};let Gt=!1;const Zt=(u,d,g)=>{let y;u==null?d._vnode&&($e(d._vnode,null,null,!0),y=d._vnode.component):b(d._vnode||null,u,d,null,null,null,g),d._vnode=u,Gt||(Gt=!0,Os(y),Vo(),Gt=!1)},ot={p:b,um:$e,m:st,r:Sn,mt:ee,mc:ge,pc:W,pbc:X,n:Ht,o:e};return{render:Zt,hydrate:void 0,createApp:qu(Zt)}}function Pi({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function Pt({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function ld(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function vr(e,t,n=!1){const i=e.children,s=t.children;if(H(i)&&H(s))for(let o=0;o<i.length;o++){const r=i[o];let c=s[o];c.shapeFlag&1&&!c.dynamicChildren&&((c.patchFlag<=0||c.patchFlag===32)&&(c=s[o]=lt(s[o]),c.el=r.el),!n&&c.patchFlag!==-2&&vr(r,c)),c.type===di&&(c.patchFlag===-1&&(c=s[o]=lt(c)),c.el=r.el),c.type===Pe&&!c.el&&(c.el=r.el)}}function pd(e){const t=e.slice(),n=[0];let i,s,o,r,c;const a=e.length;for(i=0;i<a;i++){const p=e[i];if(p!==0){if(s=n[n.length-1],e[s]<p){t[i]=s,n.push(i);continue}for(o=0,r=n.length-1;o<r;)c=o+r>>1,e[n[c]]<p?o=c+1:r=c;p<e[n[o]]&&(o>0&&(t[i]=n[o-1]),n[o]=i)}}for(o=n.length,r=n[o-1];o-- >0;)n[o]=r,r=t[r];return n}function hr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:hr(t)}function Fs(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function xr(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?xr(t.subTree):null}const kr=e=>e.__isSuspense;function ud(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):yu(e)}const ve=Symbol.for("v-fgt"),di=Symbol.for("v-txt"),Pe=Symbol.for("v-cmt"),Fn=Symbol.for("v-stc"),$t=[];let Ie=null;function R(e=!1){$t.push(Ie=e?null:[])}function yr(){$t.pop(),Ie=$t[$t.length-1]||null}let hn=1;function qn(e,t=!1){hn+=e,e<0&&Ie&&t&&(Ie.hasOnce=!0)}function Tr(e){return e.dynamicChildren=hn>0?Ie||Kt:null,yr(),hn>0&&Ie&&Ie.push(e),e}function C(e,t,n,i,s,o){return Tr(m(e,t,n,i,s,o,!0))}function ct(e,t,n,i,s){return Tr(ke(e,t,n,i,s,!0))}function Wn(e){return e?e.__v_isVNode===!0:!1}function Et(e,t){return e.type===t.type&&e.key===t.key}const br=({key:e})=>e??null,Bn=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?pe(e)||Ae(e)||j(e)?{i:De,r:e,k:t,f:!!n}:e:null);function m(e,t=null,n=null,i=0,s=null,o=e===ve?0:1,r=!1,c=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&br(t),ref:t&&Bn(t),scopeId:Ko,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:De};return c?(zn(a,n),o&128&&e.normalize(a)):n&&(a.shapeFlag|=pe(n)?8:16),hn>0&&!r&&Ie&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Ie.push(a),a}const ke=dd;function dd(e,t=null,n=null,i=0,s=null,o=!1){if((!e||e===Bu)&&(e=Pe),Wn(e)){const c=yt(e,t,!0);return n&&zn(c,n),hn>0&&!o&&Ie&&(c.shapeFlag&6?Ie[Ie.indexOf(e)]=c:Ie.push(c)),c.patchFlag=-2,c}if(Td(e)&&(e=e.__vccOpts),t){t=_d(t);let{class:c,style:a}=t;c&&!pe(c)&&(t.class=le(c)),Z(a)&&(us(a)&&!H(a)&&(a=he({},a)),t.style=He(a))}const r=pe(e)?1:kr(e)?128:ci(e)?64:Z(e)?4:j(e)?2:0;return m(e,t,n,i,s,r,o,!0)}function _d(e){return e?us(e)||ur(e)?he({},e):e:null}function yt(e,t,n=!1,i=!1){const{props:s,ref:o,patchFlag:r,children:c,transition:a}=e,p=t?fd(s||{},t):s,l={__v_isVNode:!0,__v_skip:!0,type:e.type,props:p,key:p&&br(p),ref:t&&t.ref?n&&o?H(o)?o.concat(Bn(t)):[o,Bn(t)]:Bn(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:c,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ve?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&yt(e.ssContent),ssFallback:e.ssFallback&&yt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&i&&Mt(l,a.clone(l)),l}function Ar(e=" ",t=0){return ke(di,null,e,t)}function Oi(e,t){const n=ke(Fn,null,e);return n.staticCount=t,n}function Q(e="",t=!1){return t?(R(),ct(Pe,null,e)):ke(Pe,null,e)}function Qe(e){return e==null||typeof e=="boolean"?ke(Pe):H(e)?ke(ve,null,e.slice()):Wn(e)?lt(e):ke(di,null,String(e))}function lt(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:yt(e)}function zn(e,t){let n=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(H(t))n=16;else if(typeof t=="object")if(i&65){const s=t.default;s&&(s._c&&(s._d=!1),zn(e,s()),s._c&&(s._d=!0));return}else{n=32;const s=t._;!s&&!ur(t)?t._ctx=De:s===3&&De&&(De.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else if(j(t)){if(i&65){zn(e,{default:t});return}t={default:t,_ctx:De},n=32}else t=String(t),i&64?(n=16,t=[Ar(t)]):n=8;e.children=t,e.shapeFlag|=n}function fd(...e){const t={};for(let n=0;n<e.length;n++){const i=e[n];for(const s in i)if(s==="class")t.class!==i.class&&(t.class=le([t.class,i.class]));else if(s==="style")t.style=He([t.style,i.style]);else if(ei(s)){const o=t[s],r=i[s];r&&o!==r&&!(H(o)&&o.includes(r))?t[s]=o?[].concat(o,r):r:r==null&&o==null&&!ti(s)&&(t[s]=r)}else s!==""&&(t[s]=i[s])}return t}function ze(e,t,n,i=null){Ge(e,t,7,[n,i])}const gd=rr();let md=0;function vd(e,t,n){const i=e.type,s=(t?t.appContext:e.appContext)||gd,o={uid:md++,vnode:e,type:i,parent:t,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Yp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(s.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:_r(i,s),emitsOptions:cr(i,s),emit:null,emitted:null,propsDefaults:oe,inheritAttrs:i.inheritAttrs,ctx:oe,data:oe,props:oe,attrs:oe,slots:oe,refs:oe,setupState:oe,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=zu.bind(null,o),e.ce&&e.ce(o),o}let Oe=null;const vs=()=>Oe||De;let Xn,xn;{const e=ii(),t=(n,i)=>{let s;return(s=e[n])||(s=e[n]=[]),s.push(i),o=>{s.length>1?s.forEach(r=>r(o)):s[0](o)}};Xn=t("__VUE_INSTANCE_SETTERS__",n=>Oe=n),xn=t("__VUE_SSR_SETTERS__",n=>kn=n)}const Rn=e=>{const t=Oe;return Xn(e),e.scope.on(),()=>{e.scope.off(),Xn(t)}},Bs=()=>{Oe&&Oe.scope.off(),Xn(null)};function Lr(e){return e.vnode.shapeFlag&4}let kn=!1;function hd(e,t=!1,n=!1){t&&xn(t);const{props:i,children:s}=e.vnode,o=Lr(e);td(e,i,o,t),od(e,s,n||t);const r=o?xd(e,t):void 0;return t&&xn(!1),r}function xd(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Hu);const{setup:i}=n;if(i){dt();const s=e.setupContext=i.length>1?yd(e):null,o=Rn(e),r=On(i,e,0,[e.props,s]),c=ho(r);if(_t(),o(),(c||e.sp)&&!un(e)&&er(e),c){if(r.then(Bs,Bs),t)return r.then(a=>{xn(!0);try{Hs(e,a,t)}finally{xn(!1)}}).catch(a=>{ri(a,e,0)});e.asyncDep=r}else Hs(e,r)}else wr(e)}function Hs(e,t,n){j(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Z(t)&&(e.setupState=Go(t)),wr(e)}function wr(e,t,n){const i=e.type;e.render||(e.render=i.render||tt);{const s=Rn(e);dt();try{Gu(e)}finally{_t(),s()}}}const kd={get(e,t){return be(e,"get",""),e[t]}};function yd(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,kd),slots:e.slots,emit:e.emit,expose:t}}function _i(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Go(uu(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in dn)return dn[n](e)},has(t,n){return n in t||n in dn}})):e.proxy}function Td(e){return j(e)&&"__vccOpts"in e}const V=(e,t)=>gu(e,t,kn);function bd(e,t,n){try{qn(-1);const i=arguments.length;return i===2?Z(t)&&!H(t)?Wn(t)?ke(e,null,[t]):ke(e,t):ke(e,null,t):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&Wn(n)&&(n=[n]),ke(e,t,n))}finally{qn(1)}}const Ad="3.5.41";/**
* @vue/runtime-dom v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ki;const Gs=typeof window<"u"&&window.trustedTypes;if(Gs)try{Ki=Gs.createPolicy("vue",{createHTML:e=>e})}catch{}const Pr=Ki?e=>Ki.createHTML(e):e=>e,Ld="http://www.w3.org/2000/svg",wd="http://www.w3.org/1998/Math/MathML",at=typeof document<"u"?document:null,js=at&&at.createElement("template"),Pd={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,i)=>{const s=t==="svg"?at.createElementNS(Ld,e):t==="mathml"?at.createElementNS(wd,e):n?at.createElement(e,{is:n}):at.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>at.createTextNode(e),createComment:e=>at.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>at.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,i,s,o){const r=n?n.previousSibling:t.lastChild;if(s&&(s===o||s.nextSibling))for(;t.insertBefore(s.cloneNode(!0),n),!(s===o||!(s=s.nextSibling)););else{js.innerHTML=Pr(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const c=js.content;if(i==="svg"||i==="mathml"){const a=c.firstChild;for(;a.firstChild;)c.appendChild(a.firstChild);c.removeChild(a)}t.insertBefore(c,n)}return[r?r.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},vt="transition",nn="animation",Jt=Symbol("_vtc"),Or={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Rr=he({},Xo,Or),Od=e=>(e.displayName="Transition",e.props=Rr,e),Rd=Od((e,{slots:t})=>bd(Ru,Sr(e),t)),Ot=(e,t=[])=>{H(e)?e.forEach(n=>n(...t)):e&&e(...t)},Us=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Sr(e){const t={};for(const P in e)P in Or||(t[P]=e[P]);if(e.css===!1)return t;const{name:n="v",type:i,duration:s,enterFromClass:o=`${n}-enter-from`,enterActiveClass:r=`${n}-enter-active`,enterToClass:c=`${n}-enter-to`,appearFromClass:a=o,appearActiveClass:p=r,appearToClass:l=c,leaveFromClass:_=`${n}-leave-from`,leaveActiveClass:T=`${n}-leave-active`,leaveToClass:L=`${n}-leave-to`}=e,M=Sd(s),b=M&&M[0],I=M&&M[1],{onBeforeEnter:N,onEnter:F,onEnterCancelled:U,onLeave:$,onLeaveCancelled:Y,onBeforeAppear:ie=N,onAppear:ue=F,onAppearCancelled:ge=U}=t,B=(P,K,ee,Re)=>{P._enterCancelled=Re,ht(P,K?l:c),ht(P,K?p:r),ee&&ee()},X=(P,K)=>{P._isLeaving=!1,ht(P,_),ht(P,L),ht(P,T),K&&K()},re=P=>(K,ee)=>{const Re=P?ue:F,_e=()=>B(K,P,ee);Ot(Re,[K,_e]),Vs(()=>{ht(K,P?a:o),Xe(K,P?l:c),Us(Re)||Ys(K,i,b,_e)})};return he(t,{onBeforeEnter(P){Ot(N,[P]),Xe(P,o),Xe(P,r)},onBeforeAppear(P){Ot(ie,[P]),Xe(P,a),Xe(P,p)},onEnter:re(!1),onAppear:re(!0),onLeave(P,K){P._isLeaving=!0;const ee=()=>X(P,K);Xe(P,_),P._enterCancelled?(Xe(P,T),qi(P)):(qi(P),Xe(P,T)),Vs(()=>{P._isLeaving&&(ht(P,_),Xe(P,L),Us($)||Ys(P,i,I,ee))}),Ot($,[P,ee])},onEnterCancelled(P){B(P,!1,void 0,!0),Ot(U,[P])},onAppearCancelled(P){B(P,!0,void 0,!0),Ot(ge,[P])},onLeaveCancelled(P){X(P),Ot(Y,[P])}})}function Sd(e){if(e==null)return null;if(Z(e))return[Ri(e.enter),Ri(e.leave)];{const t=Ri(e);return[t,t]}}function Ri(e){return Dp(e)}function Xe(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[Jt]||(e[Jt]=new Set)).add(t)}function ht(e,t){t.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const n=e[Jt];n&&(n.delete(t),n.size||(e[Jt]=void 0))}function Vs(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Ed=0;function Ys(e,t,n,i){const s=e._endId=++Ed,o=()=>{s===e._endId&&i()};if(n!=null)return setTimeout(o,n);const{type:r,timeout:c,propCount:a}=Er(e,t);if(!r)return i();const p=r+"end";let l=0;const _=()=>{e.removeEventListener(p,T),o()},T=L=>{L.target===e&&++l>=a&&_()};setTimeout(()=>{l<a&&_()},c+1),e.addEventListener(p,T)}function Er(e,t){const n=window.getComputedStyle(e),i=M=>(n[M]||"").split(", "),s=i(`${vt}Delay`),o=i(`${vt}Duration`),r=Ks(s,o),c=i(`${nn}Delay`),a=i(`${nn}Duration`),p=Ks(c,a);let l=null,_=0,T=0;t===vt?r>0&&(l=vt,_=r,T=o.length):t===nn?p>0&&(l=nn,_=p,T=a.length):(_=Math.max(r,p),l=_>0?r>p?vt:nn:null,T=l?l===vt?o.length:a.length:0);const L=l===vt&&/\b(?:transform|all)(?:,|$)/.test(i(`${vt}Property`).toString());return{type:l,timeout:_,propCount:T,hasTransform:L}}function Ks(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((n,i)=>qs(n)+qs(e[i])))}function qs(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function qi(e){return(e?e.ownerDocument:document).body.offsetHeight}function Cd(e,t,n){const i=e[Jt];i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const Ws=Symbol("_vod"),Cr=Symbol("_vsh"),Id=Symbol(""),$d=/(?:^|;)\s*display\s*:/;function Md(e,t,n){const i=e.style,s=pe(n);let o=!1;if(n&&!s){if(t)if(pe(t))for(const r of t.split(";")){const c=r.slice(0,r.indexOf(":")).trim();n[c]==null&&rn(i,c,"")}else for(const r in t)n[r]==null&&rn(i,r,"");for(const r in n){r==="display"&&(o=!0);const c=n[r];c!=null?Dd(e,r,!pe(t)&&t?t[r]:void 0,c)||rn(i,r,c):rn(i,r,"")}}else if(s){if(t!==n){const r=i[Id];r&&(n+=";"+r),i.cssText=n,o=$d.test(n)}}else t&&e.removeAttribute("style");Ws in e&&(e[Ws]=o?i.display:"",e[Cr]&&(i.display="none"))}const zs=/\s*!important$/;function rn(e,t,n){if(H(n))n.forEach(i=>rn(e,t,i));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const i=Nd(e,t);zs.test(n)?e.setProperty(Ft(i),n.replace(zs,""),"important"):e[i]=n}}const Xs=["Webkit","Moz","ms"],Si={};function Nd(e,t){const n=Si[t];if(n)return n;let i=Ue(t);if(i!=="filter"&&i in e)return Si[t]=i;i=yo(i);for(let s=0;s<Xs.length;s++){const o=Xs[s]+i;if(o in e)return Si[t]=o}return t}function Dd(e,t,n,i){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&pe(i)&&n===i}const Js="http://www.w3.org/1999/xlink";function Zs(e,t,n,i,s,o=Up(t)){i&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(Js,t.slice(6,t.length)):e.setAttributeNS(Js,t,n):n==null||o&&!bo(n)?e.removeAttribute(t):e.setAttribute(t,o?"":nt(n)?String(n):n)}function Qs(e,t,n,i,s){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?Pr(n):n);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const c=o==="OPTION"?e.getAttribute("value")||"":e.value,a=n==null?e.type==="checkbox"?"on":"":String(n);(c!==a||!("_value"in e))&&(e.value=a),n==null&&e.removeAttribute(t),e._value=n;return}let r=!1;if(n===""||n==null){const c=typeof e[t];c==="boolean"?n=bo(n):n==null&&c==="string"?(n="",r=!0):c==="number"&&(n=0,r=!0)}try{e[t]=n}catch{}r&&e.removeAttribute(s||t)}function Vt(e,t,n,i){e.addEventListener(t,n,i)}function Fd(e,t,n,i){e.removeEventListener(t,n,i)}const eo=Symbol("_vei");function Bd(e,t,n,i,s=null){const o=e[eo]||(e[eo]={}),r=o[t];if(i&&r)r.value=i;else{const[c,a]=jd(t);if(i){const p=o[t]=Yd(i,s);Vt(e,c,p,a)}else r&&(Fd(e,c,r,a),o[t]=void 0)}}const Hd=/(Once|Passive|Capture)$/,Gd=/^on:?(?:Once|Passive|Capture)$/;function jd(e){let t,n;for(;(n=e.match(Hd))&&!Gd.test(e);)t||(t={}),e=e.slice(0,e.length-n[1].length),t[n[1].toLowerCase()]=!0;return[e[2]===":"?e.slice(3):Ft(e.slice(2)),t]}let Ei=0;const Ud=Promise.resolve(),Vd=()=>Ei||(Ud.then(()=>Ei=0),Ei=Date.now());function Yd(e,t){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;const s=n.value;if(H(s)){const o=i.stopImmediatePropagation;i.stopImmediatePropagation=()=>{o.call(i),i._stopped=!0};const r=s.slice(),c=[i];for(let a=0;a<r.length&&!i._stopped;a++){const p=r[a];p&&Ge(p,t,5,c)}}else Ge(s,t,5,[i])};return n.value=e,n.attached=Vd(),n}const to=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Kd=(e,t,n,i,s,o)=>{const r=s==="svg";t==="class"?Cd(e,i,r):t==="style"?Md(e,n,i):ei(t)?ti(t)||Bd(e,t,n,i,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):qd(e,t,i,r))?(Qs(e,t,i),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Zs(e,t,i,r,o,t!=="value")):e._isVueCE&&(Wd(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!pe(i)))?Qs(e,Ue(t),i,o,t):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),Zs(e,t,i,r))};function qd(e,t,n,i){if(i)return!!(t==="innerHTML"||t==="textContent"||t in e&&to(t)&&j(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return to(t)&&pe(n)?!1:t in e}function Wd(e,t){const n=e._def.props;if(!n)return!1;const i=Ue(t);return Array.isArray(n)?n.some(s=>Ue(s)===i):Object.keys(n).some(s=>Ue(s)===i)}const Ir=new WeakMap,$r=new WeakMap,Jn=Symbol("_moveCb"),no=Symbol("_enterCb"),zd=e=>(delete e.props.mode,e),Xd=zd({name:"TransitionGroup",props:he({},Rr,{tag:String,moveClass:String}),setup(e,{slots:t}){const n=vs(),i=zo();let s,o;return nr(()=>{if(!s.length)return;const r=e.moveClass||`${e.name||"v"}-move`;if(!t_(s[0].el,n.vnode.el,r)){s=[];return}s.forEach(Zd),s.forEach(Qd);const c=s.filter(e_);qi(n.vnode.el),c.forEach(a=>{const p=a.el,l=p.style;Xe(p,r),l.transform=l.webkitTransform=l.transitionDuration="";const _=p[Jn]=T=>{T&&T.target!==p||(!T||T.propertyName.endsWith("transform"))&&(p.removeEventListener("transitionend",_),p[Jn]=null,ht(p,r))};p.addEventListener("transitionend",_)}),s=[]}),()=>{const r=z(e),c=Sr(r);let a=r.tag||ve;if(s=[],o)for(let p=0;p<o.length;p++){const l=o[p];l.el&&l.el instanceof Element&&!l.el[Cr]&&(s.push(l),Mt(l,vn(l,c,i,n)),Ir.set(l,Mr(l.el)))}o=t.default?fs(t.default()):[];for(let p=0;p<o.length;p++){const l=o[p];l.key!=null&&Mt(l,vn(l,c,i,n))}return ke(a,null,o)}}}),Jd=Xd;function Zd(e){const t=e.el;t[Jn]&&t[Jn](),t[no]&&t[no]()}function Qd(e){$r.set(e,Mr(e.el))}function e_(e){const t=Ir.get(e),n=$r.get(e),i=t.left-n.left,s=t.top-n.top;if(i||s){const o=e.el,r=o.style,c=o.getBoundingClientRect();let a=1,p=1;return o.offsetWidth&&(a=c.width/o.offsetWidth),o.offsetHeight&&(p=c.height/o.offsetHeight),(!Number.isFinite(a)||a===0)&&(a=1),(!Number.isFinite(p)||p===0)&&(p=1),Math.abs(a-1)<.01&&(a=1),Math.abs(p-1)<.01&&(p=1),r.transform=r.webkitTransform=`translate(${i/a}px,${s/p}px)`,r.transitionDuration="0s",e}}function Mr(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function t_(e,t,n){const i=e.cloneNode(),s=e[Jt];s&&s.forEach(c=>{c.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(c=>c&&i.classList.add(c)),i.style.display="none";const o=t.nodeType===1?t:t.parentNode;o.appendChild(i);const{hasTransform:r}=Er(i);return o.removeChild(i),r}const io=e=>{const t=e.props["onUpdate:modelValue"]||!1;return H(t)?n=>Nn(t,n):t};function n_(e){e.target.composing=!0}function so(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const $n=Symbol("_assign"),Mn=Symbol("_initialValue");function Ci(e,t,n){return t&&(e=e.trim()),n&&(e=ns(e)),e}const i_={created(e,{modifiers:{lazy:t,trim:n,number:i}},s){e.parentNode&&(e.type==="text"?e[Mn]=e.defaultValue.replace(/[\r\n]/g,""):e.type==="textarea"&&(e[Mn]=e.defaultValue.replace(/\r\n?/g,`
`))),e[$n]=io(s);const o=i||s.props&&s.props.type==="number";Vt(e,t?"change":"input",r=>{r.target.composing||e[$n](Ci(e.value,n,o))}),(n||o)&&Vt(e,"change",()=>{e.value=Ci(e.value,n,o)}),t||(Vt(e,"compositionstart",n_),Vt(e,"compositionend",so),Vt(e,"change",so))},mounted(e,{value:t,modifiers:{trim:n,number:i}}){const s=t??"",o=e[Mn];delete e[Mn],o!==void 0&&(e.type==="text"||e.type==="textarea")&&e.value!==o?e[$n](Ci(e.value,n,i)):e.value=s},beforeUpdate(e,{value:t,oldValue:n,modifiers:{lazy:i,trim:s,number:o}},r){if(e[$n]=io(r),e.composing)return;const c=(o||e.type==="number")&&!/^0\d/.test(e.value)?ns(e.value):e.value,a=t??"";if(c===a)return;const p=e.getRootNode();(p instanceof Document||p instanceof ShadowRoot)&&p.activeElement===e&&e.type!=="range"&&(i&&t===n||s&&e.value.trim()===a)||(e.value=a)}},s_=["ctrl","shift","alt","meta"],o_={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>s_.some(n=>e[`${n}Key`]&&!t.includes(n))},je=(e,t)=>{if(!e)return e;const n=e._withMods||(e._withMods={}),i=t.join(".");return n[i]||(n[i]=(s,...o)=>{for(let r=0;r<t.length;r++){const c=o_[t[r]];if(c&&c(s,t))return}return e(s,...o)})},r_=he({patchProp:Kd},Pd);let oo;function c_(){return oo||(oo=cd(r_))}const a_=(...e)=>{const t=c_().createApp(...e),{mount:n}=t;return t.mount=i=>{const s=p_(i);if(!s)return;const o=t._component;!j(o)&&!o.render&&!o.template&&(o.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const r=n(s,!1,l_(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),r},t};function l_(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function p_(e){return pe(e)?document.querySelector(e):e}const yn={MIN:0,MAX:100},_n={BASE_DECAY:3,PRESSURE_COEF:2,RECORDER_RELIEF:3,INITIATIVE_COST_BASE:1,INITIATIVE_COST_STEP:1},Hn={T1:50,T2:30,T3:15},ro={DEFAULT:8,PANIC:4},Wi={DESTROY_EVIDENCE_CAP:-20,HUSH_MONEY_EVIDENCE_CAP:30},Ii={PLAYBOOK_EVIDENCE:5,NOTARY_RISK:-5,CALM_BREATH_COMPOSURE:30};function Nr(e){return Math.min(yn.MAX,Math.max(yn.MIN,e))}function hs(e){return{...e,flags:new Set(e.flags),items:new Set(e.items)}}function u_(e,t,n,i){let s=n;return t.items.has("item_calm_breathing")&&e.tag==="BREATH"&&(s={...s,composure:Ii.CALM_BREATH_COMPOSURE}),t.items.has("item_hr_playbook")&&i===3&&e.initiative===3&&(s={...s,evidence:(s.evidence??0)+Ii.PLAYBOOK_EVIDENCE}),t.items.has("item_notary_habit")&&i===4&&e.initiative===3&&(s={...s,risk:(s.risk??0)+Ii.NOTARY_RISK}),s}function d_(e){return e.tag==="PHYSICAL"?{forcedEnding:e.next}:null}function __(e,t){switch(t){case"G_NEG_DESTROYED_EVIDENCE":e.evidenceCap=yn.MAX+Wi.DESTROY_EVIDENCE_CAP;break;case"G_NEG_HUSH_MONEY":e.evidence=Math.min(e.evidence,Wi.HUSH_MONEY_EVIDENCE_CAP);break}}function co(e,t,n=1,i=0){const s=hs(e),o=u_(t,s,t.effects??{},n),r=["evidence","opinion","composure","risk"];for(const c of r){const a=o[c];a!==void 0&&(s[c]+=a)}if(t.initiative>=2&&t.tag!=="BREATH"){const c=(t.initiative-1)*(_n.INITIATIVE_COST_BASE+_n.INITIATIVE_COST_STEP*Math.floor(i/2));s.composure-=c}s.evidence>s.evidenceCap&&(s.evidence=s.evidenceCap);for(const c of r)s[c]=Nr(s[c]);for(const c of o.addFlags??[])s.flags.add(c),__(s,c);for(const c of o.removeFlags??[])s.flags.delete(c);for(const c of o.addItems??[])s.items.add(c);return s.turn+=1,s}function f_(e,t){const n=hs(e),i=_n.BASE_DECAY+t.pressure*_n.PRESSURE_COEF,s=n.items.has("item_recorder")?_n.RECORDER_RELIEF:0;return n.composure=Nr(n.composure-i+s),n}class de extends Error{constructor(t){super(t),this.name="ContentError"}}function Dr(e,t){return{evidence:e.evidence,opinion:e.opinion,composure:e.composure,risk:e.risk,dEvidence:e.evidence-t.evidence,dOpinion:e.opinion-t.opinion,dComposure:e.composure-t.composure,dRisk:e.risk-t.risk,flags:e.flags,items:e.items,turn:e.turn}}const g_=new Set(["evidence","opinion","composure","risk","dEvidence","dOpinion","dComposure","dRisk","turn"]);function m_(e){const t=[];let n=0;for(;n<e.length;){const i=e[n];if(i===" "||i==="	"||i===`
`||i==="\r"){n+=1;continue}if(i>="0"&&i<="9"){let r=n;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:Number(e.slice(n,r))}),n=r;continue}if(/[A-Za-z_]/.test(i)){let r=n;for(;r<e.length&&/[A-Za-z0-9_]/.test(e[r]);)r+=1;t.push({t:"id",v:e.slice(n,r)}),n=r;continue}if(i==="'"||i==='"'){let r=n+1;for(;r<e.length&&e[r]!==i;)r+=1;if(r>=e.length)throw new de(`unterminated string in condition: ${e}`);t.push({t:"str",v:e.slice(n+1,r)}),n=r+1;continue}const s=e.slice(n,n+2);if(s==="&&"||s==="||"||s===">="||s==="<="||s==="=="||s==="!="){t.push({t:"op",v:s}),n+=2;continue}const o=e[n+1];if(i==="-"&&o!==void 0&&o>="0"&&o<="9"&&(t.length===0||t[t.length-1].t==="op")){let r=n+1;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:-Number(e.slice(n+1,r))}),n=r;continue}if(i===">"||i==="<"||i==="!"||i==="("||i===")"){t.push({t:"op",v:i}),n+=1;continue}throw new de(`illegal character '${i}' in condition: ${e}`)}return t}class v_{constructor(t){xe(this,"pos",0);this.tokens=t}peek(){return this.tokens[this.pos]}next(){const t=this.tokens[this.pos];if(t===void 0)throw new de("unexpected end of condition");return this.pos+=1,t}eatOp(t){const n=this.next();if(n.t!=="op"||n.v!==t)throw new de(`expected '${t}', got '${n.t==="op"?n.v:n.t}'`)}parse(){const t=this.parseOr();if(this.pos!==this.tokens.length){const n=this.peek();throw new de(`unexpected trailing token '${n?n.t==="op"?n.v:n.t:"?"}'`)}return t}parseOr(){let t=this.parseAnd();for(;this.matchOp("||");)t={kind:"binary",op:"||",left:t,right:this.parseAnd()};return t}parseAnd(){let t=this.parseCompare();for(;this.matchOp("&&");)t={kind:"binary",op:"&&",left:t,right:this.parseCompare()};return t}parseCompare(){const t=this.parseUnary(),n=this.peek();return n!==void 0&&n.t==="op"&&[">=",">","<=","<","==","!="].includes(n.v)?(this.pos+=1,{kind:"compare",op:n.v,left:t,right:this.parseUnary()}):t}parseUnary(){return this.matchOp("!")?{kind:"unary",op:"!",operand:this.parseUnary()}:this.parseAtom()}parseAtom(){const t=this.next();if(t.t==="num")return{kind:"num",value:t.v};if(t.t==="str")throw new de("string literal only allowed as function argument");if(t.t==="op"&&t.v==="("){const n=this.parseOr();return this.eatOp(")"),n}if(t.t==="id"){if(t.v==="has"||t.v==="hasItem"){this.eatOp("(");const n=this.next();if(n.t!=="str")throw new de(`'${t.v}' expects a quoted string argument`);return this.eatOp(")"),{kind:"call",fn:t.v,arg:n.v}}if(!g_.has(t.v))throw new de(`unknown identifier '${t.v}' in condition`);return{kind:"var",name:t.v}}throw new de(`unexpected operator '${t.v}' in condition`)}matchOp(t){const n=this.peek();return n!==void 0&&n.t==="op"&&n.v===t?(this.pos+=1,!0):!1}}const ao=new Map;function h_(e){const t=ao.get(e);if(t!==void 0)return t;const n=new v_(m_(e)).parse();return ao.set(e,n),n}function Yt(e,t){switch(e.kind){case"num":return e.value!==0;case"var":return Fr(e.name,t)!==0;case"call":return e.fn==="has"?t.flags.has(e.arg):t.items.has(e.arg);case"unary":return!Yt(e.operand,t);case"binary":return e.op==="&&"?Yt(e.left,t)&&Yt(e.right,t):Yt(e.left,t)||Yt(e.right,t);case"compare":{const n=lo(e.left,t),i=lo(e.right,t);switch(e.op){case">=":return n>=i;case">":return n>i;case"<=":return n<=i;case"<":return n<i;case"==":return n===i;case"!=":return n!==i}}}}function lo(e,t){if(e.kind==="num")return e.value;if(e.kind==="var")return Fr(e.name,t);throw new de("comparison operands must be numbers")}function Fr(e,t){switch(e){case"evidence":return t.evidence;case"opinion":return t.opinion;case"composure":return t.composure;case"risk":return t.risk;case"dEvidence":return t.dEvidence;case"dOpinion":return t.dOpinion;case"dComposure":return t.dComposure;case"dRisk":return t.dRisk;case"turn":return t.turn;default:throw new de(`unknown identifier '${e}'`)}}function Br(e,t){return e.trim()==="true"?!0:Yt(h_(e),t)}function x_(e){return e<Hn.T3||e<Hn.T2?2:e<Hn.T1?1:0}function k_(e,t){const n=i=>{let s=0;const o=`${t}/${i}`;for(let r=0;r<o.length;r+=1)s=Math.imul(s,31)+o.charCodeAt(r)|0;return(s>>>1&2147483647)/2147483648};return[...e].sort((i,s)=>n(i.id)-n(s.id))}function po(e,t,n=new Set){const i=e.options.filter(c=>c.oncePerNode===!0&&n.has(c.id)?!1:c.requires===void 0?!0:Br(c.requires,Dr(t,y_))),s=x_(t.composure),r=e.impulsePool.filter(c=>t.composure<c.unlockBelow).slice(0,s);return k_([...i,...r],e.id)}const y_={evidence:0,opinion:0,composure:0,risk:0};function T_(e,t){return t.composure<Hn.T3?ro.PANIC:e.timer??ro.DEFAULT}function b_(e,t,n){if(t.flags.has("FORCED_F")){const s=e.endings.find(o=>o.condition==="FORCED");if(s===void 0)throw new de(`level ${e.id} has FORCED_F state but no FORCED ending`);return s}const i=Dr(t,n);for(const s of e.endings)if(s.condition!=="FORCED"&&Br(s.condition,i))return s;throw new de(`level ${e.id}: no ending condition matched (missing 'true' fallback?)`)}const A_="__END__";function $i(e){return e.type==="choice"}class xs{constructor(t,n){xe(this,"nodeMap");xe(this,"endingMap");xe(this,"initMeter");xe(this,"current");xe(this,"currentNodeId");xe(this,"usedThisVisit",new Set);this.level=t,this.nodeMap=new Map(t.nodes.map(i=>[i.id,i])),this.endingMap=new Map(t.endings.map(i=>[i.id,i])),this.initMeter=t.initState,this.current=this.buildInitialState(n),this.currentNodeId=t.entryNode}buildInitialState(t){const n=new Set([...t.flags].filter(o=>o.startsWith("G_"))),i=n.has("G_NEG_DESTROYED_EVIDENCE")?yn.MAX+Wi.DESTROY_EVIDENCE_CAP:yn.MAX,s=n.has("G_NEG_ASSAULT")?15:0;return{evidence:this.level.initState.evidence,opinion:this.level.initState.opinion,composure:this.level.initState.composure,risk:this.level.initState.risk+s,flags:n,items:new Set(t.items),turn:0,evidenceCap:i}}get state(){return this.current}start(){return this.advanceFrom(this.currentNodeId)}choose(t){const n=this.getNode(this.currentNodeId);if(!$i(n))throw new de(`choose() called on non-choice node ${n.id} in level ${this.level.id}`);const s=po(n,this.current,this.usedThisVisit).find(o=>o.id===t);if(s===void 0)throw new de(`option '${t}' not available at node ${n.id} (level ${this.level.id})`);return this.applyChoice(n,s)}timeout(){const t=this.getNode(this.currentNodeId);if(!$i(t))throw new de(`timeout() called on non-choice node ${t.id} in level ${this.level.id}`);const n=t.options.find(i=>i.id===t.timeoutOption);if(n===void 0)throw new de(`timeoutOption '${t.timeoutOption}' not found in node ${t.id}`);return this.applyChoice(t,n)}getNode(t){const n=this.nodeMap.get(t);if(n===void 0)throw new de(`node not found: ${t} (level ${this.level.id})`);return n}applyChoice(t,n){const i=d_(n);return i!==null?(this.current=co(this.current,n,this.level.act,t.pressure),this.current.flags.add("FORCED_F"),this.current.flags.add("G_NEG_ASSAULT"),this.finishWith(i.forcedEnding)):(n.oncePerNode===!0&&this.usedThisVisit.add(n.id),this.current=co(this.current,n,this.level.act,t.pressure),this.current=f_(this.current,t),this.advanceFrom(n.next))}advanceFrom(t){if(t===A_)return this.finishWith(null);let n=t;for(let i=0;i<L_;i+=1){const s=this.endingMap.get(n);if(s!==void 0)return this.finishWith(s.id);const o=this.getNode(n);return $i(o)?(n!==this.currentNodeId&&(this.usedThisVisit=new Set),this.currentNodeId=o.id,{type:"options",options:po(o,this.current,this.usedThisVisit),timer:T_(o,this.current),timeoutOptionId:o.timeoutOption,prompt:o.prompt,pressure:o.pressure,nodeId:o.id}):(this.currentNodeId=o.id,{type:"node",node:o})}throw new de(`node chain too deep at ${n} (level ${this.level.id})`)}proceed(){const t=this.getNode(this.currentNodeId);if(t.next===void 0)throw new de(`node ${t.id} has no next (level ${this.level.id})`);return this.advanceFrom(t.next)}finishWith(t){const n=t!==null?this.endingMap.get(t):void 0;if(t!==null&&n===void 0)throw new de(`ending not found: ${t} (level ${this.level.id})`);const i=hs(this.current);return{type:"ending",ending:n!==void 0?n:b_(this.level,this.current,this.initMeter),state:i}}static simulate(t,n,i){const s=new xs(t,n);let o=s.start(),r=0;for(;;){if(o.type==="ending")return{rank:o.ending.rank,state:o.state};if(o.type==="node"){o=s.proceed();continue}if(o.type==="options"){const c=i[r];if(r+=1,c===void 0)throw new de(`simulate path exhausted at node in level ${t.id}`);o=s.choose(c);continue}}}}const L_=200,Hr="poju_shilu_save_v1";function zi(){return{version:1,flags:[],items:[],levelResults:{},cards:[],settings:{mode:"NORMAL",sound:!0}}}const Zn=globalThis.localStorage,Gr=typeof Zn<"u"&&Zn!==null;function w_(){if(!Gr)return zi();const e=Zn.getItem(Hr);return e===null?zi():JSON.parse(e)}function P_(e){Gr&&Zn.setItem(Hr,JSON.stringify(e))}const O_={L01:{flag:"G_EV_SUBWAY",minRank:["S","A"]},L02:{flag:"G_EV_ELEVATOR",minRank:["S","A"]},L03:{flag:"G_EV_MALL",minRank:["S","A"]},L04:{flag:"G_EV_NIGHTWALK",minRank:["S","A"]},L05:{flag:"G_EV_GYM",minRank:["S","A"]},L06:{flag:"G_EV_BETROTHAL",minRank:["S","A"]},L07:{flag:"G_EV_TRANSFER",minRank:["S","A"]},L08:{flag:"G_EV_PATERNITY",minRank:["S","A"]},L09:{flag:"G_EV_PRESERVATION",minRank:["S","A"]},L10:{flag:"G_EV_PROTECTION_ORDER",minRank:["S","A"]},L11:{flag:"G_EV_HR_WRITTEN",minRank:["S","A"]},L12:{flag:"G_EV_EMAIL_CHAIN",minRank:["S","A"]},L13:{flag:"G_EV_FULL_AUDIO",minRank:["S","A"]},L14:{flag:"G_EV_SUSPENSION",minRank:["S","A"]},L15:{flag:"G_EV_EXTORTION",minRank:["S","A"]},L16:{flag:"G_EV_ORIGINAL_CLIP",minRank:["S","A"]},L17:{flag:"G_EV_DOXX_NOTARY",minRank:["S","A"]},L18:{flag:"G_EV_LIVE_RECORD",minRank:["S","A"]},L19:{flag:"G_EV_PLATFORM",minRank:["S","A"]}},R_={L02:"G_NEG_DESTROYED_EVIDENCE",L07:"G_NEG_HUSH_MONEY",L10:"L10_VIOLATED",L13:"G_NEG_APOLOGY_LETTER",L17:"G_NEG_DOXXED_BACK"};function S_(e,t){switch(e){case"L01":return t==="S"||t==="A"?["item_recorder"]:[];case"L02":return["item_shen_card"];case"L08":return t==="S"?["item_calm_breathing"]:[];case"L11":return t==="S"||t==="A"?["item_hr_playbook"]:[];case"L16":return t==="S"||t==="A"?["item_notary_habit"]:[];default:return[]}}function E_(e,t,n,i,s){const o={...e,flags:[...e.flags],items:[...e.items],levelResults:{...e.levelResults},cards:[...e.cards]},r=new Set(o.flags);for(const _ of i.flags)_.startsWith("G_")&&r.add(_);const c=O_[t];if(c!==void 0&&c.minRank.includes(n.rank)){const _=R_[t];_!==void 0&&(r.has(_)||i.flags.has(_))||r.add(c.flag)}const a=S_(t,n.rank),p=new Set(o.items);for(const _ of a)p.add(_);n.unlock!==void 0&&!o.cards.includes(n.unlock)&&o.cards.push(n.unlock);const l=s==null?void 0:s.now;return o.levelResults[t]={rank:n.rank,endingId:n.id,ts:l},o.flags=[...r].filter(_=>_.startsWith("G_")),o.items=[...p],o}const jr="L01",Ur="第01关 · 地铁三分钟",Vr=1,Yr={evidence:20,opinion:50,composure:80,risk:10},Kr=["hero","npc_l01_woman","crowd","officer_lin"],qr="n_01",Wr="card_law_L01",zr=["T1","T2"],Xr=[{id:"n_01",type:"cutscene",pressure:1,script:`三点十四分，三号线。车厢是满的，不算挤。
列车进站前一次急刹，所有人往前倾了半步。
...
视频当晚就上了热搜第七。
标题里有你公司的名字。`}],C_={id:jr,title:Ur,act:Vr,initState:Yr,cast:Kr,entryNode:qr,lawyerCard:Wr,satireTargets:zr,nodes:Xr,endings:Jr},I_=Object.freeze(Object.defineProperty({__proto__:null,act:Vr,cast:Kr,default:C_,endings:Jr,entryNode:qr,id:jr,initState:Yr,lawyerCard:Wr,nodes:Xr,satireTargets:zr,title:Ur},Symbol.toStringTag,{value:"Module"})),Zr="L02",Qr="第02关 · 电梯里的镜头",ec=1,tc={evidence:25,opinion:45,composure:75,risk:10},nc=["hero","npc_l02_woman","crowd","shen_li","officer_lin"],ic="n_01",sc="card_law_L02",oc=["T1","T2"],rc=[{id:"n_01",type:"cutscene",pressure:1,script:`写字楼，十八层下行。
...
「有家长在群里传了个视频。」老师说得很委婉。`,unlock:"card_L03_F"}],N_={id:ac,title:lc,act:pc,initState:uc,cast:dc,entryNode:_c,lawyerCard:fc,satireTargets:gc,nodes:mc,endings:vc},D_=Object.freeze(Object.defineProperty({__proto__:null,act:pc,cast:dc,default:N_,endings:vc,entryNode:_c,id:ac,initState:uc,lawyerCard:fc,nodes:mc,satireTargets:gc,title:lc},Symbol.toStringTag,{value:"Module"})),hc="L04",xc="第04关 · 深夜同行",kc=1,yc={evidence:20,opinion:35,composure:55,risk:35},Tc=["hero","npc_l04_woman","officer_lin","crowd"],bc="n_01",Ac="card_law_L04",Lc=["T1","T3"],wc=[{id:"n_01",type:"cutscene",pressure:1,script:`十一点四十，出地铁 C 口。加了四个小时班，你只想快点到家。
...
后面那个问题，你答不上来。
因为真实答案是：我怕。
而「我怕」这三个字，在笔录里从来不是一个能用的理由。`,unlock:"card_L04_F"}],F_={id:hc,title:xc,act:kc,initState:yc,cast:Tc,entryNode:bc,lawyerCard:Ac,satireTargets:Lc,nodes:wc,endings:Pc},B_=Object.freeze(Object.defineProperty({__proto__:null,act:kc,cast:Tc,default:F_,endings:Pc,entryNode:bc,id:hc,initState:yc,lawyerCard:Ac,nodes:wc,satireTargets:Lc,title:xc},Symbol.toStringTag,{value:"Module"})),Oc="L05",Rc="第05关 · 托杠铃的那一下",Sc=1,Ec={evidence:20,opinion:30,composure:50,risk:40},Cc=["hero","npc_l05_woman","npc_l05_manager","npc_l05_witness","crowd"],Ic="n_01",$c="card_law_L05",Mc=["T1","T5"],Nc=[{id:"n_01",type:"cutscene",pressure:1,script:`自由重量区，晚上八点半。
...
器械区有七八个人。所有人都看见了。
没有人过去。`,next:"__END__"}],Dc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那一巴掌",script:`手机摔在地胶上，屏幕裂成蛛网。
...
「情况属实」四个字指的是撒谎，不是别的。
但没人会去分辨这个。`,unlock:"card_L05_F"}],H_={id:Oc,title:Rc,act:Sc,initState:Ec,cast:Cc,entryNode:Ic,lawyerCard:$c,satireTargets:Mc,nodes:Nc,endings:Dc},G_=Object.freeze(Object.defineProperty({__proto__:null,act:Sc,cast:Cc,default:H_,endings:Dc,entryNode:Ic,id:Oc,initState:Ec,lawyerCard:$c,nodes:Nc,satireTargets:Mc,title:Rc},Symbol.toStringTag,{value:"Module"})),Fc="L06",Bc="第06关 · 三十八万八",Hc=2,Gc={evidence:30,opinion:50,composure:48,risk:20},jc=["hero","npc_l06_girlfriend","npc_l06_mother","crowd"],Uc="n_01",Vc="card_law_L06",Yc=["T1","T3"],Kc=[{id:"n_01",type:"cutscene",pressure:1,script:`女方家客厅。茶几上摆着切好的果盘，没人动。
...
你说，先用便宜的吧。`,unlock:"card_L06_F"}],j_={id:Fc,title:Bc,act:Hc,initState:Gc,cast:jc,entryNode:Uc,lawyerCard:Vc,satireTargets:Yc,nodes:Kc,endings:qc},U_=Object.freeze(Object.defineProperty({__proto__:null,act:Hc,cast:jc,default:j_,endings:qc,entryNode:Uc,id:Fc,initState:Gc,lawyerCard:Vc,nodes:Kc,satireTargets:Yc,title:Bc},Symbol.toStringTag,{value:"Module"})),Wc="L07",zc="第07关 · 青春损失费",Xc=2,Jc={evidence:35,opinion:45,composure:45,risk:30},Zc=["hero","npc_l07_ex","shen_li"],Qc="n_01",ea="card_law_L07",ta=["T1","T4"],na=[{id:"n_01",type:"cutscene",pressure:1,script:`分手第九天。她约你在常去的那家咖啡馆。
...
她那句「这三十天，咱们都别为难对方」——
你后来想了很久。她说的是真心话。
她只是没打算把「为难」这两个字算在自己头上。`,next:"__END__"}],ba=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 玄关那一下",script:`抢行李箱的时候她摔在鞋柜上，手腕骨裂。
...
她名下有八十万。你名下有两万四。`,unlock:"card_L09_F"}],W_={id:fa,title:ga,act:ma,initState:va,cast:ha,entryNode:xa,lawyerCard:ka,satireTargets:ya,nodes:Ta,endings:ba},z_=Object.freeze(Object.defineProperty({__proto__:null,act:ma,cast:ha,default:W_,endings:ba,entryNode:xa,id:fa,initState:va,lawyerCard:ka,nodes:Ta,satireTargets:ya,title:ga},Symbol.toStringTag,{value:"Module"})),Aa="L10",La="第10关 · 二十米",wa=2,Pa={evidence:30,opinion:35,composure:38,risk:45},Oa=["hero","npc_l10_exwife","npc_l10_child","npc_l10_teacher","shen_li"],Ra="n_01",Sa="card_law_L10",Ea=["T1","T2"],Ca=[{id:"n_01",type:"cutscene",pressure:2,script:`抚养费返还的判决生效了。执行立案的第三天，
法院的人把另一份裁定书送到了公司前台。
...
她顿了一下。
「但你自己得记着。」`,next:"__END__"}],Ia=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那扇门",script:`凌晨两点，你砸开了那扇门。
...
沈骊后来只说了一句：「我知道你忍不住。」
「可法律不看你忍不忍得住，只看你忍没忍住。」`,unlock:"card_L10_F"}],X_={id:Aa,title:La,act:wa,initState:Pa,cast:Oa,entryNode:Ra,lawyerCard:Sa,satireTargets:Ea,nodes:Ca,endings:Ia},J_=Object.freeze(Object.defineProperty({__proto__:null,act:wa,cast:Oa,default:X_,endings:Ia,entryNode:Ra,id:Aa,initState:Pa,lawyerCard:Sa,nodes:Ca,satireTargets:Ea,title:La},Symbol.toStringTag,{value:"Module"})),$a="L11",Ma="第11关 · 面试第七问",Na=3,Da={evidence:20,opinion:40,composure:45,risk:20},Fa=["hero","npc_l11_hr","shen_li"],Ba="n_01",Ha="card_law_L11",Ga=["T3","T5"],ja=[{id:"n_01",type:"cutscene",pressure:1,script:`终面，第四十分钟。前六个问题答得都不错。
...
猎头开始不接你电话。
这行就这么大。`,unlock:"card_L11_F"}],Z_={id:$a,title:Ma,act:Na,initState:Da,cast:Fa,entryNode:Ba,lawyerCard:Ha,satireTargets:Ga,nodes:ja,endings:Ua},Q_=Object.freeze(Object.defineProperty({__proto__:null,act:Na,cast:Fa,default:Z_,endings:Ua,entryNode:Ba,id:$a,initState:Da,lawyerCard:Ha,nodes:ja,satireTargets:Ga,title:Ma},Symbol.toStringTag,{value:"Module"})),Va="L12",Ya="第12关 · 署名顺序",Ka=3,qa={evidence:45,opinion:42,composure:42,risk:25},Wa=["hero","npc_l12_colleague","npc_l12_boss","zhou_you"],za="n_01",Xa="card_law_L12",Ja=["T1","T3"],Za=[{id:"n_01",type:"cutscene",pressure:1,script:`项目做了十一个月。方案是你出的，架构是你搭的，上线那周你在公司睡了四天。
...
那一百四十三条 commit 记录，到最后也没人问起过。`,unlock:"card_L12_F"}],ef={id:Va,title:Ya,act:Ka,initState:qa,cast:Wa,entryNode:za,lawyerCard:Xa,satireTargets:Ja,nodes:Za,endings:Qa},tf=Object.freeze(Object.defineProperty({__proto__:null,act:Ka,cast:Wa,default:ef,endings:Qa,entryNode:za,id:Va,initState:qa,lawyerCard:Xa,nodes:Za,satireTargets:Ja,title:Ya},Symbol.toStringTag,{value:"Module"})),el="L13",tl="第13关 · 团建那句玩笑",nl=3,il={evidence:25,opinion:35,composure:36,risk:40},sl=["hero","npc_l13_hr","npc_l13_complainant","zhou_you","shen_li"],ol="n_01",rl="card_law_L13",cl=["T1","T5"],al=[{id:"n_01",type:"cutscene",pressure:1,script:`三周前，部门团建，KTV 包厢。
十一个人，两箱啤酒，唱到十一点半。
...
原来那封匿名信到最后也没查出是谁写的。
它不需要。它只需要你自己动起来。`,unlock:"card_L14_F"}],of={id:pl,title:ul,act:dl,initState:_l,cast:fl,entryNode:gl,lawyerCard:ml,satireTargets:vl,nodes:hl,endings:xl},rf=Object.freeze(Object.defineProperty({__proto__:null,act:dl,cast:fl,default:of,endings:xl,entryNode:gl,id:pl,initState:_l,lawyerCard:ml,nodes:hl,satireTargets:vl,title:ul},Symbol.toStringTag,{value:"Module"})),kl="L15",yl="第15关 · 最后一张牌",Tl=3,bl={evidence:40,opinion:40,composure:32,risk:50},Al=["hero","npc_l15_broker","npc_l15_hr","shen_li"],Ll="n_01",wl="card_law_L15",Pl=["T4"],Ol=[{id:"n_01",type:"cutscene",pressure:2,script:`裁员名单下来了，你在上面。
...
员工在离职期间将内部沟通录音公开传播。`,unlock:"card_L15_F"}],cf={id:kl,title:yl,act:Tl,initState:bl,cast:Al,entryNode:Ll,lawyerCard:wl,satireTargets:Pl,nodes:Ol,endings:Rl},af=Object.freeze(Object.defineProperty({__proto__:null,act:Tl,cast:Al,default:cf,endings:Rl,entryNode:Ll,id:kl,initState:bl,lawyerCard:wl,nodes:Ol,satireTargets:Pl,title:yl},Symbol.toStringTag,{value:"Module"})),Sl="L16",El="第16关 · 三十秒剪辑",Cl=4,Il={evidence:35,opinion:20,composure:40,risk:40},$l=["hero","npc_l16_account","shen_li","zhou_you","crowd"],Ml="n_01",Nl="card_law_L16",Dl=["T2","T4"],Fl=[{id:"n_01",type:"cutscene",pressure:3,script:`周一早上七点，你在地铁上刷到自己。
...
完整版你也发了。没人看。
因为你已经不是那个只有完整版的人了。`,unlock:"card_L16_F"}],lf={id:Sl,title:El,act:Cl,initState:Il,cast:$l,entryNode:Ml,lawyerCard:Nl,satireTargets:Dl,nodes:Fl,endings:Bl},pf=Object.freeze(Object.defineProperty({__proto__:null,act:Cl,cast:$l,default:lf,endings:Bl,entryNode:Ml,id:Sl,initState:Il,lawyerCard:Nl,nodes:Fl,satireTargets:Dl,title:El},Symbol.toStringTag,{value:"Module"})),Hl="L17",Gl="第17关 · 人肉",jl=4,Ul={evidence:40,opinion:10,composure:28,risk:45},Vl=["hero","npc_l17_father","npc_l17_hr","shen_li","crowd"],Yl="n_01",Kl="card_law_L17",ql=["T2","T4"],Wl=[{id:"n_01",type:"cutscene",pressure:4,script:`周四凌晨两点，一个文档在群里传开了。
...
从这一页开始，你们是同一类案由。`,unlock:"card_L17_F"}],uf={id:Hl,title:Gl,act:jl,initState:Ul,cast:Vl,entryNode:Yl,lawyerCard:Kl,satireTargets:ql,nodes:Wl,endings:zl},df=Object.freeze(Object.defineProperty({__proto__:null,act:jl,cast:Vl,default:uf,endings:zl,entryNode:Yl,id:Hl,initState:Ul,lawyerCard:Kl,nodes:Wl,satireTargets:ql,title:Gl},Symbol.toStringTag,{value:"Module"})),Xl="L18",Jl="第18关 · 直播间的生意",Zl=4,Ql={evidence:55,opinion:30,composure:38,risk:35},ep=["hero","npc_l18_streamer","shen_li","crowd"],tp="n_01",np="card_law_L18",ip=["T4"],sp=[{id:"n_01",type:"cutscene",pressure:2,script:`一个百万粉的账号发来连线邀请。
...
划掉了。`,unlock:"card_L20_F"}],vf={id:mp,title:vp,act:hp,initState:xp,cast:kp,entryNode:yp,lawyerCard:Tp,satireTargets:bp,nodes:Ap,endings:Lp},hf=Object.freeze(Object.defineProperty({__proto__:null,act:hp,cast:kp,default:vf,endings:Lp,entryNode:yp,id:mp,initState:xp,lawyerCard:Tp,nodes:Ap,satireTargets:bp,title:vp},Symbol.toStringTag,{value:"Module"})),xf=Object.assign({"../../content/levels/L01.json":I_,"../../content/levels/L02.json":M_,"../../content/levels/L03.json":D_,"../../content/levels/L04.json":B_,"../../content/levels/L05.json":G_,"../../content/levels/L06.json":U_,"../../content/levels/L07.json":Y_,"../../content/levels/L08.json":q_,"../../content/levels/L09.json":z_,"../../content/levels/L10.json":J_,"../../content/levels/L11.json":Q_,"../../content/levels/L12.json":tf,"../../content/levels/L13.json":sf,"../../content/levels/L14.json":rf,"../../content/levels/L15.json":af,"../../content/levels/L16.json":pf,"../../content/levels/L17.json":df,"../../content/levels/L18.json":ff,"../../content/levels/L19.json":mf,"../../content/levels/L20.json":hf}),Tn=Object.values(xf).map(e=>e.default).sort((e,t)=>e.id.localeCompare(t.id)),kf="破局实录",yf="开发预览 · M3 前置切片",Tf={evidence:"证据",opinion:"舆论",composure:"情绪",risk:"风险"},bf={hero:"陈屿",shen_li:"沈骊",officer_lin:"林昭",zhou_you:"周攸",he_song:"贺松",crowd:"围观者",narrator:"",npc_l01_woman:"红衣女子",npc_l02_woman:"住户女子",npc_l03_woman:"路人女子",npc_l03_daughter:"念念",npc_l04_woman:"报警人",npc_l05_woman:"女子",npc_l05_manager:"值班经理",npc_l05_witness:"目击大哥",npc_l06_girlfriend:"前女友",npc_l06_mother:"她母亲",npc_l07_ex:"前女友",npc_l08_wife:"妻子",npc_l08_mother:"岳母",npc_l08_child:"孩子",npc_l09_wife:"妻子",npc_l09_cousin:"表哥",npc_l10_exwife:"前妻",npc_l10_child:"女儿",npc_l10_teacher:"班主任",npc_l11_hr:"HR",npc_l12_colleague:"同事",npc_l12_boss:"部门老板",npc_l13_hr:"HR",npc_l13_complainant:"投诉人",npc_l14_hr:"HR 总监",npc_l14_director:"总监",npc_l15_broker:"中介",npc_l15_hr:"HR",npc_l16_account:"商务",npc_l17_father:"父亲",npc_l17_hr:"HR",npc_l18_streamer:"主播",npc_l19_moderator:"版务",npc_l19_pr:"公关",npc_l20_judge:"审判长",npc_l20_lawyer:"对方律师"},Af={1:"第一幕 · 流量即真相",2:"第二幕 · 亲密关系的账",3:"第三幕 · 职场的规则",4:"第四幕 · 收网"},Lf={tapToContinue:"点击继续",secondsUnit:"s",endingTitle:"结局",restart:"再玩一次",nextLevel:"下一关",levelSelect:"选择关卡",lockedLevel:"未解锁",rankNames:{S:"名场面",A:"稳住了",B:"有惊无险",C:"勉强收场",F:"翻车"},finalMeters:"最终仪表",disclaimer:"本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。",progressLabel:"进度",soundToggle:"M",studyIntro:"测试开始前\\n请输入现场编号（如 P01）\\n\\n然后独立游玩前五关\\n过程中不会有任何提示\\n做完自动出现数据回收",studyPidPlaceholder:"现场编号",studyStart:"开始",studyDoneTitle:"第一幕完成",studyCopy:"导出数据（JSON）",studySummaryHeader:"参与者 {p} · {n} 次游玩",studySummaryLine:"{lv}: {rank}「{title}」 用时{s}秒 抉择{c}次 重玩{r}",stanceLow:"稳住",stanceHigh:"顶回去",pileALabel:"这条",pileBLabel:"那条",pileListHint:"选一个",swipeHint:"左右滑动选择 · 点按也可以",settlePhase1:"结算中",settleStampS:"教科书式破局",settleStampA:"稳稳落地",settleStampB:"有惊无险",settleStampC:"伤敌自伤",settleStampF:"满盘皆输",settleMetersTitle:"终局面",settleReplay:"本关重打",settleNext:"下一关",lawyerCardTitle:"【沈骊说】案情法律与应对实务复盘",lawyerCardBadge:"核心普法",lawyerCardBtn:"查看沈律师专业点评与法条依据",lawyerModalHeader:"沈骊律师 · 案情实务备忘录",lawyerModalRisk:"合规风险等级",lawyerModalClose:"已掌握破局要点",appTagline:"你不需要嘴更毒，你只需要比对手更懂规则",startAdventure:"开始破局",continueAdventure:"继续破局",recapTitle:"关键因果复盘",costComposure:"耗心力",gainBreath:"平复呼吸",dangerImpulse:"冲动失控风险",containsOptions:"内含 {n} 项应对"},wf={L01:{label:"地铁三号线",hue:205,motif:"subway"},L02:{label:"住宅电梯",hue:220,motif:"elevator"},L03:{label:"商场中庭",hue:35,motif:"mall"},L04:{label:"深夜街道",hue:235,motif:"street"},L05:{label:"健身房",hue:15,motif:"gym"},L06:{label:"两家饭桌",hue:28,motif:"table"},L07:{label:"出租屋",hue:200,motif:"room"},L08:{label:"客厅",hue:40,motif:"room"},L09:{label:"民政局外",hue:210,motif:"office"},L10:{label:"学校门口",hue:45,motif:"street"},L11:{label:"面试间",hue:215,motif:"office"},L12:{label:"开放工位",hue:210,motif:"office"},L13:{label:"会议室",hue:220,motif:"office"},L14:{label:"总监办公室",hue:225,motif:"office"},L15:{label:"写字楼楼下",hue:200,motif:"street"},L16:{label:"剪辑室",hue:260,motif:"studio"},L17:{label:"家中",hue:30,motif:"room"},L18:{label:"直播间后台",hue:320,motif:"studio"},L19:{label:"平台工单页",hue:190,motif:"office"},L20:{label:"法院走廊",hue:210,motif:"court"}},Pf={calm:["前排","吃瓜","蹲后续","录下来了","别急，等反转","让子弹飞一会儿"],tense:["什么情况？?","有人认识吗","这女的厉害","这男的稳住啊","报警了吗","快报警","别拍了先帮个忙啊","主播别切","全网都在看"],hot:["热搜第一预定","已经录屏了","传到群里了","反转了反转了","坐等打脸","这瓜保熟","直播间炸了","三分钟了还在吵"]},Of={hero:210,shen_li:280,officer_lin:195,zhou_you:150,he_song:350,npc_l01_woman:350,npc_l02_woman:330,npc_l03_woman:320,npc_l03_daughter:45,npc_l04_woman:160,npc_l05_woman:340,npc_l05_manager:30,npc_l05_witness:200,npc_l06_girlfriend:315,npc_l06_mother:280,npc_l07_ex:300,npc_l08_wife:330,npc_l08_mother:275,npc_l08_child:50,npc_l09_wife:320,npc_l09_cousin:25,npc_l10_exwife:310,npc_l10_child:55,npc_l10_teacher:165,npc_l11_hr:220,npc_l12_colleague:145,npc_l12_boss:25,npc_l13_hr:215,npc_l13_complainant:345,npc_l14_hr:225,npc_l14_director:20,npc_l15_broker:40,npc_l15_hr:218,npc_l16_account:35,npc_l17_father:205,npc_l17_hr:222,npc_l18_streamer:325,npc_l19_moderator:195,npc_l19_pr:285,crowd:0},Rf={appTitle:kf,appSub:yf,meters:Tf,speakerNames:bf,actNames:Af,ui:Lf,scenes:wf,danmaku:Pf,speakerHues:Of},fe=Rf;function sn(e){const t=fe.ui[e];return typeof t=="string"?t:""}function Sf(e){return fe.speakerNames[e]??e}function Xi(e){return fe.speakerHues[e]??220}function wp(e){return fe.scenes[e]??{label:"",hue:210,motif:"room"}}const Ef={class:"hud"},Cf={class:"label"},If={class:"bar"},$f={class:"val-wrap"},Mf={class:"num"},Nf=gt({__name:"MeterHud",props:{state:{}},setup(e){const t=e;let n=0;const i=ae({evidence:null,opinion:null,composure:null,risk:null}),s={};Be(()=>({...t.state}),(r,c)=>{if(!c)return;const a=["evidence","opinion","composure","risk"];for(const p of a){const l=r[p]-c[p];if(l!==0){n+=1;const _=p==="risk"?l<0:l>0;i.value[p]={text:(l>0?"+":"")+l,dir:_?"pos":"neg",key:n},s[p]!==void 0&&clearTimeout(s[p]),s[p]=setTimeout(()=>{i.value[p]=null},1400)}}});const o=V(()=>[{k:"evidence",kind:"good"},{k:"opinion",kind:"good"},{k:"composure",kind:"good"},{k:"risk",kind:"bad"}].map(({k:c,kind:a})=>({key:c,label:fe.meters[c],value:t.state[c],kind:a})));return(r,c)=>(R(),C("div",Ef,[(R(!0),C(ve,null,kt(o.value,a=>(R(),C("div",{key:a.key,class:le(["meter",[a.key,a.kind,{"is-tense":a.key==="composure"&&a.value<30}]])},[m("span",Cf,O(a.label),1),m("div",If,[m("div",{class:"fill",style:He({width:Math.min(100,Math.max(0,a.value))+"%"})},null,4)]),m("div",$f,[m("span",Mf,O(a.value),1),ke(Rd,{name:"float"},{default:_s(()=>[i.value[a.key]?(R(),C("span",{key:i.value[a.key].key,class:le(["delta",i.value[a.key].dir])},O(i.value[a.key].text),3)):Q("",!0)]),_:2},1024)])],2))),128))]))}}),bt=(e,t)=>{const n=e.__vccOpts||e;for(const[i,s]of t)n[i]=s;return n},Df=bt(Nf,[["__scopeId","data-v-08cce053"]]),Ff={key:0,class:"name"},Bf={class:"text"},Hf={class:"cue"},Gf=gt({__name:"StoryBox",props:{speaker:{},text:{},kind:{}},emits:["advance"],setup(e,{emit:t}){const n=e,i=t,s=l=>l===void 0?"":fe.speakerNames[l]??l,o=l=>l===void 0?220:Xi(l),r=ae("");let c;function a(l){if(r.value="",c!==void 0&&clearInterval(c),typeof setInterval!="function"){r.value=l;return}let _=0;c=setInterval(()=>{_+=2,r.value=l.slice(0,_),_>=l.length&&c!==void 0&&(clearInterval(c),c=void 0)},28)}Be(()=>n.text,l=>a(l),{immediate:!0}),Nt(()=>{c!==void 0&&clearInterval(c)});function p(){r.value.length<n.text.length?(r.value=n.text,c!==void 0&&(clearInterval(c),c=void 0)):i("advance")}return(l,_)=>(R(),C("div",{class:le(["box",e.kind]),style:He({"--h":o(e.speaker)}),onClick:p},[e.kind==="dialogue"&&e.speaker?(R(),C("div",Ff,O(s(e.speaker)),1)):Q("",!0),m("p",Bf,O(r.value),1),m("div",Hf,O(w(fe).ui.tapToContinue),1)],6))}}),uo=bt(Gf,[["__scopeId","data-v-716d70d8"]]);function jf(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0}function Uf(e){let t=e>>>0;return()=>{t=t+1831565813|0;let n=Math.imul(t^t>>>15,1|t);return n=n+Math.imul(n^n>>>7,61|n)^n,((n^n>>>14)>>>0)/4294967296}}function Vf(e){const t=[...e],n=Uf(jf(t.map(i=>i.id).join("|")));for(let i=t.length-1;i>0;i--){const s=Math.floor(n()*(i+1)),o=t[i];t[i]=t[s],t[s]=o}return{left:t.filter((i,s)=>s%2===0),right:t.filter((i,s)=>s%2===1)}}const Yf={class:"swipe"},Kf={key:0,class:"scene-prompt"},qf={class:"duo"},Wf={class:"card-meta"},zf={key:0,class:"badge breath"},Xf={key:1,class:"badge cost"},Jf={key:2,class:"badge danger"},Zf={key:0,class:"stack-preview"},Qf={key:1,class:"more"},e0={class:"tip"},t0={class:"card-meta"},n0={key:0,class:"badge breath"},i0={key:1,class:"badge cost"},s0={key:2,class:"badge danger"},o0={key:0,class:"stack-preview"},r0={key:1,class:"more"},c0={class:"tip"},a0={class:"taps"},l0=["aria-label"],p0=["aria-label"],u0={key:2,class:"list"},d0={class:"list-head"},_0={class:"list-hint"},f0=["onClick"],g0={class:"row-header"},m0={class:"row-idx"},v0={class:"row-badges"},h0={key:0,class:"badge breath"},x0={key:1,class:"badge cost"},k0={key:2,class:"badge danger"},y0={key:3,class:"hint"},T0={key:4,class:"hint"},Mi=96,_o=10,Ni=380,b0=gt({__name:"SwipeChoice",props:{options:{},timer:{},timeoutOptionId:{},prompt:{default:""},pressure:{default:0}},emits:["choose"],setup(e,{expose:t,emit:n}){const i=e,s=n,o=V(()=>Vf(i.options)),r=V(()=>o.value.left),c=V(()=>o.value.right);t({leftStack:r,rightStack:c,pick:f=>N(f)});const a=ae(0),p=ae([]),l=ae("L"),_=V(()=>(l.value==="L"?r:c).value),T=V(()=>(l.value==="L"?c:r).value),L=V(()=>_.value[0]),M=V(()=>T.value[0]),b=V(()=>l.value==="L"?g:y),I=V(()=>l.value==="L"?y:g);function N(f){const k=(f==="L"?r:c).value;if(k.length===1&&k[0]!==void 0){s("choose",k[0].id);return}p.value=[...k],a.value=1}function F(f){s("choose",f.id)}function U(){a.value=0}function $(){ee.value||(l.value=l.value==="L"?"R":"L",P.value=0)}function Y(f){return!f||f.initiative<2||f.tag==="BREATH"?0:(f.initiative-1)*(1+Math.floor(i.pressure/2))}function ie(f){return(f==null?void 0:f.tag)==="BREATH"}function ue(f){return(f==null?void 0:f.tag)==="PHYSICAL"||(f==null?void 0:f.unlockBelow)!==void 0}const ge=ae(i.timer);let B=X();Be(()=>i.options,()=>{xi(),a.value=0,p.value=[],l.value="L",P.value=0,B!==void 0&&clearInterval(B),B=X(),ge.value=i.timer});function X(){if(typeof setInterval!="function")return;const f=setInterval(()=>{if(ge.value-=1,ge.value<=0){clearInterval(f),B===f&&(B=void 0);const k=i.options.find(A=>A.id===i.timeoutOptionId);k!==void 0&&s("choose",k.id)}},1e3);return f}Nt(()=>{xi(),B!==void 0&&clearInterval(B)});function re(f){if(!ee.value){if(a.value===0)f.key==="ArrowLeft"||f.key==="1"?Gt():f.key==="ArrowRight"||f.key==="2"?Zt():f.key==="Tab"&&(f.preventDefault(),$());else if(f.key==="Escape")U();else if(/^[1-9]$/.test(f.key)){const k=parseInt(f.key,10)-1;p.value[k]&&F(p.value[k])}}}pi(()=>{typeof window<"u"&&window.addEventListener("keydown",re)}),Nt(()=>{typeof window<"u"&&window.removeEventListener("keydown",re)});const P=ae(0),K=ae(!1),ee=ae(!1),Re=ae("");let _e=0,te=-1,W;const it=V(()=>{if(ee.value){const k=Re.value==="L"?-1:1;return`transform: translate(${k*640}px, ${k*60}px) rotate(${k*32}deg); opacity: 0; transition: transform ${Ni}ms cubic-bezier(.2,.7,.3,1), opacity ${Ni}ms;`}const f=Math.max(-_o,Math.min(_o,P.value/14));return`transform: translateX(${P.value}px) rotate(${f}deg);`}),Bt=V(()=>!K.value&&!ee.value),st=V(()=>K.value&&P.value<-Mi),$e=V(()=>K.value&&P.value>Mi);function Sn(f){return f instanceof Element&&f.closest(".tap, .lane.under, .list-btn")!==null}function vi(f){var k,A;a.value!==0||ee.value||Sn(f.target)||(K.value=!0,_e=f.clientX,P.value=0,te=f.pointerId,(A=(k=f.currentTarget).setPointerCapture)==null||A.call(k,f.pointerId))}function hi(f){!K.value||f.pointerId!==te||(P.value=f.clientX-_e)}function Lt(f){!K.value||f.pointerId!==te||(K.value=!1,Math.abs(P.value)>=Mi?ot(P.value<0?"L":"R"):P.value=0)}function Ht(f){!K.value||f.pointerId!==te||(K.value=!1,P.value=0)}function Gt(){a.value===0&&!ee.value&&ot("L")}function Zt(){a.value===0&&!ee.value&&ot("R")}function ot(f){ee.value||(ee.value=!0,Re.value=f,u(),W=window.setTimeout(()=>{W=void 0,ee.value=!1,Re.value="",P.value=0,N(f)},Ni))}function xi(){W!==void 0&&(clearTimeout(W),W=void 0),ee.value=!1,Re.value="",P.value=0}function u(){B!==void 0&&(clearInterval(B),B=void 0)}const d=fe.ui,g=d.pileALabel??"",y=d.pileBLabel??"",x=d.pileListHint??"",v=d.swipeHint??"";return(f,k)=>{var A,h;return R(),C("div",Yf,[e.prompt?(R(),C("p",Kf,O(e.prompt),1)):Q("",!0),m("div",{class:le(["timer",{panic:ge.value<=4}])},[m("span",null,O(ge.value),1)],2),a.value===0?(R(),C("div",{key:1,class:le(["stage",{settled:Bt.value}]),onPointerdown:vi,onPointermove:hi,onPointerup:Lt,onPointercancel:Ht},[m("div",qf,[m("div",{class:"lane under",onClick:k[0]||(k[0]=je(S=>$(),["stop"]))},[m("div",{class:le(["card under-card",{"is-danger":ue(M.value),"is-breath":ie(M.value)}])},[m("div",Wf,[ie(M.value)?(R(),C("span",zf,"🧘 "+O(w(d).gainBreath),1)):Y(M.value)>0?(R(),C("span",Xf,"⚡️ "+O(w(d).costComposure)+" "+O(Y(M.value)),1)):Q("",!0),ue(M.value)?(R(),C("span",Jf,"⚠️ "+O(w(d).dangerImpulse),1)):Q("",!0)]),m("p",null,O((A=M.value)==null?void 0:A.text),1),T.value.length>1?(R(),C("div",Zf,[(R(!0),C(ve,null,kt(T.value.slice(1),S=>(R(),C("span",{class:"sp-pill",key:S.id},O(S.text.length>12?S.text.slice(0,12)+"...":S.text),1))),128))])):Q("",!0),T.value.length>1?(R(),C("span",Qf,O(T.value.length),1)):Q("",!0)],2),m("div",e0,O(I.value),1)]),m("div",{class:"lane main",style:He(it.value)},[m("div",{class:le(["card main-card",{"is-danger":ue(L.value),"is-breath":ie(L.value)}])},[m("div",t0,[ie(L.value)?(R(),C("span",n0,"🧘 "+O(w(d).gainBreath),1)):Y(L.value)>0?(R(),C("span",i0,"⚡️ "+O(w(d).costComposure)+" "+O(Y(L.value)),1)):Q("",!0),ue(L.value)?(R(),C("span",s0,"⚠️ "+O(w(d).dangerImpulse),1)):Q("",!0)]),m("p",null,O((h=L.value)==null?void 0:h.text),1),_.value.length>1?(R(),C("div",o0,[(R(!0),C(ve,null,kt(_.value.slice(1),S=>(R(),C("span",{class:"sp-pill",key:S.id},O(S.text.length>12?S.text.slice(0,12)+"...":S.text),1))),128))])):Q("",!0),_.value.length>1?(R(),C("span",r0,O(_.value.length),1)):Q("",!0)],2),m("div",c0,O(b.value),1),m("div",{class:le(["stamp left",{on:st.value}])},"◀ "+O(w(g)),3),m("div",{class:le(["stamp right",{on:$e.value}])},O(w(y))+" ▶",3)],4)]),m("div",a0,[m("button",{class:"tap",onClick:je(Gt,["stop"]),"aria-label":w(g)},"◀",8,l0),m("button",{class:"tap swap",onClick:je($,["stop"]),"aria-label":"换一堆"},"⇄"),m("button",{class:"tap",onClick:je(Zt,["stop"]),"aria-label":w(y)},"▶",8,p0)])],34)):(R(),C("div",u0,[m("div",d0,[m("div",{class:"tip back",onClick:k[1]||(k[1]=S=>U())},"‹"),m("span",_0,O(w(x)),1)]),(R(!0),C(ve,null,kt(p.value,(S,E)=>(R(),C("div",{key:S.id,class:le(["row",{"row-danger":ue(S),"row-breath":ie(S)}]),onClick:D=>F(S)},[m("div",g0,[m("span",m0,O(E+1),1),m("div",v0,[ie(S)?(R(),C("span",h0,"🧘 "+O(w(d).gainBreath),1)):Y(S)>0?(R(),C("span",x0,"⚡️ "+O(w(d).costComposure)+" "+O(Y(S)),1)):Q("",!0),ue(S)?(R(),C("span",k0,"⚠️ "+O(w(d).dangerImpulse),1)):Q("",!0)])]),m("p",null,O(S.text),1)],10,f0))),128))])),a.value===0?(R(),C("div",y0,O(w(v)),1)):(R(),C("div",T0,O(w(x)),1))])}}}),A0=bt(b0,[["__scopeId","data-v-03bd3365"]]),L0=""+new URL("rank_A-Buk7knaJ.mp4",import.meta.url).href,w0=""+new URL("rank_B-MEHXL8TX.mp4",import.meta.url).href,P0=""+new URL("rank_C-DOkhQSQI.mp4",import.meta.url).href,O0=""+new URL("rank_F-DPh74h1I.mp4",import.meta.url).href,R0=""+new URL("rank_S-BXJbetyP.mp4",import.meta.url).href,S0=[{id:"card_law_L01",level:"L01",body:`【沈骊说】
...
（本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。）`,disclaimer:"ui.lawyer.disclaimer",riskLevel:"MAX",reviewStatus:"APPROVED",reviewedBy:"外部执业律师（所有者 2026-08-28 转达通过）",reviewedAt:"2026-08-28",citations:[]}],E0=["data-rank"],C0=["src"],I0={class:"stamp"},$0={class:"rk"},M0={class:"word"},N0={class:"title"},D0={class:"script"},F0={class:"lb-left"},B0={class:"lb-badge"},H0={class:"lb-title"},G0={class:"lb-btn"},j0={class:"meters-card"},U0={class:"mc-title"},V0={class:"bars"},Y0={class:"lbl"},K0={class:"track"},q0={class:"num"},W0={class:"disclaimer"},z0={class:"acts"},X0={class:"ld-head"},J0={class:"ld-title-group"},Z0={class:"ld-badge"},Q0={class:"ld-title"},eg={class:"ld-body"},tg={class:"ld-text"},ng={class:"ld-foot"},ig={class:"ld-risk"},sg={class:"ld-rk-lbl"},og=gt({__name:"EndingCard",props:{ending:{},state:{},levelId:{default:""}},emits:["restart","next"],setup(e,{emit:t}){const n=e,i=ae(1),s=ae(!1),o=ae(!1),r=fe.ui,c=V(()=>r["settleStamp"+n.ending.rank]??""),a=V(()=>{const I=Object.entries(Object.assign({"../../../content/art/endings/rank_A.mp4":L0,"../../../content/art/endings/rank_B.mp4":w0,"../../../content/art/endings/rank_C.mp4":P0,"../../../content/art/endings/rank_F.mp4":O0,"../../../content/art/endings/rank_S.mp4":R0})).find(([N])=>N.endsWith("/rank_"+n.ending.rank+".mp4"));return(I==null?void 0:I[1])??""}),p=V(()=>{const b=S0;if(n.levelId){const I=b.find(N=>N.level===n.levelId);if(I!==void 0)return I}return b.find(I=>n.ending.id.includes(I.level))??b[0]});let l,_;pi(()=>{if(typeof setTimeout!="function"){i.value=3;return}l=setTimeout(()=>{i.value=2},1200),_=setTimeout(()=>{i.value=3},2600)}),Nt(()=>{l!==void 0&&clearTimeout(l),_!==void 0&&clearTimeout(_)});function T(){l!==void 0&&(clearTimeout(l),l=void 0),_!==void 0&&(clearTimeout(_),_=void 0),i.value=3}function L(b){b.stopPropagation(),o.value=!0}function M(b){b.stopPropagation(),o.value=!1}return(b,I)=>(R(),C("div",{class:"cinema","data-rank":e.ending.rank,onClick:T},[a.value?(R(),C("video",{key:0,class:"bgvid",src:a.value,autoplay:"",muted:"",loop:"",playsinline:"",onCanplay:I[0]||(I[0]=N=>s.value=!0)},null,40,C0)):Q("",!0),m("div",{class:le(["dim",{deeper:i.value>=2}])},null,2),m("div",{class:le(["stamp-wrap",{show:i.value>=2}])},[m("div",I0,[m("span",$0,O(e.ending.rank),1),m("span",M0,O(c.value),1)])],2),m("div",{class:le(["sheet",{show:i.value>=3}])},[m("h2",N0,O(e.ending.title),1),m("p",D0,O(e.ending.script),1),p.value?(R(),C("div",{key:0,class:"lawyer-bar",onClick:je(L,["stop"])},[m("div",F0,[m("span",B0,O(w(r).lawyerCardBadge),1),m("span",H0,O(w(r).lawyerCardTitle),1)]),m("span",G0,[Ar(O(w(r).lawyerCardBtn)+" ",1),I[4]||(I[4]=m("i",{class:"arr"},"›",-1))])])):Q("",!0),m("div",j0,[m("div",U0,O(w(r).settleMetersTitle),1),m("div",V0,[(R(),C(ve,null,kt(["evidence","opinion","composure","risk"],N=>m("div",{key:N,class:"bar"},[m("span",Y0,O(w(fe).meters[N]),1),m("span",K0,[m("i",{style:He({width:Math.min(100,e.state[N])+"%"}),class:le(N)},null,6)]),m("span",q0,O(e.state[N]),1)])),64))])]),m("p",W0,O(w(fe).ui.disclaimer),1),m("div",z0,[m("button",{onClick:I[1]||(I[1]=je(N=>b.$emit("restart"),["stop"]))},O(w(r).settleReplay),1),m("button",{class:"primary",onClick:I[2]||(I[2]=je(N=>b.$emit("next"),["stop"]))},O(w(r).settleNext),1)])],2),o.value&&p.value?(R(),C("div",{key:1,class:"lawyer-mask",onClick:je(M,["stop"])},[m("div",{class:"lawyer-drawer",onClick:I[3]||(I[3]=je(()=>{},["stop"]))},[m("header",X0,[m("div",J0,[m("span",Z0,O(w(r).lawyerCardBadge),1),m("span",Q0,O(w(r).lawyerModalHeader),1)]),m("button",{class:"ld-close",onClick:je(M,["stop"])},"✕")]),m("div",eg,[m("div",tg,O(p.value.body),1)]),m("footer",ng,[m("div",ig,[m("span",sg,O(w(r).lawyerModalRisk)+":",1),m("span",{class:le(["ld-rk-val",p.value.riskLevel])},O(p.value.riskLevel??"MEDIUM"),3)]),m("button",{class:"ld-ok",onClick:je(M,["stop"])},O(w(r).lawyerModalClose),1)])])])):Q("",!0)],8,E0))}}),rg=bt(og,[["__scopeId","data-v-a7c7954c"]]),cg={class:"select"},ag={class:"sel-header"},lg={class:"header-top"},pg={class:"app-title"},ug={class:"tagline"},dg={class:"hero-cta-wrap"},_g={class:"cta-left"},fg={class:"cta-txt-group"},gg={class:"cta-action"},mg={class:"cta-sub"},vg={class:"list"},hg={key:0,class:"act-title"},xg={class:"act-levels"},kg=["onClick"],yg={class:"tid"},Tg={class:"ttitle"},bg={class:"foot"},Ag=gt({__name:"LevelSelect",props:{levels:{},best:{}},emits:["pick"],setup(e){const t=e,n=fe.ui,i=c=>c===void 0?"":"r"+c,s=V(()=>{var c;for(const a of t.levels)if(!t.best[a.id])return a.id;return((c=t.levels[0])==null?void 0:c.id)??"L01"}),o=V(()=>Object.keys(t.best).length>0),r=V(()=>{const c={};for(const a of t.levels)(c[a.act]??(c[a.act]=[])).push(a);return Object.entries(c).map(([a,p])=>({act:Number(a),name:fe.actNames[a]??"",levels:p}))});return(c,a)=>(R(),C("div",cg,[m("header",ag,[m("div",lg,[m("h1",pg,O(w(fe).appTitle),1),a[1]||(a[1]=m("span",{class:"version-tag"},"M3 切片",-1))]),m("p",ug,O(w(n).appTagline),1),m("div",dg,[m("button",{class:"hero-cta",onClick:a[0]||(a[0]=p=>c.$emit("pick",s.value))},[m("div",_g,[a[2]||(a[2]=m("span",{class:"play-btn"},"▶",-1)),m("div",fg,[m("span",gg,O(o.value?w(n).continueAdventure:w(n).startAdventure),1),m("span",mg,"进入 "+O(s.value),1)])]),a[3]||(a[3]=m("span",{class:"cta-arrow"},"›",-1))])])]),m("div",vg,[(R(!0),C(ve,null,kt(r.value,p=>(R(),C("div",{key:p.act,class:"act-section"},[p.name?(R(),C("div",hg,O(p.name),1)):Q("",!0),m("div",xg,[(R(!0),C(ve,null,kt(p.levels,l=>(R(),C("button",{key:l.id,class:"level-btn",onClick:_=>c.$emit("pick",l.id)},[m("span",yg,O(l.id),1),m("span",Tg,O(l.title),1),m("span",{class:le(["badge",i(e.best[l.id])])},O(e.best[l.id]??"·"),3)],8,kg))),128))])]))),128))]),m("footer",bg,O(w(fe).ui.disclaimer),1)]))}}),Lg=bt(Ag,[["__scopeId","data-v-e1c5f01f"]]),wg=""+new URL("L01-BJmHDizO.png",import.meta.url).href,Pg=""+new URL("L02-Cgrrfiit.png",import.meta.url).href,Og=""+new URL("L03-Dhb-92UY.png",import.meta.url).href,Rg=""+new URL("L04-Dxn6iz_R.png",import.meta.url).href,Sg=""+new URL("L05-BCX3gD5-.png",import.meta.url).href,Eg=""+new URL("L06-DPfiJfY4.png",import.meta.url).href,Cg=""+new URL("L07-DgpRWPjk.png",import.meta.url).href,Ig=""+new URL("L08-HGz_P2cJ.png",import.meta.url).href,$g=""+new URL("L09-VpgvEvrb.png",import.meta.url).href,Mg=""+new URL("L10-D_mOdB4H.png",import.meta.url).href,Ng=""+new URL("L11-BXLJJDeb.png",import.meta.url).href,Dg=""+new URL("L12-DemYAPsM.png",import.meta.url).href,Fg=""+new URL("L13-Dn-DLBYO.png",import.meta.url).href,Bg=""+new URL("L14-BLDD-heh.png",import.meta.url).href,Hg=""+new URL("L15-BVYsTDdi.png",import.meta.url).href,Gg=""+new URL("L16-kHk4EBk-.png",import.meta.url).href,jg=""+new URL("L17-BomGMZbR.png",import.meta.url).href,Ug=""+new URL("L18-B2bLjWIc.png",import.meta.url).href,Vg=""+new URL("L19-DHpwxvAB.png",import.meta.url).href,Yg=""+new URL("L20-CyAYX9HG.png",import.meta.url).href,Kg=["src"],qg={key:1,class:"photo-shade"},Wg={key:2,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},zg={key:3,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Xg={key:4,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Jg={key:5,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Zg={key:6,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Qg={key:7,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},e1={class:"tag"},t1=gt({__name:"SceneBackdrop",props:{levelId:{},pressure:{}},setup(e){const t=e,n=Object.assign({"../../../content/art/scenes/L01.png":wg,"../../../content/art/scenes/L02.png":Pg,"../../../content/art/scenes/L03.png":Og,"../../../content/art/scenes/L04.png":Rg,"../../../content/art/scenes/L05.png":Sg,"../../../content/art/scenes/L06.png":Eg,"../../../content/art/scenes/L07.png":Cg,"../../../content/art/scenes/L08.png":Ig,"../../../content/art/scenes/L09.png":$g,"../../../content/art/scenes/L10.png":Mg,"../../../content/art/scenes/L11.png":Ng,"../../../content/art/scenes/L12.png":Dg,"../../../content/art/scenes/L13.png":Fg,"../../../content/art/scenes/L14.png":Bg,"../../../content/art/scenes/L15.png":Hg,"../../../content/art/scenes/L16.png":Gg,"../../../content/art/scenes/L17.png":jg,"../../../content/art/scenes/L18.png":Ug,"../../../content/art/scenes/L19.png":Vg,"../../../content/art/scenes/L20.png":Yg}),i=ae("");Be(()=>t.levelId,c=>{const a=Object.entries(n).find(([p])=>p.endsWith("/"+c+".png"));i.value=a!==void 0?a[1]:""},{immediate:!0});const s=V(()=>wp(t.levelId)),o=V(()=>{const c=s.value.hue,a=8+Math.round(t.pressure*.8);return{background:`radial-gradient(120% 70% at 50% 18%, hsl(${c} 32% ${a+10}%) 0%, hsl(${c} 38% ${a}%) 45%, hsl(${c} 45% ${Math.max(4,a-4)}%) 100%)`}}),r=V(()=>s.value.motif);return(c,a)=>(R(),C("div",{class:"backdrop",style:He(o.value)},[i.value?(R(),C("img",{key:0,class:"photo",src:i.value,alt:""},null,8,Kg)):Q("",!0),i.value?(R(),C("div",qg)):Q("",!0),r.value==="subway"?(R(),C("svg",Wg,[...a[0]||(a[0]=[Oi('<rect x="40" y="80" width="320" height="180" rx="14" class="win" data-v-b08529d1></rect><rect x="52" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="132" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="212" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="292" y="92" width="56" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="0" y="300" width="400" height="10" class="rail" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',7)])])):r.value==="elevator"?(R(),C("svg",zg,[...a[1]||(a[1]=[m("rect",{x:"120",y:"60",width:"160",height:"440",rx:"6",class:"door"},null,-1),m("line",{x1:"200",y1:"60",x2:"200",y2:"500",class:"seam"},null,-1),m("circle",{cx:"200",cy:"530",r:"12",class:"lamp"},null,-1),m("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="street"?(R(),C("svg",Xg,[...a[2]||(a[2]=[Oi('<line x1="60" y1="0" x2="60" y2="380" class="pole" data-v-b08529d1></line><rect x="48" y="380" width="24" height="8" rx="3" class="lamp" data-v-b08529d1></rect><rect x="0" y="430" width="400" height="6" class="rail" data-v-b08529d1></rect><rect x="0" y="470" width="400" height="4" class="rail dim" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):r.value==="court"?(R(),C("svg",Jg,[...a[3]||(a[3]=[m("rect",{x:"80",y:"120",width:"240",height:"90",rx:"4",class:"win"},null,-1),m("rect",{x:"100",y:"300",width:"200",height:"14",rx:"3",class:"desk"},null,-1),m("rect",{x:"60",y:"380",width:"280",height:"10",rx:"3",class:"desk dim"},null,-1),m("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="studio"?(R(),C("svg",Zg,[...a[4]||(a[4]=[Oi('<rect x="40" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><rect x="230" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><circle cx="200" cy="260" r="8" class="lamp" data-v-b08529d1></circle><line x1="200" y1="0" x2="200" y2="252" class="pole thin" data-v-b08529d1></line><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):(R(),C("svg",Qg,[...a[5]||(a[5]=[m("rect",{x:"50",y:"110",width:"140",height:"100",rx:"6",class:"win"},null,-1),m("rect",{x:"220",y:"110",width:"130",height:"70",rx:"6",class:"win dim"},null,-1),m("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])),m("div",e1,O(s.value.label),1)],4))}}),n1=bt(t1,[["__scopeId","data-v-b08529d1"]]),i1={class:"danmaku","aria-hidden":"true"},s1=gt({__name:"DanmakuLayer",props:{pressure:{},active:{type:Boolean}},setup(e){const t=e,n=ae([]);let i=0,s;function o(){return t.pressure>=4?fe.danmaku.hot:t.pressure>=3?fe.danmaku.tense:fe.danmaku.calm}function r(){if(!t.active)return;const c=o();if(c.length===0)return;const a=c[Math.floor(Math.random()*c.length)]??"";n.value.push({id:i+=1,text:a,lane:Math.floor(Math.random()*4),speed:t.pressure>=4?7+Math.random()*3:10+Math.random()*4,bold:Math.random()<.25}),n.value.length>14&&(n.value=n.value.slice(-14))}return typeof setInterval=="function"&&(s=setInterval(r,t.pressure>=4?900:1800),Be(()=>t.pressure,()=>{})),Nt(()=>{s!==void 0&&clearInterval(s)}),(c,a)=>(R(),C("div",i1,[ke(Jd,{name:"fly"},{default:_s(()=>[(R(!0),C(ve,null,kt(n.value,p=>(R(),C("span",{key:p.id,class:le(["line",{bold:p.bold}]),style:He({top:12+p.lane*34+"px","--dur":p.speed+"s"})},O(p.text),7))),128))]),_:1})]))}}),o1=bt(s1,[["__scopeId","data-v-55cd0013"]]),r1=""+new URL("he_song-DAGlX_4O.png",import.meta.url).href,c1=""+new URL("hero-BAfbz0Vs.png",import.meta.url).href,a1=""+new URL("npc_l01_woman-DSDWwEL8.png",import.meta.url).href,l1=""+new URL("npc_l02_woman-qXhWvPKu.png",import.meta.url).href,p1=""+new URL("npc_l03_daughter-Dt2TiO8f.png",import.meta.url).href,u1=""+new URL("npc_l03_woman-BQ3wIsYH.png",import.meta.url).href,d1=""+new URL("npc_l04_woman-CZQbIvDG.png",import.meta.url).href,_1=""+new URL("npc_l05_manager-Ce6F9DQj.png",import.meta.url).href,f1=""+new URL("npc_l05_woman-BXLOsOGn.png",import.meta.url).href,g1=""+new URL("npc_l06_girlfriend-CrncpSA3.png",import.meta.url).href,m1=""+new URL("npc_l06_mother-BJuBbFLU.png",import.meta.url).href,v1=""+new URL("npc_l07_ex-CEJAEgFV.png",import.meta.url).href,h1=""+new URL("npc_l08_child-Bm0Rde6F.png",import.meta.url).href,x1=""+new URL("npc_l08_mother-tu98VogT.png",import.meta.url).href,k1=""+new URL("npc_l08_wife-Cy9DZe9m.png",import.meta.url).href,y1=""+new URL("npc_l09_wife-CJUlJISq.png",import.meta.url).href,T1=""+new URL("npc_l10_exwife-D0NJtWQK.png",import.meta.url).href,b1=""+new URL("npc_l11_hr-Dqx_GpDt.png",import.meta.url).href,A1=""+new URL("npc_l12_boss-nYTyR_X5.png",import.meta.url).href,L1=""+new URL("npc_l12_colleague-BD3ntBZW.png",import.meta.url).href,w1=""+new URL("npc_l13_hr-Dovjb9V8.png",import.meta.url).href,P1=""+new URL("npc_l14_director-B-efKLNg.png",import.meta.url).href,O1=""+new URL("npc_l14_hr-DRiqQqX2.png",import.meta.url).href,R1=""+new URL("npc_l15_broker-CqY8iI1Q.png",import.meta.url).href,S1=""+new URL("npc_l15_hr-CSF8zzWx.png",import.meta.url).href,E1=""+new URL("npc_l16_account-D825uOC6.png",import.meta.url).href,C1=""+new URL("npc_l17_father-jYHQ9zlG.png",import.meta.url).href,I1=""+new URL("npc_l17_hr-D3pAIKo4.png",import.meta.url).href,$1=""+new URL("npc_l18_streamer-CYlpG6aq.png",import.meta.url).href,M1=""+new URL("npc_l19_moderator-CoZr2C0k.png",import.meta.url).href,N1=""+new URL("npc_l19_pr-Do-3PPx1.png",import.meta.url).href,D1=""+new URL("officer_lin-Bduk5y-m.png",import.meta.url).href,F1=""+new URL("shen_li-Bd_DLpmj.png",import.meta.url).href,B1=""+new URL("zhou_you-DSERK5v3.png",import.meta.url).href,H1={key:0,class:"duo","aria-hidden":"true"},G1=["src"],j1={key:1,class:"pt",viewBox:"0 0 120 160"},U1=["src","alt"],V1={key:1,class:"pt",viewBox:"0 0 120 160"},Y1={class:"nm"},K1=gt({__name:"PortraitSlot",props:{speaker:{},visible:{type:Boolean}},setup(e){const t=e,n=Object.assign({"../../../content/art/characters/he_song.png":r1,"../../../content/art/characters/hero.png":c1,"../../../content/art/characters/npc_l01_woman.png":a1,"../../../content/art/characters/npc_l02_woman.png":l1,"../../../content/art/characters/npc_l03_daughter.png":p1,"../../../content/art/characters/npc_l03_woman.png":u1,"../../../content/art/characters/npc_l04_woman.png":d1,"../../../content/art/characters/npc_l05_manager.png":_1,"../../../content/art/characters/npc_l05_woman.png":f1,"../../../content/art/characters/npc_l06_girlfriend.png":g1,"../../../content/art/characters/npc_l06_mother.png":m1,"../../../content/art/characters/npc_l07_ex.png":v1,"../../../content/art/characters/npc_l08_child.png":h1,"../../../content/art/characters/npc_l08_mother.png":x1,"../../../content/art/characters/npc_l08_wife.png":k1,"../../../content/art/characters/npc_l09_wife.png":y1,"../../../content/art/characters/npc_l10_exwife.png":T1,"../../../content/art/characters/npc_l11_hr.png":b1,"../../../content/art/characters/npc_l12_boss.png":A1,"../../../content/art/characters/npc_l12_colleague.png":L1,"../../../content/art/characters/npc_l13_hr.png":w1,"../../../content/art/characters/npc_l14_director.png":P1,"../../../content/art/characters/npc_l14_hr.png":O1,"../../../content/art/characters/npc_l15_broker.png":R1,"../../../content/art/characters/npc_l15_hr.png":S1,"../../../content/art/characters/npc_l16_account.png":E1,"../../../content/art/characters/npc_l17_father.png":C1,"../../../content/art/characters/npc_l17_hr.png":I1,"../../../content/art/characters/npc_l18_streamer.png":$1,"../../../content/art/characters/npc_l19_moderator.png":M1,"../../../content/art/characters/npc_l19_pr.png":N1,"../../../content/art/characters/officer_lin.png":D1,"../../../content/art/characters/shen_li.png":F1,"../../../content/art/characters/zhou_you.png":B1});function i(T){if(T===null)return{url:"",ok:!1};const L=Object.entries(n).find(([M])=>M.endsWith("/"+T+".png"));return L!==void 0?{url:L[1],ok:!0}:{url:"",ok:!1}}const s=i("hero"),o=Xi("hero"),r=V(()=>t.speaker===null||t.speaker==="hero"?null:t.speaker),c=V(()=>i(r.value)),a=V(()=>Xi(r.value??"")),p=V(()=>r.value===null?"":Sf(r.value)),l=ae(!1);Be(()=>t.speaker,()=>{l.value=!1});const _=V(()=>t.speaker==="hero");return(T,L)=>e.visible?(R(),C("div",H1,[m("div",{class:le(["who hero",{talking:_.value}]),style:He({"--h":w(o)})},[w(s).ok?(R(),C("img",{key:0,class:"pt art",src:w(s).url,alt:""},null,8,G1)):(R(),C("svg",j1,[...L[1]||(L[1]=[m("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])]))],6),r.value?(R(),C("div",{key:0,class:le(["who guest",{talking:!0}]),style:He({"--h":a.value})},[c.value.ok&&!l.value?(R(),C("img",{key:0,class:"pt art",src:c.value.url,alt:p.value,onError:L[0]||(L[0]=M=>l.value=!0)},null,40,U1)):(R(),C("svg",V1,[...L[2]||(L[2]=[m("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])])),m("span",Y1,O(p.value),1)],4)):Q("",!0)])):Q("",!0)}}),q1=bt(K1,[["__scopeId","data-v-77cf8af7"]]);function W1(e,t){const n=220*Math.pow(2,Math.round(e/30)%12/12);return t==="tense"?{root:n,steps:[0,2,3,5,7,8,10]}:t==="panic"?{root:n,steps:[0,1,3,6,7,9,10]}:{root:n*1.5,steps:[0,2,4,7,9,12,14]}}function fo(e,t){const n=Math.floor(t/e.steps.length),i=(t%e.steps.length+e.steps.length)%e.steps.length;return e.root*Math.pow(2,(e.steps[i]??0)/12+n)}function go(e){let t=e|0;return()=>(t=Math.imul(t,1664525)+1013904223|0,(t>>>8&16777215)/16777216)}class z1{constructor(){xe(this,"ctx",null);xe(this,"master",null);xe(this,"bgmGain",null);xe(this,"sfxGain",null);xe(this,"bgmTimer",null);xe(this,"mood","calm");xe(this,"hue",210);xe(this,"step",0);xe(this,"rnd",go(42));xe(this,"muted",!1)}unlock(){if(this.ctx===null){const t=globalThis.AudioContext;if(t===void 0)return;this.ctx=new t,this.master=this.ctx.createGain(),this.master.gain.value=this.muted?0:.55,this.master.connect(this.ctx.destination),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.5,this.bgmGain.connect(this.master),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.9,this.sfxGain.connect(this.master)}this.ctx.state==="suspended"&&this.ctx.resume()}setMuted(t){this.muted=t,this.master!==null&&this.ctx!==null&&this.master.gain.setTargetAtTime(t?0:.55,this.ctx.currentTime,.05)}tone(t,n,i,s,o,r=0){if(this.ctx===null)return;const c=this.ctx.currentTime+r,a=this.ctx.createOscillator(),p=this.ctx.createGain();a.type=s,a.frequency.value=t,p.gain.setValueAtTime(0,c),p.gain.linearRampToValueAtTime(i,c+.012),p.gain.exponentialRampToValueAtTime(1e-4,c+n),a.connect(p),p.connect(o),a.start(c),a.stop(c+n+.05)}pad(t,n){if(this.bgmGain===null||this.ctx===null)return;const i=this.ctx.currentTime,s=this.ctx.createOscillator(),o=this.ctx.createGain(),r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=900,s.type="sawtooth",s.frequency.value=t/2,o.gain.setValueAtTime(0,i),o.gain.linearRampToValueAtTime(.05,i+n*.3),o.gain.linearRampToValueAtTime(1e-4,i+n),s.connect(r),r.connect(o),o.connect(this.bgmGain),s.start(i),s.stop(i+n+.1)}scene(t,n,i,s){const o=s<15||i>=4?"panic":i>=3||s<40?"tense":"calm";let r=0;for(let c=0;c<t.length;c+=1)r=r*31+t.charCodeAt(c)|0;(o!==this.mood||n!==this.hue)&&(this.mood=o,this.hue=n,this.rnd=go(r),this.step=0)}tick(){if(this.ctx===null||this.bgmGain===null||this.muted)return;const t=W1(this.hue,this.mood),n=this.step%8,i=this.mood==="calm"?.35:this.mood==="tense"?.55:.75;if(this.rnd()<i){const s=Math.floor(this.rnd()*8),o=fo(t,s);this.tone(o,this.mood==="calm"?.9:.45,.06,this.mood==="calm"?"sine":"triangle",this.bgmGain)}n===0&&this.pad(fo(t,0),this.mood==="calm"?6.4:3.2),this.mood==="panic"&&(n===0||n===4)&&(this.tone(52,.14,.16,"sine",this.bgmGain),this.tone(52,.12,.12,"sine",this.bgmGain,.18)),this.step+=1}sfx(t){if(!(this.ctx===null||this.sfxGain===null||this.muted))switch(t){case"click":this.tone(880,.06,.1,"sine",this.sfxGain);break;case"options":this.tone(523,.08,.09,"sine",this.sfxGain),this.tone(784,.1,.09,"sine",this.sfxGain,.07);break;case"tick":this.tone(1245,.04,.07,"square",this.sfxGain);break;case"ending":{const n=this.sfxGain;n!==null&&[523,659,784,1047].forEach((i,s)=>this.tone(i,.5,.08,"sine",n,s*.13));break}case"bad":{const n=this.sfxGain;n!==null&&[330,294,262,196].forEach((i,s)=>this.tone(i,.35,.09,"triangle",n,s*.15));break}}}startLoop(){if(this.bgmTimer!==null)return;const t=800;typeof setInterval=="function"&&(this.bgmTimer=setInterval(()=>this.tick(),t))}stopLoop(){this.bgmTimer!==void 0&&this.bgmTimer!==null&&(clearInterval(this.bgmTimer),this.bgmTimer=null)}}const Rt=new z1,X1={class:"stage"},J1={key:2,class:"topbar"},Z1={class:"lv-title"},Q1={key:3,class:"study-entry"},em={class:"sub"},tm=["placeholder"],nm=["disabled"],im={key:4,class:"study-done"},sm={class:"sum"},om={class:"story"},rm={name:"App"},cm=gt({...rm,props:{ctx:{}},setup(e){const n=e.ctx;Be(n.event,b=>{b!==null&&b.type==="ending"&&(n.settle(),Rt.sfx(b.ending.rank==="S"||b.ending.rank==="A"?"ending":"bad"))}),Be(n.event,b=>{var N,F,U;if(b===null)return;const I=wp(((N=n.current.value)==null?void 0:N.id)??"L01").hue;b.type==="node"?Rt.scene(((F=n.current.value)==null?void 0:F.id)??"L01",I,b.node.pressure??0,n.meters.value.composure):b.type==="options"&&(Rt.sfx("options"),Rt.scene(((U=n.current.value)==null?void 0:U.id)??"L01",I,3,n.meters.value.composure))});const i=ae(0),s=ae(null);Be(n.event,b=>{if(b===null){i.value=0,s.value=null;return}b.type==="node"?(i.value=b.node.pressure??0,s.value="speaker"in b.node?String(b.node.speaker):null):b.type==="options"&&(i.value=b.options.length>0?i.value:0,s.value=null)});const o=V(()=>{const b=n.meters.value.composure;return b>=50||n.screen.value!=="level"?{opacity:0}:{opacity:(.25+(50-b)/50*.55).toFixed(2),animation:b<15?"throb 1.1s ease-in-out infinite":"none"}}),r=V(()=>n.screen.value==="level"),c=ae(""),a=V(()=>n.STUDY_LEVELS.every(b=>{try{return n.studySummary().includes(b)}catch{return!1}}));function p(){const b=n.studyExport();typeof navigator<"u"&&navigator.clipboard!==void 0&&navigator.clipboard.writeText(b);const I=new Blob([b],{type:"application/json"}),N=document.createElement("a");N.href=URL.createObjectURL(I),N.download=`study-${c.value||"anon"}.json`,N.click()}const l=ae(!1),_=V(()=>l.value?"x":"m");function T(){l.value=!l.value,Rt.setMuted(l.value)}function L(){Rt.unlock(),Rt.startLoop()}document.addEventListener("pointerdown",L,{once:!0});const M=V(()=>n.current.value?n.current.value.id:"L01");return(b,I)=>{var N;return R(),C("div",X1,[r.value?(R(),ct(n1,{key:0,"level-id":M.value,pressure:i.value},null,8,["level-id","pressure"])):Q("",!0),r.value&&((N=w(n).event.value)==null?void 0:N.type)!=="ending"?(R(),ct(o1,{key:1,pressure:i.value,active:r.value},null,8,["pressure","active"])):Q("",!0),r.value?(R(),C("header",J1,[m("button",{class:"back",onClick:I[0]||(I[0]=F=>w(n).toSelect())},"‹"),m("span",Z1,O(w(n).banner.value),1),m("button",{class:le(["mute",{off:l.value}]),onClick:I[1]||(I[1]=F=>T())},O(_.value),3)])):Q("",!0),w(n).studyOn&&w(n).studyScreen.value==="entry"?(R(),C("div",Q1,[m("h1",null,O(w(fe).appTitle),1),m("p",em,O(w(sn)("studyIntro")),1),Tu(m("input",{"onUpdate:modelValue":I[2]||(I[2]=F=>c.value=F),class:"pid",placeholder:w(sn)("studyPidPlaceholder"),maxlength:"8"},null,8,tm),[[i_,c.value]]),m("button",{class:"go",disabled:c.value.trim().length===0,onClick:I[3]||(I[3]=F=>w(n).studyBegin(c.value.trim()))},O(w(sn)("studyStart")),9,nm)])):w(n).studyOn&&w(n).studyScreen.value==="done"&&a.value?(R(),C("div",im,[m("h2",null,O(w(sn)("studyDoneTitle")),1),m("pre",sm,O(w(n).studySummary()),1),m("button",{class:"go",onClick:p},O(w(sn)("studyCopy")),1)])):w(n).screen.value==="select"?(R(),ct(Lg,{key:5,levels:w(n).studyOn?w(Tn).filter(F=>w(n).STUDY_LEVELS.includes(F.id)):w(Tn),best:w(n).best.value,onPick:w(n).startLevel},null,8,["levels","best","onPick"])):w(n).event.value?(R(),C(ve,{key:6},[w(n).event.value.type!=="ending"?(R(),ct(Df,{key:0,state:w(n).meters.value},null,8,["state"])):Q("",!0),ke(q1,{speaker:w(n).event.value.type==="node"&&"speaker"in w(n).event.value.node?s.value:null,visible:w(n).event.value.type==="node"&&"speaker"in w(n).event.value.node},null,8,["speaker","visible"]),m("div",om,[w(n).event.value.type==="node"&&"script"in w(n).event.value.node?(R(),ct(uo,{key:0,kind:"cutscene",text:String(w(n).event.value.node.script??""),onAdvance:I[4]||(I[4]=F=>w(n).advance())},null,8,["text"])):w(n).event.value.type==="node"&&"speaker"in w(n).event.value.node?(R(),ct(uo,{key:1,kind:"dialogue",speaker:String(w(n).event.value.node.speaker??""),text:String(w(n).event.value.node.text??""),onAdvance:I[5]||(I[5]=F=>w(n).advance())},null,8,["speaker","text"])):w(n).event.value.type==="options"?(R(),ct(A0,{key:2,options:w(n).event.value.options,timer:w(n).event.value.timer,"timeout-option-id":w(n).event.value.timeoutOptionId,prompt:w(n).event.value.prompt??"",pressure:i.value,onChoose:w(n).choose},null,8,["options","timer","timeout-option-id","prompt","pressure","onChoose"])):w(n).event.value.type==="ending"?(R(),ct(rg,{key:3,"level-id":M.value,ending:w(n).event.value.ending,state:w(n).event.value.state,onRestart:w(n).restart,onNext:w(n).nextLevel},null,8,["level-id","ending","state","onRestart","onNext"])):Q("",!0)])],64)):Q("",!0),r.value?(R(),C("div",{key:7,class:"vignette",style:He(o.value)},null,4)):Q("",!0)])}}}),Pp="poju-study-v1",am=()=>typeof location<"u"&&new URLSearchParams(location.search).get("study")==="1";function At(){if(typeof localStorage>"u")return{sessionId:"",participant:"",startedAt:0,runs:[]};const e=localStorage.getItem(Pp);return e===null?{sessionId:"",participant:"",startedAt:0,runs:[]}:JSON.parse(e)}function fi(e){typeof localStorage<"u"&&localStorage.setItem(Pp,JSON.stringify(e))}function lm(e){const t={sessionId:`S-${performance.now().toString(36)}`,participant:e,startedAt:performance.now(),runs:[]};return gi=t,fi(t),t}function pm(e,t,n){const i={level:t,startedAt:performance.now(),endedAt:0,totalMs:0,choices:[],endingRank:"",endingTitle:"",finalMeters:{evidence:0,opinion:0,composure:0,risk:0},replayed:n},s=gi??At();return s.runs.push(i),fi(s),i}let Ji=0,Op="",gi=null;function Qn(e){Ji=performance.now(),Op=e}function um(e,t,n,i,s){e.choices.push({level:n,nodeId:Op,optionId:i,ms:Ji>0?performance.now()-Ji:0,meters:{...s}});const o=gi??At();fi(o)}function dm(e,t,n,i,s){e.endedAt=performance.now(),e.totalMs=e.endedAt-e.startedAt,e.endingRank=n,e.endingTitle=i,e.finalMeters={...s},fi(gi??At())}function _m(){return JSON.stringify(At(),null,2)}function fm(){const e=At(),n=[fe.ui.studySummaryHeader.replace("{p}",e.participant).replace("{n}",String(e.runs.length))],i=new Map;for(const s of e.runs){const o=i.get(s.level)??[];o.push(s),i.set(s.level,o)}for(const[s,o]of[...i.entries()].sort()){const r=o[0],c=Math.round(r.totalMs/1e3),a=fe.ui.studySummaryLine;n.push(a.replace("{lv}",s).replace("{rank}",r.endingRank).replace("{title}",r.endingTitle).replace("{s}",String(c)).replace("{c}",String(r.choices.length)).replace("{r}",o.length>1?"Y":"N"))}return n.join(`
`)}const bn=ae("select"),Tt=oi(null),Ce=oi(null),An=ae(w_()),Rp=ae(""),mi=oi(null),ks=ae({evidence:0,opinion:0,composure:0,risk:0}),Dt=am(),Zi=["L01","L02","L03","L04","L05"],Sp=ae("entry"),Ln=oi(null),gm=ae(0);function mm(e){An.value=zi(),lm(e),Sp.value="done",wn("L01")}function wn(e){const t=Tn.find(i=>i.id===e)??null;if(t===null)return;Tt.value=t,Rp.value=t.title;const n=new xs(t,An.value);if(mi.value=n,Ce.value=n.start(),ks.value={...n.state},bn.value="level",Dt){const i=At(),s=i.runs.some(o=>o.level===e&&o.endingRank!=="");Ln.value=pm(i,e,s),Qn("entry")}}function vm(){const e=mi.value;e!==null&&(Ce.value=e.proceed(),Dt&&Ce.value.type==="node"&&Qn(String(Ce.value.node.id)),Dt&&Ce.value.type==="options"&&Ce.value.nodeId!==void 0&&Qn(Ce.value.nodeId))}function hm(e){const t=mi.value;t!==null&&(Ce.value=t.choose(e),ks.value={...t.state},Dt&&Ln.value!==null&&Tt.value!==null&&(um(Ln.value,At(),Tt.value.id,e,t.state),Ce.value.type==="options"&&Ce.value.nodeId!==void 0&&Qn(Ce.value.nodeId)))}function xm(){const e=mi.value,t=Tt.value,n=Ce.value;if(e===null||t===null||n===null||n.type!=="ending")return;if(Dt){Ln.value!==null&&dm(Ln.value,At(),n.ending.rank,n.ending.title,e.state),gm.value+=1;return}const i=E_(An.value,t.id,n.ending,n.state,{now:0});An.value=i,P_(i)}function km(){Tt.value!==null&&wn(Tt.value.id)}function ym(){const e=Tt.value;if(e===null)return;if(Dt){const i=Zi.indexOf(e.id),s=i>=0?Zi[i+1]:void 0;if(s===void 0){bn.value="select";return}wn(s);return}const t=Tn.findIndex(i=>i.id===e.id),n=Tn[t+1];if(n===void 0){bn.value="select";return}wn(n.id)}function Tm(){bn.value="select"}const bm=V(()=>{const e={};for(const[t,n]of Object.entries(An.value.levelResults))e[t]=n.rank;return e}),Am={screen:bn,current:Tt,event:Ce,banner:Rp,best:bm,meters:ks,startLevel:wn,advance:vm,choose:hm,settle:xm,restart:km,nextLevel:ym,toSelect:Tm,studyOn:Dt,STUDY_LEVELS:Zi,studyScreen:Sp,studyBegin:mm,studyExport:()=>_m(),studySummary:()=>fm()},Lm=a_(cm,{ctx:Am});Lm.mount("#app");
