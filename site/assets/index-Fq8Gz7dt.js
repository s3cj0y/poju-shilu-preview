var Tp=Object.defineProperty;var Ap=(e,t,n)=>t in e?Tp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var ve=(e,t,n)=>Ap(e,typeof t!="symbol"?t+"":t,n);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();/**
* @vue/shared v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Yi(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const ne={},Kt=[],nt=()=>{},ls=()=>!1,Zn=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Qn=e=>e.startsWith("onUpdate:"),me=Object.assign,Ki=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},bp=Object.prototype.hasOwnProperty,z=(e,t)=>bp.call(e,t),M=Array.isArray,qt=e=>On(e)==="[object Map]",ps=e=>On(e)==="[object Set]",mo=e=>On(e)==="[object Date]",j=e=>typeof e=="function",ue=e=>typeof e=="string",it=e=>typeof e=="symbol",X=e=>e!==null&&typeof e=="object",us=e=>(X(e)||j(e))&&j(e.then)&&j(e.catch),_s=Object.prototype.toString,On=e=>_s.call(e),Lp=e=>On(e).slice(8,-1),ds=e=>On(e)==="[object Object]",qi=e=>ue(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,an=Yi(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),ei=e=>{const t=Object.create(null);return n=>t[n]||(t[n]=e(n))},Pp=/-\w/g,He=ei(e=>e.replace(Pp,t=>t.slice(1).toUpperCase())),Op=/\B([A-Z])/g,Nt=ei(e=>e.replace(Op,"-$1").toLowerCase()),fs=ei(e=>e.charAt(0).toUpperCase()+e.slice(1)),di=ei(e=>e?`on${fs(e)}`:""),tt=(e,t)=>!Object.is(e,t),Dn=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},gs=(e,t,n,i=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:i,value:n})},Wi=e=>{const t=parseFloat(e);return isNaN(t)?e:t},wp=e=>{const t=ue(e)?Number(e):NaN;return isNaN(t)?e:t};let ho;const ti=()=>ho||(ho=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function De(e){if(M(e)){const t={};for(let n=0;n<e.length;n++){const i=e[n],o=ue(i)?Cp(i):De(i);if(o)for(const s in o)t[s]=o[s]}return t}else if(ue(e)||X(e))return e}const Rp=/;(?![^(]*\))/g,Sp=/:([^]+)/,Ep=/\/\*[^]*?\*\//g;function Cp(e){const t={};return e.replace(Ep,"").split(Rp).forEach(n=>{if(n){const i=n.split(Sp);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function xe(e){let t="";if(ue(e))t=e;else if(M(e))for(let n=0;n<e.length;n++){const i=xe(e[n]);i&&(t+=i+" ")}else if(X(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const Ip="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",$p=Yi(Ip);function ms(e){return!!e||e===""}function Mp(e,t){if(e.length!==t.length)return!1;let n=!0;for(let i=0;n&&i<e.length;i++)n=zi(e[i],t[i]);return n}function zi(e,t){if(e===t)return!0;let n=mo(e),i=mo(t);if(n||i)return n&&i?e.getTime()===t.getTime():!1;if(n=it(e),i=it(t),n||i)return e===t;if(n=M(e),i=M(t),n||i)return n&&i?Mp(e,t):!1;if(n=X(e),i=X(t),n||i){if(!n||!i)return!1;const o=Object.keys(e).length,s=Object.keys(t).length;if(o!==s)return!1;for(const r in e){const c=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(c&&!a||!c&&a||!zi(e[r],t[r]))return!1}}return String(e)===String(t)}const hs=e=>!!(e&&e.__v_isRef===!0),D=e=>ue(e)?e:e==null?"":M(e)||X(e)&&(e.toString===_s||!j(e.toString))?hs(e)?D(e.value):JSON.stringify(e,vs,2):String(e),vs=(e,t)=>hs(t)?vs(e,t.value):qt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[i,o],s)=>(n[fi(i,s)+" =>"]=o,n),{})}:ps(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>fi(n))}:it(t)?fi(t):X(t)&&!M(t)&&!ds(t)?String(t):t,fi=(e,t="")=>{var n;return it(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ye;class Np{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&ye&&(ye.active?(this.parent=ye,this.index=(ye.scopes||(ye.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes){const i=this.scopes.slice();for(t=0,n=i.length;t<n;t++)i[t].pause()}for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes){const o=this.scopes.slice();for(t=0,n=o.length;t<n;t++)o[t].resume()}const i=this.effects.slice();for(t=0,n=i.length;t<n;t++)i[t].resume()}}run(t){if(this._active){const n=ye;try{return ye=this,t()}finally{ye=n}}}on(){++this._on===1&&(this.prevScope=ye,ye=this)}off(){if(this._on>0&&--this._on===0){if(ye===this)ye=this.prevScope;else{let t=ye;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(this.effects.length=0,n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){const o=this.scopes.slice();for(n=0,i=o.length;n<i;n++)o[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const o=this.parent.scopes.pop();o&&o!==this&&(this.parent.scopes[this.index]=o,o.index=this.index)}this.parent=void 0}}}function Dp(){return ye}let se;const gi=new WeakSet;class xs{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ye&&(ye.active?ye.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,gi.has(this)&&(gi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ys(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,vo(this),Ts(this);const t=se,n=je;se=this,je=!0;try{return this.fn()}finally{As(this),se=t,je=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)Zi(t);this.deps=this.depsTail=void 0,vo(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?gi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Ri(this)&&this.run()}get dirty(){return Ri(this)}}let ks=0,ln,pn;function ys(e,t=!1){if(e.flags|=8,t){e.next=pn,pn=e;return}e.next=ln,ln=e}function Xi(){ks++}function Ji(){if(--ks>0)return;if(pn){let t=pn;for(pn=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;ln;){let t=ln;for(ln=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(i){e||(e=i)}t=n}}if(e)throw e}function Ts(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function As(e){let t,n=e.depsTail,i=n;for(;i;){const o=i.prevDep;i.version===-1?(i===n&&(n=o),Zi(i),Fp(i)):t=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=o}e.deps=t,e.depsTail=n}function Ri(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(bs(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function bs(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===gn)||(e.globalVersion=gn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Ri(e))))return;e.flags|=2;const t=e.dep,n=se,i=je;se=e,je=!0;try{Ts(e);const o=e.fn(e._value);(t.version===0||tt(o,e._value))&&(e.flags|=128,e._value=o,t.version++)}catch(o){throw t.version++,o}finally{se=n,je=i,As(e),e.flags&=-3}}function Zi(e,t=!1){const{dep:n,prevSub:i,nextSub:o}=e;if(i&&(i.nextSub=o,e.prevSub=void 0),o&&(o.prevSub=i,e.nextSub=void 0),n.subs===e&&(n.subs=i,!i&&n.computed)){n.computed.flags&=-5;for(let s=n.computed.deps;s;s=s.nextDep)Zi(s,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function Fp(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let je=!0;const Ls=[];function _t(){Ls.push(je),je=!1}function dt(){const e=Ls.pop();je=e===void 0?!0:e}function vo(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=se;se=void 0;try{t()}finally{se=n}}}let gn=0;class Bp{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Qi{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!se||!je||se===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==se)n=this.activeLink=new Bp(se,this),se.deps?(n.prevDep=se.depsTail,se.depsTail.nextDep=n,se.depsTail=n):se.deps=se.depsTail=n,Ps(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const i=n.nextDep;i.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=i),n.prevDep=se.depsTail,n.nextDep=void 0,se.depsTail.nextDep=n,se.depsTail=n,se.deps===n&&(se.deps=i)}return n}trigger(t){this.version++,gn++,this.notify(t)}notify(t){Xi();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{Ji()}}}function Ps(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let i=t.deps;i;i=i.nextDep)Ps(i)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const Si=new WeakMap,Et=Symbol(""),Ei=Symbol(""),mn=Symbol("");function Ae(e,t,n){if(je&&se){let i=Si.get(e);i||Si.set(e,i=new Map);let o=i.get(n);o||(i.set(n,o=new Qi),o.map=i,o.key=n),o.track()}}function pt(e,t,n,i,o,s){const r=Si.get(e);if(!r){gn++;return}const c=a=>{a&&a.trigger()};if(Xi(),t==="clear")r.forEach(c);else{const a=M(e),u=a&&qi(n);if(a&&n==="length"){const p=Number(i);r.forEach((d,m)=>{(m==="length"||m===mn||!it(m)&&m>=p)&&c(d)})}else switch((n!==void 0||r.has(void 0))&&c(r.get(n)),u&&c(r.get(mn)),t){case"add":a?u&&c(r.get("length")):(c(r.get(Et)),qt(e)&&c(r.get(Ei)));break;case"delete":a||(c(r.get(Et)),qt(e)&&c(r.get(Ei)));break;case"set":qt(e)&&c(r.get(Et));break}}Ji()}function Ht(e){const t=K(e);return t===e?t:(Ae(t,"iterate",mn),Ne(e)?t:t.map(Ue))}function ni(e){return Ae(e=K(e),"iterate",mn),e}function Qe(e,t){return ft(e)?Xt(Ct(e)?Ue(t):t):Ue(t)}const Hp={__proto__:null,[Symbol.iterator](){return mi(this,Symbol.iterator,e=>Qe(this,e))},concat(...e){return Ht(this).concat(...e.map(t=>M(t)?Ht(t):t))},entries(){return mi(this,"entries",e=>(e[1]=Qe(this,e[1]),e))},every(e,t){return rt(this,"every",e,t,void 0,arguments)},filter(e,t){return rt(this,"filter",e,t,n=>n.map(i=>Qe(this,i)),arguments)},find(e,t){return rt(this,"find",e,t,n=>Qe(this,n),arguments)},findIndex(e,t){return rt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return rt(this,"findLast",e,t,n=>Qe(this,n),arguments)},findLastIndex(e,t){return rt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return rt(this,"forEach",e,t,void 0,arguments)},includes(...e){return hi(this,"includes",e)},indexOf(...e){return hi(this,"indexOf",e)},join(e){return Ht(this).join(e)},lastIndexOf(...e){return hi(this,"lastIndexOf",e)},map(e,t){return rt(this,"map",e,t,void 0,arguments)},pop(){return tn(this,"pop")},push(...e){return tn(this,"push",e)},reduce(e,...t){return xo(this,"reduce",e,t)},reduceRight(e,...t){return xo(this,"reduceRight",e,t)},shift(){return tn(this,"shift")},some(e,t){return rt(this,"some",e,t,void 0,arguments)},splice(...e){return tn(this,"splice",e)},toReversed(){return Ht(this).toReversed()},toSorted(e){return Ht(this).toSorted(e)},toSpliced(...e){return Ht(this).toSpliced(...e)},unshift(...e){return tn(this,"unshift",e)},values(){return mi(this,"values",e=>Qe(this,e))}};function mi(e,t,n){const i=ni(e),o=i[t]();return i!==e&&!Ne(e)&&(o._next=o.next,o.next=()=>{const s=o._next();return s.done||(s.value=n(s.value)),s}),o}const jp=Array.prototype;function rt(e,t,n,i,o,s){const r=ni(e),c=r!==e&&!Ne(e),a=r[t];if(a!==jp[t]){const d=a.apply(e,s);return c?Ue(d):d}let u=n;r!==e&&(c?u=function(d,m){return n.call(this,Qe(e,d),m,e)}:n.length>2&&(u=function(d,m){return n.call(this,d,m,e)}));const p=a.call(r,u,i);return c&&o?o(p):p}function xo(e,t,n,i){const o=ni(e),s=o!==e&&!Ne(e);let r=n,c=!1;o!==e&&(s?(c=i.length===0,r=function(u,p,d){return c&&(c=!1,u=Qe(e,u)),n.call(this,u,Qe(e,p),d,e)}):n.length>3&&(r=function(u,p,d){return n.call(this,u,p,d,e)}));const a=o[t](r,...i);return c?Qe(e,a):a}function hi(e,t,n){const i=K(e);Ae(i,"iterate",mn);const o=i[t](...n);return(o===-1||o===!1)&&io(n[0])?(n[0]=K(n[0]),i[t](...n)):o}function tn(e,t,n=[]){_t(),Xi();const i=K(e)[t].apply(e,n);return Ji(),dt(),i}const Gp=Yi("__proto__,__v_isRef,__isVue"),Os=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(it));function Up(e){it(e)||(e=String(e));const t=K(this);return Ae(t,"has",e),t.hasOwnProperty(e)}class ws{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,i){if(n==="__v_skip")return t.__v_skip;const o=this._isReadonly,s=this._isShallow;if(n==="__v_isReactive")return!o;if(n==="__v_isReadonly")return o;if(n==="__v_isShallow")return s;if(n==="__v_raw")return i===(o?s?Qp:Cs:s?Es:Ss).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(i)?t:void 0;const r=M(t);if(!o){let a;if(r&&(a=Hp[n]))return a;if(n==="hasOwnProperty")return Up}const c=Reflect.get(t,n,be(t)?t:i);if((it(n)?Os.has(n):Gp(n))||(o||Ae(t,"get",n),s))return c;if(be(c)){const a=r&&qi(n)?c:c.value;return o&&X(a)?Ii(a):a}return X(c)?o?Ii(c):to(c):c}}class Rs extends ws{constructor(t=!1){super(!1,t)}set(t,n,i,o){let s=t[n];const r=M(t)&&qi(n);if(!this._isShallow){const u=ft(s);if(!Ne(i)&&!ft(i)&&(s=K(s),i=K(i)),!r&&be(s)&&!be(i))return u||(s.value=i),!0}const c=r?Number(n)<t.length:z(t,n),a=Reflect.set(t,n,i,be(t)?t:o);return t===K(o)&&a&&(c?tt(i,s)&&pt(t,"set",n,i):pt(t,"add",n,i)),a}deleteProperty(t,n){const i=z(t,n);t[n];const o=Reflect.deleteProperty(t,n);return o&&i&&pt(t,"delete",n,void 0),o}has(t,n){const i=Reflect.has(t,n);return(!it(n)||!Os.has(n))&&Ae(t,"has",n),i}ownKeys(t){return Ae(t,"iterate",M(t)?"length":Et),Reflect.ownKeys(t)}}class Vp extends ws{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const Yp=new Rs,Kp=new Vp,qp=new Rs(!0);const Ci=e=>e,Cn=e=>Reflect.getPrototypeOf(e);function Wp(e,t,n){return function(...i){const o=this.__v_raw,s=K(o),r=qt(s),c=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,u=o[e](...i),p=n?Ci:t?Xt:Ue;return!t&&Ae(s,"iterate",a?Ei:Et),me(Object.create(u),{next(){const{value:d,done:m}=u.next();return m?{value:d,done:m}:{value:c?[p(d[0]),p(d[1])]:p(d),done:m}}})}}function In(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function zp(e,t){const n={get(o){const s=this.__v_raw,r=K(s),c=K(o);e||(tt(o,c)&&Ae(r,"get",o),Ae(r,"get",c));const{has:a}=Cn(r),u=t?Ci:e?Xt:Ue;if(a.call(r,o))return u(s.get(o));if(a.call(r,c))return u(s.get(c));s!==r&&s.get(o)},get size(){const o=this.__v_raw;return!e&&Ae(K(o),"iterate",Et),o.size},has(o){const s=this.__v_raw,r=K(s),c=K(o);return e||(tt(o,c)&&Ae(r,"has",o),Ae(r,"has",c)),o===c?s.has(o):s.has(o)||s.has(c)},forEach(o,s){const r=this,c=r.__v_raw,a=K(c),u=t?Ci:e?Xt:Ue;return!e&&Ae(a,"iterate",Et),c.forEach((p,d)=>o.call(s,u(p),u(d),r))}};return me(n,e?{add:In("add"),set:In("set"),delete:In("delete"),clear:In("clear")}:{add(o){const s=K(this),r=Cn(s),c=K(o),a=!t&&!Ne(o)&&!ft(o)?c:o;return r.has.call(s,a)||tt(o,a)&&r.has.call(s,o)||tt(c,a)&&r.has.call(s,c)||(s.add(a),pt(s,"add",a,a)),this},set(o,s){!t&&!Ne(s)&&!ft(s)&&(s=K(s));const r=K(this),{has:c,get:a}=Cn(r);let u=c.call(r,o);u||(o=K(o),u=c.call(r,o));const p=a.call(r,o);return r.set(o,s),u?tt(s,p)&&pt(r,"set",o,s):pt(r,"add",o,s),this},delete(o){const s=K(this),{has:r,get:c}=Cn(s);let a=r.call(s,o);a||(o=K(o),a=r.call(s,o)),c&&c.call(s,o);const u=s.delete(o);return a&&pt(s,"delete",o,void 0),u},clear(){const o=K(this),s=o.size!==0,r=o.clear();return s&&pt(o,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(o=>{n[o]=Wp(o,e,t)}),n}function eo(e,t){const n=zp(e,t);return(i,o,s)=>o==="__v_isReactive"?!e:o==="__v_isReadonly"?e:o==="__v_raw"?i:Reflect.get(z(n,o)&&o in i?n:i,o,s)}const Xp={get:eo(!1,!1)},Jp={get:eo(!1,!0)},Zp={get:eo(!0,!1)};const Ss=new WeakMap,Es=new WeakMap,Cs=new WeakMap,Qp=new WeakMap;function eu(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function to(e){return ft(e)?e:no(e,!1,Yp,Xp,Ss)}function tu(e){return no(e,!1,qp,Jp,Es)}function Ii(e){return no(e,!0,Kp,Zp,Cs)}function no(e,t,n,i,o){if(!X(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const s=o.get(e);if(s)return s;const r=eu(Lp(e));if(r===0)return e;const c=new Proxy(e,r===2?i:n);return o.set(e,c),c}function Ct(e){return ft(e)?Ct(e.__v_raw):!!(e&&e.__v_isReactive)}function ft(e){return!!(e&&e.__v_isReadonly)}function Ne(e){return!!(e&&e.__v_isShallow)}function io(e){return e?!!e.__v_raw:!1}function K(e){const t=e&&e.__v_raw;return t?K(t):e}function nu(e){return!z(e,"__v_skip")&&Object.isExtensible(e)&&gs(e,"__v_skip",!0),e}const Ue=e=>X(e)?to(e):e,Xt=e=>X(e)?Ii(e):e;function be(e){return e?e.__v_isRef===!0:!1}function le(e){return Is(e,!1)}function ii(e){return Is(e,!0)}function Is(e,t){return be(e)?e:new iu(e,t)}class iu{constructor(t,n){this.dep=new Qi,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:K(t),this._value=n?t:Ue(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,i=this.__v_isShallow||Ne(t)||ft(t);t=i?t:K(t),tt(t,n)&&(this._rawValue=t,this._value=i?t:Ue(t),this.dep.trigger())}}function O(e){return be(e)?e.value:e}const ou={get:(e,t,n)=>t==="__v_raw"?e:O(Reflect.get(e,t,n)),set:(e,t,n,i)=>{const o=e[t];return be(o)&&!be(n)?(o.value=n,!0):Reflect.set(e,t,n,i)}};function $s(e){return Ct(e)?e:new Proxy(e,ou)}class su{constructor(t,n,i){this.fn=t,this.setter=n,this._value=void 0,this.dep=new Qi(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=gn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&se!==this)return ys(this,!0),!0}get value(){const t=this.dep.track();return bs(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function ru(e,t,n=!1){let i,o;return j(e)?i=e:(i=e.get,o=e.set),new su(i,o,n)}const $n={},Gn=new WeakMap;let St;function cu(e,t=!1,n=St){if(n){let i=Gn.get(n);i||Gn.set(n,i=[]),i.push(e)}}function au(e,t,n=ne){const{immediate:i,deep:o,once:s,scheduler:r,augmentJob:c,call:a}=n,u=R=>o?R:Ne(R)||o===!1||o===0?ut(R,1):ut(R);let p,d,m,k,B=!1,b=!1;if(be(e)?(d=()=>e.value,B=Ne(e)):Ct(e)?(d=()=>u(e),B=!0):M(e)?(b=!0,B=e.some(R=>Ct(R)||Ne(R)),d=()=>e.map(R=>{if(be(R))return R.value;if(Ct(R))return u(R);if(j(R))return a?a(R,2):R()})):j(e)?t?d=a?()=>a(e,2):e:d=()=>{if(m){_t();try{m()}finally{dt()}}const R=St;St=p;try{return a?a(e,3,[k]):e(k)}finally{St=R}}:d=nt,t&&o){const R=d,V=o===!0?1/0:o;d=()=>ut(R(),V)}const F=Dp(),G=()=>{p.stop(),F&&F.active&&Ki(F.effects,p)};if(s&&t){const R=t;t=(...V)=>{const ce=R(...V);return G(),ce}}let C=b?new Array(e.length).fill($n):$n;const U=R=>{if(!(!(p.flags&1)||!p.dirty&&!R))if(t){const V=p.run();if(R||o||B||(b?V.some((ce,J)=>tt(ce,C[J])):tt(V,C))){m&&m();const ce=St;St=p;try{const J=[V,C===$n?void 0:b&&C[0]===$n?[]:C,k];C=V,a?a(t,3,J):t(...J)}finally{St=ce}}}else p.run()};return c&&c(U),p=new xs(d),p.scheduler=r?()=>r(U,!1):U,k=R=>cu(R,!1,p),m=p.onStop=()=>{const R=Gn.get(p);if(R){if(a)a(R,4);else for(const V of R)V();Gn.delete(p)}},t?i?U(!0):C=p.run():r?r(U.bind(null,!0),!0):p.run(),G.pause=p.pause.bind(p),G.resume=p.resume.bind(p),G.stop=G,G}function ut(e,t=1/0,n){if(t<=0||!X(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,be(e))ut(e.value,t,n);else if(M(e))for(let i=0;i<e.length;i++)ut(e[i],t,n);else if(ps(e)||qt(e))e.forEach(i=>{ut(i,t,n)});else if(ds(e)){for(const i in e)ut(e[i],t,n);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&ut(e[i],t,n)}return e}/**
* @vue/runtime-core v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function wn(e,t,n,i){try{return i?e(...i):e()}catch(o){oi(o,t,n)}}function Fe(e,t,n,i){if(j(e)){const o=wn(e,t,n,i);return o&&us(o)&&o.catch(s=>{oi(s,t,n)}),o}if(M(e)){const o=[];for(let s=0;s<e.length;s++)o.push(Fe(e[s],t,n,i));return o}}function oi(e,t,n,i=!0){const o=t?t.vnode:null,{errorHandler:s,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||ne;if(t){let c=t.parent;const a=t.proxy,u=`https://vuejs.org/error-reference/#runtime-${n}`;for(;c;){const p=c.ec;if(p){for(let d=0;d<p.length;d++)if(p[d](e,a,u)===!1)return}c=c.parent}if(s){_t(),wn(s,null,10,[e,a,u]),dt();return}}lu(e,n,o,i,r)}function lu(e,t,n,i=!0,o=!1){if(o)throw e;console.error(e)}const Oe=[];let Je=-1;const Wt=[];let kt=null,jt=0;const Ms=Promise.resolve();let Un=null;function pu(e){const t=Un||Ms;return e?t.then(this?e.bind(this):e):t}function uu(e){let t=Je+1,n=Oe.length;for(;t<n;){const i=t+n>>>1,o=Oe[i],s=hn(o);s<e||s===e&&o.flags&2?t=i+1:n=i}return t}function oo(e){if(!(e.flags&1)){const t=hn(e),n=Oe[Oe.length-1];!n||!(e.flags&2)&&t>=hn(n)?Oe.push(e):Oe.splice(uu(t),0,e),e.flags|=1,Ns()}}function Ns(){Un||(Un=Ms.then(Fs))}function _u(e){if(!M(e))kt&&e.id===-1?kt.splice(jt+1,0,e):e.flags&1||(Wt.push(e),e.flags|=1);else for(let t=0;t<e.length;t++)Wt.push(e[t]);Ns()}function ko(e,t,n=Je+1){for(;n<Oe.length;n++){const i=Oe[n];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;Oe.splice(n,1),n--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function Ds(e){if(Wt.length){const t=[...new Set(Wt)].sort((n,i)=>hn(n)-hn(i));if(Wt.length=0,kt){for(let n=0;n<t.length;n++)kt.push(t[n]);return}for(kt=t,jt=0;jt<kt.length;jt++){const n=kt[jt];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}kt=null,jt=0}}const hn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Fs(e){try{for(Je=0;Je<Oe.length;Je++){const t=Oe[Je];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),wn(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Je<Oe.length;Je++){const t=Oe[Je];t&&(t.flags&=-2)}Je=-1,Oe.length=0,Ds(),Un=null,(Oe.length||Wt.length)&&Fs()}}let Me=null,Bs=null;function Vn(e){const t=Me;return Me=e,Bs=e&&e.type.__scopeId||null,t}function Hs(e,t=Me,n){if(!t||e._n)return e;const i=(...o)=>{i._d&&Eo(-1);const s=Vn(t),r=It.length;let c;try{c=e(...o)}finally{for(let a=It.length;a>r;a--)_r();Vn(s),i._d&&Eo(1)}return c};return i._n=!0,i._c=!0,i._d=!0,i}function du(e,t){if(Me===null)return e;const n=li(Me),i=e.dirs||(e.dirs=[]);for(let o=0;o<t.length;o++){let[s,r,c,a=ne]=t[o];s&&(j(s)&&(s={mounted:s,updated:s}),s.deep&&ut(r),i.push({dir:s,instance:n,value:r,oldValue:void 0,arg:c,modifiers:a}))}return e}function Pt(e,t,n,i){const o=e.dirs,s=t&&t.dirs;for(let r=0;r<o.length;r++){const c=o[r];s&&(c.oldValue=s[r].value);let a=c.dir[i];a&&(_t(),Fe(a,n,8,[e.el,c,e,t]),dt())}}function fu(e,t){if(we){let n=we.provides;const i=we.parent&&we.parent.provides;i===n&&(n=we.provides=Object.create(i)),n[e]=t}}function Fn(e,t,n=!1){const i=mr();if(i||zt){let o=zt?zt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(o&&e in o)return o[e];if(arguments.length>1)return n&&j(t)?t.call(i&&i.proxy):t}}const gu=Symbol.for("v-scx"),mu=()=>Fn(gu);function Ge(e,t,n){return js(e,t,n)}function js(e,t,n=ne){const{immediate:i,deep:o,flush:s,once:r}=n,c=me({},n),a=t&&i||!t&&s!=="post";let u;if(yn){if(s==="sync"){const k=mu();u=k.__watcherHandles||(k.__watcherHandles=[])}else if(!a){const k=()=>{};return k.stop=nt,k.resume=nt,k.pause=nt,k}}const p=we;c.call=(k,B,b)=>Fe(k,p,B,b);let d=!1;s==="post"?c.scheduler=k=>{Se(k,p&&p.suspense)}:s!=="sync"&&(d=!0,c.scheduler=(k,B)=>{B?k():oo(k)}),c.augmentJob=k=>{t&&(k.flags|=4),d&&(k.flags|=2,p&&(k.id=p.uid,k.i=p))};const m=au(e,t,c);return yn&&(u?u.push(m):a&&m()),m}function hu(e,t,n){const i=this.proxy,o=ue(e)?e.includes(".")?Gs(i,e):()=>i[e]:e.bind(i,i);let s;j(t)?s=t:(s=t.handler,n=t);const r=Sn(this),c=js(o,s.bind(i),n);return r(),c}function Gs(e,t){const n=t.split(".");return()=>{let i=e;for(let o=0;o<n.length&&i;o++)i=i[n[o]];return i}}const vu=Symbol("_vte"),si=e=>e.__isTeleport,Ze=Symbol("_leaveCb"),nn=Symbol("_enterCb");function xu(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return ro(()=>{e.isMounted=!0}),Ws(()=>{e.isUnmounting=!0}),e}const $e=[Function,Array],ku={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:$e,onEnter:$e,onAfterEnter:$e,onEnterCancelled:$e,onBeforeLeave:$e,onLeave:$e,onAfterLeave:$e,onLeaveCancelled:$e,onBeforeAppear:$e,onAppear:$e,onAfterAppear:$e,onAppearCancelled:$e};function yu(e){let t=e[0];if(e.length>1){for(const n of e)if(n.type!==ot){t=n;break}}return t}function Tu(e,t){const{leavingVNodes:n}=e;let i=n.get(t.type);return i||(i=Object.create(null),n.set(t.type,i)),i}function $i(e,t,n,i,o){const{appear:s,mode:r,persisted:c=!1,onBeforeEnter:a,onEnter:u,onAfterEnter:p,onEnterCancelled:d,onBeforeLeave:m,onLeave:k,onAfterLeave:B,onLeaveCancelled:b,onBeforeAppear:F,onAppear:G,onAfterAppear:C,onAppearCancelled:U}=t,R=String(e.key),V=Tu(n,e),ce=($,W)=>{$&&Fe($,i,9,W)},J=($,W)=>{const ie=W[1];ce($,W),M($)?$.every(w=>w.length<=1)&&ie():$.length<=1&&ie()},_e={mode:r,persisted:c,beforeEnter($){let W=a;if(!n.isMounted)if(s)W=F||a;else return;$[Ze]&&$[Ze](!0);const ie=V[R];ie&&Gt(e,ie)&&ie.el[Ze]&&ie.el[Ze](),ce(W,[$])},enter($){if(V[R]===e)return;let W=u,ie=p,w=d;if(!n.isMounted)if(s)W=G||u,ie=C||p,w=U||d;else return;let oe=!1;$[nn]=Be=>{oe||(oe=!0,Be?ce(w,[$]):ce(ie,[$]),_e.delayedLeave&&_e.delayedLeave(),$[nn]=void 0)};const he=$[nn].bind(null,!1);W?J(W,[$,he]):he()},leave($,W){const ie=String(e.key);if($[nn]&&$[nn](!0),n.isUnmounting)return W();ce(m,[$]);let w=!1;$[Ze]=he=>{w||(w=!0,W(),he?ce(b,[$]):ce(B,[$]),$[Ze]=void 0,V[ie]===e&&delete V[ie])};const oe=$[Ze].bind(null,!1);V[ie]=e,k?J(k,[$,oe]):oe()},clone($){return $i($,t,n,i)}};return _e}function Us(e){if(!so(e))return si(e.type)&&e.children?yu(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:n}=e;if(n){if(t&16)return n[0];if(t&32&&j(n.default))return n.default()}}function vn(e,t){if(e.shapeFlag&6&&e.component){e.transition=t;const n=e.component.subTree;vn(si(n.type)&&Us(n)||n,t)}else e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Vs(e,t=!1,n){let i=[],o=0;for(let s=0;s<e.length;s++){let r=e[s];const c=n==null?r.key:String(n)+String(r.key!=null?r.key:s);r.type===Te?(r.patchFlag&128&&o++,i=i.concat(Vs(r.children,t,c))):(t||r.type!==ot)&&i.push(c!=null?Mt(r,{key:c}):r)}if(o>1)for(let s=0;s<i.length;s++)i[s].patchFlag=-2;return i}function gt(e,t){return j(e)?me({name:e.name},t,{setup:e}):e}function Ys(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function yo(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const Yn=new WeakMap;function un(e,t,n,i,o=!1){if(M(e)){e.forEach((b,F)=>un(b,t&&(M(t)?t[F]:t),n,i,o));return}if(_n(i)&&!o){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&un(e,t,n,i.component.subTree);return}const s=i.shapeFlag&4?li(i.component):i.el,r=o?null:s,{i:c,r:a}=e,u=t&&t.r,p=c.refs===ne?c.refs={}:c.refs,d=c.setupState,m=K(d),k=d===ne?ls:b=>yo(p,b)?!1:z(m,b),B=(b,F)=>!(F&&yo(p,F));if(u!=null&&u!==a){if(To(t),ue(u))p[u]=null,k(u)&&(d[u]=null);else if(be(u)){const b=t;B(u,b.k)&&(u.value=null),b.k&&(p[b.k]=null)}}if(j(a))wn(a,c,12,[r,p]);else{const b=ue(a),F=be(a);if(b||F){const G=()=>{if(e.f){const C=b?k(a)?d[a]:p[a]:B()||!e.k?a.value:p[e.k];if(o)M(C)&&Ki(C,s);else if(M(C))C.includes(s)||C.push(s);else if(b)p[a]=[s],k(a)&&(d[a]=p[a]);else{const U=[s];B(a,e.k)&&(a.value=U),e.k&&(p[e.k]=U)}}else b?(p[a]=r,k(a)&&(d[a]=r)):F&&(B(a,e.k)&&(a.value=r),e.k&&(p[e.k]=r))};if(r){const C=()=>{G(),Yn.delete(e)};C.id=-1,Yn.set(e,C),Se(C,n)}else To(e),G()}}}function To(e){const t=Yn.get(e);t&&(t.flags|=8,Yn.delete(e))}ti().requestIdleCallback;ti().cancelIdleCallback;const _n=e=>!!e.type.__asyncLoader,so=e=>e.type.__isKeepAlive;function Au(e,t){Ks(e,"a",t)}function bu(e,t){Ks(e,"da",t)}function Ks(e,t,n=we){const i=e.__wdc||(e.__wdc=()=>{let o=n;for(;o;){if(o.isDeactivated)return;o=o.parent}return e()});if(ri(t,i,n),n){let o=n.parent;for(;o&&o.parent;)so(o.parent.vnode)&&Lu(i,t,n,o),o=o.parent}}function Lu(e,t,n,i){const o=ri(t,e,i,!0);Zt(()=>{Ki(i[t],o)},n)}function ri(e,t,n=we,i=!1){if(n){const o=n[e]||(n[e]=[]),s=t.__weh||(t.__weh=(...r)=>{_t();const c=Sn(n),a=Fe(t,n,e,r);return c(),dt(),a});return i?o.unshift(s):o.push(s),s}}const mt=e=>(t,n=we)=>{(!yn||e==="sp")&&ri(e,(...i)=>t(...i),n)},Pu=mt("bm"),ro=mt("m"),Ou=mt("bu"),qs=mt("u"),Ws=mt("bum"),Zt=mt("um"),wu=mt("sp"),Ru=mt("rtg"),Su=mt("rtc");function Eu(e,t=we){ri("ec",e,t)}const Cu=Symbol.for("v-ndc");function Rn(e,t,n,i){let o;const s=n,r=M(e);if(r||ue(e)){const c=r&&Ct(e);let a=!1,u=!1;c&&(a=!Ne(e),u=ft(e),e=ni(e)),o=new Array(e.length);for(let p=0,d=e.length;p<d;p++)o[p]=t(a?u?Xt(Ue(e[p])):Ue(e[p]):e[p],p,void 0,s)}else if(typeof e=="number"){o=new Array(e);for(let c=0;c<e;c++)o[c]=t(c+1,c,void 0,s)}else if(X(e))if(e[Symbol.iterator])o=Array.from(e,(c,a)=>t(c,a,void 0,s));else{const c=Object.keys(e);o=new Array(c.length);for(let a=0,u=c.length;a<u;a++){const p=c[a];o[a]=t(e[p],p,a,s)}}else o=[];return o}const Mi=e=>e?hr(e)?li(e):Mi(e.parent):null,dn=me(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Mi(e.parent),$root:e=>Mi(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Xs(e),$forceUpdate:e=>e.f||(e.f=()=>{oo(e.update)}),$nextTick:e=>e.n||(e.n=pu.bind(e.proxy)),$watch:e=>hu.bind(e)}),vi=(e,t)=>e!==ne&&!e.__isScriptSetup&&z(e,t),Iu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:i,data:o,props:s,accessCache:r,type:c,appContext:a}=e;if(t[0]!=="$"){const m=r[t];if(m!==void 0)switch(m){case 1:return i[t];case 2:return o[t];case 4:return n[t];case 3:return s[t]}else{if(vi(i,t))return r[t]=1,i[t];if(o!==ne&&z(o,t))return r[t]=2,o[t];if(z(s,t))return r[t]=3,s[t];if(n!==ne&&z(n,t))return r[t]=4,n[t];Ni&&(r[t]=0)}}const u=dn[t];let p,d;if(u)return t==="$attrs"&&Ae(e.attrs,"get",""),u(e);if((p=c.__cssModules)&&(p=p[t]))return p;if(n!==ne&&z(n,t))return r[t]=4,n[t];if(d=a.config.globalProperties,z(d,t))return d[t]},set({_:e},t,n){const{data:i,setupState:o,ctx:s}=e;return vi(o,t)?(o[t]=n,!0):i!==ne&&z(i,t)?(i[t]=n,!0):z(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(s[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:i,appContext:o,props:s,type:r}},c){let a;return!!(n[c]||e!==ne&&c[0]!=="$"&&z(e,c)||vi(t,c)||z(s,c)||z(i,c)||z(dn,c)||z(o.config.globalProperties,c)||(a=r.__cssModules)&&a[c])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:z(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function Ao(e){return M(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}let Ni=!0;function $u(e){const t=Xs(e),n=e.proxy,i=e.ctx;Ni=!1,t.beforeCreate&&bo(t.beforeCreate,e,"bc");const{data:o,computed:s,methods:r,watch:c,provide:a,inject:u,created:p,beforeMount:d,mounted:m,beforeUpdate:k,updated:B,activated:b,deactivated:F,beforeDestroy:G,beforeUnmount:C,destroyed:U,unmounted:R,render:V,renderTracked:ce,renderTriggered:J,errorCaptured:_e,serverPrefetch:$,expose:W,inheritAttrs:ie,components:w,directives:oe,filters:he}=t;if(u&&Mu(u,i,null),r)for(const re in r){const Z=r[re];j(Z)&&(i[re]=Z.bind(n))}if(o){const re=o.call(n,n);X(re)&&(e.data=to(re))}if(Ni=!0,s)for(const re in s){const Z=s[re],Ve=j(Z)?Z.bind(n,n):j(Z.get)?Z.get.bind(n,n):nt,Dt=!j(Z)&&j(Z.set)?Z.set.bind(n):nt,st=q({get:Ve,set:Dt});Object.defineProperty(i,re,{enumerable:!0,configurable:!0,get:()=>st.value,set:Re=>st.value=Re})}if(c)for(const re in c)zs(c[re],i,n,re);if(a){const re=j(a)?a.call(n):a;Reflect.ownKeys(re).forEach(Z=>{fu(Z,re[Z])})}p&&bo(p,e,"c");function fe(re,Z){M(Z)?Z.forEach(Ve=>re(Ve.bind(n))):Z&&re(Z.bind(n))}if(fe(Pu,d),fe(ro,m),fe(Ou,k),fe(qs,B),fe(Au,b),fe(bu,F),fe(Eu,_e),fe(Su,ce),fe(Ru,J),fe(Ws,C),fe(Zt,R),fe(wu,$),M(W))if(W.length){const re=e.exposed||(e.exposed={});W.forEach(Z=>{Object.defineProperty(re,Z,{get:()=>n[Z],set:Ve=>n[Z]=Ve,enumerable:!0})})}else e.exposed||(e.exposed={});V&&e.render===nt&&(e.render=V),ie!=null&&(e.inheritAttrs=ie),w&&(e.components=w),oe&&(e.directives=oe),$&&Ys(e)}function Mu(e,t,n=nt){M(e)&&(e=Di(e));for(const i in e){const o=e[i];let s;X(o)?"default"in o?s=Fn(o.from||i,o.default,!0):s=Fn(o.from||i):s=Fn(o),be(s)?Object.defineProperty(t,i,{enumerable:!0,configurable:!0,get:()=>s.value,set:r=>s.value=r}):t[i]=s}}function bo(e,t,n){Fe(M(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,n)}function zs(e,t,n,i){let o=i.includes(".")?Gs(n,i):()=>n[i];if(ue(e)){const s=t[e];j(s)&&Ge(o,s)}else if(j(e))Ge(o,e.bind(n));else if(X(e))if(M(e))e.forEach(s=>zs(s,t,n,i));else{const s=j(e.handler)?e.handler.bind(n):t[e.handler];j(s)&&Ge(o,s,e)}}function Xs(e){const t=e.type,{mixins:n,extends:i}=t,{mixins:o,optionsCache:s,config:{optionMergeStrategies:r}}=e.appContext,c=s.get(t);let a;return c?a=c:!o.length&&!n&&!i?a=t:(a={},o.length&&o.forEach(u=>Kn(a,u,r,!0)),Kn(a,t,r)),X(t)&&s.set(t,a),a}function Kn(e,t,n,i=!1){const{mixins:o,extends:s}=t;s&&Kn(e,s,n,!0),o&&o.forEach(r=>Kn(e,r,n,!0));for(const r in t)if(!(i&&r==="expose")){const c=Nu[r]||n&&n[r];e[r]=c?c(e[r],t[r]):t[r]}return e}const Nu={data:Lo,props:Po,emits:Po,methods:rn,computed:rn,beforeCreate:Le,created:Le,beforeMount:Le,mounted:Le,beforeUpdate:Le,updated:Le,beforeDestroy:Le,beforeUnmount:Le,destroyed:Le,unmounted:Le,activated:Le,deactivated:Le,errorCaptured:Le,serverPrefetch:Le,components:rn,directives:rn,watch:Fu,provide:Lo,inject:Du};function Lo(e,t){return t?e?function(){return me(j(e)?e.call(this,this):e,j(t)?t.call(this,this):t)}:t:e}function Du(e,t){return rn(Di(e),Di(t))}function Di(e){if(M(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function Le(e,t){return e?[...new Set([].concat(e,t))]:t}function rn(e,t){return e?me(Object.create(null),e,t):t}function Po(e,t){return e?M(e)&&M(t)?[...new Set([...e,...t])]:me(Object.create(null),Ao(e),Ao(t??{})):t}function Fu(e,t){if(!e)return t;if(!t)return e;const n=me(Object.create(null),e);for(const i in t)n[i]=Le(e[i],t[i]);return n}function Js(){return{app:null,config:{isNativeTag:ls,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Bu=0;function Hu(e,t){return function(i,o=null){j(i)||(i=me({},i)),o!=null&&!X(o)&&(o=null);const s=Js(),r=new WeakSet,c=[];let a=!1;const u=s.app={_uid:Bu++,_component:i,_props:o,_container:null,_context:s,_instance:null,version:h_,get config(){return s.config},set config(p){},use(p,...d){return r.has(p)||(p&&j(p.install)?(r.add(p),p.install(u,...d)):j(p)&&(r.add(p),p(u,...d))),u},mixin(p){return s.mixins.includes(p)||s.mixins.push(p),u},component(p,d){return d?(s.components[p]=d,u):s.components[p]},directive(p,d){return d?(s.directives[p]=d,u):s.directives[p]},mount(p,d,m){if(!a){const k=u._ceVNode||Ie(i,o);return k.appContext=s,m===!0?m="svg":m===!1&&(m=void 0),e(k,p,m),a=!0,u._container=p,p.__vue_app__=u,li(k.component)}},onUnmount(p){c.push(p)},unmount(){a&&(Fe(c,u._instance,16),e(null,u._container),delete u._container.__vue_app__)},provide(p,d){return s.provides[p]=d,u},runWithContext(p){const d=zt;zt=u;try{return p()}finally{zt=d}}};return u}}let zt=null;const ju=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${He(t)}Modifiers`]||e[`${Nt(t)}Modifiers`];function Gu(e,t,...n){if(e.isUnmounted)return;const i=e.vnode.props||ne;let o=n;const s=t.startsWith("update:"),r=s&&ju(i,t.slice(7));r&&(r.trim&&(o=n.map(p=>ue(p)?p.trim():p)),r.number&&(o=n.map(Wi)));let c,a=i[c=di(t)]||i[c=di(He(t))];!a&&s&&(a=i[c=di(Nt(t))]),a&&Fe(a,e,6,o);const u=i[c+"Once"];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,Fe(u,e,6,o)}}const Uu=new WeakMap;function Zs(e,t,n=!1){const i=n?Uu:t.emitsCache,o=i.get(e);if(o!==void 0)return o;const s=e.emits;let r={},c=!1;if(!j(e)){const a=u=>{const p=Zs(u,t,!0);p&&(c=!0,me(r,p))};!n&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!s&&!c?(X(e)&&i.set(e,null),null):(M(s)?s.forEach(a=>r[a]=null):me(r,s),X(e)&&i.set(e,r),r)}function ci(e,t){return!e||!Zn(t)?!1:(t=t.slice(2),t=t==="Once"?t:t.replace(/Once$/,""),z(e,t[0].toLowerCase()+t.slice(1))||z(e,Nt(t))||z(e,t))}function Oo(e){const{type:t,vnode:n,proxy:i,withProxy:o,propsOptions:[s],slots:r,attrs:c,emit:a,render:u,renderCache:p,props:d,data:m,setupState:k,ctx:B,inheritAttrs:b}=e,F=Vn(e);let G,C;try{if(n.shapeFlag&4){const R=o||i,V=R;G=et(u.call(V,R,p,d,k,m,B)),C=c}else{const R=t;G=et(R.length>1?R(d,{attrs:c,slots:r,emit:a}):R(d,null)),C=t.props?c:Vu(c)}}catch(R){It.length=0,oi(R,e,1),G=Ie(ot)}let U=G;if(C&&b!==!1){const R=Object.keys(C),{shapeFlag:V}=U;R.length&&V&7&&(s&&R.some(Qn)&&(C=Yu(C,s)),U=Mt(U,C,!1,!0))}if(n.dirs&&(U=Mt(U,null,!1,!0),U.dirs=U.dirs?U.dirs.concat(n.dirs):n.dirs),n.transition){const R=si(U.type)&&Us(U)||U;vn(R,n.transition)}return G=U,Vn(F),G}const Vu=e=>{let t;for(const n in e)(n==="class"||n==="style"||Zn(n))&&((t||(t={}))[n]=e[n]);return t},Yu=(e,t)=>{const n={};for(const i in e)(!Qn(i)||!(i.slice(9)in t))&&(n[i]=e[i]);return n};function Ku(e,t,n){const{props:i,children:o,component:s}=e,{props:r,children:c,patchFlag:a}=t,u=s.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?wo(i,r,u):!!r;if(a&8){const p=t.dynamicProps;for(let d=0;d<p.length;d++){const m=p[d];if(Qs(r,i,m)&&!ci(u,m))return!0}}}else return(o||c)&&(!c||!c.$stable)?!0:i===r?!1:i?r?wo(i,r,u):!0:!!r;return!1}function wo(e,t,n){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let o=0;o<i.length;o++){const s=i[o];if(Qs(t,e,s)&&!ci(n,s))return!0}return!1}function Qs(e,t,n){const i=e[n],o=t[n];return n==="style"&&X(i)&&X(o)?!zi(i,o):i!==o}function qu({vnode:e,parent:t,suspense:n},i){for(;t;){const o=t.subTree;if(o.suspense&&o.suspense.activeBranch===e&&(o.suspense.vnode.el=o.el=i,e=o),o===e)(e=t.vnode).el=i,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=i)}const er={},tr=()=>Object.create(er),nr=e=>Object.getPrototypeOf(e)===er;function Wu(e,t,n,i=!1){const o={},s=tr();e.propsDefaults=Object.create(null),ir(e,t,o,s);for(const r in e.propsOptions[0])r in o||(o[r]=void 0);n?e.props=i?o:tu(o):e.type.props?e.props=o:e.props=s,e.attrs=s}function zu(e,t,n,i){const{props:o,attrs:s,vnode:{patchFlag:r}}=e,c=K(o),[a]=e.propsOptions;let u=!1;if((i||r>0)&&!(r&16)){if(r&8){const p=e.vnode.dynamicProps;for(let d=0;d<p.length;d++){let m=p[d];if(ci(e.emitsOptions,m))continue;const k=t[m];if(a)if(z(s,m))k!==s[m]&&(s[m]=k,u=!0);else{const B=He(m);o[B]=Fi(a,c,B,k,e,!1)}else k!==s[m]&&(s[m]=k,u=!0)}}}else{ir(e,t,o,s)&&(u=!0);let p;for(const d in c)(!t||!z(t,d)&&((p=Nt(d))===d||!z(t,p)))&&(a?n&&(n[d]!==void 0||n[p]!==void 0)&&(o[d]=Fi(a,c,d,void 0,e,!0)):delete o[d]);if(s!==c)for(const d in s)(!t||!z(t,d))&&(delete s[d],u=!0)}u&&pt(e.attrs,"set","")}function ir(e,t,n,i){const[o,s]=e.propsOptions;let r=!1,c;if(t)for(let a in t){if(an(a))continue;const u=t[a];let p;o&&z(o,p=He(a))?!s||!s.includes(p)?n[p]=u:(c||(c={}))[p]=u:ci(e.emitsOptions,a)||(!(a in i)||u!==i[a])&&(i[a]=u,r=!0)}if(s){const a=K(n),u=c||ne;for(let p=0;p<s.length;p++){const d=s[p];n[d]=Fi(o,a,d,u[d],e,!z(u,d))}}return r}function Fi(e,t,n,i,o,s){const r=e[n];if(r!=null){const c=z(r,"default");if(c&&i===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&j(a)){const{propsDefaults:u}=o;if(n in u)i=u[n];else{const p=Sn(o);i=u[n]=a.call(null,t),p()}}else i=a;o.ce&&o.ce._setProp(n,i)}r[0]&&(s&&!c?i=!1:r[1]&&(i===""||i===Nt(n))&&(i=!0))}return i}const Xu=new WeakMap;function or(e,t,n=!1){const i=n?Xu:t.propsCache,o=i.get(e);if(o)return o;const s=e.props,r={},c=[];let a=!1;if(!j(e)){const p=d=>{a=!0;const[m,k]=or(d,t,!0);me(r,m),k&&c.push(...k)};!n&&t.mixins.length&&t.mixins.forEach(p),e.extends&&p(e.extends),e.mixins&&e.mixins.forEach(p)}if(!s&&!a)return X(e)&&i.set(e,Kt),Kt;if(M(s))for(let p=0;p<s.length;p++){const d=He(s[p]);Ro(d)&&(r[d]=ne)}else if(s)for(const p in s){const d=He(p);if(Ro(d)){const m=s[p],k=r[d]=M(m)||j(m)?{type:m}:me({},m),B=k.type;let b=!1,F=!0;if(M(B))for(let G=0;G<B.length;++G){const C=B[G],U=j(C)&&C.name;if(U==="Boolean"){b=!0;break}else U==="String"&&(F=!1)}else b=j(B)&&B.name==="Boolean";k[0]=b,k[1]=F,(b||z(k,"default"))&&c.push(d)}}const u=[r,c];return X(e)&&i.set(e,u),u}function Ro(e){return e[0]!=="$"&&!an(e)}const co=e=>e==="_"||e==="_ctx"||e==="$stable",ao=e=>M(e)?e.map(et):[et(e)],Ju=(e,t,n)=>{if(t._n)return t;const i=Hs((...o)=>ao(t(...o)),n);return i._c=!1,i},sr=(e,t,n)=>{const i=e._ctx;for(const o in e){if(co(o))continue;const s=e[o];if(j(s))t[o]=Ju(o,s,i);else if(s!=null){const r=ao(s);t[o]=()=>r}}},rr=(e,t)=>{const n=ao(t);e.slots.default=()=>n},cr=(e,t,n)=>{for(const i in t)(n||!co(i))&&(e[i]=t[i])},Zu=(e,t,n)=>{const i=e.slots=tr();if(e.vnode.shapeFlag&32){const o=t._;o?(cr(i,t,n),n&&gs(i,"_",o,!0)):sr(t,i)}else t&&rr(e,t)},Qu=(e,t,n)=>{const{vnode:i,slots:o}=e;let s=!0,r=ne;if(i.shapeFlag&32){const c=t._;c?n&&c===1?s=!1:cr(o,t,n):(s=!t.$stable,sr(t,o)),r=t}else t&&(rr(e,t),r={default:1});if(s)for(const c in o)!co(c)&&r[c]==null&&delete o[c]},Se=o_;function e_(e){return t_(e)}function t_(e,t){const n=ti();n.__VUE__=!0;const{insert:i,remove:o,patchProp:s,createElement:r,createText:c,createComment:a,setText:u,setElementText:p,parentNode:d,nextSibling:m,setScopeId:k=nt,insertStaticContent:B}=e,b=(l,_,f,x=null,v=null,g=null,L=void 0,A=null,T=!!_.dynamicChildren)=>{if(l===_)return;l&&!Gt(l,_)&&(x=Q(l),Re(l,v,g,!0),l=null),_.patchFlag===-2&&(T=!1,_.dynamicChildren=null);const{type:h,ref:I,shapeFlag:P}=_;switch(h){case ai:F(l,_,f,x);break;case ot:G(l,_,f,x);break;case Bn:l==null&&C(_,f,x,L);break;case Te:w(l,_,f,x,v,g,L,A,T);break;default:P&1?V(l,_,f,x,v,g,L,A,T):P&6?oe(l,_,f,x,v,g,L,A,T):(P&64||P&128)&&h.process(l,_,f,x,v,g,L,A,T,ht)}I!=null&&v?un(I,l&&l.ref,g,_||l,!_):I==null&&l&&l.ref!=null&&un(l.ref,null,g,l,!0)},F=(l,_,f,x)=>{if(l==null)i(_.el=c(_.children),f,x);else{const v=_.el=l.el;_.children!==l.children&&u(v,_.children)}},G=(l,_,f,x)=>{l==null?i(_.el=a(_.children||""),f,x):_.el=l.el},C=(l,_,f,x)=>{[l.el,l.anchor]=B(l.children,_,f,x,l.el,l.anchor)},U=({el:l,anchor:_},f,x)=>{let v;for(;l&&l!==_;)v=m(l),i(l,f,x),l=v;i(_,f,x)},R=({el:l,anchor:_})=>{let f;for(;l&&l!==_;)f=m(l),o(l),l=f;o(_)},V=(l,_,f,x,v,g,L,A,T)=>{if(_.type==="svg"?L="svg":_.type==="math"&&(L="mathml"),l==null)ce(_,f,x,v,g,L,A,T);else{const h=l.el&&l.el._isVueCE?l.el:null;try{h&&h._beginPatch(),$(l,_,v,g,L,A,T)}finally{h&&h._endPatch()}}},ce=(l,_,f,x,v,g,L,A)=>{let T,h;const{props:I,shapeFlag:P,transition:S,dirs:N}=l;if(T=l.el=r(l.type,g,I&&I.is,I),P&8?p(T,l.children):P&16&&_e(l.children,T,null,x,v,xi(l,g),L,A),N&&Pt(l,null,x,"created"),J(T,l,l.scopeId,L,x),I){for(const te in I)te!=="value"&&!an(te)&&s(T,te,null,I[te],g,x);"value"in I&&s(T,"value",null,I.value,g),(h=I.onVnodeBeforeMount)&&ze(h,x,l)}N&&Pt(l,null,x,"beforeMount");const Y=n_(v,S);Y&&S.beforeEnter(T),i(T,_,f),((h=I&&I.onVnodeMounted)||Y||N)&&Se(()=>{try{h&&ze(h,x,l),Y&&S.enter(T),N&&Pt(l,null,x,"mounted")}finally{}},v)},J=(l,_,f,x,v)=>{if(f&&k(l,f),x)for(let g=0;g<x.length;g++)k(l,x[g]);if(v){let g=v.subTree;if(_===g||ur(g.type)&&(g.ssContent===_||g.ssFallback===_)){const L=v.vnode;J(l,L,L.scopeId,L.slotScopeIds,v.parent)}}},_e=(l,_,f,x,v,g,L,A,T=0)=>{for(let h=T;h<l.length;h++){const I=l[h]=A?lt(l[h]):et(l[h]);b(null,I,_,f,x,v,g,L,A)}},$=(l,_,f,x,v,g,L)=>{const A=_.el=l.el;let{patchFlag:T,dynamicChildren:h,dirs:I}=_;T|=l.patchFlag&16;const P=l.props||ne,S=_.props||ne;let N;if(f&&Ot(f,!1),(N=S.onVnodeBeforeUpdate)&&ze(N,f,_,l),I&&Pt(_,l,f,"beforeUpdate"),f&&Ot(f,!0),h&&(!l.dynamicChildren||l.dynamicChildren.length!==h.length)&&(T=0,L=!1,h=null),(P.innerHTML&&S.innerHTML==null||P.textContent&&S.textContent==null)&&p(A,""),h?W(l.dynamicChildren,h,A,f,x,xi(_,v),g):L||Z(l,_,A,null,f,x,xi(_,v),g,!1),T>0){if(T&16)ie(A,P,S,f,v);else if(T&2&&P.class!==S.class&&s(A,"class",null,S.class,v),T&4&&s(A,"style",P.style,S.style,v),T&8){const Y=_.dynamicProps;for(let te=0;te<Y.length;te++){const ee=Y[te],ge=P[ee],ke=S[ee];(ke!==ge||ee==="value")&&s(A,ee,ge,ke,v,f)}}T&1&&l.children!==_.children&&p(A,_.children)}else!L&&h==null&&ie(A,P,S,f,v);((N=S.onVnodeUpdated)||I)&&Se(()=>{N&&ze(N,f,_,l),I&&Pt(_,l,f,"updated")},x)},W=(l,_,f,x,v,g,L)=>{for(let A=0;A<_.length;A++){const T=l[A],h=_[A],I=T.el&&(T.type===Te||!Gt(T,h)||T.shapeFlag&198)?d(T.el):f;b(T,h,I,null,x,v,g,L,!0)}},ie=(l,_,f,x,v)=>{if(_!==f){if(_!==ne)for(const g in _)!an(g)&&!(g in f)&&s(l,g,_[g],null,v,x);for(const g in f){if(an(g))continue;const L=f[g],A=_[g];L!==A&&g!=="value"&&s(l,g,A,L,v,x)}"value"in f&&s(l,"value",_.value,f.value,v)}},w=(l,_,f,x,v,g,L,A,T)=>{const h=_.el=l?l.el:c(""),I=_.anchor=l?l.anchor:c("");let{patchFlag:P,dynamicChildren:S,slotScopeIds:N}=_;N&&(A=A?A.concat(N):N),l==null?(i(h,f,x),i(I,f,x),_e(_.children||[],f,I,v,g,L,A,T)):P>0&&P&64&&S&&l.dynamicChildren&&l.dynamicChildren.length===S.length?(W(l.dynamicChildren,S,f,v,g,L,A),(_.key!=null||v&&_===v.subTree)&&ar(l,_,!0)):Z(l,_,f,I,v,g,L,A,T)},oe=(l,_,f,x,v,g,L,A,T)=>{_.slotScopeIds=A,l==null?_.shapeFlag&512?v.ctx.activate(_,f,x,L,T):he(_,f,x,v,g,L,T):Be(l,_,T)},he=(l,_,f,x,v,g,L)=>{const A=l.component=u_(l,x,v);if(so(l)&&(A.ctx.renderer=ht),__(A,!1,L),A.asyncDep){if(v&&v.registerDep(A,fe,L),!l.el){const T=A.subTree=Ie(ot);G(null,T,_,f),l.placeholder=T.el}}else fe(A,l,_,f,v,g,L)},Be=(l,_,f)=>{const x=_.component=l.component;if(Ku(l,_,f))if(x.asyncDep&&!x.asyncResolved){re(x,_,f);return}else x.next=_,x.update();else _.el=l.el,x.vnode=_},fe=(l,_,f,x,v,g,L)=>{const A=()=>{if(l.isMounted){let{next:P,bu:S,u:N,parent:Y,vnode:te}=l;{const qe=lr(l);if(qe){P&&(P.el=te.el,re(l,P,L)),qe.asyncDep.then(()=>{Se(()=>{l.isUnmounted||h()},v)});return}}let ee=P,ge;Ot(l,!1),P?(P.el=te.el,re(l,P,L)):P=te,S&&Dn(S),(ge=P.props&&P.props.onVnodeBeforeUpdate)&&ze(ge,Y,P,te),Ot(l,!0);const ke=Oo(l),Ke=l.subTree;l.subTree=ke,b(Ke,ke,d(Ke.el),Q(Ke),l,v,g),P.el=ke.el,ee===null&&qu(l,ke.el),N&&Se(N,v),(ge=P.props&&P.props.onVnodeUpdated)&&Se(()=>ze(ge,Y,P,te),v)}else{let P;const{el:S,props:N}=_,{bm:Y,m:te,parent:ee,root:ge,type:ke}=l,Ke=_n(_);Ot(l,!1),Y&&Dn(Y),!Ke&&(P=N&&N.onVnodeBeforeMount)&&ze(P,ee,_),Ot(l,!0);{ge.ce&&ge.ce._hasShadowRoot()&&ge.ce._injectChildStyle(ke,l.parent?l.parent.type:void 0);const qe=l.subTree=Oo(l);b(null,qe,f,x,l,v,g),_.el=qe.el}if(te&&Se(te,v),!Ke&&(P=N&&N.onVnodeMounted)){const qe=_;Se(()=>ze(P,ee,qe),v)}(_.shapeFlag&256||ee&&_n(ee.vnode)&&ee.vnode.shapeFlag&256)&&l.a&&Se(l.a,v),l.isMounted=!0,_=f=x=null}};l.scope.on();const T=l.effect=new xs(A);l.scope.off();const h=l.update=T.run.bind(T),I=l.job=T.runIfDirty.bind(T);I.i=l,I.id=l.uid,T.scheduler=()=>oo(I),Ot(l,!0),h()},re=(l,_,f)=>{_.component=l;const x=l.vnode.props;l.vnode=_,l.next=null,zu(l,_.props,x,f),Qu(l,_.children,f),_t(),ko(l),dt()},Z=(l,_,f,x,v,g,L,A,T=!1)=>{const h=l&&l.children,I=l?l.shapeFlag:0,P=_.children,{patchFlag:S,shapeFlag:N}=_;if(S>0){if(S&128){Dt(h,P,f,x,v,g,L,A,T);return}else if(S&256){Ve(h,P,f,x,v,g,L,A,T);return}}N&8?(I&16&&Lt(h,v,g),P!==h&&p(f,P)):I&16?N&16?Dt(h,P,f,x,v,g,L,A,T):Lt(h,v,g,!0):(I&8&&p(f,""),N&16&&_e(P,f,x,v,g,L,A,T))},Ve=(l,_,f,x,v,g,L,A,T)=>{l=l||Kt,_=_||Kt;const h=l.length,I=_.length,P=Math.min(h,I);let S;for(S=0;S<P;S++){const N=_[S]=T?lt(_[S]):et(_[S]);b(l[S],N,f,null,v,g,L,A,T)}h>I?Lt(l,v,g,!0,!1,P):_e(_,f,x,v,g,L,A,T,P)},Dt=(l,_,f,x,v,g,L,A,T)=>{let h=0;const I=_.length;let P=l.length-1,S=I-1;for(;h<=P&&h<=S;){const N=l[h],Y=_[h]=T?lt(_[h]):et(_[h]);if(Gt(N,Y))b(N,Y,f,null,v,g,L,A,T);else break;h++}for(;h<=P&&h<=S;){const N=l[P],Y=_[S]=T?lt(_[S]):et(_[S]);if(Gt(N,Y))b(N,Y,f,null,v,g,L,A,T);else break;P--,S--}if(h>P){if(h<=S){const N=S+1,Y=N<I?_[N].el:x;for(;h<=S;)b(null,_[h]=T?lt(_[h]):et(_[h]),f,Y,v,g,L,A,T),h++}}else if(h>S)for(;h<=P;)Re(l[h],v,g,!0),h++;else{const N=h,Y=h,te=new Map;for(h=Y;h<=S;h++){const Ee=_[h]=T?lt(_[h]):et(_[h]);Ee.key!=null&&te.set(Ee.key,h)}let ee,ge=0;const ke=S-Y+1;let Ke=!1,qe=0;const en=new Array(ke);for(h=0;h<ke;h++)en[h]=0;for(h=N;h<=P;h++){const Ee=l[h];if(ge>=ke){Re(Ee,v,g,!0);continue}let We;if(Ee.key!=null)We=te.get(Ee.key);else for(ee=Y;ee<=S;ee++)if(en[ee-Y]===0&&Gt(Ee,_[ee])){We=ee;break}We===void 0?Re(Ee,v,g,!0):(en[We-Y]=h+1,We>=qe?qe=We:Ke=!0,b(Ee,_[We],f,null,v,g,L,A,T),ge++)}const _o=Ke?i_(en):Kt;for(ee=_o.length-1,h=ke-1;h>=0;h--){const Ee=Y+h,We=_[Ee],fo=_[Ee+1],go=Ee+1<I?fo.el||pr(fo):x;en[h]===0?b(null,We,f,go,v,g,L,A,T):Ke&&(ee<0||h!==_o[ee]?st(We,f,go,2):ee--)}}},st=(l,_,f,x,v=null)=>{const{el:g,type:L,transition:A,children:T,shapeFlag:h}=l;if(h&6){st(l.component.subTree,_,f,x);return}if(h&128){l.suspense.move(_,f,x);return}if(h&64){L.move(l,_,f,ht);return}if(L===Te){i(g,_,f);for(let P=0;P<T.length;P++)st(T[P],_,f,x);i(l.anchor,_,f);return}if(L===Bn){U(l,_,f);return}if(x!==2&&h&1&&A)if(x===0)A.persisted&&!g[Ze]?i(g,_,f):(A.beforeEnter(g),i(g,_,f),Se(()=>A.enter(g),v));else{const{leave:P,delayLeave:S,afterLeave:N}=A,Y=()=>{l.ctx.isUnmounted?o(g):i(g,_,f)},te=()=>{const ee=g._isLeaving||!!g[Ze];g._isLeaving&&g[Ze](!0),A.persisted&&!ee?Y():P(g,()=>{Y(),N&&N()})};S?S(g,Y,te):te()}else i(g,_,f)},Re=(l,_,f,x=!1,v=!1)=>{const{type:g,props:L,ref:A,children:T,dynamicChildren:h,shapeFlag:I,patchFlag:P,dirs:S,cacheIndex:N,memo:Y}=l;if(P===-2&&(v=!1),A!=null&&(_t(),un(A,null,f,l,!0),dt()),N!=null&&(_.renderCache[N]=void 0),I&256){_.ctx.deactivate(l);return}const te=I&1&&S,ee=!_n(l);let ge;if(ee&&(ge=L&&L.onVnodeBeforeUnmount)&&ze(ge,_,l),I&6)En(l.component,f,x);else{if(I&128){l.suspense.unmount(f,x);return}te&&Pt(l,null,_,"beforeUnmount"),I&64?l.type.remove(l,_,f,ht,x):h&&!h.hasOnce&&(g!==Te||P>0&&P&64)?Lt(h,_,f,!1,!0):(g===Te&&P&384||!v&&I&16)&&Lt(T,_,f),x&&bt(l)}const ke=Y!=null&&N==null;(ee&&(ge=L&&L.onVnodeUnmounted)||te||ke)&&Se(()=>{ge&&ze(ge,_,l),te&&Pt(l,null,_,"unmounted"),ke&&(l.el=null)},f)},bt=l=>{const{type:_,el:f,anchor:x,transition:v}=l;if(_===Te){Ft(f,x);return}if(_===Bn){R(l);return}const g=()=>{o(f),v&&!v.persisted&&v.afterLeave&&v.afterLeave()};if(l.shapeFlag&1&&v&&!v.persisted){const{leave:L,delayLeave:A}=v,T=()=>L(f,g);A?A(l.el,g,T):T()}else g()},Ft=(l,_)=>{let f;for(;l!==_;)f=m(l),o(l),l=f;o(_)},En=(l,_,f)=>{const{bum:x,scope:v,job:g,subTree:L,um:A,m:T,a:h}=l;So(T),So(h),x&&Dn(x),v.stop(),g&&(g.flags|=8,Re(L,l,_,f)),A&&Se(A,_),Se(()=>{l.isUnmounted=!0},_)},Lt=(l,_,f,x=!1,v=!1,g=0)=>{for(let L=g;L<l.length;L++)Re(l[L],_,f,x,v)},Q=l=>{if(l.shapeFlag&6)return Q(l.component.subTree);if(l.shapeFlag&128)return l.suspense.next();const _=m(l.anchor||l.el),f=_&&_[vu];return f?m(f):_};let ae=!1;const Ye=(l,_,f)=>{let x;l==null?_._vnode&&(Re(_._vnode,null,null,!0),x=_._vnode.component):b(_._vnode||null,l,_,null,null,null,f),_._vnode=l,ae||(ae=!0,ko(x),Ds(),ae=!1)},ht={p:b,um:Re,m:st,r:bt,mt:he,mc:_e,pc:Z,pbc:W,n:Q,o:e};return{render:Ye,hydrate:void 0,createApp:Hu(Ye)}}function xi({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function Ot({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function n_(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function ar(e,t,n=!1){const i=e.children,o=t.children;if(M(i)&&M(o))for(let s=0;s<i.length;s++){const r=i[s];let c=o[s];c.shapeFlag&1&&!c.dynamicChildren&&((c.patchFlag<=0||c.patchFlag===32)&&(c=o[s]=lt(o[s]),c.el=r.el),!n&&c.patchFlag!==-2&&ar(r,c)),c.type===ai&&(c.patchFlag===-1&&(c=o[s]=lt(c)),c.el=r.el),c.type===ot&&!c.el&&(c.el=r.el)}}function i_(e){const t=e.slice(),n=[0];let i,o,s,r,c;const a=e.length;for(i=0;i<a;i++){const u=e[i];if(u!==0){if(o=n[n.length-1],e[o]<u){t[i]=o,n.push(i);continue}for(s=0,r=n.length-1;s<r;)c=s+r>>1,e[n[c]]<u?s=c+1:r=c;u<e[n[s]]&&(s>0&&(t[i]=n[s-1]),n[s]=i)}}for(s=n.length,r=n[s-1];s-- >0;)n[s]=r,r=t[r];return n}function lr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:lr(t)}function So(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function pr(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?pr(t.subTree):null}const ur=e=>e.__isSuspense;function o_(e,t){t&&t.pendingBranch?M(e)?t.effects.push(...e):t.effects.push(e):_u(e)}const Te=Symbol.for("v-fgt"),ai=Symbol.for("v-txt"),ot=Symbol.for("v-cmt"),Bn=Symbol.for("v-stc"),It=[];let Ce=null;function E(e=!1){It.push(Ce=e?null:[])}function _r(){It.pop(),Ce=It[It.length-1]||null}let xn=1;function Eo(e,t=!1){xn+=e,e<0&&Ce&&t&&(Ce.hasOnce=!0)}function dr(e){return e.dynamicChildren=xn>0?Ce||Kt:null,_r(),xn>0&&Ce&&Ce.push(e),e}function H(e,t,n,i,o,s){return dr(y(e,t,n,i,o,s,!0))}function ct(e,t,n,i,o){return dr(Ie(e,t,n,i,o,!0))}function fr(e){return e?e.__v_isVNode===!0:!1}function Gt(e,t){return e.type===t.type&&e.key===t.key}const gr=({key:e})=>e??null,Hn=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?ue(e)||be(e)||j(e)?{i:Me,r:e,k:t,f:!!n}:e:null);function y(e,t=null,n=null,i=0,o=null,s=e===Te?0:1,r=!1,c=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&gr(t),ref:t&&Hn(t),scopeId:Bs,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:s,patchFlag:i,dynamicProps:o,dynamicChildren:null,appContext:null,ctx:Me};return c?(qn(a,n),s&128&&e.normalize(a)):n&&(a.shapeFlag|=ue(n)?8:16),xn>0&&!r&&Ce&&(a.patchFlag>0||s&6)&&a.patchFlag!==32&&Ce.push(a),a}const Ie=s_;function s_(e,t=null,n=null,i=0,o=null,s=!1){if((!e||e===Cu)&&(e=ot),fr(e)){const c=Mt(e,t,!0);return n&&qn(c,n),xn>0&&!s&&Ce&&(c.shapeFlag&6?Ce[Ce.indexOf(e)]=c:Ce.push(c)),c.patchFlag=-2,c}if(m_(e)&&(e=e.__vccOpts),t){t=r_(t);let{class:c,style:a}=t;c&&!ue(c)&&(t.class=xe(c)),X(a)&&(io(a)&&!M(a)&&(a=me({},a)),t.style=De(a))}const r=ue(e)?1:ur(e)?128:si(e)?64:X(e)?4:j(e)?2:0;return y(e,t,n,i,o,r,s,!0)}function r_(e){return e?io(e)||nr(e)?me({},e):e:null}function Mt(e,t,n=!1,i=!1){const{props:o,ref:s,patchFlag:r,children:c,transition:a}=e,u=t?a_(o||{},t):o,p={__v_isVNode:!0,__v_skip:!0,type:e.type,props:u,key:u&&gr(u),ref:t&&t.ref?n&&s?M(s)?s.concat(Hn(t)):[s,Hn(t)]:Hn(t):s,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:c,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Te?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Mt(e.ssContent),ssFallback:e.ssFallback&&Mt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&i&&vn(p,a.clone(p)),p}function c_(e=" ",t=0){return Ie(ai,null,e,t)}function ki(e,t){const n=Ie(Bn,null,e);return n.staticCount=t,n}function Pe(e="",t=!1){return t?(E(),ct(ot,null,e)):Ie(ot,null,e)}function et(e){return e==null||typeof e=="boolean"?Ie(ot):M(e)?Ie(Te,null,e.slice()):fr(e)?lt(e):Ie(ai,null,String(e))}function lt(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Mt(e)}function qn(e,t){let n=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(M(t))n=16;else if(typeof t=="object")if(i&65){const o=t.default;o&&(o._c&&(o._d=!1),qn(e,o()),o._c&&(o._d=!0));return}else{n=32;const o=t._;!o&&!nr(t)?t._ctx=Me:o===3&&Me&&(Me.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else if(j(t)){if(i&65){qn(e,{default:t});return}t={default:t,_ctx:Me},n=32}else t=String(t),i&64?(n=16,t=[c_(t)]):n=8;e.children=t,e.shapeFlag|=n}function a_(...e){const t={};for(let n=0;n<e.length;n++){const i=e[n];for(const o in i)if(o==="class")t.class!==i.class&&(t.class=xe([t.class,i.class]));else if(o==="style")t.style=De([t.style,i.style]);else if(Zn(o)){const s=t[o],r=i[o];r&&s!==r&&!(M(s)&&s.includes(r))?t[o]=s?[].concat(s,r):r:r==null&&s==null&&!Qn(o)&&(t[o]=r)}else o!==""&&(t[o]=i[o])}return t}function ze(e,t,n,i=null){Fe(e,t,7,[n,i])}const l_=Js();let p_=0;function u_(e,t,n){const i=e.type,o=(t?t.appContext:e.appContext)||l_,s={uid:p_++,vnode:e,type:i,parent:t,appContext:o,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Np(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(o.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:or(i,o),emitsOptions:Zs(i,o),emit:null,emitted:null,propsDefaults:ne,inheritAttrs:i.inheritAttrs,ctx:ne,data:ne,props:ne,attrs:ne,slots:ne,refs:ne,setupState:ne,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return s.ctx={_:s},s.root=t?t.root:s,s.emit=Gu.bind(null,s),e.ce&&e.ce(s),s}let we=null;const mr=()=>we||Me;let Wn,kn;{const e=ti(),t=(n,i)=>{let o;return(o=e[n])||(o=e[n]=[]),o.push(i),s=>{o.length>1?o.forEach(r=>r(s)):o[0](s)}};Wn=t("__VUE_INSTANCE_SETTERS__",n=>we=n),kn=t("__VUE_SSR_SETTERS__",n=>yn=n)}const Sn=e=>{const t=we;return Wn(e),e.scope.on(),()=>{e.scope.off(),Wn(t)}},Co=()=>{we&&we.scope.off(),Wn(null)};function hr(e){return e.vnode.shapeFlag&4}let yn=!1;function __(e,t=!1,n=!1){t&&kn(t);const{props:i,children:o}=e.vnode,s=hr(e);Wu(e,i,s,t),Zu(e,o,n||t);const r=s?d_(e,t):void 0;return t&&kn(!1),r}function d_(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Iu);const{setup:i}=n;if(i){_t();const o=e.setupContext=i.length>1?g_(e):null,s=Sn(e),r=wn(i,e,0,[e.props,o]),c=us(r);if(dt(),s(),(c||e.sp)&&!_n(e)&&Ys(e),c){if(r.then(Co,Co),t)return r.then(a=>{kn(!0);try{Io(e,a,t)}finally{kn(!1)}}).catch(a=>{oi(a,e,0)});e.asyncDep=r}else Io(e,r)}else vr(e)}function Io(e,t,n){j(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:X(t)&&(e.setupState=$s(t)),vr(e)}function vr(e,t,n){const i=e.type;e.render||(e.render=i.render||nt);{const o=Sn(e);_t();try{$u(e)}finally{dt(),o()}}}const f_={get(e,t){return Ae(e,"get",""),e[t]}};function g_(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,f_),slots:e.slots,emit:e.emit,expose:t}}function li(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy($s(nu(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in dn)return dn[n](e)},has(t,n){return n in t||n in dn}})):e.proxy}function m_(e){return j(e)&&"__vccOpts"in e}const q=(e,t)=>ru(e,t,yn),h_="3.5.41";/**
* @vue/runtime-dom v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Bi;const $o=typeof window<"u"&&window.trustedTypes;if($o)try{Bi=$o.createPolicy("vue",{createHTML:e=>e})}catch{}const xr=Bi?e=>Bi.createHTML(e):e=>e,v_="http://www.w3.org/2000/svg",x_="http://www.w3.org/1998/Math/MathML",at=typeof document<"u"?document:null,Mo=at&&at.createElement("template"),k_={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,i)=>{const o=t==="svg"?at.createElementNS(v_,e):t==="mathml"?at.createElementNS(x_,e):n?at.createElement(e,{is:n}):at.createElement(e);return e==="select"&&i&&i.multiple!=null&&o.setAttribute("multiple",i.multiple),o},createText:e=>at.createTextNode(e),createComment:e=>at.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>at.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,i,o,s){const r=n?n.previousSibling:t.lastChild;if(o&&(o===s||o.nextSibling))for(;t.insertBefore(o.cloneNode(!0),n),!(o===s||!(o=o.nextSibling)););else{Mo.innerHTML=xr(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const c=Mo.content;if(i==="svg"||i==="mathml"){const a=c.firstChild;for(;a.firstChild;)c.appendChild(a.firstChild);c.removeChild(a)}t.insertBefore(c,n)}return[r?r.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},vt="transition",on="animation",Jt=Symbol("_vtc"),kr={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},y_=me({},ku,kr),wt=(e,t=[])=>{M(e)?e.forEach(n=>n(...t)):e&&e(...t)},No=e=>e?M(e)?e.some(t=>t.length>1):e.length>1:!1;function T_(e){const t={};for(const w in e)w in kr||(t[w]=e[w]);if(e.css===!1)return t;const{name:n="v",type:i,duration:o,enterFromClass:s=`${n}-enter-from`,enterActiveClass:r=`${n}-enter-active`,enterToClass:c=`${n}-enter-to`,appearFromClass:a=s,appearActiveClass:u=r,appearToClass:p=c,leaveFromClass:d=`${n}-leave-from`,leaveActiveClass:m=`${n}-leave-active`,leaveToClass:k=`${n}-leave-to`}=e,B=A_(o),b=B&&B[0],F=B&&B[1],{onBeforeEnter:G,onEnter:C,onEnterCancelled:U,onLeave:R,onLeaveCancelled:V,onBeforeAppear:ce=G,onAppear:J=C,onAppearCancelled:_e=U}=t,$=(w,oe,he,Be)=>{w._enterCancelled=Be,xt(w,oe?p:c),xt(w,oe?u:r),he&&he()},W=(w,oe)=>{w._isLeaving=!1,xt(w,d),xt(w,k),xt(w,m),oe&&oe()},ie=w=>(oe,he)=>{const Be=w?J:C,fe=()=>$(oe,w,he);wt(Be,[oe,fe]),Do(()=>{xt(oe,w?a:s),Xe(oe,w?p:c),No(Be)||Fo(oe,i,b,fe)})};return me(t,{onBeforeEnter(w){wt(G,[w]),Xe(w,s),Xe(w,r)},onBeforeAppear(w){wt(ce,[w]),Xe(w,a),Xe(w,u)},onEnter:ie(!1),onAppear:ie(!0),onLeave(w,oe){w._isLeaving=!0;const he=()=>W(w,oe);Xe(w,d),w._enterCancelled?(Xe(w,m),Hi(w)):(Hi(w),Xe(w,m)),Do(()=>{w._isLeaving&&(xt(w,d),Xe(w,k),No(R)||Fo(w,i,F,he))}),wt(R,[w,he])},onEnterCancelled(w){$(w,!1,void 0,!0),wt(U,[w])},onAppearCancelled(w){$(w,!0,void 0,!0),wt(_e,[w])},onLeaveCancelled(w){W(w),wt(V,[w])}})}function A_(e){if(e==null)return null;if(X(e))return[yi(e.enter),yi(e.leave)];{const t=yi(e);return[t,t]}}function yi(e){return wp(e)}function Xe(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[Jt]||(e[Jt]=new Set)).add(t)}function xt(e,t){t.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const n=e[Jt];n&&(n.delete(t),n.size||(e[Jt]=void 0))}function Do(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let b_=0;function Fo(e,t,n,i){const o=e._endId=++b_,s=()=>{o===e._endId&&i()};if(n!=null)return setTimeout(s,n);const{type:r,timeout:c,propCount:a}=yr(e,t);if(!r)return i();const u=r+"end";let p=0;const d=()=>{e.removeEventListener(u,m),s()},m=k=>{k.target===e&&++p>=a&&d()};setTimeout(()=>{p<a&&d()},c+1),e.addEventListener(u,m)}function yr(e,t){const n=window.getComputedStyle(e),i=B=>(n[B]||"").split(", "),o=i(`${vt}Delay`),s=i(`${vt}Duration`),r=Bo(o,s),c=i(`${on}Delay`),a=i(`${on}Duration`),u=Bo(c,a);let p=null,d=0,m=0;t===vt?r>0&&(p=vt,d=r,m=s.length):t===on?u>0&&(p=on,d=u,m=a.length):(d=Math.max(r,u),p=d>0?r>u?vt:on:null,m=p?p===vt?s.length:a.length:0);const k=p===vt&&/\b(?:transform|all)(?:,|$)/.test(i(`${vt}Property`).toString());return{type:p,timeout:d,propCount:m,hasTransform:k}}function Bo(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((n,i)=>Ho(n)+Ho(e[i])))}function Ho(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Hi(e){return(e?e.ownerDocument:document).body.offsetHeight}function L_(e,t,n){const i=e[Jt];i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const jo=Symbol("_vod"),Tr=Symbol("_vsh"),P_=Symbol(""),O_=/(?:^|;)\s*display\s*:/;function w_(e,t,n){const i=e.style,o=ue(n);let s=!1;if(n&&!o){if(t)if(ue(t))for(const r of t.split(";")){const c=r.slice(0,r.indexOf(":")).trim();n[c]==null&&cn(i,c,"")}else for(const r in t)n[r]==null&&cn(i,r,"");for(const r in n){r==="display"&&(s=!0);const c=n[r];c!=null?S_(e,r,!ue(t)&&t?t[r]:void 0,c)||cn(i,r,c):cn(i,r,"")}}else if(o){if(t!==n){const r=i[P_];r&&(n+=";"+r),i.cssText=n,s=O_.test(n)}}else t&&e.removeAttribute("style");jo in e&&(e[jo]=s?i.display:"",e[Tr]&&(i.display="none"))}const Go=/\s*!important$/;function cn(e,t,n){if(M(n))n.forEach(i=>cn(e,t,i));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const i=R_(e,t);Go.test(n)?e.setProperty(Nt(i),n.replace(Go,""),"important"):e[i]=n}}const Uo=["Webkit","Moz","ms"],Ti={};function R_(e,t){const n=Ti[t];if(n)return n;let i=He(t);if(i!=="filter"&&i in e)return Ti[t]=i;i=fs(i);for(let o=0;o<Uo.length;o++){const s=Uo[o]+i;if(s in e)return Ti[t]=s}return t}function S_(e,t,n,i){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&ue(i)&&n===i}const Vo="http://www.w3.org/1999/xlink";function Yo(e,t,n,i,o,s=$p(t)){i&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(Vo,t.slice(6,t.length)):e.setAttributeNS(Vo,t,n):n==null||s&&!ms(n)?e.removeAttribute(t):e.setAttribute(t,s?"":it(n)?String(n):n)}function Ko(e,t,n,i,o){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?xr(n):n);return}const s=e.tagName;if(t==="value"&&s!=="PROGRESS"&&!s.includes("-")){const c=s==="OPTION"?e.getAttribute("value")||"":e.value,a=n==null?e.type==="checkbox"?"on":"":String(n);(c!==a||!("_value"in e))&&(e.value=a),n==null&&e.removeAttribute(t),e._value=n;return}let r=!1;if(n===""||n==null){const c=typeof e[t];c==="boolean"?n=ms(n):n==null&&c==="string"?(n="",r=!0):c==="number"&&(n=0,r=!0)}try{e[t]=n}catch{}r&&e.removeAttribute(o||t)}function Ut(e,t,n,i){e.addEventListener(t,n,i)}function E_(e,t,n,i){e.removeEventListener(t,n,i)}const qo=Symbol("_vei");function C_(e,t,n,i,o=null){const s=e[qo]||(e[qo]={}),r=s[t];if(i&&r)r.value=i;else{const[c,a]=M_(t);if(i){const u=s[t]=F_(i,o);Ut(e,c,u,a)}else r&&(E_(e,c,r,a),s[t]=void 0)}}const I_=/(Once|Passive|Capture)$/,$_=/^on:?(?:Once|Passive|Capture)$/;function M_(e){let t,n;for(;(n=e.match(I_))&&!$_.test(e);)t||(t={}),e=e.slice(0,e.length-n[1].length),t[n[1].toLowerCase()]=!0;return[e[2]===":"?e.slice(3):Nt(e.slice(2)),t]}let Ai=0;const N_=Promise.resolve(),D_=()=>Ai||(N_.then(()=>Ai=0),Ai=Date.now());function F_(e,t){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;const o=n.value;if(M(o)){const s=i.stopImmediatePropagation;i.stopImmediatePropagation=()=>{s.call(i),i._stopped=!0};const r=o.slice(),c=[i];for(let a=0;a<r.length&&!i._stopped;a++){const u=r[a];u&&Fe(u,t,5,c)}}else Fe(o,t,5,[i])};return n.value=e,n.attached=D_(),n}const Wo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,B_=(e,t,n,i,o,s)=>{const r=o==="svg";t==="class"?L_(e,i,r):t==="style"?w_(e,n,i):Zn(t)?Qn(t)||C_(e,t,n,i,s):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):H_(e,t,i,r))?(Ko(e,t,i),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&Yo(e,t,i,r,s,t!=="value")):e._isVueCE&&(j_(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!ue(i)))?Ko(e,He(t),i,s,t):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),Yo(e,t,i,r))};function H_(e,t,n,i){if(i)return!!(t==="innerHTML"||t==="textContent"||t in e&&Wo(t)&&j(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const o=e.tagName;if(o==="IMG"||o==="VIDEO"||o==="CANVAS"||o==="SOURCE")return!1}return Wo(t)&&ue(n)?!1:t in e}function j_(e,t){const n=e._def.props;if(!n)return!1;const i=He(t);return Array.isArray(n)?n.some(o=>He(o)===i):Object.keys(n).some(o=>He(o)===i)}const Ar=new WeakMap,br=new WeakMap,zn=Symbol("_moveCb"),zo=Symbol("_enterCb"),G_=e=>(delete e.props.mode,e),U_=G_({name:"TransitionGroup",props:me({},y_,{tag:String,moveClass:String}),setup(e,{slots:t}){const n=mr(),i=xu();let o,s;return qs(()=>{if(!o.length)return;const r=e.moveClass||`${e.name||"v"}-move`;if(!W_(o[0].el,n.vnode.el,r)){o=[];return}o.forEach(Y_),o.forEach(K_);const c=o.filter(q_);Hi(n.vnode.el),c.forEach(a=>{const u=a.el,p=u.style;Xe(u,r),p.transform=p.webkitTransform=p.transitionDuration="";const d=u[zn]=m=>{m&&m.target!==u||(!m||m.propertyName.endsWith("transform"))&&(u.removeEventListener("transitionend",d),u[zn]=null,xt(u,r))};u.addEventListener("transitionend",d)}),o=[]}),()=>{const r=K(e),c=T_(r);let a=r.tag||Te;if(o=[],s)for(let u=0;u<s.length;u++){const p=s[u];p.el&&p.el instanceof Element&&!p.el[Tr]&&(o.push(p),vn(p,$i(p,c,i,n)),Ar.set(p,Lr(p.el)))}s=t.default?Vs(t.default()):[];for(let u=0;u<s.length;u++){const p=s[u];p.key!=null&&vn(p,$i(p,c,i,n))}return Ie(a,null,s)}}}),V_=U_;function Y_(e){const t=e.el;t[zn]&&t[zn](),t[zo]&&t[zo]()}function K_(e){br.set(e,Lr(e.el))}function q_(e){const t=Ar.get(e),n=br.get(e),i=t.left-n.left,o=t.top-n.top;if(i||o){const s=e.el,r=s.style,c=s.getBoundingClientRect();let a=1,u=1;return s.offsetWidth&&(a=c.width/s.offsetWidth),s.offsetHeight&&(u=c.height/s.offsetHeight),(!Number.isFinite(a)||a===0)&&(a=1),(!Number.isFinite(u)||u===0)&&(u=1),Math.abs(a-1)<.01&&(a=1),Math.abs(u-1)<.01&&(u=1),r.transform=r.webkitTransform=`translate(${i/a}px,${o/u}px)`,r.transitionDuration="0s",e}}function Lr(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function W_(e,t,n){const i=e.cloneNode(),o=e[Jt];o&&o.forEach(c=>{c.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(c=>c&&i.classList.add(c)),i.style.display="none";const s=t.nodeType===1?t:t.parentNode;s.appendChild(i);const{hasTransform:r}=yr(i);return s.removeChild(i),r}const Xo=e=>{const t=e.props["onUpdate:modelValue"]||!1;return M(t)?n=>Dn(t,n):t};function z_(e){e.target.composing=!0}function Jo(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const Mn=Symbol("_assign"),Nn=Symbol("_initialValue");function bi(e,t,n){return t&&(e=e.trim()),n&&(e=Wi(e)),e}const X_={created(e,{modifiers:{lazy:t,trim:n,number:i}},o){e.parentNode&&(e.type==="text"?e[Nn]=e.defaultValue.replace(/[\r\n]/g,""):e.type==="textarea"&&(e[Nn]=e.defaultValue.replace(/\r\n?/g,`
`))),e[Mn]=Xo(o);const s=i||o.props&&o.props.type==="number";Ut(e,t?"change":"input",r=>{r.target.composing||e[Mn](bi(e.value,n,s))}),(n||s)&&Ut(e,"change",()=>{e.value=bi(e.value,n,s)}),t||(Ut(e,"compositionstart",z_),Ut(e,"compositionend",Jo),Ut(e,"change",Jo))},mounted(e,{value:t,modifiers:{trim:n,number:i}}){const o=t??"",s=e[Nn];delete e[Nn],s!==void 0&&(e.type==="text"||e.type==="textarea")&&e.value!==s?e[Mn](bi(e.value,n,i)):e.value=o},beforeUpdate(e,{value:t,oldValue:n,modifiers:{lazy:i,trim:o,number:s}},r){if(e[Mn]=Xo(r),e.composing)return;const c=(s||e.type==="number")&&!/^0\d/.test(e.value)?Wi(e.value):e.value,a=t??"";if(c===a)return;const u=e.getRootNode();(u instanceof Document||u instanceof ShadowRoot)&&u.activeElement===e&&e.type!=="range"&&(i&&t===n||o&&e.value.trim()===a)||(e.value=a)}},J_=["ctrl","shift","alt","meta"],Z_={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>J_.some(n=>e[`${n}Key`]&&!t.includes(n))},Yt=(e,t)=>{if(!e)return e;const n=e._withMods||(e._withMods={}),i=t.join(".");return n[i]||(n[i]=(o,...s)=>{for(let r=0;r<t.length;r++){const c=Z_[t[r]];if(c&&c(o,t))return}return e(o,...s)})},Q_=me({patchProp:B_},k_);let Zo;function ed(){return Zo||(Zo=e_(Q_))}const td=(...e)=>{const t=ed().createApp(...e),{mount:n}=t;return t.mount=i=>{const o=id(i);if(!o)return;const s=t._component;!j(s)&&!s.render&&!s.template&&(s.template=o.innerHTML),o.nodeType===1&&(o.textContent="");const r=n(o,!1,nd(o));return o instanceof Element&&(o.removeAttribute("v-cloak"),o.setAttribute("data-v-app","")),r},t};function nd(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function id(e){return ue(e)?document.querySelector(e):e}const Tn={MIN:0,MAX:100},fn={BASE_DECAY:3,PRESSURE_COEF:2,RECORDER_RELIEF:3,INITIATIVE_COST_BASE:1,INITIATIVE_COST_STEP:1},jn={T1:50,T2:30,T3:15},Qo={DEFAULT:8,PANIC:4},ji={DESTROY_EVIDENCE_CAP:-20,HUSH_MONEY_EVIDENCE_CAP:30},Li={PLAYBOOK_EVIDENCE:5,NOTARY_RISK:-5,CALM_BREATH_COMPOSURE:30};function Pr(e){return Math.min(Tn.MAX,Math.max(Tn.MIN,e))}function lo(e){return{...e,flags:new Set(e.flags),items:new Set(e.items)}}function od(e,t,n,i){let o=n;return t.items.has("item_calm_breathing")&&e.tag==="BREATH"&&(o={...o,composure:Li.CALM_BREATH_COMPOSURE}),t.items.has("item_hr_playbook")&&i===3&&e.initiative===3&&(o={...o,evidence:(o.evidence??0)+Li.PLAYBOOK_EVIDENCE}),t.items.has("item_notary_habit")&&i===4&&e.initiative===3&&(o={...o,risk:(o.risk??0)+Li.NOTARY_RISK}),o}function sd(e){return e.tag==="PHYSICAL"?{forcedEnding:e.next}:null}function rd(e,t){switch(t){case"G_NEG_DESTROYED_EVIDENCE":e.evidenceCap=Tn.MAX+ji.DESTROY_EVIDENCE_CAP;break;case"G_NEG_HUSH_MONEY":e.evidence=Math.min(e.evidence,ji.HUSH_MONEY_EVIDENCE_CAP);break}}function es(e,t,n=1,i=0){const o=lo(e),s=od(t,o,t.effects??{},n),r=["evidence","opinion","composure","risk"];for(const c of r){const a=s[c];a!==void 0&&(o[c]+=a)}if(t.initiative>=2&&t.tag!=="BREATH"){const c=(t.initiative-1)*(fn.INITIATIVE_COST_BASE+fn.INITIATIVE_COST_STEP*Math.floor(i/2));o.composure-=c}o.evidence>o.evidenceCap&&(o.evidence=o.evidenceCap);for(const c of r)o[c]=Pr(o[c]);for(const c of s.addFlags??[])o.flags.add(c),rd(o,c);for(const c of s.removeFlags??[])o.flags.delete(c);for(const c of s.addItems??[])o.items.add(c);return o.turn+=1,o}function cd(e,t){const n=lo(e),i=fn.BASE_DECAY+t.pressure*fn.PRESSURE_COEF,o=n.items.has("item_recorder")?fn.RECORDER_RELIEF:0;return n.composure=Pr(n.composure-i+o),n}class de extends Error{constructor(t){super(t),this.name="ContentError"}}function Or(e,t){return{evidence:e.evidence,opinion:e.opinion,composure:e.composure,risk:e.risk,dEvidence:e.evidence-t.evidence,dOpinion:e.opinion-t.opinion,dComposure:e.composure-t.composure,dRisk:e.risk-t.risk,flags:e.flags,items:e.items,turn:e.turn}}const ad=new Set(["evidence","opinion","composure","risk","dEvidence","dOpinion","dComposure","dRisk","turn"]);function ld(e){const t=[];let n=0;for(;n<e.length;){const i=e[n];if(i===" "||i==="	"||i===`
`||i==="\r"){n+=1;continue}if(i>="0"&&i<="9"){let r=n;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:Number(e.slice(n,r))}),n=r;continue}if(/[A-Za-z_]/.test(i)){let r=n;for(;r<e.length&&/[A-Za-z0-9_]/.test(e[r]);)r+=1;t.push({t:"id",v:e.slice(n,r)}),n=r;continue}if(i==="'"||i==='"'){let r=n+1;for(;r<e.length&&e[r]!==i;)r+=1;if(r>=e.length)throw new de(`unterminated string in condition: ${e}`);t.push({t:"str",v:e.slice(n+1,r)}),n=r+1;continue}const o=e.slice(n,n+2);if(o==="&&"||o==="||"||o===">="||o==="<="||o==="=="||o==="!="){t.push({t:"op",v:o}),n+=2;continue}const s=e[n+1];if(i==="-"&&s!==void 0&&s>="0"&&s<="9"&&(t.length===0||t[t.length-1].t==="op")){let r=n+1;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:-Number(e.slice(n+1,r))}),n=r;continue}if(i===">"||i==="<"||i==="!"||i==="("||i===")"){t.push({t:"op",v:i}),n+=1;continue}throw new de(`illegal character '${i}' in condition: ${e}`)}return t}class pd{constructor(t){ve(this,"pos",0);this.tokens=t}peek(){return this.tokens[this.pos]}next(){const t=this.tokens[this.pos];if(t===void 0)throw new de("unexpected end of condition");return this.pos+=1,t}eatOp(t){const n=this.next();if(n.t!=="op"||n.v!==t)throw new de(`expected '${t}', got '${n.t==="op"?n.v:n.t}'`)}parse(){const t=this.parseOr();if(this.pos!==this.tokens.length){const n=this.peek();throw new de(`unexpected trailing token '${n?n.t==="op"?n.v:n.t:"?"}'`)}return t}parseOr(){let t=this.parseAnd();for(;this.matchOp("||");)t={kind:"binary",op:"||",left:t,right:this.parseAnd()};return t}parseAnd(){let t=this.parseCompare();for(;this.matchOp("&&");)t={kind:"binary",op:"&&",left:t,right:this.parseCompare()};return t}parseCompare(){const t=this.parseUnary(),n=this.peek();return n!==void 0&&n.t==="op"&&[">=",">","<=","<","==","!="].includes(n.v)?(this.pos+=1,{kind:"compare",op:n.v,left:t,right:this.parseUnary()}):t}parseUnary(){return this.matchOp("!")?{kind:"unary",op:"!",operand:this.parseUnary()}:this.parseAtom()}parseAtom(){const t=this.next();if(t.t==="num")return{kind:"num",value:t.v};if(t.t==="str")throw new de("string literal only allowed as function argument");if(t.t==="op"&&t.v==="("){const n=this.parseOr();return this.eatOp(")"),n}if(t.t==="id"){if(t.v==="has"||t.v==="hasItem"){this.eatOp("(");const n=this.next();if(n.t!=="str")throw new de(`'${t.v}' expects a quoted string argument`);return this.eatOp(")"),{kind:"call",fn:t.v,arg:n.v}}if(!ad.has(t.v))throw new de(`unknown identifier '${t.v}' in condition`);return{kind:"var",name:t.v}}throw new de(`unexpected operator '${t.v}' in condition`)}matchOp(t){const n=this.peek();return n!==void 0&&n.t==="op"&&n.v===t?(this.pos+=1,!0):!1}}const ts=new Map;function ud(e){const t=ts.get(e);if(t!==void 0)return t;const n=new pd(ld(e)).parse();return ts.set(e,n),n}function Vt(e,t){switch(e.kind){case"num":return e.value!==0;case"var":return wr(e.name,t)!==0;case"call":return e.fn==="has"?t.flags.has(e.arg):t.items.has(e.arg);case"unary":return!Vt(e.operand,t);case"binary":return e.op==="&&"?Vt(e.left,t)&&Vt(e.right,t):Vt(e.left,t)||Vt(e.right,t);case"compare":{const n=ns(e.left,t),i=ns(e.right,t);switch(e.op){case">=":return n>=i;case">":return n>i;case"<=":return n<=i;case"<":return n<i;case"==":return n===i;case"!=":return n!==i}}}}function ns(e,t){if(e.kind==="num")return e.value;if(e.kind==="var")return wr(e.name,t);throw new de("comparison operands must be numbers")}function wr(e,t){switch(e){case"evidence":return t.evidence;case"opinion":return t.opinion;case"composure":return t.composure;case"risk":return t.risk;case"dEvidence":return t.dEvidence;case"dOpinion":return t.dOpinion;case"dComposure":return t.dComposure;case"dRisk":return t.dRisk;case"turn":return t.turn;default:throw new de(`unknown identifier '${e}'`)}}function Rr(e,t){return e.trim()==="true"?!0:Vt(ud(e),t)}function _d(e){return e<jn.T3||e<jn.T2?2:e<jn.T1?1:0}function dd(e,t){const n=i=>{let o=0;const s=`${t}/${i}`;for(let r=0;r<s.length;r+=1)o=Math.imul(o,31)+s.charCodeAt(r)|0;return(o>>>1&2147483647)/2147483648};return[...e].sort((i,o)=>n(i.id)-n(o.id))}function is(e,t,n=new Set){const i=e.options.filter(c=>c.oncePerNode===!0&&n.has(c.id)?!1:c.requires===void 0?!0:Rr(c.requires,Or(t,fd))),o=_d(t.composure),r=e.impulsePool.filter(c=>t.composure<c.unlockBelow).slice(0,o);return dd([...i,...r],e.id)}const fd={evidence:0,opinion:0,composure:0,risk:0};function gd(e,t){return t.composure<jn.T3?Qo.PANIC:e.timer??Qo.DEFAULT}function md(e,t,n){if(t.flags.has("FORCED_F")){const o=e.endings.find(s=>s.condition==="FORCED");if(o===void 0)throw new de(`level ${e.id} has FORCED_F state but no FORCED ending`);return o}const i=Or(t,n);for(const o of e.endings)if(o.condition!=="FORCED"&&Rr(o.condition,i))return o;throw new de(`level ${e.id}: no ending condition matched (missing 'true' fallback?)`)}const hd="__END__";function Pi(e){return e.type==="choice"}class po{constructor(t,n){ve(this,"nodeMap");ve(this,"endingMap");ve(this,"initMeter");ve(this,"current");ve(this,"currentNodeId");ve(this,"usedThisVisit",new Set);this.level=t,this.nodeMap=new Map(t.nodes.map(i=>[i.id,i])),this.endingMap=new Map(t.endings.map(i=>[i.id,i])),this.initMeter=t.initState,this.current=this.buildInitialState(n),this.currentNodeId=t.entryNode}buildInitialState(t){const n=new Set([...t.flags].filter(s=>s.startsWith("G_"))),i=n.has("G_NEG_DESTROYED_EVIDENCE")?Tn.MAX+ji.DESTROY_EVIDENCE_CAP:Tn.MAX,o=n.has("G_NEG_ASSAULT")?15:0;return{evidence:this.level.initState.evidence,opinion:this.level.initState.opinion,composure:this.level.initState.composure,risk:this.level.initState.risk+o,flags:n,items:new Set(t.items),turn:0,evidenceCap:i}}get state(){return this.current}start(){return this.advanceFrom(this.currentNodeId)}choose(t){const n=this.getNode(this.currentNodeId);if(!Pi(n))throw new de(`choose() called on non-choice node ${n.id} in level ${this.level.id}`);const o=is(n,this.current,this.usedThisVisit).find(s=>s.id===t);if(o===void 0)throw new de(`option '${t}' not available at node ${n.id} (level ${this.level.id})`);return this.applyChoice(n,o)}timeout(){const t=this.getNode(this.currentNodeId);if(!Pi(t))throw new de(`timeout() called on non-choice node ${t.id} in level ${this.level.id}`);const n=t.options.find(i=>i.id===t.timeoutOption);if(n===void 0)throw new de(`timeoutOption '${t.timeoutOption}' not found in node ${t.id}`);return this.applyChoice(t,n)}getNode(t){const n=this.nodeMap.get(t);if(n===void 0)throw new de(`node not found: ${t} (level ${this.level.id})`);return n}applyChoice(t,n){const i=sd(n);return i!==null?(this.current=es(this.current,n,this.level.act,t.pressure),this.current.flags.add("FORCED_F"),this.current.flags.add("G_NEG_ASSAULT"),this.finishWith(i.forcedEnding)):(n.oncePerNode===!0&&this.usedThisVisit.add(n.id),this.current=es(this.current,n,this.level.act,t.pressure),this.current=cd(this.current,t),this.advanceFrom(n.next))}advanceFrom(t){if(t===hd)return this.finishWith(null);let n=t;for(let i=0;i<vd;i+=1){const o=this.endingMap.get(n);if(o!==void 0)return this.finishWith(o.id);const s=this.getNode(n);return Pi(s)?(n!==this.currentNodeId&&(this.usedThisVisit=new Set),this.currentNodeId=s.id,{type:"options",options:is(s,this.current,this.usedThisVisit),timer:gd(s,this.current),timeoutOptionId:s.timeoutOption}):(this.currentNodeId=s.id,{type:"node",node:s})}throw new de(`node chain too deep at ${n} (level ${this.level.id})`)}proceed(){const t=this.getNode(this.currentNodeId);if(t.next===void 0)throw new de(`node ${t.id} has no next (level ${this.level.id})`);return this.advanceFrom(t.next)}finishWith(t){const n=t!==null?this.endingMap.get(t):void 0;if(t!==null&&n===void 0)throw new de(`ending not found: ${t} (level ${this.level.id})`);const i=lo(this.current);return{type:"ending",ending:n!==void 0?n:md(this.level,this.current,this.initMeter),state:i}}static simulate(t,n,i){const o=new po(t,n);let s=o.start(),r=0;for(;;){if(s.type==="ending")return{rank:s.ending.rank,state:s.state};if(s.type==="node"){s=o.proceed();continue}if(s.type==="options"){const c=i[r];if(r+=1,c===void 0)throw new de(`simulate path exhausted at node in level ${t.id}`);s=o.choose(c);continue}}}}const vd=200,Sr="poju_shilu_save_v1";function os(){return{version:1,flags:[],items:[],levelResults:{},cards:[],settings:{mode:"NORMAL",sound:!0}}}const Xn=globalThis.localStorage,Er=typeof Xn<"u"&&Xn!==null;function xd(){if(!Er)return os();const e=Xn.getItem(Sr);return e===null?os():JSON.parse(e)}function kd(e){Er&&Xn.setItem(Sr,JSON.stringify(e))}const yd={L01:{flag:"G_EV_SUBWAY",minRank:["S","A"]},L02:{flag:"G_EV_ELEVATOR",minRank:["S","A"]},L03:{flag:"G_EV_MALL",minRank:["S","A"]},L04:{flag:"G_EV_NIGHTWALK",minRank:["S","A"]},L05:{flag:"G_EV_GYM",minRank:["S","A"]},L06:{flag:"G_EV_BETROTHAL",minRank:["S","A"]},L07:{flag:"G_EV_TRANSFER",minRank:["S","A"]},L08:{flag:"G_EV_PATERNITY",minRank:["S","A"]},L09:{flag:"G_EV_PRESERVATION",minRank:["S","A"]},L10:{flag:"G_EV_PROTECTION_ORDER",minRank:["S","A"]},L11:{flag:"G_EV_HR_WRITTEN",minRank:["S","A"]},L12:{flag:"G_EV_EMAIL_CHAIN",minRank:["S","A"]},L13:{flag:"G_EV_FULL_AUDIO",minRank:["S","A"]},L14:{flag:"G_EV_SUSPENSION",minRank:["S","A"]},L15:{flag:"G_EV_EXTORTION",minRank:["S","A"]},L16:{flag:"G_EV_ORIGINAL_CLIP",minRank:["S","A"]},L17:{flag:"G_EV_DOXX_NOTARY",minRank:["S","A"]},L18:{flag:"G_EV_LIVE_RECORD",minRank:["S","A"]},L19:{flag:"G_EV_PLATFORM",minRank:["S","A"]}},Td={L02:"G_NEG_DESTROYED_EVIDENCE",L07:"G_NEG_HUSH_MONEY",L10:"L10_VIOLATED",L13:"G_NEG_APOLOGY_LETTER",L17:"G_NEG_DOXXED_BACK"};function Ad(e,t){switch(e){case"L01":return t==="S"||t==="A"?["item_recorder"]:[];case"L02":return["item_shen_card"];case"L08":return t==="S"?["item_calm_breathing"]:[];case"L11":return t==="S"||t==="A"?["item_hr_playbook"]:[];case"L16":return t==="S"||t==="A"?["item_notary_habit"]:[];default:return[]}}function bd(e,t,n,i,o){const s={...e,flags:[...e.flags],items:[...e.items],levelResults:{...e.levelResults},cards:[...e.cards]},r=new Set(s.flags);for(const d of i.flags)d.startsWith("G_")&&r.add(d);const c=yd[t];if(c!==void 0&&c.minRank.includes(n.rank)){const d=Td[t];d!==void 0&&(r.has(d)||i.flags.has(d))||r.add(c.flag)}const a=Ad(t,n.rank),u=new Set(s.items);for(const d of a)u.add(d);n.unlock!==void 0&&!s.cards.includes(n.unlock)&&s.cards.push(n.unlock);const p=o==null?void 0:o.now;return s.levelResults[t]={rank:n.rank,endingId:n.id,ts:p},s.flags=[...r].filter(d=>d.startsWith("G_")),s.items=[...u],s}const Cr="L01",Ir="第01关 · 地铁三分钟",$r=1,Mr={evidence:20,opinion:50,composure:80,risk:10},Nr=["hero","npc_l01_woman","crowd","officer_lin"],Dr="n_01",Fr="card_law_L01",Br=["T1","T2"],Hr=[{id:"n_01",type:"cutscene",pressure:1,script:`三点十四分，三号线。车厢是满的，不算挤。
列车进站前一次急刹，所有人往前倾了半步。
...
视频当晚就上了热搜第七。
标题里有你公司的名字。`}],Ld={id:Cr,title:Ir,act:$r,initState:Mr,cast:Nr,entryNode:Dr,lawyerCard:Fr,satireTargets:Br,nodes:Hr,endings:jr},Pd=Object.freeze(Object.defineProperty({__proto__:null,act:$r,cast:Nr,default:Ld,endings:jr,entryNode:Dr,id:Cr,initState:Mr,lawyerCard:Fr,nodes:Hr,satireTargets:Br,title:Ir},Symbol.toStringTag,{value:"Module"})),Gr="L02",Ur="第02关 · 电梯里的镜头",Vr=1,Yr={evidence:25,opinion:45,composure:75,risk:10},Kr=["hero","npc_l02_woman","crowd","shen_li","officer_lin"],qr="n_01",Wr="card_law_L02",zr=["T1","T2"],Xr=[{id:"n_01",type:"cutscene",pressure:1,script:`写字楼，十八层下行。
...
烫金的字，边角很硬。`,next:"__END__"}],Jr=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 你先动的手",script:`大堂的监控拍得很清楚：她站着，你伸的手。
...
没什么——是这世上最没用的一句辩解。`,unlock:"card_L02_F"}],Od={id:Gr,title:Ur,act:Vr,initState:Yr,cast:Kr,entryNode:qr,lawyerCard:Wr,satireTargets:zr,nodes:Xr,endings:Jr},wd=Object.freeze(Object.defineProperty({__proto__:null,act:Vr,cast:Kr,default:Od,endings:Jr,entryNode:qr,id:Gr,initState:Yr,lawyerCard:Wr,nodes:Xr,satireTargets:zr,title:Ur},Symbol.toStringTag,{value:"Module"})),Zr="L03",Qr="第03关 · 爸爸和女儿",ec=1,tc={evidence:15,opinion:25,composure:60,risk:30},nc=["hero","npc_l03_daughter","npc_l03_woman","crowd","officer_lin"],ic="n_01",oc="card_law_L03",sc=["T1","T2","T3"],rc=[{id:"n_01",type:"cutscene",pressure:1,script:`周六下午，商场三楼，玩具区门口。
...
那三个字很小，但离得近的人都听见了。`,next:"__END__"}],cc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 她摔在扶梯口",script:`你推开了挡路的人。人群晃了一下。
...
「有家长在群里传了个视频。」老师说得很委婉。`,unlock:"card_L03_F"}],Rd={id:Zr,title:Qr,act:ec,initState:tc,cast:nc,entryNode:ic,lawyerCard:oc,satireTargets:sc,nodes:rc,endings:cc},Sd=Object.freeze(Object.defineProperty({__proto__:null,act:ec,cast:nc,default:Rd,endings:cc,entryNode:ic,id:Zr,initState:tc,lawyerCard:oc,nodes:rc,satireTargets:sc,title:Qr},Symbol.toStringTag,{value:"Module"})),ac="L04",lc="第04关 · 深夜同行",pc=1,uc={evidence:20,opinion:35,composure:55,risk:35},_c=["hero","npc_l04_woman","officer_lin","crowd"],dc="n_01",fc="card_law_L04",gc=["T1","T3"],mc=[{id:"n_01",type:"cutscene",pressure:1,script:`十一点四十，出地铁 C 口。加了四个小时班，你只想快点到家。
...
后面那个问题，你答不上来。
因为真实答案是：我怕。
而「我怕」这三个字，在笔录里从来不是一个能用的理由。`,unlock:"card_L04_F"}],Ed={id:ac,title:lc,act:pc,initState:uc,cast:_c,entryNode:dc,lawyerCard:fc,satireTargets:gc,nodes:mc,endings:hc},Cd=Object.freeze(Object.defineProperty({__proto__:null,act:pc,cast:_c,default:Ed,endings:hc,entryNode:dc,id:ac,initState:uc,lawyerCard:fc,nodes:mc,satireTargets:gc,title:lc},Symbol.toStringTag,{value:"Module"})),vc="L05",xc="第05关 · 托杠铃的那一下",kc=1,yc={evidence:20,opinion:30,composure:50,risk:40},Tc=["hero","npc_l05_woman","npc_l05_manager","npc_l05_witness","crowd"],Ac="n_01",bc="card_law_L05",Lc=["T1","T5"],Pc=[{id:"n_01",type:"cutscene",pressure:1,script:`自由重量区，晚上八点半。
...
器械区有七八个人。所有人都看见了。
没有人过去。`,next:"__END__"}],Oc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那一巴掌",script:`手机摔在地胶上，屏幕裂成蛛网。
...
「情况属实」四个字指的是撒谎，不是别的。
但没人会去分辨这个。`,unlock:"card_L05_F"}],Id={id:vc,title:xc,act:kc,initState:yc,cast:Tc,entryNode:Ac,lawyerCard:bc,satireTargets:Lc,nodes:Pc,endings:Oc},$d=Object.freeze(Object.defineProperty({__proto__:null,act:kc,cast:Tc,default:Id,endings:Oc,entryNode:Ac,id:vc,initState:yc,lawyerCard:bc,nodes:Pc,satireTargets:Lc,title:xc},Symbol.toStringTag,{value:"Module"})),wc="L06",Rc="第06关 · 三十八万八",Sc=2,Ec={evidence:30,opinion:50,composure:48,risk:20},Cc=["hero","npc_l06_girlfriend","npc_l06_mother","crowd"],Ic="n_01",$c="card_law_L06",Mc=["T1","T3"],Nc=[{id:"n_01",type:"cutscene",pressure:1,script:`女方家客厅。茶几上摆着切好的果盘，没人动。
...
你说不用。
她说：「我知道不用。我就是想让你知道，我们出得起。」`,next:"__END__"}],Dc=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口那一下",script:`你推开她的时候，她的后腰撞在鞋柜角上。
...
你说，先用便宜的吧。`,unlock:"card_L06_F"}],Md={id:wc,title:Rc,act:Sc,initState:Ec,cast:Cc,entryNode:Ic,lawyerCard:$c,satireTargets:Mc,nodes:Nc,endings:Dc},Nd=Object.freeze(Object.defineProperty({__proto__:null,act:Sc,cast:Cc,default:Md,endings:Dc,entryNode:Ic,id:wc,initState:Ec,lawyerCard:$c,nodes:Nc,satireTargets:Mc,title:Rc},Symbol.toStringTag,{value:"Module"})),Fc="L07",Bc="第07关 · 青春损失费",Hc=2,jc={evidence:35,opinion:45,composure:45,risk:30},Gc=["hero","npc_l07_ex","shen_li"],Uc="n_01",Vc="card_law_L07",Yc=["T1","T4"],Kc=[{id:"n_01",type:"cutscene",pressure:1,script:`分手第九天。她约你在常去的那家咖啡馆。
...
它就那么挂着。挂了很多年。`,unlock:"card_L07_F"}],Dd={id:Fc,title:Bc,act:Hc,initState:jc,cast:Gc,entryNode:Uc,lawyerCard:Vc,satireTargets:Yc,nodes:Kc,endings:qc},Fd=Object.freeze(Object.defineProperty({__proto__:null,act:Hc,cast:Gc,default:Dd,endings:qc,entryNode:Uc,id:Fc,initState:jc,lawyerCard:Vc,nodes:Kc,satireTargets:Yc,title:Bc},Symbol.toStringTag,{value:"Module"})),Wc="L08",zc="第08关 · 孩子不是你的",Xc=2,Jc={evidence:25,opinion:40,composure:40,risk:25},Zc=["hero","npc_l08_wife","npc_l08_mother","npc_l08_child","shen_li"],Qc="n_01",ea="card_law_L08",ta=["T1","T3"],na=[{id:"n_01",type:"cutscene",pressure:1,script:`念念三岁体检，血型 AB。
你 O 型，她妈妈 O 型。
...
那三年是真的。这一点，报告上没写。`,next:"__END__"}],ia=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口那一推",script:`你推开挡在门口的她。她撞到门框，额角青了一块。
...
那张纸，你只有过一次机会。`,unlock:"card_L08_F"}],Bd={id:Wc,title:zc,act:Xc,initState:Jc,cast:Zc,entryNode:Qc,lawyerCard:ea,satireTargets:ta,nodes:na,endings:ia},Hd=Object.freeze(Object.defineProperty({__proto__:null,act:Xc,cast:Zc,default:Bd,endings:ia,entryNode:Qc,id:Wc,initState:Jc,lawyerCard:ea,nodes:na,satireTargets:ta,title:zc},Symbol.toStringTag,{value:"Module"})),oa="L09",sa="第09关 · 冷静期",ra=2,ca={evidence:40,opinion:45,composure:42,risk:35},aa=["hero","npc_l09_wife","npc_l09_cousin","shen_li"],la="n_01",pa="card_law_L09",ua=["T2","T4"],_a=[{id:"n_01",type:"cutscene",pressure:1,script:`民政局。离婚登记申请交上去了，三十天冷静期。
工作人员说：三十天后你们再一起来一趟。
...
她那句「这三十天，咱们都别为难对方」——
你后来想了很久。她说的是真心话。
她只是没打算把「为难」这两个字算在自己头上。`,next:"__END__"}],da=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 玄关那一下",script:`抢行李箱的时候她摔在鞋柜上，手腕骨裂。
...
她名下有八十万。你名下有两万四。`,unlock:"card_L09_F"}],jd={id:oa,title:sa,act:ra,initState:ca,cast:aa,entryNode:la,lawyerCard:pa,satireTargets:ua,nodes:_a,endings:da},Gd=Object.freeze(Object.defineProperty({__proto__:null,act:ra,cast:aa,default:jd,endings:da,entryNode:la,id:oa,initState:ca,lawyerCard:pa,nodes:_a,satireTargets:ua,title:sa},Symbol.toStringTag,{value:"Module"})),fa="L10",ga="第10关 · 二十米",ma=2,ha={evidence:30,opinion:35,composure:38,risk:45},va=["hero","npc_l10_exwife","npc_l10_child","npc_l10_teacher","shen_li"],xa="n_01",ka="card_law_L10",ya=["T1","T2"],Ta=[{id:"n_01",type:"cutscene",pressure:2,script:`抚养费返还的判决生效了。执行立案的第三天，
法院的人把另一份裁定书送到了公司前台。
...
沈骊后来只说了一句：「我知道你忍不住。」
「可法律不看你忍不忍得住，只看你忍没忍住。」`,unlock:"card_L10_F"}],Ud={id:fa,title:ga,act:ma,initState:ha,cast:va,entryNode:xa,lawyerCard:ka,satireTargets:ya,nodes:Ta,endings:Aa},Vd=Object.freeze(Object.defineProperty({__proto__:null,act:ma,cast:va,default:Ud,endings:Aa,entryNode:xa,id:fa,initState:ha,lawyerCard:ka,nodes:Ta,satireTargets:ya,title:ga},Symbol.toStringTag,{value:"Module"})),ba="L11",La="第11关 · 面试第七问",Pa=3,Oa={evidence:20,opinion:40,composure:45,risk:20},wa=["hero","npc_l11_hr","shen_li"],Ra="n_01",Sa="card_law_L11",Ea=["T3","T5"],Ca=[{id:"n_01",type:"cutscene",pressure:1,script:`终面，第四十分钟。前六个问题答得都不错。
...
你说谢谢，不用了。
挂了电话，你把回执拍照存进云盘，文件名写的是日期。`,next:"__END__"}],Ia=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 会议室",script:`你掀了桌子。笔记本电脑砸在他小腿上。
...
猎头开始不接你电话。
这行就这么大。`,unlock:"card_L11_F"}],Yd={id:ba,title:La,act:Pa,initState:Oa,cast:wa,entryNode:Ra,lawyerCard:Sa,satireTargets:Ea,nodes:Ca,endings:Ia},Kd=Object.freeze(Object.defineProperty({__proto__:null,act:Pa,cast:wa,default:Yd,endings:Ia,entryNode:Ra,id:ba,initState:Oa,lawyerCard:Sa,nodes:Ca,satireTargets:Ea,title:La},Symbol.toStringTag,{value:"Module"})),$a="L12",Ma="第12关 · 署名顺序",Na=3,Da={evidence:45,opinion:42,composure:42,risk:25},Fa=["hero","npc_l12_colleague","npc_l12_boss","zhou_you"],Ba="n_01",Ha="card_law_L12",ja=["T1","T3"],Ga=[{id:"n_01",type:"cutscene",pressure:1,script:`项目做了十一个月。方案是你出的，架构是你搭的，上线那周你在公司睡了四天。
...
周攸路过看了一眼，说：「这行小字挺好。」
你说：「这行小字是你换来的。」`,next:"__END__"}],Ua=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 摔的那一下",script:`笔记本砸在桌上，屏幕裂了，碎片弹到她手背上。
...
那一百四十三条 commit 记录，到最后也没人问起过。`,unlock:"card_L12_F"}],qd={id:$a,title:Ma,act:Na,initState:Da,cast:Fa,entryNode:Ba,lawyerCard:Ha,satireTargets:ja,nodes:Ga,endings:Ua},Wd=Object.freeze(Object.defineProperty({__proto__:null,act:Na,cast:Fa,default:qd,endings:Ua,entryNode:Ba,id:$a,initState:Da,lawyerCard:Ha,nodes:Ga,satireTargets:ja,title:Ma},Symbol.toStringTag,{value:"Module"})),Va="L13",Ya="第13关 · 团建那句玩笑",Ka=3,qa={evidence:25,opinion:35,composure:36,risk:40},Wa=["hero","npc_l13_hr","npc_l13_complainant","zhou_you","shen_li"],za="n_01",Xa="card_law_L13",Ja=["T1","T5"],Za=[{id:"n_01",type:"cutscene",pressure:1,script:`三周前，部门团建，KTV 包厢。
十一个人，两箱啤酒，唱到十一点半。
...
道歉这个动作，在流程里从来只有一种解释。`,unlock:"card_L13_F"}],zd={id:Va,title:Ya,act:Ka,initState:qa,cast:Wa,entryNode:za,lawyerCard:Xa,satireTargets:Ja,nodes:Za,endings:Qa},Xd=Object.freeze(Object.defineProperty({__proto__:null,act:Ka,cast:Wa,default:zd,endings:Qa,entryNode:za,id:Va,initState:qa,lawyerCard:Xa,nodes:Za,satireTargets:Ja,title:Ya},Symbol.toStringTag,{value:"Module"})),el="L14",tl="第14关 · 匿名举报",nl=3,il={evidence:30,opinion:35,composure:34,risk:45},ol=["hero","npc_l14_hr","npc_l14_director","zhou_you","shen_li"],sl="n_01",rl="card_law_L14",cl=["T1","T5"],al=[{id:"n_01",type:"cutscene",pressure:2,script:`晋升公示第七天，最后一天。
...
周攸看到那条，截图发给你：「第三条。」
你回：「嗯。」`,next:"__END__"}],ll=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口",script:`你推开了他。他手里的咖啡洒了一身，人撞在门框上。
...
原来那封匿名信到最后也没查出是谁写的。
它不需要。它只需要你自己动起来。`,unlock:"card_L14_F"}],Jd={id:el,title:tl,act:nl,initState:il,cast:ol,entryNode:sl,lawyerCard:rl,satireTargets:cl,nodes:al,endings:ll},Zd=Object.freeze(Object.defineProperty({__proto__:null,act:nl,cast:ol,default:Jd,endings:ll,entryNode:sl,id:el,initState:il,lawyerCard:rl,nodes:al,satireTargets:cl,title:tl},Symbol.toStringTag,{value:"Module"})),pl="L15",ul="第15关 · 最后一张牌",_l=3,dl={evidence:40,opinion:40,composure:32,risk:50},fl=["hero","npc_l15_broker","npc_l15_hr","shen_li"],gl="n_01",ml="card_law_L15",hl=["T4"],vl=[{id:"n_01",type:"cutscene",pressure:2,script:`裁员名单下来了，你在上面。
...
沈骊在路边等你，车窗摇下来：「上车吧，堵着呢。」`,next:"__END__"}],xl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 那一拳",script:`你在楼下堵住他，一拳打在他脸上。鼻梁骨折。
...
员工在离职期间将内部沟通录音公开传播。`,unlock:"card_L15_F"}],Qd={id:pl,title:ul,act:_l,initState:dl,cast:fl,entryNode:gl,lawyerCard:ml,satireTargets:hl,nodes:vl,endings:xl},ef=Object.freeze(Object.defineProperty({__proto__:null,act:_l,cast:fl,default:Qd,endings:xl,entryNode:gl,id:pl,initState:dl,lawyerCard:ml,nodes:vl,satireTargets:hl,title:ul},Symbol.toStringTag,{value:"Module"})),kl="L16",yl="第16关 · 三十秒剪辑",Tl=4,Al={evidence:35,opinion:20,composure:40,risk:40},bl=["hero","npc_l16_account","shen_li","zhou_you","crowd"],Ll="n_01",Pl="card_law_L16",Ol=["T2","T4"],wl=[{id:"n_01",type:"cutscene",pressure:3,script:`周一早上七点，你在地铁上刷到自己。
...
沈骊把那张工商信息截图放大，看了很久。
「这个人，我见过两次。」
「两次都在别人的案子里。」`,next:"__END__"}],Rl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 找上门",script:`你找到了那家公司的地址，冲进去把设备砸了。
...
完整版你也发了。没人看。
因为你已经不是那个只有完整版的人了。`,unlock:"card_L16_F"}],tf={id:kl,title:yl,act:Tl,initState:Al,cast:bl,entryNode:Ll,lawyerCard:Pl,satireTargets:Ol,nodes:wl,endings:Rl},nf=Object.freeze(Object.defineProperty({__proto__:null,act:Tl,cast:bl,default:tf,endings:Rl,entryNode:Ll,id:kl,initState:Al,lawyerCard:Pl,nodes:wl,satireTargets:Ol,title:yl},Symbol.toStringTag,{value:"Module"})),Sl="L17",El="第17关 · 人肉",Cl=4,Il={evidence:40,opinion:10,composure:28,risk:45},$l=["hero","npc_l17_father","npc_l17_hr","shen_li","crowd"],Ml="n_01",Nl="card_law_L17",Dl=["T2","T4"],Fl=[{id:"n_01",type:"cutscene",pressure:4,script:`周四凌晨两点，一个文档在群里传开了。
...
「小屿，」他说，「你别恨她们。」
「你就把这事办完。」`,next:"__END__"}],Bl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 你找过去了",script:`你按扒到的地址找过去，砸了门，打了人。
...
从这一页开始，你们是同一类案由。`,unlock:"card_L17_F"}],of={id:Sl,title:El,act:Cl,initState:Il,cast:$l,entryNode:Ml,lawyerCard:Nl,satireTargets:Dl,nodes:Fl,endings:Bl},sf=Object.freeze(Object.defineProperty({__proto__:null,act:Cl,cast:$l,default:of,endings:Bl,entryNode:Ml,id:Sl,initState:Il,lawyerCard:Nl,nodes:Fl,satireTargets:Dl,title:El},Symbol.toStringTag,{value:"Module"})),Hl="L18",jl="第18关 · 直播间的生意",Gl=4,Ul={evidence:55,opinion:30,composure:38,risk:35},Vl=["hero","npc_l18_streamer","shen_li","crowd"],Yl="n_01",Kl="card_law_L18",ql=["T4"],Wl=[{id:"n_01",type:"cutscene",pressure:2,script:`一个百万粉的账号发来连线邀请。
...
「还有十六个。」她说。
「不过没关系。这十七个后面只有一个人。」`,next:"__END__"}],zl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 直播事故",script:`你在连线里失控了，摔了东西，骂了整整四十秒。
...
这就是这门生意的全部：
真相跑不过一句脏话。`,unlock:"card_L18_F"}],rf={id:Hl,title:jl,act:Gl,initState:Ul,cast:Vl,entryNode:Yl,lawyerCard:Kl,satireTargets:ql,nodes:Wl,endings:zl},cf=Object.freeze(Object.defineProperty({__proto__:null,act:Gl,cast:Vl,default:rf,endings:zl,entryNode:Yl,id:Hl,initState:Ul,lawyerCard:Kl,nodes:Wl,satireTargets:ql,title:jl},Symbol.toStringTag,{value:"Module"})),Xl="L19",Jl="第19关 · 各执一词",Zl=4,Ql={evidence:60,opinion:45,composure:42,risk:30},ep=["hero","npc_l19_moderator","npc_l19_pr","shen_li"],tp="n_01",np="card_law_L19",ip=["T5"],op=[{id:"n_01",type:"cutscene",pressure:2,script:`平台申诉结果：不予处理。
...
沈骊把回执递给你：「立案了。」
「开庭大概在三个月后。」`,next:"__END__"}],sp=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 会议室",script:`你把材料摔了，推翻了椅子，一个工作人员的手被划伤。
...
那六份盖章材料还在你手上。
只是现在，你没有地方提交它们了。`,unlock:"card_L19_F"}],af={id:Xl,title:Jl,act:Zl,initState:Ql,cast:ep,entryNode:tp,lawyerCard:np,satireTargets:ip,nodes:op,endings:sp},lf=Object.freeze(Object.defineProperty({__proto__:null,act:Zl,cast:ep,default:af,endings:sp,entryNode:tp,id:Xl,initState:Ql,lawyerCard:np,nodes:op,satireTargets:ip,title:Jl},Symbol.toStringTag,{value:"Module"})),rp="L20",cp="第20关 · 对簿",ap=4,lp={evidence:60,opinion:50,composure:60,risk:30},pp=["hero","he_song","zhou_you","shen_li","crowd"],up="n_01",_p="card_law_L20",dp=["T2","T4","T5"],fp=[{id:"n_01",type:"cutscene",pressure:3,script:`开庭。第三法庭，旁听席坐满了。
...
划掉了。`,next:"__END__"}],gp=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 最后一步",script:`你越过栏杆冲了过去。法警拦下你的时候，你已经碰到了他。
...
划掉了。`,unlock:"card_L20_F"}],pf={id:rp,title:cp,act:ap,initState:lp,cast:pp,entryNode:up,lawyerCard:_p,satireTargets:dp,nodes:fp,endings:gp},uf=Object.freeze(Object.defineProperty({__proto__:null,act:ap,cast:pp,default:pf,endings:gp,entryNode:up,id:rp,initState:lp,lawyerCard:_p,nodes:fp,satireTargets:dp,title:cp},Symbol.toStringTag,{value:"Module"})),_f=Object.assign({"../../content/levels/L01.json":Pd,"../../content/levels/L02.json":wd,"../../content/levels/L03.json":Sd,"../../content/levels/L04.json":Cd,"../../content/levels/L05.json":$d,"../../content/levels/L06.json":Nd,"../../content/levels/L07.json":Fd,"../../content/levels/L08.json":Hd,"../../content/levels/L09.json":Gd,"../../content/levels/L10.json":Vd,"../../content/levels/L11.json":Kd,"../../content/levels/L12.json":Wd,"../../content/levels/L13.json":Xd,"../../content/levels/L14.json":Zd,"../../content/levels/L15.json":ef,"../../content/levels/L16.json":nf,"../../content/levels/L17.json":sf,"../../content/levels/L18.json":cf,"../../content/levels/L19.json":lf,"../../content/levels/L20.json":uf}),An=Object.values(_f).map(e=>e.default).sort((e,t)=>e.id.localeCompare(t.id)),df="破局实录",ff="开发预览 · M3 前置切片",gf={evidence:"证据",opinion:"舆论",composure:"情绪",risk:"风险"},mf={hero:"陈屿",shen_li:"沈骊",officer_lin:"林昭",zhou_you:"周攸",he_song:"贺松",crowd:"围观者",narrator:"",npc_l01_woman:"红衣女子",npc_l02_woman:"住户女子",npc_l03_woman:"路人女子",npc_l03_daughter:"念念",npc_l04_woman:"报警人",npc_l05_woman:"女子",npc_l05_manager:"值班经理",npc_l05_witness:"目击大哥",npc_l06_girlfriend:"前女友",npc_l06_mother:"她母亲",npc_l07_ex:"前女友",npc_l08_wife:"妻子",npc_l08_mother:"岳母",npc_l08_child:"孩子",npc_l09_wife:"妻子",npc_l09_cousin:"表哥",npc_l10_exwife:"前妻",npc_l10_child:"女儿",npc_l10_teacher:"班主任",npc_l11_hr:"HR",npc_l12_colleague:"同事",npc_l12_boss:"部门老板",npc_l13_hr:"HR",npc_l13_complainant:"投诉人",npc_l14_hr:"HR 总监",npc_l14_director:"总监",npc_l15_broker:"中介",npc_l15_hr:"HR",npc_l16_account:"商务",npc_l17_father:"父亲",npc_l17_hr:"HR",npc_l18_streamer:"主播",npc_l19_moderator:"版务",npc_l19_pr:"公关",npc_l20_judge:"审判长",npc_l20_lawyer:"对方律师"},hf={1:"第一幕 · 流量即真相",2:"第二幕 · 亲密关系的账",3:"第三幕 · 职场的规则",4:"第四幕 · 收网"},vf={tapToContinue:"点击继续",secondsUnit:"s",endingTitle:"结局",restart:"再玩一次",nextLevel:"下一关",levelSelect:"选择关卡",lockedLevel:"未解锁",rankNames:{S:"名场面",A:"稳住了",B:"有惊无险",C:"勉强收场",F:"翻车"},finalMeters:"最终仪表",disclaimer:"本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。",progressLabel:"进度",soundToggle:"M",studyIntro:"测试开始前\\n请输入现场编号（如 P01）\\n\\n然后独立游玩前五关\\n过程中不会有任何提示\\n做完自动出现数据回收",studyPidPlaceholder:"现场编号",studyStart:"开始",studyDoneTitle:"第一幕完成",studyCopy:"导出数据（JSON）",studySummaryHeader:"参与者 {p} · {n} 次游玩",studySummaryLine:"{lv}: {rank}「{title}」 用时{s}秒 抉择{c}次 重玩{r}",stanceLow:"稳住",stanceHigh:"顶回去",pileALabel:"这条",pileBLabel:"那条",pileListHint:"选一个",swipeHint:"左右滑动选择 · 点按也可以",settlePhase1:"结算中",settleStampS:"教科书式破局",settleStampA:"稳稳落地",settleStampB:"有惊无险",settleStampC:"伤敌自伤",settleStampF:"满盘皆输",settleMetersTitle:"终局面",settleReplay:"本关重打",settleNext:"下一关"},xf={L01:{label:"地铁三号线",hue:205,motif:"subway"},L02:{label:"住宅电梯",hue:220,motif:"elevator"},L03:{label:"商场中庭",hue:35,motif:"mall"},L04:{label:"深夜街道",hue:235,motif:"street"},L05:{label:"健身房",hue:15,motif:"gym"},L06:{label:"两家饭桌",hue:28,motif:"table"},L07:{label:"出租屋",hue:200,motif:"room"},L08:{label:"客厅",hue:40,motif:"room"},L09:{label:"民政局外",hue:210,motif:"office"},L10:{label:"学校门口",hue:45,motif:"street"},L11:{label:"面试间",hue:215,motif:"office"},L12:{label:"开放工位",hue:210,motif:"office"},L13:{label:"会议室",hue:220,motif:"office"},L14:{label:"总监办公室",hue:225,motif:"office"},L15:{label:"写字楼楼下",hue:200,motif:"street"},L16:{label:"剪辑室",hue:260,motif:"studio"},L17:{label:"家中",hue:30,motif:"room"},L18:{label:"直播间后台",hue:320,motif:"studio"},L19:{label:"平台工单页",hue:190,motif:"office"},L20:{label:"法院走廊",hue:210,motif:"court"}},kf={calm:["前排","吃瓜","蹲后续","录下来了","别急，等反转","让子弹飞一会儿"],tense:["什么情况？?","有人认识吗","这女的厉害","这男的稳住啊","报警了吗","快报警","别拍了先帮个忙啊","主播别切","全网都在看"],hot:["热搜第一预定","已经录屏了","传到群里了","反转了反转了","坐等打脸","这瓜保熟","直播间炸了","三分钟了还在吵"]},yf={hero:210,shen_li:280,officer_lin:195,zhou_you:150,he_song:350,npc_l01_woman:350,npc_l02_woman:330,npc_l03_woman:320,npc_l03_daughter:45,npc_l04_woman:160,npc_l05_woman:340,npc_l05_manager:30,npc_l05_witness:200,npc_l06_girlfriend:315,npc_l06_mother:280,npc_l07_ex:300,npc_l08_wife:330,npc_l08_mother:275,npc_l08_child:50,npc_l09_wife:320,npc_l09_cousin:25,npc_l10_exwife:310,npc_l10_child:55,npc_l10_teacher:165,npc_l11_hr:220,npc_l12_colleague:145,npc_l12_boss:25,npc_l13_hr:215,npc_l13_complainant:345,npc_l14_hr:225,npc_l14_director:20,npc_l15_broker:40,npc_l15_hr:218,npc_l16_account:35,npc_l17_father:205,npc_l17_hr:222,npc_l18_streamer:325,npc_l19_moderator:195,npc_l19_pr:285,crowd:0},Tf={appTitle:df,appSub:ff,meters:gf,speakerNames:mf,actNames:hf,ui:vf,scenes:xf,danmaku:kf,speakerHues:yf},pe=Tf;function sn(e){const t=pe.ui[e];return typeof t=="string"?t:""}function Af(e){return pe.speakerNames[e]??e}function Gi(e){return pe.speakerHues[e]??220}function mp(e){return pe.scenes[e]??{label:"",hue:210,motif:"room"}}const bf={class:"hud"},Lf={class:"label"},Pf={class:"bar"},Of={class:"num"},wf=gt({__name:"MeterHud",props:{state:{}},setup(e){const t=e,n=q(()=>[{k:"evidence",kind:"good"},{k:"opinion",kind:"good"},{k:"composure",kind:"good"},{k:"risk",kind:"bad"}].map(({k:o,kind:s})=>({key:o,label:pe.meters[o],value:t.state[o],kind:s})));return(i,o)=>(E(),H("div",bf,[(E(!0),H(Te,null,Rn(n.value,s=>(E(),H("div",{key:s.key,class:xe(["meter",s.kind])},[y("span",Lf,D(s.label),1),y("div",Pf,[y("div",{class:"fill",style:De({width:s.value+"%"})},null,4)]),y("span",Of,D(s.value),1)],2))),128))]))}}),Tt=(e,t)=>{const n=e.__vccOpts||e;for(const[i,o]of t)n[i]=o;return n},Rf=Tt(wf,[["__scopeId","data-v-20dd9153"]]),Sf={key:0,class:"name"},Ef={class:"text"},Cf={class:"cue"},If=gt({__name:"StoryBox",props:{speaker:{},text:{},kind:{}},emits:["advance"],setup(e,{emit:t}){const n=e,i=t,o=p=>p===void 0?"":pe.speakerNames[p]??p,s=p=>p===void 0?220:Gi(p),r=le("");let c;function a(p){if(r.value="",c!==void 0&&clearInterval(c),typeof setInterval!="function"){r.value=p;return}let d=0;c=setInterval(()=>{d+=2,r.value=p.slice(0,d),d>=p.length&&c!==void 0&&(clearInterval(c),c=void 0)},28)}Ge(()=>n.text,p=>a(p),{immediate:!0}),Zt(()=>{c!==void 0&&clearInterval(c)});function u(){r.value.length<n.text.length?(r.value=n.text,c!==void 0&&(clearInterval(c),c=void 0)):i("advance")}return(p,d)=>(E(),H("div",{class:xe(["box",e.kind]),style:De({"--h":s(e.speaker)}),onClick:u},[e.kind==="dialogue"&&e.speaker?(E(),H("div",Sf,D(o(e.speaker)),1)):Pe("",!0),y("p",Ef,D(r.value),1),y("div",Cf,D(O(pe).ui.tapToContinue),1)],6))}}),ss=Tt(If,[["__scopeId","data-v-716d70d8"]]);function $f(e){let t=2166136261;for(let n=0;n<e.length;n++)t^=e.charCodeAt(n),t=Math.imul(t,16777619);return t>>>0}function Mf(e){let t=e>>>0;return()=>{t=t+1831565813|0;let n=Math.imul(t^t>>>15,1|t);return n=n+Math.imul(n^n>>>7,61|n)^n,((n^n>>>14)>>>0)/4294967296}}function Nf(e){const t=[...e],n=Mf($f(t.map(i=>i.id).join("|")));for(let i=t.length-1;i>0;i--){const o=Math.floor(n()*(i+1)),s=t[i];t[i]=t[o],t[o]=s}return{left:t.filter((i,o)=>o%2===0),right:t.filter((i,o)=>o%2===1)}}const Df={class:"swipe"},Ff={class:"duo"},Bf={class:"card under-card"},Hf={key:0,class:"more"},jf={class:"tip"},Gf={class:"card"},Uf={key:0,class:"more"},Vf={class:"tip"},Yf={class:"taps"},Kf=["aria-label"],qf=["aria-label"],Wf={key:1,class:"list"},zf={class:"list-head"},Xf={class:"list-hint"},Jf=["onClick"],Zf={key:2,class:"hint"},Qf={key:3,class:"hint"},Oi=96,rs=10,wi=380,e0=gt({__name:"SwipeChoice",props:{options:{},timer:{},timeoutOptionId:{}},emits:["choose"],setup(e,{emit:t}){const n=e,i=t,o=q(()=>Nf(n.options)),s=q(()=>o.value.left),r=q(()=>o.value.right),c=le(0),a=le([]),u=le("L"),p=q(()=>(u.value==="L"?s:r).value),d=q(()=>(u.value==="L"?r:s).value),m=q(()=>p.value[0]),k=q(()=>d.value[0]),B=q(()=>u.value==="L"?bt:Ft),b=q(()=>u.value==="L"?Ft:bt);function F(Q){const ae=(Q==="L"?s:r).value;if(ae.length===1&&ae[0]!==void 0){i("choose",ae[0].id);return}a.value=[...ae],c.value=1}function G(Q){i("choose",Q.id)}function C(){c.value=0}function U(){$.value||(u.value=u.value==="L"?"R":"L",J.value=0)}const R=le(n.timer);let V=ce();Ge(()=>n.options,()=>{c.value=0,a.value=[],u.value="L",J.value=0,$.value=!1,V!==void 0&&clearInterval(V),V=ce(),R.value=n.timer});function ce(){if(typeof setInterval!="function")return;const Q=setInterval(()=>{if(R.value-=1,R.value<=0){clearInterval(Q),V===Q&&(V=void 0);const ae=n.options.find(Ye=>Ye.id===n.timeoutOptionId);ae!==void 0&&i("choose",ae.id)}},1e3);return Q}Zt(()=>{V!==void 0&&clearInterval(V)});const J=le(0),_e=le(!1),$=le(!1),W=le("");let ie=0,w=-1;const oe=q(()=>{if($.value){const ae=W.value==="L"?-1:1;return`transform: translate(${ae*640}px, ${ae*60}px) rotate(${ae*32}deg); opacity: 0; transition: transform ${wi}ms cubic-bezier(.2,.7,.3,1), opacity ${wi}ms;`}const Q=Math.max(-rs,Math.min(rs,J.value/14));return`transform: translateX(${J.value}px) rotate(${Q}deg);`}),he=q(()=>!_e.value&&!$.value),Be=q(()=>_e.value&&J.value<-Oi),fe=q(()=>_e.value&&J.value>Oi);function re(Q){var ae,Ye;c.value!==0||$.value||(_e.value=!0,ie=Q.clientX,J.value=0,w=Q.pointerId,(Ye=(ae=Q.currentTarget).setPointerCapture)==null||Ye.call(ae,Q.pointerId))}function Z(Q){!_e.value||Q.pointerId!==w||(J.value=Q.clientX-ie)}function Ve(Q){!_e.value||Q.pointerId!==w||(_e.value=!1,Math.abs(J.value)>=Oi?Re(J.value<0?"L":"R"):J.value=0)}function Dt(){c.value===0&&!$.value&&Re("L")}function st(){c.value===0&&!$.value&&Re("R")}function Re(Q){$.value=!0,W.value=Q,window.setTimeout(()=>{$.value=!1,W.value="",J.value=0,F(Q)},wi)}const bt=pe.ui.pileALabel??"",Ft=pe.ui.pileBLabel??"",En=pe.ui.pileListHint??"",Lt=pe.ui.swipeHint??"";return(Q,ae)=>{var Ye,ht;return E(),H("div",Df,[y("div",{class:xe(["timer",{panic:R.value<=4}])},[y("span",null,D(R.value),1)],2),c.value===0?(E(),H("div",{key:0,class:xe(["stage",{settled:he.value}]),onPointerdown:re,onPointermove:Z,onPointerup:Ve,onPointercancel:Ve},[y("div",Ff,[y("div",{class:"lane under",onClick:ae[0]||(ae[0]=Yt(Bt=>U(),["stop"]))},[y("div",Bf,[y("p",null,D((Ye=k.value)==null?void 0:Ye.text),1),d.value.length>1?(E(),H("span",Hf,D(d.value.length),1)):Pe("",!0)]),y("div",jf,D(b.value),1)]),y("div",{class:"lane main",style:De(oe.value)},[y("div",Gf,[y("p",null,D((ht=m.value)==null?void 0:ht.text),1),p.value.length>1?(E(),H("span",Uf,D(p.value.length),1)):Pe("",!0)]),y("div",Vf,D(B.value),1),y("div",{class:xe(["stamp left",{on:Be.value}])},"◀ "+D(O(bt)),3),y("div",{class:xe(["stamp right",{on:fe.value}])},D(O(Ft))+" ▶",3)],4)]),y("div",Yf,[y("button",{class:"tap",onClick:Yt(Dt,["stop"]),"aria-label":O(bt)},"◀",8,Kf),y("button",{class:"tap swap",onClick:Yt(U,["stop"]),"aria-label":"换一堆"},"⇄"),y("button",{class:"tap",onClick:Yt(st,["stop"]),"aria-label":O(Ft)},"▶",8,qf)])],34)):(E(),H("div",Wf,[y("div",zf,[y("div",{class:"tip back",onClick:ae[1]||(ae[1]=Bt=>C())},"‹"),y("span",Xf,D(O(En)),1)]),(E(!0),H(Te,null,Rn(a.value,Bt=>(E(),H("div",{key:Bt.id,class:"row",onClick:l=>G(Bt)},[y("p",null,D(Bt.text),1)],8,Jf))),128))])),c.value===0?(E(),H("div",Zf,D(O(Lt)),1)):(E(),H("div",Qf,D(O(En)),1))])}}}),t0=Tt(e0,[["__scopeId","data-v-dc728162"]]),n0=""+new URL("rank_A-Buk7knaJ.mp4",import.meta.url).href,i0=""+new URL("rank_B-MEHXL8TX.mp4",import.meta.url).href,o0=""+new URL("rank_C-DOkhQSQI.mp4",import.meta.url).href,s0=""+new URL("rank_F-DPh74h1I.mp4",import.meta.url).href,r0=""+new URL("rank_S-BXJbetyP.mp4",import.meta.url).href,c0=["data-rank"],a0=["src"],l0={class:"stamp"},p0={class:"rk"},u0={class:"word"},_0={class:"title"},d0={class:"script"},f0={class:"meters-card"},g0={class:"mc-title"},m0={class:"bars"},h0={class:"lbl"},v0={class:"track"},x0={class:"num"},k0={class:"disclaimer"},y0={class:"acts"},T0=gt({__name:"EndingCard",props:{ending:{},state:{}},emits:["restart","next"],setup(e,{emit:t}){const n=e,i=le(1),o=le(!1),s=pe.ui,r=q(()=>s["settleStamp"+n.ending.rank]??""),c=q(()=>{const m=Object.entries(Object.assign({"../../../content/art/endings/rank_A.mp4":n0,"../../../content/art/endings/rank_B.mp4":i0,"../../../content/art/endings/rank_C.mp4":o0,"../../../content/art/endings/rank_F.mp4":s0,"../../../content/art/endings/rank_S.mp4":r0})).find(([k])=>k.endsWith("/rank_"+n.ending.rank+".mp4"));return(m==null?void 0:m[1])??""});let a,u;ro(()=>{if(typeof setTimeout!="function"){i.value=3;return}a=setTimeout(()=>{i.value=2},1200),u=setTimeout(()=>{i.value=3},2600)}),Zt(()=>{a!==void 0&&clearTimeout(a),u!==void 0&&clearTimeout(u)});function p(){i.value=3}return(d,m)=>(E(),H("div",{class:"cinema","data-rank":e.ending.rank,onClick:p},[c.value?(E(),H("video",{key:0,class:"bgvid",src:c.value,autoplay:"",muted:"",loop:"",playsinline:"",onCanplay:m[0]||(m[0]=k=>o.value=!0)},null,40,a0)):Pe("",!0),y("div",{class:xe(["dim",{deeper:i.value>=2}])},null,2),y("div",{class:xe(["stamp-wrap",{show:i.value>=2}])},[y("div",l0,[y("span",p0,D(e.ending.rank),1),y("span",u0,D(r.value),1)])],2),y("div",{class:xe(["sheet",{show:i.value>=3}])},[y("h2",_0,D(e.ending.title),1),y("p",d0,D(e.ending.script),1),y("div",f0,[y("div",g0,D(O(s).settleMetersTitle),1),y("div",m0,[(E(),H(Te,null,Rn(["evidence","opinion","composure","risk"],k=>y("div",{key:k,class:"bar"},[y("span",h0,D(O(pe).meters[k]),1),y("span",v0,[y("i",{style:De({width:Math.min(100,e.state[k])+"%"}),class:xe(k)},null,6)]),y("span",x0,D(e.state[k]),1)])),64))])]),y("p",k0,D(O(pe).ui.disclaimer),1),y("div",y0,[y("button",{onClick:m[1]||(m[1]=Yt(k=>d.$emit("restart"),["stop"]))},D(O(s).settleReplay),1),y("button",{class:"primary",onClick:m[2]||(m[2]=Yt(k=>d.$emit("next"),["stop"]))},D(O(s).settleNext),1)])],2)],8,c0))}}),A0=Tt(T0,[["__scopeId","data-v-4ea8c84b"]]),b0={class:"select"},L0={class:"sub"},P0={class:"list"},O0=["onClick"],w0={class:"tid"},R0={class:"ttitle"},S0={class:"foot"},E0=gt({__name:"LevelSelect",props:{levels:{},best:{}},emits:["pick"],setup(e){const t=n=>n===void 0?"":"r"+n;return(n,i)=>(E(),H("div",b0,[y("header",null,[y("h1",null,D(O(pe).appTitle),1),y("p",L0,D(O(pe).appSub),1)]),y("div",P0,[(E(!0),H(Te,null,Rn(e.levels,o=>(E(),H("button",{key:o.id,onClick:s=>n.$emit("pick",o.id)},[y("span",w0,D(o.id),1),y("span",R0,D(o.title),1),y("span",{class:xe(["badge",t(e.best[o.id])])},D(e.best[o.id]??"·"),3)],8,O0))),128))]),y("footer",S0,D(O(pe).ui.disclaimer),1)]))}}),C0=Tt(E0,[["__scopeId","data-v-81b5ddea"]]),I0=""+new URL("L01-BJmHDizO.png",import.meta.url).href,$0=""+new URL("L02-Cgrrfiit.png",import.meta.url).href,M0=""+new URL("L03-Dhb-92UY.png",import.meta.url).href,N0=""+new URL("L04-Dxn6iz_R.png",import.meta.url).href,D0=""+new URL("L05-BCX3gD5-.png",import.meta.url).href,F0=""+new URL("L06-DPfiJfY4.png",import.meta.url).href,B0=""+new URL("L07-DgpRWPjk.png",import.meta.url).href,H0=""+new URL("L08-HGz_P2cJ.png",import.meta.url).href,j0=""+new URL("L09-VpgvEvrb.png",import.meta.url).href,G0=""+new URL("L10-D_mOdB4H.png",import.meta.url).href,U0=""+new URL("L11-BXLJJDeb.png",import.meta.url).href,V0=""+new URL("L12-DemYAPsM.png",import.meta.url).href,Y0=""+new URL("L13-Dn-DLBYO.png",import.meta.url).href,K0=""+new URL("L14-BLDD-heh.png",import.meta.url).href,q0=""+new URL("L15-BVYsTDdi.png",import.meta.url).href,W0=""+new URL("L16-kHk4EBk-.png",import.meta.url).href,z0=""+new URL("L17-BomGMZbR.png",import.meta.url).href,X0=""+new URL("L18-B2bLjWIc.png",import.meta.url).href,J0=""+new URL("L19-DHpwxvAB.png",import.meta.url).href,Z0=""+new URL("L20-CyAYX9HG.png",import.meta.url).href,Q0=["src"],eg={key:1,class:"photo-shade"},tg={key:2,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},ng={key:3,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},ig={key:4,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},og={key:5,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},sg={key:6,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},rg={key:7,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},cg={class:"tag"},ag=gt({__name:"SceneBackdrop",props:{levelId:{},pressure:{}},setup(e){const t=e,n=Object.assign({"../../../content/art/scenes/L01.png":I0,"../../../content/art/scenes/L02.png":$0,"../../../content/art/scenes/L03.png":M0,"../../../content/art/scenes/L04.png":N0,"../../../content/art/scenes/L05.png":D0,"../../../content/art/scenes/L06.png":F0,"../../../content/art/scenes/L07.png":B0,"../../../content/art/scenes/L08.png":H0,"../../../content/art/scenes/L09.png":j0,"../../../content/art/scenes/L10.png":G0,"../../../content/art/scenes/L11.png":U0,"../../../content/art/scenes/L12.png":V0,"../../../content/art/scenes/L13.png":Y0,"../../../content/art/scenes/L14.png":K0,"../../../content/art/scenes/L15.png":q0,"../../../content/art/scenes/L16.png":W0,"../../../content/art/scenes/L17.png":z0,"../../../content/art/scenes/L18.png":X0,"../../../content/art/scenes/L19.png":J0,"../../../content/art/scenes/L20.png":Z0}),i=le("");Ge(()=>t.levelId,c=>{const a=Object.entries(n).find(([u])=>u.endsWith("/"+c+".png"));i.value=a!==void 0?a[1]:""},{immediate:!0});const o=q(()=>mp(t.levelId)),s=q(()=>{const c=o.value.hue,a=8+Math.round(t.pressure*.8);return{background:`radial-gradient(120% 70% at 50% 18%, hsl(${c} 32% ${a+10}%) 0%, hsl(${c} 38% ${a}%) 45%, hsl(${c} 45% ${Math.max(4,a-4)}%) 100%)`}}),r=q(()=>o.value.motif);return(c,a)=>(E(),H("div",{class:"backdrop",style:De(s.value)},[i.value?(E(),H("img",{key:0,class:"photo",src:i.value,alt:""},null,8,Q0)):Pe("",!0),i.value?(E(),H("div",eg)):Pe("",!0),r.value==="subway"?(E(),H("svg",tg,[...a[0]||(a[0]=[ki('<rect x="40" y="80" width="320" height="180" rx="14" class="win" data-v-a0709a1d></rect><rect x="52" y="92" width="70" height="156" rx="4" class="win2" data-v-a0709a1d></rect><rect x="132" y="92" width="70" height="156" rx="4" class="win2" data-v-a0709a1d></rect><rect x="212" y="92" width="70" height="156" rx="4" class="win2" data-v-a0709a1d></rect><rect x="292" y="92" width="56" height="156" rx="4" class="win2" data-v-a0709a1d></rect><rect x="0" y="300" width="400" height="10" class="rail" data-v-a0709a1d></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-a0709a1d></line>',7)])])):r.value==="elevator"?(E(),H("svg",ng,[...a[1]||(a[1]=[y("rect",{x:"120",y:"60",width:"160",height:"440",rx:"6",class:"door"},null,-1),y("line",{x1:"200",y1:"60",x2:"200",y2:"500",class:"seam"},null,-1),y("circle",{cx:"200",cy:"530",r:"12",class:"lamp"},null,-1),y("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="street"?(E(),H("svg",ig,[...a[2]||(a[2]=[ki('<line x1="60" y1="0" x2="60" y2="380" class="pole" data-v-a0709a1d></line><rect x="48" y="380" width="24" height="8" rx="3" class="lamp" data-v-a0709a1d></rect><rect x="0" y="430" width="400" height="6" class="rail" data-v-a0709a1d></rect><rect x="0" y="470" width="400" height="4" class="rail dim" data-v-a0709a1d></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-a0709a1d></line>',5)])])):r.value==="court"?(E(),H("svg",og,[...a[3]||(a[3]=[y("rect",{x:"80",y:"120",width:"240",height:"90",rx:"4",class:"win"},null,-1),y("rect",{x:"100",y:"300",width:"200",height:"14",rx:"3",class:"desk"},null,-1),y("rect",{x:"60",y:"380",width:"280",height:"10",rx:"3",class:"desk dim"},null,-1),y("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="studio"?(E(),H("svg",sg,[...a[4]||(a[4]=[ki('<rect x="40" y="90" width="130" height="80" rx="6" class="win" data-v-a0709a1d></rect><rect x="230" y="90" width="130" height="80" rx="6" class="win" data-v-a0709a1d></rect><circle cx="200" cy="260" r="8" class="lamp" data-v-a0709a1d></circle><line x1="200" y1="0" x2="200" y2="252" class="pole thin" data-v-a0709a1d></line><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-a0709a1d></line>',5)])])):(E(),H("svg",rg,[...a[5]||(a[5]=[y("rect",{x:"50",y:"110",width:"140",height:"100",rx:"6",class:"win"},null,-1),y("rect",{x:"220",y:"110",width:"130",height:"70",rx:"6",class:"win dim"},null,-1),y("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])),y("div",cg,D(o.value.label),1)],4))}}),lg=Tt(ag,[["__scopeId","data-v-a0709a1d"]]),pg={class:"danmaku","aria-hidden":"true"},ug=gt({__name:"DanmakuLayer",props:{pressure:{},active:{type:Boolean}},setup(e){const t=e,n=le([]);let i=0,o;function s(){return t.pressure>=4?pe.danmaku.hot:t.pressure>=3?pe.danmaku.tense:pe.danmaku.calm}function r(){if(!t.active)return;const c=s();if(c.length===0)return;const a=c[Math.floor(Math.random()*c.length)]??"";n.value.push({id:i+=1,text:a,lane:Math.floor(Math.random()*4),speed:t.pressure>=4?7+Math.random()*3:10+Math.random()*4,bold:Math.random()<.25}),n.value.length>14&&(n.value=n.value.slice(-14))}return typeof setInterval=="function"&&(o=setInterval(r,t.pressure>=4?900:1800),Ge(()=>t.pressure,()=>{})),Zt(()=>{o!==void 0&&clearInterval(o)}),(c,a)=>(E(),H("div",pg,[Ie(V_,{name:"fly"},{default:Hs(()=>[(E(!0),H(Te,null,Rn(n.value,u=>(E(),H("span",{key:u.id,class:xe(["line",{bold:u.bold}]),style:De({top:12+u.lane*34+"px","--dur":u.speed+"s"})},D(u.text),7))),128))]),_:1})]))}}),_g=Tt(ug,[["__scopeId","data-v-55cd0013"]]),dg=""+new URL("he_song-DAGlX_4O.png",import.meta.url).href,fg=""+new URL("hero-BAfbz0Vs.png",import.meta.url).href,gg=""+new URL("npc_l01_woman-DSDWwEL8.png",import.meta.url).href,mg=""+new URL("npc_l02_woman-qXhWvPKu.png",import.meta.url).href,hg=""+new URL("npc_l03_daughter-Dt2TiO8f.png",import.meta.url).href,vg=""+new URL("npc_l03_woman-BQ3wIsYH.png",import.meta.url).href,xg=""+new URL("npc_l04_woman-CZQbIvDG.png",import.meta.url).href,kg=""+new URL("npc_l05_manager-Ce6F9DQj.png",import.meta.url).href,yg=""+new URL("npc_l05_woman-BXLOsOGn.png",import.meta.url).href,Tg=""+new URL("npc_l06_girlfriend-CrncpSA3.png",import.meta.url).href,Ag=""+new URL("npc_l06_mother-BJuBbFLU.png",import.meta.url).href,bg=""+new URL("npc_l07_ex-CEJAEgFV.png",import.meta.url).href,Lg=""+new URL("npc_l08_child-Bm0Rde6F.png",import.meta.url).href,Pg=""+new URL("npc_l08_mother-tu98VogT.png",import.meta.url).href,Og=""+new URL("npc_l08_wife-Cy9DZe9m.png",import.meta.url).href,wg=""+new URL("npc_l09_wife-CJUlJISq.png",import.meta.url).href,Rg=""+new URL("npc_l10_exwife-D0NJtWQK.png",import.meta.url).href,Sg=""+new URL("npc_l11_hr-Dqx_GpDt.png",import.meta.url).href,Eg=""+new URL("npc_l12_boss-nYTyR_X5.png",import.meta.url).href,Cg=""+new URL("npc_l12_colleague-BD3ntBZW.png",import.meta.url).href,Ig=""+new URL("npc_l13_hr-Dovjb9V8.png",import.meta.url).href,$g=""+new URL("npc_l14_director-B-efKLNg.png",import.meta.url).href,Mg=""+new URL("npc_l14_hr-DRiqQqX2.png",import.meta.url).href,Ng=""+new URL("npc_l15_broker-CqY8iI1Q.png",import.meta.url).href,Dg=""+new URL("npc_l15_hr-CSF8zzWx.png",import.meta.url).href,Fg=""+new URL("npc_l16_account-D825uOC6.png",import.meta.url).href,Bg=""+new URL("npc_l17_father-jYHQ9zlG.png",import.meta.url).href,Hg=""+new URL("npc_l17_hr-D3pAIKo4.png",import.meta.url).href,jg=""+new URL("npc_l18_streamer-CYlpG6aq.png",import.meta.url).href,Gg=""+new URL("npc_l19_moderator-CoZr2C0k.png",import.meta.url).href,Ug=""+new URL("npc_l19_pr-Do-3PPx1.png",import.meta.url).href,Vg=""+new URL("officer_lin-Bduk5y-m.png",import.meta.url).href,Yg=""+new URL("shen_li-Bd_DLpmj.png",import.meta.url).href,Kg=""+new URL("zhou_you-DSERK5v3.png",import.meta.url).href,qg={key:0,class:"duo","aria-hidden":"true"},Wg=["src"],zg={key:1,class:"pt",viewBox:"0 0 120 160"},Xg=["src","alt"],Jg={key:1,class:"pt",viewBox:"0 0 120 160"},Zg={class:"nm"},Qg=gt({__name:"PortraitSlot",props:{speaker:{},visible:{type:Boolean}},setup(e){const t=e,n=Object.assign({"../../../content/art/characters/he_song.png":dg,"../../../content/art/characters/hero.png":fg,"../../../content/art/characters/npc_l01_woman.png":gg,"../../../content/art/characters/npc_l02_woman.png":mg,"../../../content/art/characters/npc_l03_daughter.png":hg,"../../../content/art/characters/npc_l03_woman.png":vg,"../../../content/art/characters/npc_l04_woman.png":xg,"../../../content/art/characters/npc_l05_manager.png":kg,"../../../content/art/characters/npc_l05_woman.png":yg,"../../../content/art/characters/npc_l06_girlfriend.png":Tg,"../../../content/art/characters/npc_l06_mother.png":Ag,"../../../content/art/characters/npc_l07_ex.png":bg,"../../../content/art/characters/npc_l08_child.png":Lg,"../../../content/art/characters/npc_l08_mother.png":Pg,"../../../content/art/characters/npc_l08_wife.png":Og,"../../../content/art/characters/npc_l09_wife.png":wg,"../../../content/art/characters/npc_l10_exwife.png":Rg,"../../../content/art/characters/npc_l11_hr.png":Sg,"../../../content/art/characters/npc_l12_boss.png":Eg,"../../../content/art/characters/npc_l12_colleague.png":Cg,"../../../content/art/characters/npc_l13_hr.png":Ig,"../../../content/art/characters/npc_l14_director.png":$g,"../../../content/art/characters/npc_l14_hr.png":Mg,"../../../content/art/characters/npc_l15_broker.png":Ng,"../../../content/art/characters/npc_l15_hr.png":Dg,"../../../content/art/characters/npc_l16_account.png":Fg,"../../../content/art/characters/npc_l17_father.png":Bg,"../../../content/art/characters/npc_l17_hr.png":Hg,"../../../content/art/characters/npc_l18_streamer.png":jg,"../../../content/art/characters/npc_l19_moderator.png":Gg,"../../../content/art/characters/npc_l19_pr.png":Ug,"../../../content/art/characters/officer_lin.png":Vg,"../../../content/art/characters/shen_li.png":Yg,"../../../content/art/characters/zhou_you.png":Kg});function i(m){if(m===null)return{url:"",ok:!1};const k=Object.entries(n).find(([B])=>B.endsWith("/"+m+".png"));return k!==void 0?{url:k[1],ok:!0}:{url:"",ok:!1}}const o=i("hero"),s=Gi("hero"),r=q(()=>t.speaker===null||t.speaker==="hero"?null:t.speaker),c=q(()=>i(r.value)),a=q(()=>Gi(r.value??"")),u=q(()=>r.value===null?"":Af(r.value)),p=le(!1);Ge(()=>t.speaker,()=>{p.value=!1});const d=q(()=>t.speaker==="hero");return(m,k)=>e.visible?(E(),H("div",qg,[y("div",{class:xe(["who hero",{talking:d.value}]),style:De({"--h":O(s)})},[O(o).ok?(E(),H("img",{key:0,class:"pt art",src:O(o).url,alt:""},null,8,Wg)):(E(),H("svg",zg,[...k[1]||(k[1]=[y("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])]))],6),r.value?(E(),H("div",{key:0,class:xe(["who guest",{talking:!0}]),style:De({"--h":a.value})},[c.value.ok&&!p.value?(E(),H("img",{key:0,class:"pt art",src:c.value.url,alt:u.value,onError:k[0]||(k[0]=B=>p.value=!0)},null,40,Xg)):(E(),H("svg",Jg,[...k[2]||(k[2]=[y("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])])),y("span",Zg,D(u.value),1)],4)):Pe("",!0)])):Pe("",!0)}}),e1=Tt(Qg,[["__scopeId","data-v-b5ca4a9b"]]);function t1(e,t){const n=220*Math.pow(2,Math.round(e/30)%12/12);return t==="tense"?{root:n,steps:[0,2,3,5,7,8,10]}:t==="panic"?{root:n,steps:[0,1,3,6,7,9,10]}:{root:n*1.5,steps:[0,2,4,7,9,12,14]}}function cs(e,t){const n=Math.floor(t/e.steps.length),i=(t%e.steps.length+e.steps.length)%e.steps.length;return e.root*Math.pow(2,(e.steps[i]??0)/12+n)}function as(e){let t=e|0;return()=>(t=Math.imul(t,1664525)+1013904223|0,(t>>>8&16777215)/16777216)}class n1{constructor(){ve(this,"ctx",null);ve(this,"master",null);ve(this,"bgmGain",null);ve(this,"sfxGain",null);ve(this,"bgmTimer",null);ve(this,"mood","calm");ve(this,"hue",210);ve(this,"step",0);ve(this,"rnd",as(42));ve(this,"muted",!1)}unlock(){if(this.ctx===null){const t=globalThis.AudioContext;if(t===void 0)return;this.ctx=new t,this.master=this.ctx.createGain(),this.master.gain.value=this.muted?0:.55,this.master.connect(this.ctx.destination),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.5,this.bgmGain.connect(this.master),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.9,this.sfxGain.connect(this.master)}this.ctx.state==="suspended"&&this.ctx.resume()}setMuted(t){this.muted=t,this.master!==null&&this.ctx!==null&&this.master.gain.setTargetAtTime(t?0:.55,this.ctx.currentTime,.05)}tone(t,n,i,o,s,r=0){if(this.ctx===null)return;const c=this.ctx.currentTime+r,a=this.ctx.createOscillator(),u=this.ctx.createGain();a.type=o,a.frequency.value=t,u.gain.setValueAtTime(0,c),u.gain.linearRampToValueAtTime(i,c+.012),u.gain.exponentialRampToValueAtTime(1e-4,c+n),a.connect(u),u.connect(s),a.start(c),a.stop(c+n+.05)}pad(t,n){if(this.bgmGain===null||this.ctx===null)return;const i=this.ctx.currentTime,o=this.ctx.createOscillator(),s=this.ctx.createGain(),r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=900,o.type="sawtooth",o.frequency.value=t/2,s.gain.setValueAtTime(0,i),s.gain.linearRampToValueAtTime(.05,i+n*.3),s.gain.linearRampToValueAtTime(1e-4,i+n),o.connect(r),r.connect(s),s.connect(this.bgmGain),o.start(i),o.stop(i+n+.1)}scene(t,n,i,o){const s=o<15||i>=4?"panic":i>=3||o<40?"tense":"calm";let r=0;for(let c=0;c<t.length;c+=1)r=r*31+t.charCodeAt(c)|0;(s!==this.mood||n!==this.hue)&&(this.mood=s,this.hue=n,this.rnd=as(r),this.step=0)}tick(){if(this.ctx===null||this.bgmGain===null||this.muted)return;const t=t1(this.hue,this.mood),n=this.step%8,i=this.mood==="calm"?.35:this.mood==="tense"?.55:.75;if(this.rnd()<i){const o=Math.floor(this.rnd()*8),s=cs(t,o);this.tone(s,this.mood==="calm"?.9:.45,.06,this.mood==="calm"?"sine":"triangle",this.bgmGain)}n===0&&this.pad(cs(t,0),this.mood==="calm"?6.4:3.2),this.mood==="panic"&&(n===0||n===4)&&(this.tone(52,.14,.16,"sine",this.bgmGain),this.tone(52,.12,.12,"sine",this.bgmGain,.18)),this.step+=1}sfx(t){if(!(this.ctx===null||this.sfxGain===null||this.muted))switch(t){case"click":this.tone(880,.06,.1,"sine",this.sfxGain);break;case"options":this.tone(523,.08,.09,"sine",this.sfxGain),this.tone(784,.1,.09,"sine",this.sfxGain,.07);break;case"tick":this.tone(1245,.04,.07,"square",this.sfxGain);break;case"ending":{const n=this.sfxGain;n!==null&&[523,659,784,1047].forEach((i,o)=>this.tone(i,.5,.08,"sine",n,o*.13));break}case"bad":{const n=this.sfxGain;n!==null&&[330,294,262,196].forEach((i,o)=>this.tone(i,.35,.09,"triangle",n,o*.15));break}}}startLoop(){if(this.bgmTimer!==null)return;const t=800;typeof setInterval=="function"&&(this.bgmTimer=setInterval(()=>this.tick(),t))}stopLoop(){this.bgmTimer!==void 0&&this.bgmTimer!==null&&(clearInterval(this.bgmTimer),this.bgmTimer=null)}}const Rt=new n1,i1={class:"stage"},o1={key:2,class:"topbar"},s1={class:"lv-title"},r1={key:3,class:"study-entry"},c1={class:"sub"},a1=["placeholder"],l1=["disabled"],p1={key:4,class:"study-done"},u1={class:"sum"},_1={class:"story"},d1={name:"App"},f1=gt({...d1,props:{ctx:{}},setup(e){const n=e.ctx;Ge(n.event,b=>{b!==null&&b.type==="ending"&&(n.settle(),Rt.sfx(b.ending.rank==="S"||b.ending.rank==="A"?"ending":"bad"))}),Ge(n.event,b=>{var G,C,U;if(b===null)return;const F=mp(((G=n.current.value)==null?void 0:G.id)??"L01").hue;b.type==="node"?Rt.scene(((C=n.current.value)==null?void 0:C.id)??"L01",F,b.node.pressure??0,n.meters.value.composure):b.type==="options"&&(Rt.sfx("options"),Rt.scene(((U=n.current.value)==null?void 0:U.id)??"L01",F,3,n.meters.value.composure))});const i=le(0),o=le(null);Ge(n.event,b=>{if(b===null){i.value=0,o.value=null;return}b.type==="node"?(i.value=b.node.pressure??0,o.value="speaker"in b.node?String(b.node.speaker):null):b.type==="options"&&(i.value=b.options.length>0?i.value:0,o.value=null)});const s=q(()=>{const b=n.meters.value.composure;return b>=50||n.screen.value!=="level"?{opacity:0}:{opacity:(.25+(50-b)/50*.55).toFixed(2),animation:b<15?"throb 1.1s ease-in-out infinite":"none"}}),r=q(()=>n.screen.value==="level"),c=le(""),a=q(()=>n.STUDY_LEVELS.every(b=>{try{return n.studySummary().includes(b)}catch{return!1}}));function u(){const b=n.studyExport();typeof navigator<"u"&&navigator.clipboard!==void 0&&navigator.clipboard.writeText(b);const F=new Blob([b],{type:"application/json"}),G=document.createElement("a");G.href=URL.createObjectURL(F),G.download=`study-${c.value||"anon"}.json`,G.click()}const p=le(!1),d=q(()=>p.value?"x":"m");function m(){p.value=!p.value,Rt.setMuted(p.value)}function k(){Rt.unlock(),Rt.startLoop()}document.addEventListener("pointerdown",k,{once:!0});const B=q(()=>n.current.value?n.current.value.id:"L01");return(b,F)=>{var G;return E(),H("div",i1,[r.value?(E(),ct(lg,{key:0,"level-id":B.value,pressure:i.value},null,8,["level-id","pressure"])):Pe("",!0),r.value&&((G=O(n).event.value)==null?void 0:G.type)!=="ending"?(E(),ct(_g,{key:1,pressure:i.value,active:r.value},null,8,["pressure","active"])):Pe("",!0),r.value?(E(),H("header",o1,[y("button",{class:"back",onClick:F[0]||(F[0]=C=>O(n).toSelect())},"‹"),y("span",s1,D(O(n).banner.value),1),y("button",{class:xe(["mute",{off:p.value}]),onClick:F[1]||(F[1]=C=>m())},D(d.value),3)])):Pe("",!0),O(n).studyOn&&O(n).studyScreen.value==="entry"?(E(),H("div",r1,[y("h1",null,D(O(pe).appTitle),1),y("p",c1,D(O(sn)("studyIntro")),1),du(y("input",{"onUpdate:modelValue":F[2]||(F[2]=C=>c.value=C),class:"pid",placeholder:O(sn)("studyPidPlaceholder"),maxlength:"8"},null,8,a1),[[X_,c.value]]),y("button",{class:"go",disabled:c.value.trim().length===0,onClick:F[3]||(F[3]=C=>O(n).studyBegin(c.value.trim()))},D(O(sn)("studyStart")),9,l1)])):O(n).studyOn&&O(n).studyScreen.value==="done"&&a.value?(E(),H("div",p1,[y("h2",null,D(O(sn)("studyDoneTitle")),1),y("pre",u1,D(O(n).studySummary()),1),y("button",{class:"go",onClick:u},D(O(sn)("studyCopy")),1)])):O(n).screen.value==="select"?(E(),ct(C0,{key:5,levels:O(n).studyOn?O(An).filter(C=>O(n).STUDY_LEVELS.includes(C.id)):O(An),best:O(n).best.value,onPick:O(n).startLevel},null,8,["levels","best","onPick"])):O(n).event.value?(E(),H(Te,{key:6},[O(n).event.value.type!=="ending"?(E(),ct(Rf,{key:0,state:O(n).meters.value},null,8,["state"])):Pe("",!0),Ie(e1,{speaker:O(n).event.value.type==="node"&&"speaker"in O(n).event.value.node?o.value:null,visible:O(n).event.value.type==="node"&&"speaker"in O(n).event.value.node},null,8,["speaker","visible"]),y("div",_1,[O(n).event.value.type==="node"&&"script"in O(n).event.value.node?(E(),ct(ss,{key:0,kind:"cutscene",text:String(O(n).event.value.node.script??""),onAdvance:F[4]||(F[4]=C=>O(n).advance())},null,8,["text"])):O(n).event.value.type==="node"&&"speaker"in O(n).event.value.node?(E(),ct(ss,{key:1,kind:"dialogue",speaker:String(O(n).event.value.node.speaker??""),text:String(O(n).event.value.node.text??""),onAdvance:F[5]||(F[5]=C=>O(n).advance())},null,8,["speaker","text"])):O(n).event.value.type==="options"?(E(),ct(t0,{key:2,options:O(n).event.value.options,timer:O(n).event.value.timer,"timeout-option-id":O(n).event.value.timeoutOptionId,onChoose:O(n).choose},null,8,["options","timer","timeout-option-id","onChoose"])):O(n).event.value.type==="ending"?(E(),ct(A0,{key:3,ending:O(n).event.value.ending,state:O(n).event.value.state,onRestart:O(n).restart,onNext:O(n).nextLevel},null,8,["ending","state","onRestart","onNext"])):Pe("",!0)])],64)):Pe("",!0),r.value?(E(),H("div",{key:7,class:"vignette",style:De(s.value)},null,4)):Pe("",!0)])}}}),hp="poju-study-v1",g1=()=>typeof location<"u"&&new URLSearchParams(location.search).get("study")==="1";function At(){if(typeof localStorage>"u")return{sessionId:"",participant:"",startedAt:0,runs:[]};const e=localStorage.getItem(hp);return e===null?{sessionId:"",participant:"",startedAt:0,runs:[]}:JSON.parse(e)}function pi(e){typeof localStorage<"u"&&localStorage.setItem(hp,JSON.stringify(e))}function m1(e){const t={sessionId:`S-${performance.now().toString(36)}`,participant:e,startedAt:performance.now(),runs:[]};return ui=t,pi(t),t}function h1(e,t,n){const i={level:t,startedAt:performance.now(),endedAt:0,totalMs:0,choices:[],endingRank:"",endingTitle:"",finalMeters:{evidence:0,opinion:0,composure:0,risk:0},replayed:n},o=ui??At();return o.runs.push(i),pi(o),i}let Ui=0,vp="",ui=null;function xp(e){Ui=performance.now(),vp=e}function v1(e,t,n,i,o){e.choices.push({level:n,nodeId:vp,optionId:i,ms:Ui>0?performance.now()-Ui:0,meters:{...o}});const s=ui??At();pi(s)}function x1(e,t,n,i,o){e.endedAt=performance.now(),e.totalMs=e.endedAt-e.startedAt,e.endingRank=n,e.endingTitle=i,e.finalMeters={...o},pi(ui??At())}function k1(){return JSON.stringify(At(),null,2)}function y1(){const e=At(),n=[pe.ui.studySummaryHeader.replace("{p}",e.participant).replace("{n}",String(e.runs.length))],i=new Map;for(const o of e.runs){const s=i.get(o.level)??[];s.push(o),i.set(o.level,s)}for(const[o,s]of[...i.entries()].sort()){const r=s[0],c=Math.round(r.totalMs/1e3),a=pe.ui.studySummaryLine;n.push(a.replace("{lv}",o).replace("{rank}",r.endingRank).replace("{title}",r.endingTitle).replace("{s}",String(c)).replace("{c}",String(r.choices.length)).replace("{r}",s.length>1?"Y":"N"))}return n.join(`
`)}const bn=le("select"),yt=ii(null),$t=ii(null),Jn=le(xd()),kp=le(""),_i=ii(null),uo=le({evidence:0,opinion:0,composure:0,risk:0}),Qt=g1(),Vi=["L01","L02","L03","L04","L05"],yp=le("entry"),Ln=ii(null);function T1(e){m1(e),yp.value="done",Pn("L01")}function Pn(e){const t=An.find(i=>i.id===e)??null;if(t===null)return;yt.value=t,kp.value=t.title;const n=new po(t,Jn.value);if(_i.value=n,$t.value=n.start(),uo.value={...n.state},bn.value="level",Qt){const i=At(),o=i.runs.some(s=>s.level===e&&s.endingRank!=="");Ln.value=h1(i,e,o),xp("entry")}}function A1(){const e=_i.value;e!==null&&($t.value=e.proceed(),Qt&&$t.value.type==="node"&&xp(String($t.value.node.id)))}function b1(e){const t=_i.value;t!==null&&($t.value=t.choose(e),uo.value={...t.state},Qt&&Ln.value!==null&&yt.value!==null&&v1(Ln.value,At(),yt.value.id,e,t.state))}function L1(){const e=_i.value,t=yt.value,n=$t.value;if(e===null||t===null||n===null||n.type!=="ending")return;const i=bd(Jn.value,t.id,n.ending,n.state,{now:0});Jn.value=i,kd(i),Qt&&Ln.value!==null&&x1(Ln.value,At(),n.ending.rank,n.ending.title,e.state)}function P1(){yt.value!==null&&Pn(yt.value.id)}function O1(){const e=yt.value;if(e===null)return;if(Qt){const i=Vi.indexOf(e.id),o=i>=0?Vi[i+1]:void 0;if(o===void 0){bn.value="select";return}Pn(o);return}const t=An.findIndex(i=>i.id===e.id),n=An[t+1];if(n===void 0){bn.value="select";return}Pn(n.id)}function w1(){bn.value="select"}const R1=q(()=>{const e={};for(const[t,n]of Object.entries(Jn.value.levelResults))e[t]=n.rank;return e}),S1={screen:bn,current:yt,event:$t,banner:kp,best:R1,meters:uo,startLevel:Pn,advance:A1,choose:b1,settle:L1,restart:P1,nextLevel:O1,toSelect:w1,studyOn:Qt,STUDY_LEVELS:Vi,studyScreen:yp,studyBegin:T1,studyExport:()=>k1(),studySummary:()=>y1()},E1=td(f1,{ctx:S1});E1.mount("#app");
