...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L04_F"}],gf={id:Sc,title:Rc,act:Ec,initState:Ic,cast:Cc,entryNode:$c,lawyerCard:Mc,satireTargets:Nc,nodes:Fc,endings:Dc},Bc=Object.freeze(Object.defineProperty({__proto__:null,act:Ec,cast:Cc,default:gf,endings:Dc,entryNode:$c,id:Sc,initState:Ic,lawyerCard:Mc,nodes:Fc,satireTargets:Nc,title:Rc},Symbol.toStringTag,{value:"Module"})),Hc="L05",Gc="第05关 · 托杠铃的那一下",Vc=1,jc={evidence:20,opinion:30,composure:50,risk:40},Uc=["hero","npc_l05_woman","npc_l05_manager","npc_l05_witness","crowd"],Yc="n_01",Kc="card_law_L05",qc=["T1","T5"],Wc=[{id:"n_01",type:"cutscene",pressure:1,script:`自由重量区，晚上八点半。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L09_F"}],kf={id:Ra,title:Ea,act:Ia,initState:Ca,cast:$a,entryNode:Ma,lawyerCard:Na,satireTargets:Fa,nodes:Da,endings:Ba},Ha=Object.freeze(Object.defineProperty({__proto__:null,act:Ia,cast:$a,default:kf,endings:Ba,entryNode:Ma,id:Ra,initState:Ca,lawyerCard:Na,nodes:Da,satireTargets:Fa,title:Ea},Symbol.toStringTag,{value:"Module"})),Ga="L10",Va="第10关 · 二十米",ja=2,Ua={evidence:30,opinion:35,composure:38,risk:45},Ya=["hero","npc_l10_exwife","npc_l10_child","npc_l10_teacher","shen_li"],Ka="n_01",qa="card_law_L10",Wa=["T1","T2"],za=[{id:"n_01",type:"cutscene",pressure:2,script:`抚养费返还的判决生效了。执行立案的第三天，
法院的人把另一份裁定书送到了公司前台。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L13_F"}],bf={id:kl,title:yl,act:Ll,initState:Tl,cast:bl,entryNode:Al,lawyerCard:wl,satireTargets:Ol,nodes:Pl,endings:Sl},Rl=Object.freeze(Object.defineProperty({__proto__:null,act:Ll,cast:bl,default:bf,endings:Sl,entryNode:Al,id:kl,initState:Tl,lawyerCard:wl,nodes:Pl,satireTargets:Ol,title:yl},Symbol.toStringTag,{value:"Module"})),El="L14",Il="第14关 · 匿名举报",Cl=3,$l={evidence:30,opinion:35,composure:34,risk:45},Ml=["hero","npc_l14_hr","npc_l14_director","zhou_you","shen_li"],Nl="n_01",Fl="card_law_L14",Dl=["T1","T5"],Bl=[{id:"n_01",type:"cutscene",pressure:2,script:`晋升公示第七天，最后一天。
...
周攸看到那条，截图发给你：「第三条。」
你回：「嗯。」`,next:"__END__"}],Hl=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 门口",script:`你推开了他。他手里的咖啡洒了一身，人撞在门框上。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L14_F"}],Af={id:El,title:Il,act:Cl,initState:$l,cast:Ml,entryNode:Nl,lawyerCard:Fl,satireTargets:Dl,nodes:Bl,endings:Hl},Gl=Object.freeze(Object.defineProperty({__proto__:null,act:Cl,cast:Ml,default:Af,endings:Hl,entryNode:Nl,id:El,initState:$l,lawyerCard:Fl,nodes:Bl,satireTargets:Dl,title:Il},Symbol.toStringTag,{value:"Module"})),Vl="L15",jl="第15关 · 最后一张牌",Ul=3,Yl={evidence:40,opinion:40,composure:32,risk:50},Kl=["hero","npc_l15_broker","npc_l15_hr","shen_li"],ql="n_01",Wl="card_law_L15",zl=["T4"],Xl=[{id:"n_01",type:"cutscene",pressure:2,script:`裁员名单下来了，你在上面。
...
「还有十六个。」她说。
「不过没关系。这十七个后面只有一个人。」`,next:"__END__"}],Ru=[{id:"e_assault",rank:"F",condition:"FORCED",title:"翻车 · 直播事故",script:`你在连线里失控了，摔了东西，骂了整整四十秒。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L18_F"}],Sf={id:yu,title:Lu,act:Tu,initState:bu,cast:Au,entryNode:wu,lawyerCard:Ou,satireTargets:Pu,nodes:Su,endings:Ru},Eu=Object.freeze(Object.defineProperty({__proto__:null,act:Tu,cast:Au,default:Sf,endings:Ru,entryNode:wu,id:yu,initState:bu,lawyerCard:Ou,nodes:Su,satireTargets:Pu,title:Lu},Symbol.toStringTag,{value:"Module"})),Iu="L19",Cu="第19关 · 各执一词",$u=4,Mu={evidence:60,opinion:45,composure:42,risk:30},Nu=["hero","npc_l19_moderator","npc_l19_pr","shen_li"],Fu="n_01",Du="card_law_L19",Bu=["T5"],Hu=[{id:"n_01",type:"cutscene",pressure:2,script:`平台申诉结果：不予处理。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L19_F"}],Rf={id:Iu,title:Cu,act:$u,initState:Mu,cast:Nu,entryNode:Fu,lawyerCard:Du,satireTargets:Bu,nodes:Hu,endings:Gu},Vu=Object.freeze(Object.defineProperty({__proto__:null,act:$u,cast:Nu,default:Rf,endings:Gu,entryNode:Fu,id:Iu,initState:Mu,lawyerCard:Du,nodes:Hu,satireTargets:Bu,title:Cu},Symbol.toStringTag,{value:"Module"})),ju="L20",Uu="第20关 · 对簿",Yu=4,Ku={evidence:60,opinion:50,composure:60,risk:30},qu=["hero","he_song","zhou_you","shen_li","crowd"],Wu="n_01",zu="card_law_L20",Xu=["T2","T4","T5"],Ju=[{id:"n_01",type:"cutscene",pressure:3,script:`开庭。第三法庭，旁听席坐满了。
...
（本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。）`,disclaimer:"ui.lawyer.disclaimer",riskLevel:"MAX",reviewStatus:"APPROVED",reviewedBy:"外部执业律师（所有者 2026-08-28 转达通过）",reviewedAt:"2026-08-28",citations:[]}],U0=["data-rank"],Y0=["src"],K0={class:"stamp"},q0={key:0,class:"finale-badge"},W0={class:"rk"},z0={class:"word"},X0={class:"title"},J0={class:"script"},Q0={class:"lb-left"},Z0={class:"lb-badge"},eg={class:"lb-title"},tg={class:"lb-btn"},ng={class:"meters-card"},ig={class:"mc-title"},og={class:"bars"},sg={class:"lbl"},rg={class:"track"},cg={class:"num"},ag={key:1,class:"teaching-hint"},lg={class:"th-text"},ug={class:"rt-mark"},pg={class:"rt-text"},dg={key:3,class:"gap-diagnosis"},_g={class:"gd-title"},fg={class:"disclaimer"},gg={class:"acts"},mg={key:0,class:"next-hook"},vg={class:"ld-head"},hg={class:"ld-title-group"},xg={class:"ld-badge"},kg={class:"ld-title"},yg={class:"ld-body"},Lg={class:"ld-text"},Tg={class:"ld-foot"},bg=at({__name:"EndingCard",props:{ending:{},state:{},levelId:{default:""},finaleTier:{default:null}},emits:["restart","next"],setup(e,{emit:t}){const n=e,i=ee(1),o=ee(!1),s=ee(!1),r=ve.ui,c=te(()=>["L01","L02","L03","L04","L05"].includes(n.levelId)),a=te(()=>c.value&&n.ending.rank!=="S"&&n.ending.rank!=="A"&&n.state.composure<30),u=te(()=>r["settleStamp"+n.ending.rank]??""),l=te(()=>{if(!n.levelId)return null;const I=Object.entries(Object.assign({"../../../content/levels/L01.json":rc,"../../../content/levels/L02.json":vc,"../../../content/levels/L03.json":Pc,"../../../content/levels/L04.json":Bc,"../../../content/levels/L05.json":Xc,"../../../content/levels/L06.json":ca,"../../../content/levels/L07.json":ha,"../../../content/levels/L08.json":Sa,"../../../content/levels/L09.json":Ha,"../../../content/levels/L10.json":Ja,"../../../content/levels/L11.json":al,"../../../content/levels/L12.json":xl,"../../../content/levels/L13.json":Rl,"../../../content/levels/L14.json":Gl,"../../../content/levels/L15.json":Ql,"../../../content/levels/L16.json":lu,"../../../content/levels/L17.json":ku,"../../../content/levels/L18.json":Eu,"../../../content/levels/L19.json":Vu,"../../../content/levels/L20.json":Zu})).find(([V])=>V.endsWith("/"+n.levelId+".json"));return(I==null?void 0:I[1])??null}),_=te(()=>{var $,I,V;return((V=(I=($=l.value)==null?void 0:$.endings)==null?void 0:I.find(R=>R.rank==="S"))==null?void 0:V.title)??null}),v=te(()=>n.ending.rank!=="S"&&_.value!==null),g=te(()=>{var de,j;if(n.ending.rank==="S"||l.value===null)return[];const $=(de=l.value.endings)==null?void 0:de.find(D=>D.rank==="S"),V=[...(($==null?void 0:$.condition)??"").matchAll(/(\w+)\s*(>=|<=)\s*(\d+)/g)],R=ve.meters,Z=[];for(const[,D,H,ie]of V){const T=Number(ie);let C;if(D==="dOpinion")C=n.state.opinion-(((j=l.value.initState)==null?void 0:j.opinion)??0);else if(D==="evidence"||D==="opinion"||D==="composure"||D==="risk")C=n.state[D];else continue;const _e=R[D==="dOpinion"?"opinion":D]??D;if(H===">="&&C<T)Z.push({line:(r.gapNeed??"").replace("{name}",_e).replace("{n}",String(T-C)),gap:T-C});else if(H==="<="&&C>T){const q=C-T;Z.push({line:(r.gapOver??"").replace("{name}",_e).replace("{n}",String(q)),gap:q})}}return Z.sort((D,H)=>H.gap-D.gap),Z.slice(0,2).map(D=>D.line)}),A=te(()=>{if(!n.levelId||n.levelId.startsWith("L20"))return null;const $=Number(n.levelId.slice(1));return ve.ui["hookL"+String($+1).padStart(2,"0")]??null}),M=te(()=>({TRUE:r.finaleTrue??"",WIN:r.finaleWin??"",COSTLY:r.finaleCostly??""})),z=te(()=>n.levelId==="L20"&&n.finaleTier!==null?M.value[n.finaleTier]??"":""),J=te(()=>{const I=Object.entries(Object.assign({"../../../content/art/endings/rank_A.mp4":D0,"../../../content/art/endings/rank_B.mp4":B0,"../../../content/art/endings/rank_C.mp4":H0,"../../../content/art/endings/rank_F.mp4":G0,"../../../content/art/endings/rank_S.mp4":V0})).find(([V])=>V.endsWith("/rank_"+n.ending.rank+".mp4"));return(I==null?void 0:I[1])??""}),U=te(()=>{const $=j0;if(n.levelId){const I=$.find(V=>V.level===n.levelId);if(I!==void 0)return I}return $.find(I=>n.ending.id.includes(I.level))??$[0]});let B,w;function Q(){ye.sfx("stamp"),n.ending.rank==="S"||n.ending.rank==="A"?ye.sfx("ending"):n.ending.rank==="F"&&ye.sfx("bad")}nn(()=>{if(typeof setTimeout!="function"){i.value=3;return}B=setTimeout(()=>{i.value=2,Q()},1200),w=setTimeout(()=>{i.value=3},2600)}),jt(()=>{B!==void 0&&clearTimeout(B),w!==void 0&&clearTimeout(w)});function ae(){i.value<2&&Q(),B!==void 0&&(clearTimeout(B),B=void 0),w!==void 0&&(clearTimeout(w),w=void 0),i.value=3}function ke($){$.stopPropagation(),ye.sfx("drawer"),s.value=!0}function ge($){$.stopPropagation(),ye.sfx("click"),s.value=!1}return($,I)=>(S(),F("div",{class:"cinema","data-rank":e.ending.rank,onClick:ae},[J.value?(S(),F("video",{key:0,class:"bgvid",src:J.value,autoplay:"",muted:"",loop:"",playsinline:"",onCanplay:I[0]||(I[0]=V=>o.value=!0)},null,40,Y0)):ne("",!0),f("div",{class:me(["dim",{deeper:i.value>=2}])},null,2),f("div",{class:me(["stamp-wrap",{show:i.value>=2}])},[f("div",K0,[z.value?(S(),F("span",q0,P(z.value),1)):ne("",!0),f("span",W0,P(e.ending.rank),1),f("span",z0,P(u.value),1)])],2),f("div",{class:me(["sheet",{show:i.value>=3}])},[f("h2",X0,P(e.ending.title),1),f("p",J0,P(e.ending.script),1),U.value?(S(),F("div",{key:0,class:"lawyer-bar",onClick:Ve(ke,["stop"])},[f("div",Q0,[f("span",Z0,P(h(r).lawyerCardBadge),1),f("span",eg,P(h(r).lawyerCardTitle),1)]),f("span",tg,[bt(P(h(r).lawyerCardBtn)+" ",1),I[5]||(I[5]=f("i",{class:"arr"},"›",-1))])])):ne("",!0),f("div",ng,[f("div",ig,P(h(r).settleMetersTitle),1),f("div",og,[(S(),F(Te,null,wt(["evidence","opinion","composure","risk"],V=>f("div",{key:V,class:"bar"},[f("span",sg,P(h(ve).meters[V]),1),f("span",rg,[f("i",{style:He({width:Math.min(100,e.state[V])+"%"}),class:me(V)},null,6)]),f("span",cg,P(e.state[V]),1)])),64))])]),a.value?(S(),F("div",ag,[I[6]||(I[6]=f("span",{class:"th-bulb"},"💡",-1)),f("span",lg,P(h(r).teachingHintComposure),1)])):ne("",!0),v.value?(S(),F("button",{key:2,class:"replay-tease",onClick:I[1]||(I[1]=Ve(V=>$.$emit("restart"),["stop"]))},[f("span",ug,P(h(r).endingTeaseS),1),f("span",pg,"《"+P(_.value)+"》 · "+P(h(r).endingTeaseHint),1),I[7]||(I[7]=f("span",{class:"rt-arr"},"›",-1))])):ne("",!0),g.value.length>0?(S(),F("div",dg,[f("span",_g,P(h(r).gapTitle),1),(S(!0),F(Te,null,wt(g.value,(V,R)=>(S(),F("span",{key:R,class:"gd-line"},P(V),1))),128))])):ne("",!0),f("p",fg,P(h(ve).ui.disclaimer),1),f("div",gg,[f("button",{onClick:I[2]||(I[2]=Ve(V=>$.$emit("restart"),["stop"]))},P(h(r).settleReplay),1),f("button",{class:"primary",onClick:I[3]||(I[3]=Ve(V=>$.$emit("next"),["stop"]))},[f("span",null,P(h(r).settleNext),1),A.value?(S(),F("span",mg,P(A.value),1)):ne("",!0)])])],2),s.value&&U.value?(S(),F("div",{key:1,class:"lawyer-mask",onClick:Ve(ge,["stop"])},[f("div",{class:"lawyer-drawer",onClick:I[4]||(I[4]=Ve(()=>{},["stop"]))},[f("header",vg,[f("div",hg,[f("span",xg,P(h(r).lawyerCardBadge),1),f("span",kg,P(h(r).lawyerModalHeader),1)]),f("button",{class:"ld-close",onClick:Ve(ge,["stop"])},"✕")]),f("div",yg,[f("div",Lg,P(U.value.body),1)]),f("footer",Tg,[f("button",{class:"ld-ok",onClick:Ve(ge,["stop"])},P(h(r).lawyerModalClose),1)])])])):ne("",!0)],8,U0))}}),Ag=xt(bg,[["__scopeId","data-v-c28401a0"]]),wg={class:"select"},Og={class:"sel-header"},Pg={class:"header-top"},Sg={class:"app-title"},Rg={class:"tagline"},Eg={class:"hero-cta-wrap"},Ig={class:"cta-left"},Cg={class:"cta-txt-group"},$g={class:"cta-action"},Mg={class:"cta-sub"},Ng={class:"list"},Fg={key:0,class:"act-title"},Dg={class:"act-levels"},Bg=["onClick"],Hg={class:"tid"},Gg={class:"gal-count"},Vg={class:"ttitle"},jg={class:"foot"},Ug=at({__name:"LevelSelect",props:{levels:{},best:{}},emits:["pick"],setup(e){const t=e,n=ve.ui,i=l=>l===void 0?"":"r"+l,o=new Map(At.map(l=>[l.id,l.endings.length])),s=l=>(n.endingsCount??"").replace("{n}",String(t0(l))).replace("{m}",String(o.get(l)??0)),r=te(()=>{var l;for(const _ of t.levels)if(!t.best[_.id])return _.id;return((l=t.levels[0])==null?void 0:l.id)??"L01"}),c=te(()=>Object.keys(t.best).length>0),a=te(()=>n["hook"+r.value]??n.appTagline),u=te(()=>{const l={};for(const _ of t.levels)(l[_.act]??(l[_.act]=[])).push(_);return Object.entries(l).map(([_,v])=>({act:Number(_),name:ve.actNames[_]??"",levels:v}))});return(l,_)=>(S(),F("div",wg,[f("header",Og,[f("div",Pg,[f("h1",Sg,P(h(ve).appTitle),1)]),f("p",Rg,P(h(n).appTagline),1),f("div",Eg,[f("button",{class:"hero-cta",onClick:_[0]||(_[0]=v=>l.$emit("pick",r.value))},[f("div",Ig,[_[1]||(_[1]=f("span",{class:"play-btn"},"▶",-1)),f("div",Cg,[f("span",$g,P(c.value?h(n).continueAdventure:h(n).startAdventure),1),f("span",Mg,P(a.value),1)])]),_[2]||(_[2]=f("span",{class:"cta-arrow"},"›",-1))])])]),f("div",Ng,[(S(!0),F(Te,null,wt(u.value,v=>(S(),F("div",{key:v.act,class:"act-section"},[v.name?(S(),F("div",Fg,P(v.name),1)):ne("",!0),f("div",Dg,[(S(!0),F(Te,null,wt(v.levels,g=>(S(),F("button",{key:g.id,class:"level-btn",onClick:A=>l.$emit("pick",g.id)},[f("span",Hg,[bt(P(g.id),1),f("i",Gg,P(s(g.id)),1)]),f("span",Vg,P(g.title),1),f("span",{class:me(["badge",i(e.best[g.id])])},P(e.best[g.id]??"·"),3)],8,Bg))),128))])]))),128))]),f("footer",jg,P(h(ve).ui.disclaimer),1)]))}}),Yg=xt(Ug,[["__scopeId","data-v-fb72a828"]]),Kg=""+new URL("L01-DW1w2hpH.png",import.meta.url).href,qg=""+new URL("L02-Cgrrfiit.png",import.meta.url).href,Wg=""+new URL("L03-Dhb-92UY.png",import.meta.url).href,zg=""+new URL("L04-Dxn6iz_R.png",import.meta.url).href,Xg=""+new URL("L05-BCX3gD5-.png",import.meta.url).href,Jg=""+new URL("L06-DPfiJfY4.png",import.meta.url).href,Qg=""+new URL("L07-DgpRWPjk.png",import.meta.url).href,Zg=""+new URL("L08-HGz_P2cJ.png",import.meta.url).href,e1=""+new URL("L09-VpgvEvrb.png",import.meta.url).href,t1=""+new URL("L10-D_mOdB4H.png",import.meta.url).href,n1=""+new URL("L11-BXLJJDeb.png",import.meta.url).href,i1=""+new URL("L12-DemYAPsM.png",import.meta.url).href,o1=""+new URL("L13-Dn-DLBYO.png",import.meta.url).href,s1=""+new URL("L14-BLDD-heh.png",import.meta.url).href,r1=""+new URL("L15-BVYsTDdi.png",import.meta.url).href,c1=""+new URL("L16-kHk4EBk-.png",import.meta.url).href,a1=""+new URL("L17-BomGMZbR.png",import.meta.url).href,l1=""+new URL("L18-B2bLjWIc.png",import.meta.url).href,u1=""+new URL("L19-DHpwxvAB.png",import.meta.url).href,p1=""+new URL("L20-CyAYX9HG.png",import.meta.url).href,d1=["src"],_1={key:1,class:"photo-shade"},f1={key:2,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},g1={key:3,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},m1={key:4,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},v1={key:5,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},h1={key:6,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},x1={key:7,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},k1={class:"tag"},y1=at({__name:"SceneBackdrop",props:{levelId:{},pressure:{}},setup(e){const t=e,n=Object.assign({"../../../content/art/scenes/L01.png":Kg,"../../../content/art/scenes/L02.png":qg,"../../../content/art/scenes/L03.png":Wg,"../../../content/art/scenes/L04.png":zg,"../../../content/art/scenes/L05.png":Xg,"../../../content/art/scenes/L06.png":Jg,"../../../content/art/scenes/L07.png":Qg,"../../../content/art/scenes/L08.png":Zg,"../../../content/art/scenes/L09.png":e1,"../../../content/art/scenes/L10.png":t1,"../../../content/art/scenes/L11.png":n1,"../../../content/art/scenes/L12.png":i1,"../../../content/art/scenes/L13.png":o1,"../../../content/art/scenes/L14.png":s1,"../../../content/art/scenes/L15.png":r1,"../../../content/art/scenes/L16.png":c1,"../../../content/art/scenes/L17.png":a1,"../../../content/art/scenes/L18.png":l1,"../../../content/art/scenes/L19.png":u1,"../../../content/art/scenes/L20.png":p1}),i=ee("");Re(()=>t.levelId,c=>{const a=Object.entries(n).find(([u])=>u.endsWith("/"+c+".png"));i.value=a!==void 0?a[1]:""},{immediate:!0});const o=te(()=>ep(t.levelId)),s=te(()=>{const c=o.value.hue,a=8+Math.round(t.pressure*.8);return{background:`radial-gradient(120% 70% at 50% 18%, hsl(${c} 32% ${a+10}%) 0%, hsl(${c} 38% ${a}%) 45%, hsl(${c} 45% ${Math.max(4,a-4)}%) 100%)`}}),r=te(()=>o.value.motif);return(c,a)=>(S(),F("div",{class:"backdrop",style:He(s.value)},[i.value?(S(),F("img",{key:0,class:"photo",src:i.value,alt:""},null,8,d1)):ne("",!0),i.value?(S(),F("div",_1)):ne("",!0),r.value==="subway"?(S(),F("svg",f1,[...a[0]||(a[0]=[Ri('<rect x="40" y="80" width="320" height="180" rx="14" class="win" data-v-b08529d1></rect><rect x="52" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="132" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="212" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="292" y="92" width="56" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="0" y="300" width="400" height="10" class="rail" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',7)])])):r.value==="elevator"?(S(),F("svg",g1,[...a[1]||(a[1]=[f("rect",{x:"120",y:"60",width:"160",height:"440",rx:"6",class:"door"},null,-1),f("line",{x1:"200",y1:"60",x2:"200",y2:"500",class:"seam"},null,-1),f("circle",{cx:"200",cy:"530",r:"12",class:"lamp"},null,-1),f("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="street"?(S(),F("svg",m1,[...a[2]||(a[2]=[Ri('<line x1="60" y1="0" x2="60" y2="380" class="pole" data-v-b08529d1></line><rect x="48" y="380" width="24" height="8" rx="3" class="lamp" data-v-b08529d1></rect><rect x="0" y="430" width="400" height="6" class="rail" data-v-b08529d1></rect><rect x="0" y="470" width="400" height="4" class="rail dim" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):r.value==="court"?(S(),F("svg",v1,[...a[3]||(a[3]=[f("rect",{x:"80",y:"120",width:"240",height:"90",rx:"4",class:"win"},null,-1),f("rect",{x:"100",y:"300",width:"200",height:"14",rx:"3",class:"desk"},null,-1),f("rect",{x:"60",y:"380",width:"280",height:"10",rx:"3",class:"desk dim"},null,-1),f("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="studio"?(S(),F("svg",h1,[...a[4]||(a[4]=[Ri('<rect x="40" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><rect x="230" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><circle cx="200" cy="260" r="8" class="lamp" data-v-b08529d1></circle><line x1="200" y1="0" x2="200" y2="252" class="pole thin" data-v-b08529d1></line><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):(S(),F("svg",x1,[...a[5]||(a[5]=[f("rect",{x:"50",y:"110",width:"140",height:"100",rx:"6",class:"win"},null,-1),f("rect",{x:"220",y:"110",width:"130",height:"70",rx:"6",class:"win dim"},null,-1),f("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])),f("div",k1,P(o.value.label),1)],4))}}),L1=xt(y1,[["__scopeId","data-v-b08529d1"]]),T1={class:"danmaku","aria-hidden":"true"},b1=at({__name:"DanmakuLayer",props:{pressure:{},active:{type:Boolean}},setup(e){const t=e,n=ee([]);let i=0,o;function s(){return t.pressure>=4?ve.danmaku.hot:t.pressure>=3?ve.danmaku.tense:ve.danmaku.calm}function r(){if(!t.active)return;const c=s();if(c.length===0)return;const a=c[Math.floor(Math.random()*c.length)]??"";n.value.push({id:i+=1,text:a,lane:Math.floor(Math.random()*4),speed:t.pressure>=4?7+Math.random()*3:10+Math.random()*4,bold:Math.random()<.25}),n.value.length>14&&(n.value=n.value.slice(-14))}return typeof setInterval=="function"&&(o=setInterval(r,t.pressure>=4?900:1800),Re(()=>t.pressure,()=>{})),jt(()=>{o!==void 0&&clearInterval(o)}),(c,a)=>(S(),F("div",T1,[we(O_,{name:"fly"},{default:yo(()=>[(S(!0),F(Te,null,wt(n.value,u=>(S(),F("span",{key:u.id,class:me(["line",{bold:u.bold}]),style:He({top:12+u.lane*34+"px","--dur":u.speed+"s"})},P(u.text),7))),128))]),_:1})]))}}),A1=xt(b1,[["__scopeId","data-v-55cd0013"]]),w1=""+new URL("he_song-DAGlX_4O.png",import.meta.url).href,O1=""+new URL("hero-BAfbz0Vs.png",import.meta.url).href,P1=""+new URL("npc_l01_woman-DbGv3OTN.png",import.meta.url).href,S1=""+new URL("npc_l02_woman-qXhWvPKu.png",import.meta.url).href,R1=""+new URL("npc_l03_daughter-Dt2TiO8f.png",import.meta.url).href,E1=""+new URL("npc_l03_woman-BQ3wIsYH.png",import.meta.url).href,I1=""+new URL("npc_l04_woman-CZQbIvDG.png",import.meta.url).href,C1=""+new URL("npc_l05_manager-Ce6F9DQj.png",import.meta.url).href,$1=""+new URL("npc_l05_woman-BXLOsOGn.png",import.meta.url).href,M1=""+new URL("npc_l06_girlfriend-CrncpSA3.png",import.meta.url).href,N1=""+new URL("npc_l06_mother-BJuBbFLU.png",import.meta.url).href,F1=""+new URL("npc_l07_ex-CEJAEgFV.png",import.meta.url).href,D1=""+new URL("npc_l08_child-Bm0Rde6F.png",import.meta.url).href,B1=""+new URL("npc_l08_mother-tu98VogT.png",import.meta.url).href,H1=""+new URL("npc_l08_wife-Cy9DZe9m.png",import.meta.url).href,G1=""+new URL("npc_l09_wife-CJUlJISq.png",import.meta.url).href,V1=""+new URL("npc_l10_exwife-D0NJtWQK.png",import.meta.url).href,j1=""+new URL("npc_l11_hr-Dqx_GpDt.png",import.meta.url).href,U1=""+new URL("npc_l12_boss-nYTyR_X5.png",import.meta.url).href,Y1=""+new URL("npc_l12_colleague-BD3ntBZW.png",import.meta.url).href,K1=""+new URL("npc_l13_hr-Dovjb9V8.png",import.meta.url).href,q1=""+new URL("npc_l14_director-B-efKLNg.png",import.meta.url).href,W1=""+new URL("npc_l14_hr-DRiqQqX2.png",import.meta.url).href,z1=""+new URL("npc_l15_broker-CqY8iI1Q.png",import.meta.url).href,X1=""+new URL("npc_l15_hr-CSF8zzWx.png",import.meta.url).href,J1=""+new URL("npc_l16_account-D825uOC6.png",import.meta.url).href,Q1=""+new URL("npc_l17_father-jYHQ9zlG.png",import.meta.url).href,Z1=""+new URL("npc_l17_hr-D3pAIKo4.png",import.meta.url).href,em=""+new URL("npc_l18_streamer-CYlpG6aq.png",import.meta.url).href,tm=""+new URL("npc_l19_moderator-CoZr2C0k.png",import.meta.url).href,nm=""+new URL("npc_l19_pr-Do-3PPx1.png",import.meta.url).href,im=""+new URL("officer_lin-Bduk5y-m.png",import.meta.url).href,om=""+new URL("shen_li-Bd_DLpmj.png",import.meta.url).href,sm=""+new URL("zhou_you-DSERK5v3.png",import.meta.url).href,rm={key:0,class:"duo","aria-hidden":"true"},cm=["src"],am=["src","alt"],lm=at({__name:"PortraitSlot",props:{speaker:{},visible:{type:Boolean},impact:{type:Boolean,default:!1}},setup(e){const t=e,n=Object.assign({"../../../content/art/characters/he_song.png":w1,"../../../content/art/characters/hero.png":O1,"../../../content/art/characters/npc_l01_woman.png":P1,"../../../content/art/characters/npc_l02_woman.png":S1,"../../../content/art/characters/npc_l03_daughter.png":R1,"../../../content/art/characters/npc_l03_woman.png":E1,"../../../content/art/characters/npc_l04_woman.png":I1,"../../../content/art/characters/npc_l05_manager.png":C1,"../../../content/art/characters/npc_l05_woman.png":$1,"../../../content/art/characters/npc_l06_girlfriend.png":M1,"../../../content/art/characters/npc_l06_mother.png":N1,"../../../content/art/characters/npc_l07_ex.png":F1,"../../../content/art/characters/npc_l08_child.png":D1,"../../../content/art/characters/npc_l08_mother.png":B1,"../../../content/art/characters/npc_l08_wife.png":H1,"../../../content/art/characters/npc_l09_wife.png":G1,"../../../content/art/characters/npc_l10_exwife.png":V1,"../../../content/art/characters/npc_l11_hr.png":j1,"../../../content/art/characters/npc_l12_boss.png":U1,"../../../content/art/characters/npc_l12_colleague.png":Y1,"../../../content/art/characters/npc_l13_hr.png":K1,"../../../content/art/characters/npc_l14_director.png":q1,"../../../content/art/characters/npc_l14_hr.png":W1,"../../../content/art/characters/npc_l15_broker.png":z1,"../../../content/art/characters/npc_l15_hr.png":X1,"../../../content/art/characters/npc_l16_account.png":J1,"../../../content/art/characters/npc_l17_father.png":Q1,"../../../content/art/characters/npc_l17_hr.png":Z1,"../../../content/art/characters/npc_l18_streamer.png":em,"../../../content/art/characters/npc_l19_moderator.png":tm,"../../../content/art/characters/npc_l19_pr.png":nm,"../../../content/art/characters/officer_lin.png":im,"../../../content/art/characters/shen_li.png":om,"../../../content/art/characters/zhou_you.png":sm});function i(v){if(v===null)return{url:"",ok:!1};const g=Object.entries(n).find(([A])=>A.endsWith("/"+v+".png"));return g!==void 0?{url:g[1],ok:!0}:{url:"",ok:!1}}const o=i("hero"),s=ni("hero"),r=te(()=>t.speaker===null||t.speaker==="hero"?null:t.speaker),c=te(()=>i(r.value)),a=te(()=>ni(r.value??"")),u=te(()=>r.value===null?"":Po(r.value)),l=ee(!1);Re(()=>t.speaker,()=>{l.value=!1});const _=te(()=>t.speaker==="hero");return(v,g)=>e.visible?(S(),F("div",rm,[h(o).ok?(S(),F("div",{key:0,class:me(["who hero",{talking:_.value}]),style:He({"--h":h(s)})},[f("img",{class:"pt art",src:h(o).url,alt:""},null,8,cm)],6)):ne("",!0),r.value!==null&&c.value.ok&&!l.value?(S(),F("div",{key:1,class:me(["who guest",{talking:!0,impact:e.impact}]),style:He({"--h":a.value})},[f("img",{class:"pt art",src:c.value.url,alt:u.value,onError:g[0]||(g[0]=A=>l.value=!0)},null,40,am)],6)):ne("",!0)])):ne("",!0)}}),um=xt(lm,[["__scopeId","data-v-10f0d9cf"]]),pm={class:"backlog-panel"},dm={class:"bl-header"},_m={class:"bl-title-group"},fm={class:"bl-title"},gm={key:0,class:"bl-empty"},mm={key:0,class:"bl-speaker"},vm={class:"bl-sp-name"},hm={class:"bl-text"},xm={class:"bl-footer"},km=at({__name:"BacklogModal",props:{history:{}},emits:["close"],setup(e,{emit:t}){const n=t,i=ve.ui,o=ee(null);function s(){xo(()=>{o.value&&(o.value.scrollTop=o.value.scrollHeight)})}function r(c){c.key==="Escape"&&n("close")}return nn(()=>{s(),typeof window<"u"&&window.addEventListener("keydown",r)}),jt(()=>{typeof window<"u"&&window.removeEventListener("keydown",r)}),(c,a)=>(S(),F("div",{class:"backlog-mask",onClick:a[2]||(a[2]=Ve(u=>c.$emit("close"),["self"]))},[f("div",pm,[f("header",dm,[f("div",_m,[a[3]||(a[3]=f("span",{class:"bl-badge"},"LOG",-1)),f("h3",fm,P(h(i).backlogTitle),1)]),f("button",{class:"bl-close",onClick:a[0]||(a[0]=u=>c.$emit("close"))},"✕")]),f("div",{ref_key:"scrollRef",ref:o,class:"bl-list"},[e.history.length===0?(S(),F("div",gm,P(h(i).backlogEmpty),1)):ne("",!0),(S(!0),F(Te,null,wt(e.history,(u,l)=>(S(),F("div",{key:l,class:me(["bl-item",u.kind]),style:He({"--h":u.speaker?h(ni)(u.speaker):220})},[u.kind==="dialogue"&&u.speaker?(S(),F("div",mm,[f("span",vm,P(h(Po)(u.speaker)),1)])):ne("",!0),f("p",hm,P(u.text),1)],6))),128))],512),f("footer",xm,[f("button",{class:"bl-confirm-btn",onClick:a[1]||(a[1]=u=>c.$emit("close"))},P(h(i).backlogClose??h(i).lawyerModalClose),1)])])]))}}),ym=xt(km,[["__scopeId","data-v-ad553f48"]]),Lm={key:0,class:"stage-strike-flash","aria-hidden":"true"},Tm={key:4,class:"topbar"},bm={class:"lv-title"},Am={key:5,class:"study-entry"},wm={class:"sub"},Om=["placeholder"],Pm=["disabled"],Sm={key:6,class:"study-done"},Rm={class:"sum"},Em={key:1,class:"story"},Im={key:10,class:"timeout-toast"},Cm={class:"tt-label"},$m={class:"tt-text"},Mm={name:"App"},Nm=at({...Mm,props:{ctx:{}},setup(e){const n=e.ctx;Re(n.event,T=>{T!==null&&T.type==="ending"&&(n.settle(),ye.sfx(T.ending.rank==="S"||T.ending.rank==="A"?"ending":"bad"),M.value!==null&&e0(M.value,T.ending.id))}),Re(n.event,T=>{var _e,q,kt;if(T===null)return;const C=ep(((_e=n.current.value)==null?void 0:_e.id)??"L01").hue;T.type==="node"?ye.scene(((q=n.current.value)==null?void 0:q.id)??"L01",C,T.node.pressure??0,n.meters.value.composure):T.type==="options"&&(ye.sfx("options"),ye.scene(((kt=n.current.value)==null?void 0:kt.id)??"L01",C,3,n.meters.value.composure))});const i=ee(0),o=ee(null),s=ee(null);Re(n.event,T=>{if(T===null){i.value=0,o.value=null,s.value=null;return}if(T.type==="node"){i.value=T.node.pressure??0;const C="speaker"in T.node?T.node.speaker:null;o.value=C!=null&&String(C)!=="null"&&String(C).trim()!==""?String(C):null,o.value!==null&&(s.value=o.value)}else T.type==="options"&&(i.value=T.options.length>0?i.value:0,o.value=null)});const r=te(()=>{const T=n.meters.value.composure;return T>=50||n.screen.value!=="level"?{opacity:0}:{opacity:(.25+(50-T)/50*.55).toFixed(2),animation:T<15?"throb 1.1s ease-in-out infinite":"none"}}),c=te(()=>n.screen.value==="level"),a=ee(""),u=te(()=>n.STUDY_LEVELS.every(T=>{try{return n.studySummary().includes(T)}catch{return!1}}));function l(){const T=n.studyExport();typeof navigator<"u"&&navigator.clipboard!==void 0&&navigator.clipboard.writeText(T);const C=new Blob([T],{type:"application/json"}),_e=document.createElement("a");_e.href=URL.createObjectURL(C),_e.download=`study-${a.value||"anon"}.json`,_e.click()}const _=ee(!1),v=te(()=>_.value?"x":"m");function g(){_.value=!_.value,ye.setMuted(_.value)}function A(){ye.unlock(),ye.startLoop()}document.addEventListener("pointerdown",A,{once:!0});const M=te(()=>n.current.value?n.current.value.id:"L01"),z=ee([]),J=ee(!1),U=ee(!1),B=ee(!1);let w;const Q=ee(null);function ae(){var T;ye.sfx("drawer"),J.value=!0,(T=Q.value)==null||T.pause()}function ke(){var T;ye.sfx("click"),J.value=!1,(T=Q.value)==null||T.resume()}function ge(){if(!B.value)return;w!==void 0&&clearTimeout(w);const T=n.event.value;if(T===null||T.type!=="node")return;const C="text"in T.node?String(T.node.text).length:20,_e=Math.max(1800,C*55);w=setTimeout(()=>{var q;B.value&&((q=n.event.value)==null?void 0:q.type)==="node"&&n.advance()},_e)}Re(B,T=>{T?ge():w!==void 0&&(clearTimeout(w),w=void 0)}),Re(n.event,T=>{if(T===null){w!==void 0&&clearTimeout(w);return}T.type==="node"?("script"in T.node&&T.node.script?(z.value.push({speaker:null,text:String(T.node.script),kind:"cutscene"}),Fi(String(T.node.script))):"speaker"in T.node&&T.node.text&&T.node.speaker!=null&&String(T.node.speaker)!=="null"?(z.value.push({speaker:String(T.node.speaker),text:String(T.node.text),kind:"dialogue"}),Fi(String(T.node.text))):"text"in T.node&&T.node.text&&(z.value.push({speaker:null,text:String(T.node.text),kind:"cutscene"}),Fi(String(T.node.text))),ge()):T.type==="options"?(w!==void 0&&(clearTimeout(w),w=void 0),J.value&&xo(()=>{var C;return(C=Q.value)==null?void 0:C.pause()})):T.type==="ending"&&w!==void 0&&(clearTimeout(w),w=void 0)});const $=ee(null);let I;function V(T){Kf(),$.value=T,ye.sfx("bad"),I!==void 0&&clearTimeout(I),I=setTimeout(()=>{$.value=null},2200)}const R=ee(!1),Z=ee(!1);let de;const j=ee(null);let D,H;function ie(T){R.value=!0,Z.value=!0,de!==void 0&&clearTimeout(de),de=setTimeout(()=>{R.value=!1,Z.value=!1},260);const C=n.event.value;if(C!==null&&C.type==="options"){const _e=C.options.find(kt=>kt.id===T),q=Zf(_e==null?void 0:_e.effects);if(q!==null){const In=ve.ui["stamp"+q.dim.charAt(0).toUpperCase()+q.dim.slice(1)+(q.positive?"Up":"Down")]??"";In!==""&&(D!==void 0&&clearTimeout(D),H!==void 0&&clearTimeout(H),D=setTimeout(()=>{j.value={word:In,positive:q.positive},ye.sfx(q.positive?"stamp":"bad")},240),H=setTimeout(()=>{j.value=null},1250))}}n.choose(T)}return Re(M,()=>{z.value=[],B.value=!1,J.value=!1,U.value=!1,o.value=null,s.value=null,i.value=0,w!==void 0&&clearTimeout(w)}),(T,C)=>{var _e;return S(),F("div",{class:me(["stage",{"stage-shake":Z.value}])},[R.value?(S(),F("div",Lm)):ne("",!0),j.value!==null?(S(),F("div",{key:1,class:me(["stage-impact-stamp",j.value.positive?"good":"evil"]),"aria-hidden":"true"},P(j.value.word),3)):ne("",!0),c.value?(S(),qe(L1,{key:2,"level-id":M.value,pressure:i.value},null,8,["level-id","pressure"])):ne("",!0),c.value&&((_e=h(n).event.value)==null?void 0:_e.type)!=="ending"?(S(),qe(A1,{key:3,pressure:i.value,active:c.value},null,8,["pressure","active"])):ne("",!0),c.value?(S(),F("header",Tm,[f("button",{class:"back",onClick:C[0]||(C[0]=q=>h(n).toSelect())},"‹"),f("span",bm,P(h(n).banner.value),1),f("button",{class:me(["mute",{off:_.value}]),onClick:C[1]||(C[1]=q=>g())},P(v.value),3)])):ne("",!0),h(n).studyOn&&h(n).studyScreen.value==="entry"?(S(),F("div",Am,[f("h1",null,P(h(ve).appTitle),1),f("p",wm,P(h($t)("studyIntro")),1),Qp(f("input",{"onUpdate:modelValue":C[2]||(C[2]=q=>a.value=q),class:"pid",placeholder:h($t)("studyPidPlaceholder"),maxlength:"8"},null,8,Om),[[C_,a.value]]),f("button",{class:"go",disabled:a.value.trim().length===0,onClick:C[3]||(C[3]=q=>h(n).studyBegin(a.value.trim()))},P(h($t)("studyStart")),9,Pm)])):h(n).studyOn&&h(n).studyScreen.value==="done"&&u.value?(S(),F("div",Sm,[f("h2",null,P(h($t)("studyDoneTitle")),1),f("pre",Rm,P(h(n).studySummary()),1),f("button",{class:"go",onClick:l},P(h($t)("studyCopy")),1)])):h(n).screen.value==="select"?(S(),qe(Yg,{key:7,levels:h(n).studyOn?h(At).filter(q=>h(n).STUDY_LEVELS.includes(q.id)):h(At),best:h(n).best.value,onPick:h(n).startLevel},null,8,["levels","best","onPick"])):h(n).event.value?(S(),F(Te,{key:8},[h(n).event.value.type!=="ending"?(S(),qe(l0,{key:0,state:h(n).meters.value},null,8,["state"])):ne("",!0),we(um,{speaker:o.value??s.value,visible:h(n).event.value.type!=="ending"&&(o.value??s.value)!==null,impact:R.value},null,8,["speaker","visible","impact"]),U.value?(S(),F("div",{key:2,class:"restore-hud-trigger",onClick:C[16]||(C[16]=q=>U.value=!1)},[f("span",null,P(h($t)("tapToRestore")),1)])):(S(),F("div",Em,[h(n).event.value.type==="node"&&"script"in h(n).event.value.node?(S(),qe(Bi,{key:0,kind:"cutscene",text:String(h(n).event.value.node.script??""),instant:h(Di)(String(h(n).event.value.node.script??"")),"auto-active":B.value,onAdvance:C[4]||(C[4]=q=>h(n).advance()),onOpenLog:ae,onToggleAuto:C[5]||(C[5]=q=>B.value=!B.value),onSkip:C[6]||(C[6]=q=>h(n).advance()),onHideUi:C[7]||(C[7]=q=>U.value=!0)},null,8,["text","instant","auto-active"])):h(n).event.value.type==="node"&&"speaker"in h(n).event.value.node&&h(n).event.value.node.speaker!=null&&String(h(n).event.value.node.speaker)!=="null"&&String(h(n).event.value.node.speaker).trim()!==""?(S(),qe(Bi,{key:1,kind:"dialogue",speaker:String(h(n).event.value.node.speaker),text:String(h(n).event.value.node.text??""),instant:h(Di)(String(h(n).event.value.node.text??"")),"auto-active":B.value,onAdvance:C[8]||(C[8]=q=>h(n).advance()),onOpenLog:ae,onToggleAuto:C[9]||(C[9]=q=>B.value=!B.value),onSkip:C[10]||(C[10]=q=>h(n).advance()),onHideUi:C[11]||(C[11]=q=>U.value=!0)},null,8,["speaker","text","instant","auto-active"])):h(n).event.value.type==="node"&&"text"in h(n).event.value.node?(S(),qe(Bi,{key:2,kind:"cutscene",text:String(h(n).event.value.node.text??""),instant:h(Di)(String(h(n).event.value.node.text??"")),"auto-active":B.value,onAdvance:C[12]||(C[12]=q=>h(n).advance()),onOpenLog:ae,onToggleAuto:C[13]||(C[13]=q=>B.value=!B.value),onSkip:C[14]||(C[14]=q=>h(n).advance()),onHideUi:C[15]||(C[15]=q=>U.value=!0)},null,8,["text","instant","auto-active"])):h(n).event.value.type==="options"?(S(),qe(F0,{key:3,ref_key:"choiceLayerRef",ref:Q,options:h(n).event.value.options,timer:h(n).event.value.timer,"timeout-option-id":h(n).event.value.timeoutOptionId,prompt:h(n).event.value.prompt??"",onChoose:ie,onTimeout:V,onOpenLog:ae},null,8,["options","timer","timeout-option-id","prompt"])):h(n).event.value.type==="ending"?(S(),qe(Ag,{key:4,"level-id":M.value,ending:h(n).event.value.ending,state:h(n).event.value.state,"finale-tier":h(n).finaleTier.value,onRestart:h(n).restart,onNext:h(n).nextLevel},null,8,["level-id","ending","state","finale-tier","onRestart","onNext"])):ne("",!0)]))],64)):ne("",!0),J.value?(S(),qe(ym,{key:9,history:z.value,onClose:ke},null,8,["history"])):ne("",!0),$.value?(S(),F("div",Im,[f("span",Cm,P(h($t)("timeoutNotice")),1),f("span",$m,"「"+P($.value)+"」",1)])):ne("",!0),c.value?(S(),F("div",{key:11,class:"vignette",style:He(r.value)},null,4)):ne("",!0)],2)}}}),On=ee("select"),Pt=li(null),De=li(null),Gt=ee(nf()),op=ee(""),ki=li(null),So=ee({evidence:0,opinion:0,composure:0,risk:0}),sp=ee(null),St=jf(),oo=["L01","L02","L03","L04","L05"],rp=ee("entry"),Pn=li(null),Fm=ee(0);function Dm(e){Gt.value=Qi(),Uf(e),rp.value="done",Qt("L01")}function Qt(e){const t=At.find(o=>o.id===e)??null;if(t===null)return;Pt.value=t,op.value=t.title;let n=t;if(e==="L20"&&!St){const o=uf(Gt.value);n={...t,initState:{evidence:o.evidence,opinion:o.opinion,composure:o.composure,risk:o.risk}}}const i=new Oo(n,Gt.value);if(ki.value=i,De.value=i.start(),So.value={...i.state},On.value="level",St){const o=Rt(),s=o.runs.some(r=>r.level===e&&r.endingRank!=="");Pn.value=Yf(o,e,s),ii("entry")}}function Bm(){const e=ki.value;e!==null&&(De.value=e.proceed(),St&&De.value.type==="node"&&ii(String(De.value.node.id)),St&&De.value.type==="options"&&De.value.nodeId!==void 0&&ii(De.value.nodeId))}function Hm(e){const t=ki.value;t!==null&&(De.value=t.choose(e),So.value={...t.state},St&&Pn.value!==null&&Pt.value!==null&&(qf(Pn.value,Rt(),Pt.value.id,e,t.state),De.value.type==="options"&&De.value.nodeId!==void 0&&ii(De.value.nodeId)))}function Gm(){const e=ki.value,t=Pt.value,n=De.value;if(e===null||t===null||n===null||n.type!=="ending")return;if(St){Pn.value!==null&&Wf(Pn.value,Rt(),n.ending.rank,n.ending.title,e.state),Fm.value+=1;return}const i=af(Gt.value,t.id,n.ending,n.state,{now:0});Gt.value=i,of(i),t.id==="L20"&&(sp.value=pf(i,n.ending.rank))}function Vm(){Pt.value!==null&&Qt(Pt.value.id)}function jm(){const e=Pt.value;if(e===null)return;if(St){const s=oo.indexOf(e.id),r=s>=0?oo[s+1]:void 0;if(r===void 0){On.value="select";return}Qt(r);return}const t=At.findIndex(s=>s.id===e.id),n=At.find(s=>!(s.id in Gt.value.levelResults)),i=n!==void 0?At.findIndex(s=>s.id===n.id):-1;if(n!==void 0&&i>t+1){Qt(n.id);return}const o=At[t+1];if(o===void 0){On.value="select";return}Qt(o.id)}function Um(){On.value="select"}const Ym=te(()=>{const e={};for(const[t,n]of Object.entries(Gt.value.levelResults))e[t]=n.rank;return e}),Km={screen:On,current:Pt,event:De,banner:op,best:Ym,meters:So,finaleTier:sp,startLevel:Qt,advance:Bm,choose:Hm,settle:Gm,restart:Vm,nextLevel:jm,toSelect:Um,studyOn:St,STUDY_LEVELS:oo,studyScreen:rp,studyBegin:Dm,studyExport:()=>zf(),studySummary:()=>Xf()},qm=D_(Nm,{ctx:Km});qm.mount("#app");
