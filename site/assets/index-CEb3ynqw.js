...
* @license MIT
**/function Ji(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const re={},Kt=[],it=()=>{},mo=()=>!1,ni=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),ii=e=>e.startsWith("onUpdate:"),xe=Object.assign,Zi=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},Np=Object.prototype.hasOwnProperty,ee=(e,t)=>Np.call(e,t),H=Array.isArray,qt=e=>On(e)==="[object Map]",vo=e=>On(e)==="[object Set]",ws=e=>On(e)==="[object Date]",j=e=>typeof e=="function",de=e=>typeof e=="string",st=e=>typeof e=="symbol",ne=e=>e!==null&&typeof e=="object",ho=e=>(ne(e)||j(e))&&j(e.then)&&j(e.catch),xo=Object.prototype.toString,On=e=>xo.call(e),Fp=e=>On(e).slice(8,-1),ko=e=>On(e)==="[object Object]",Qi=e=>de(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,pn=Ji(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),si=e=>{const t=Object.create(null);return n=>t[n]||(t[n]=e(n))},Dp=/-\w/g,je=si(e=>e.replace(Dp,t=>t.slice(1).toUpperCase())),Bp=/\B([A-Z])/g,Ht=si(e=>e.replace(Bp,"-$1").toLowerCase()),yo=si(e=>e.charAt(0).toUpperCase()+e.slice(1)),xi=si(e=>e?`on${yo(e)}`:""),nt=(e,t)=>!Object.is(e,t),Fn=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},To=(e,t,n,i=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:i,value:n})},es=e=>{const t=parseFloat(e);return isNaN(t)?e:t},Hp=e=>{const t=de(e)?Number(e):NaN;return isNaN(t)?e:t};let Os;const oi=()=>Os||(Os=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function He(e){if(H(e)){const t={};for(let n=0;n<e.length;n++){const i=e[n],s=de(i)?jp(i):He(i);if(s)for(const o in s)t[o]=s[o]}return t}else if(de(e)||ne(e))return e}const Gp=/;(?![^(]*\))/g,Vp=/:([^]+)/,Up=/\/\*[^]*?\*\//g;function jp(e){const t={};return e.replace(Up,"").split(Gp).forEach(n=>{if(n){const i=n.split(Vp);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function fe(e){let t="";if(de(e))t=e;else if(H(e))for(let n=0;n<e.length;n++){const i=fe(e[n]);i&&(t+=i+" ")}else if(ne(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const Yp="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Kp=Ji(Yp);function Lo(e){return!!e||e===""}function qp(e,t){if(e.length!==t.length)return!1;let n=!0;for(let i=0;n&&i<e.length;i++)n=ts(e[i],t[i]);return n}function ts(e,t){if(e===t)return!0;let n=ws(e),i=ws(t);if(n||i)return n&&i?e.getTime()===t.getTime():!1;if(n=st(e),i=st(t),n||i)return e===t;if(n=H(e),i=H(t),n||i)return n&&i?qp(e,t):!1;if(n=ne(e),i=ne(t),n||i){if(!n||!i)return!1;const s=Object.keys(e).length,o=Object.keys(t).length;if(s!==o)return!1;for(const r in e){const c=e.hasOwnProperty(r),a=t.hasOwnProperty(r);if(c&&!a||!c&&a||!ts(e[r],t[r]))return!1}}return String(e)===String(t)}const bo=e=>!!(e&&e.__v_isRef===!0),S=e=>de(e)?e:e==null?"":H(e)||ne(e)&&(e.toString===xo||!j(e.toString))?bo(e)?S(e.value):JSON.stringify(e,Ao,2):String(e),Ao=(e,t)=>bo(t)?Ao(e,t.value):qt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[i,s],o)=>(n[ki(i,o)+" =>"]=s,n),{})}:vo(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>ki(n))}:st(t)?ki(t):ne(t)&&!H(t)&&!ko(t)?String(t):t,ki=(e,t="")=>{var n;return st(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let be;class Wp{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this._warnOnRun=!0,this.__v_skip=!0,!t&&be&&(be.active?(this.parent=be,this.index=(be.scopes||(be.scopes=[])).push(this)-1):(this._active=!1,this._warnOnRun=!1))}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes){const i=this.scopes.slice();for(t=0,n=i.length;t<n;t++)i[t].pause()}for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes){const s=this.scopes.slice();for(t=0,n=s.length;t<n;t++)s[t].resume()}const i=this.effects.slice();for(t=0,n=i.length;t<n;t++)i[t].resume()}}run(t){if(this._active){const n=be;try{return be=this,t()}finally{be=n}}}on(){++this._on===1&&(this.prevScope=be,be=this)}off(){if(this._on>0&&--this._on===0){if(be===this)be=this.prevScope;else{let t=be;for(;t;){if(t.prevScope===this){t.prevScope=this.prevScope;break}t=t.prevScope}}this.prevScope=void 0}}stop(t){if(this._active){this._active=!1;let n,i;for(n=0,i=this.effects.length;n<i;n++)this.effects[n].stop();for(this.effects.length=0,n=0,i=this.cleanups.length;n<i;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){const s=this.scopes.slice();for(n=0,i=s.length;n<i;n++)s[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const s=this.parent.scopes.pop();s&&s!==this&&(this.parent.scopes[this.index]=s,s.index=this.index)}this.parent=void 0}}}function zp(){return be}let ae;const yi=new WeakSet;class wo{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,be&&(be.active?be.effects.push(this):this.flags&=-2)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,yi.has(this)&&(yi.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Po(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Ps(this),Ro(this);const t=ae,n=Ye;ae=this,Ye=!0;try{return this.fn()}finally{Eo(this),ae=t,Ye=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)ss(t);this.deps=this.depsTail=void 0,Ps(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?yi.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Mi(this)&&this.run()}get dirty(){return Mi(this)}}let Oo=0,un,dn;function Po(e,t=!1){if(e.flags|=8,t){e.next=dn,dn=e;return}e.next=un,un=e}function ns(){Oo++}function is(){if(--Oo>0)return;if(dn){let t=dn;for(dn=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;un;){let t=un;for(un=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(i){e||(e=i)}t=n}}if(e)throw e}function Ro(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function Eo(e){let t,n=e.depsTail,i=n;for(;i;){const s=i.prevDep;i.version===-1?(i===n&&(n=s),ss(i),Xp(i)):t=i,i.dep.activeLink=i.prevActiveLink,i.prevActiveLink=void 0,i=s}e.deps=t,e.depsTail=n}function Mi(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(So(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function So(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===hn)||(e.globalVersion=hn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Mi(e))))return;e.flags|=2;const t=e.dep,n=ae,i=Ye;ae=e,Ye=!0;try{Ro(e);const s=e.fn(e._value);(t.version===0||nt(s,e._value))&&(e.flags|=128,e._value=s,t.version++)}catch(s){throw t.version++,s}finally{ae=n,Ye=i,Eo(e),e.flags&=-3}}function ss(e,t=!1){const{dep:n,prevSub:i,nextSub:s}=e;if(i&&(i.nextSub=s,e.prevSub=void 0),s&&(s.prevSub=i,e.nextSub=void 0),n.subs===e&&(n.subs=i,!i&&n.computed)){n.computed.flags&=-5;for(let o=n.computed.deps;o;o=o.nextDep)ss(o,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function Xp(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let Ye=!0;const Io=[];function dt(){Io.push(Ye),Ye=!1}function _t(){const e=Io.pop();Ye=e===void 0?!0:e}function Ps(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=ae;ae=void 0;try{t()}finally{ae=n}}}let hn=0;class Jp{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class os{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ae||!Ye||ae===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==ae)n=this.activeLink=new Jp(ae,this),ae.deps?(n.prevDep=ae.depsTail,ae.depsTail.nextDep=n,ae.depsTail=n):ae.deps=ae.depsTail=n,Co(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const i=n.nextDep;i.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=i),n.prevDep=ae.depsTail,n.nextDep=void 0,ae.depsTail.nextDep=n,ae.depsTail=n,ae.deps===n&&(ae.deps=i)}return n}trigger(t){this.version++,hn++,this.notify(t)}notify(t){ns();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{is()}}}function Co(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let i=t.deps;i;i=i.nextDep)Co(i)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const Ni=new WeakMap,$t=Symbol(""),Fi=Symbol(""),xn=Symbol("");function Ae(e,t,n){if(Ye&&ae){let i=Ni.get(e);i||Ni.set(e,i=new Map);let s=i.get(n);s||(i.set(n,s=new os),s.map=i,s.key=n),s.track()}}function pt(e,t,n,i,s,o){const r=Ni.get(e);if(!r){hn++;return}const c=a=>{a&&a.trigger()};if(ns(),t==="clear")r.forEach(c);else{const a=H(e),l=a&&Qi(n);if(a&&n==="length"){const p=Number(i);r.forEach((_,h)=>{(h==="length"||h===xn||!st(h)&&h>=p)&&c(_)})}else switch((n!==void 0||r.has(void 0))&&c(r.get(n)),l&&c(r.get(xn)),t){case"add":a?l&&c(r.get("length")):(c(r.get($t)),qt(e)&&c(r.get(Fi)));break;case"delete":a||(c(r.get($t)),qt(e)&&c(r.get(Fi)));break;case"set":qt(e)&&c(r.get($t));break}}is()}function Vt(e){const t=Z(e);return t===e?t:(Ae(t,"iterate",xn),Be(e)?t:t.map(Ke))}function ri(e){return Ae(e=Z(e),"iterate",xn),e}function et(e,t){return ft(e)?Jt(Mt(e)?Ke(t):t):Ke(t)}const Zp={__proto__:null,[Symbol.iterator](){return Ti(this,Symbol.iterator,e=>et(this,e))},concat(...e){return Vt(this).concat(...e.map(t=>H(t)?Vt(t):t))},entries(){return Ti(this,"entries",e=>(e[1]=et(this,e[1]),e))},every(e,t){return rt(this,"every",e,t,void 0,arguments)},filter(e,t){return rt(this,"filter",e,t,n=>n.map(i=>et(this,i)),arguments)},find(e,t){return rt(this,"find",e,t,n=>et(this,n),arguments)},findIndex(e,t){return rt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return rt(this,"findLast",e,t,n=>et(this,n),arguments)},findLastIndex(e,t){return rt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return rt(this,"forEach",e,t,void 0,arguments)},includes(...e){return Li(this,"includes",e)},indexOf(...e){return Li(this,"indexOf",e)},join(e){return Vt(this).join(e)},lastIndexOf(...e){return Li(this,"lastIndexOf",e)},map(e,t){return rt(this,"map",e,t,void 0,arguments)},pop(){return on(this,"pop")},push(...e){return on(this,"push",e)},reduce(e,...t){return Rs(this,"reduce",e,t)},reduceRight(e,...t){return Rs(this,"reduceRight",e,t)},shift(){return on(this,"shift")},some(e,t){return rt(this,"some",e,t,void 0,arguments)},splice(...e){return on(this,"splice",e)},toReversed(){return Vt(this).toReversed()},toSorted(e){return Vt(this).toSorted(e)},toSpliced(...e){return Vt(this).toSpliced(...e)},unshift(...e){return on(this,"unshift",e)},values(){return Ti(this,"values",e=>et(this,e))}};function Ti(e,t,n){const i=ri(e),s=i[t]();return i!==e&&!Be(e)&&(s._next=s.next,s.next=()=>{const o=s._next();return o.done||(o.value=n(o.value)),o}),s}const Qp=Array.prototype;function rt(e,t,n,i,s,o){const r=ri(e),c=r!==e&&!Be(e),a=r[t];if(a!==Qp[t]){const _=a.apply(e,o);return c?Ke(_):_}let l=n;r!==e&&(c?l=function(_,h){return n.call(this,et(e,_),h,e)}:n.length>2&&(l=function(_,h){return n.call(this,_,h,e)}));const p=a.call(r,l,i);return c&&s?s(p):p}function Rs(e,t,n,i){const s=ri(e),o=s!==e&&!Be(e);let r=n,c=!1;s!==e&&(o?(c=i.length===0,r=function(l,p,_){return c&&(c=!1,l=et(e,l)),n.call(this,l,et(e,p),_,e)}):n.length>3&&(r=function(l,p,_){return n.call(this,l,p,_,e)}));const a=s[t](r,...i);return c?et(e,a):a}function Li(e,t,n){const i=Z(e);Ae(i,"iterate",xn);const s=i[t](...n);return(s===-1||s===!1)&&ls(n[0])?(n[0]=Z(n[0]),i[t](...n)):s}function on(e,t,n=[]){dt(),ns();const i=Z(e)[t].apply(e,n);return is(),_t(),i}const eu=Ji("__proto__,__v_isRef,__isVue"),$o=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(st));function tu(e){st(e)||(e=String(e));const t=Z(this);return Ae(t,"has",e),t.hasOwnProperty(e)}class Mo{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,i){if(n==="__v_skip")return t.__v_skip;const s=this._isReadonly,o=this._isShallow;if(n==="__v_isReactive")return!s;if(n==="__v_isReadonly")return s;if(n==="__v_isShallow")return o;if(n==="__v_raw")return i===(s?o?uu:Bo:o?Do:Fo).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(i)?t:void 0;const r=H(t);if(!s){let a;if(r&&(a=Zp[n]))return a;if(n==="hasOwnProperty")return tu}const c=Reflect.get(t,n,Oe(t)?t:i);if((st(n)?$o.has(n):eu(n))||(s||Ae(t,"get",n),o))return c;if(Oe(c)){const a=r&&Qi(n)?c:c.value;return s&&ne(a)?Bi(a):a}return ne(c)?s?Bi(c):cs(c):c}}class No extends Mo{constructor(t=!1){super(!1,t)}set(t,n,i,s){let o=t[n];const r=H(t)&&Qi(n);if(!this._isShallow){const l=ft(o);if(!Be(i)&&!ft(i)&&(o=Z(o),i=Z(i)),!r&&Oe(o)&&!Oe(i))return l||(o.value=i),!0}const c=r?Number(n)<t.length:ee(t,n),a=Reflect.set(t,n,i,Oe(t)?t:s);return t===Z(s)&&a&&(c?nt(i,o)&&pt(t,"set",n,i):pt(t,"add",n,i)),a}deleteProperty(t,n){const i=ee(t,n);t[n];const s=Reflect.deleteProperty(t,n);return s&&i&&pt(t,"delete",n,void 0),s}has(t,n){const i=Reflect.has(t,n);return(!st(n)||!$o.has(n))&&Ae(t,"has",n),i}ownKeys(t){return Ae(t,"iterate",H(t)?"length":$t),Reflect.ownKeys(t)}}class nu extends Mo{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const iu=new No,su=new nu,ou=new No(!0);const Di=e=>e,In=e=>Reflect.getPrototypeOf(e);function ru(e,t,n){return function(...i){const s=this.__v_raw,o=Z(s),r=qt(o),c=e==="entries"||e===Symbol.iterator&&r,a=e==="keys"&&r,l=s[e](...i),p=n?Di:t?Jt:Ke;return!t&&Ae(o,"iterate",a?Fi:$t),xe(Object.create(l),{next(){const{value:_,done:h}=l.next();return h?{value:_,done:h}:{value:c?[p(_[0]),p(_[1])]:p(_),done:h}}})}}function Cn(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function cu(e,t){const n={get(s){const o=this.__v_raw,r=Z(o),c=Z(s);e||(nt(s,c)&&Ae(r,"get",s),Ae(r,"get",c));const{has:a}=In(r),l=t?Di:e?Jt:Ke;if(a.call(r,s))return l(o.get(s));if(a.call(r,c))return l(o.get(c));o!==r&&o.get(s)},get size(){const s=this.__v_raw;return!e&&Ae(Z(s),"iterate",$t),s.size},has(s){const o=this.__v_raw,r=Z(o),c=Z(s);return e||(nt(s,c)&&Ae(r,"has",s),Ae(r,"has",c)),s===c?o.has(s):o.has(s)||o.has(c)},forEach(s,o){const r=this,c=r.__v_raw,a=Z(c),l=t?Di:e?Jt:Ke;return!e&&Ae(a,"iterate",$t),c.forEach((p,_)=>s.call(o,l(p),l(_),r))}};return xe(n,e?{add:Cn("add"),set:Cn("set"),delete:Cn("delete"),clear:Cn("clear")}:{add(s){const o=Z(this),r=In(o),c=Z(s),a=!t&&!Be(s)&&!ft(s)?c:s;return r.has.call(o,a)||nt(s,a)&&r.has.call(o,s)||nt(c,a)&&r.has.call(o,c)||(o.add(a),pt(o,"add",a,a)),this},set(s,o){!t&&!Be(o)&&!ft(o)&&(o=Z(o));const r=Z(this),{has:c,get:a}=In(r);let l=c.call(r,s);l||(s=Z(s),l=c.call(r,s));const p=a.call(r,s);return r.set(s,o),l?nt(o,p)&&pt(r,"set",s,o):pt(r,"add",s,o),this},delete(s){const o=Z(this),{has:r,get:c}=In(o);let a=r.call(o,s);a||(s=Z(s),a=r.call(o,s)),c&&c.call(o,s);const l=o.delete(s);return a&&pt(o,"delete",s,void 0),l},clear(){const s=Z(this),o=s.size!==0,r=s.clear();return o&&pt(s,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(s=>{n[s]=ru(s,e,t)}),n}function rs(e,t){const n=cu(e,t);return(i,s,o)=>s==="__v_isReactive"?!e:s==="__v_isReadonly"?e:s==="__v_raw"?i:Reflect.get(ee(n,s)&&s in i?n:i,s,o)}const au={get:rs(!1,!1)},lu={get:rs(!1,!0)},pu={get:rs(!0,!1)};const Fo=new WeakMap,Do=new WeakMap,Bo=new WeakMap,uu=new WeakMap;function du(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function cs(e){return ft(e)?e:as(e,!1,iu,au,Fo)}function _u(e){return as(e,!1,ou,lu,Do)}function Bi(e){return as(e,!0,su,pu,Bo)}function as(e,t,n,i,s){if(!ne(e)||e.__v_raw&&!(t&&e.__v_isReactive)||e.__v_skip||!Object.isExtensible(e))return e;const o=s.get(e);if(o)return o;const r=du(Fp(e));if(r===0)return e;const c=new Proxy(e,r===2?i:n);return s.set(e,c),c}function Mt(e){return ft(e)?Mt(e.__v_raw):!!(e&&e.__v_isReactive)}function ft(e){return!!(e&&e.__v_isReadonly)}function Be(e){return!!(e&&e.__v_isShallow)}function ls(e){return e?!!e.__v_raw:!1}function Z(e){const t=e&&e.__v_raw;return t?Z(t):e}function fu(e){return!ee(e,"__v_skip")&&Object.isExtensible(e)&&To(e,"__v_skip",!0),e}const Ke=e=>ne(e)?cs(e):e,Jt=e=>ne(e)?Bi(e):e;function Oe(e){return e?e.__v_isRef===!0:!1}function Q(e){return Ho(e,!1)}function ci(e){return Ho(e,!0)}function Ho(e,t){return Oe(e)?e:new gu(e,t)}class gu{constructor(t,n){this.dep=new os,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:Z(t),this._value=n?t:Ke(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,i=this.__v_isShallow||Be(t)||ft(t);t=i?t:Z(t),nt(t,n)&&(this._rawValue=t,this._value=i?t:Ke(t),this.dep.trigger())}}function b(e){return Oe(e)?e.value:e}const mu={get:(e,t,n)=>t==="__v_raw"?e:b(Reflect.get(e,t,n)),set:(e,t,n,i)=>{const s=e[t];return Oe(s)&&!Oe(n)?(s.value=n,!0):Reflect.set(e,t,n,i)}};function Go(e){return Mt(e)?e:new Proxy(e,mu)}class vu{constructor(t,n,i){this.fn=t,this.setter=n,this._value=void 0,this.dep=new os(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=hn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=i}notify(){if(this.flags|=16,!(this.flags&8)&&ae!==this)return Po(this,!0),!0}get value(){const t=this.dep.track();return So(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function hu(e,t,n=!1){let i,s;return j(e)?i=e:(i=e.get,s=e.set),new vu(i,s,n)}const $n={},Vn=new WeakMap;let Et;function xu(e,t=!1,n=Et){if(n){let i=Vn.get(n);i||Vn.set(n,i=[]),i.push(e)}}function ku(e,t,n=re){const{immediate:i,deep:s,once:o,scheduler:r,augmentJob:c,call:a}=n,l=A=>s?A:Be(A)||s===!1||s===0?ut(A,1):ut(A);let p,_,h,v,w=!1,I=!1;if(Oe(e)?(_=()=>e.value,w=Be(e)):Mt(e)?(_=()=>l(e),w=!0):H(e)?(I=!0,w=e.some(A=>Mt(A)||Be(A)),_=()=>e.map(A=>{if(Oe(A))return A.value;if(Mt(A))return l(A);if(j(A))return a?a(A,2):A()})):j(e)?t?_=a?()=>a(e,2):e:_=()=>{if(h){dt();try{h()}finally{_t()}}const A=Et;Et=p;try{return a?a(e,3,[v]):e(v)}finally{Et=A}}:_=it,t&&s){const A=_,N=s===!0?1/0:s;_=()=>ut(A(),N)}const W=zp(),Y=()=>{p.stop(),W&&W.active&&Zi(W.effects,p)};if(o&&t){const A=t;t=(...N)=>{const K=A(...N);return Y(),K}}let G=I?new Array(e.length).fill($n):$n;const F=A=>{if(!(!(p.flags&1)||!p.dirty&&!A))if(t){const N=p.run();if(A||s||w||(I?N.some((K,me)=>nt(K,G[me])):nt(N,G))){h&&h();const K=Et;Et=p;try{const me=[N,G===$n?void 0:I&&G[0]===$n?[]:G,v];G=N,a?a(t,3,me):t(...me)}finally{Et=K}}}else p.run()};return c&&c(F),p=new wo(_),p.scheduler=r?()=>r(F,!1):F,v=A=>xu(A,!1,p),h=p.onStop=()=>{const A=Vn.get(p);if(A){if(a)a(A,4);else for(const N of A)N();Vn.delete(p)}},t?i?F(!0):G=p.run():r?r(F.bind(null,!0),!0):p.run(),Y.pause=p.pause.bind(p),Y.resume=p.resume.bind(p),Y.stop=Y,Y}function ut(e,t=1/0,n){if(t<=0||!ne(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,Oe(e))ut(e.value,t,n);else if(H(e))for(let i=0;i<e.length;i++)ut(e[i],t,n);else if(vo(e)||qt(e))e.forEach(i=>{ut(i,t,n)});else if(ko(e)){for(const i in e)ut(e[i],t,n);for(const i of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,i)&&ut(e[i],t,n)}return e}/**
* @vue/runtime-core v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Pn(e,t,n,i){try{return i?e(...i):e()}catch(s){ai(s,t,n)}}function Ge(e,t,n,i){if(j(e)){const s=Pn(e,t,n,i);return s&&ho(s)&&s.catch(o=>{ai(o,t,n)}),s}if(H(e)){const s=[];for(let o=0;o<e.length;o++)s.push(Ge(e[o],t,n,i));return s}}function ai(e,t,n,i=!0){const s=t?t.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:r}=t&&t.appContext.config||re;if(t){let c=t.parent;const a=t.proxy,l=`https://vuejs.org/error-reference/#runtime-${n}`;for(;c;){const p=c.ec;if(p){for(let _=0;_<p.length;_++)if(p[_](e,a,l)===!1)return}c=c.parent}if(o){dt(),Pn(o,null,10,[e,a,l]),_t();return}}yu(e,n,s,i,r)}function yu(e,t,n,i=!0,s=!1){if(s)throw e;console.error(e)}const Re=[];let Qe=-1;const Wt=[];let xt=null,Ut=0;const Vo=Promise.resolve();let Un=null;function ps(e){const t=Un||Vo;return e?t.then(this?e.bind(this):e):t}function Tu(e){let t=Qe+1,n=Re.length;for(;t<n;){const i=t+n>>>1,s=Re[i],o=kn(s);o<e||o===e&&s.flags&2?t=i+1:n=i}return t}function us(e){if(!(e.flags&1)){const t=kn(e),n=Re[Re.length-1];!n||!(e.flags&2)&&t>=kn(n)?Re.push(e):Re.splice(Tu(t),0,e),e.flags|=1,Uo()}}function Uo(){Un||(Un=Vo.then(Yo))}function Lu(e){if(!H(e))xt&&e.id===-1?xt.splice(Ut+1,0,e):e.flags&1||(Wt.push(e),e.flags|=1);else for(let t=0;t<e.length;t++)Wt.push(e[t]);Uo()}function Es(e,t,n=Qe+1){for(;n<Re.length;n++){const i=Re[n];if(i&&i.flags&2){if(e&&i.id!==e.uid)continue;Re.splice(n,1),n--,i.flags&4&&(i.flags&=-2),i(),i.flags&4||(i.flags&=-2)}}}function jo(e){if(Wt.length){const t=[...new Set(Wt)].sort((n,i)=>kn(n)-kn(i));if(Wt.length=0,xt){for(let n=0;n<t.length;n++)xt.push(t[n]);return}for(xt=t,Ut=0;Ut<xt.length;Ut++){const n=xt[Ut];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}xt=null,Ut=0}}const kn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Yo(e){try{for(Qe=0;Qe<Re.length;Qe++){const t=Re[Qe];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Pn(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;Qe<Re.length;Qe++){const t=Re[Qe];t&&(t.flags&=-2)}Qe=-1,Re.length=0,jo(),Un=null,(Re.length||Wt.length)&&Yo()}}let De=null,Ko=null;function jn(e){const t=De;return De=e,Ko=e&&e.type.__scopeId||null,t}function ds(e,t=De,n){if(!t||e._n)return e;const i=(...s)=>{i._d&&Wn(-1);const o=jn(t),r=Nt.length;let c;try{c=e(...s)}finally{for(let a=Nt.length;a>r;a--)yr();jn(o),i._d&&Wn(1)}return c};return i._n=!0,i._c=!0,i._d=!0,i}function bu(e,t){if(De===null)return e;const n=fi(De),i=e.dirs||(e.dirs=[]);for(let s=0;s<t.length;s++){let[o,r,c,a=re]=t[s];o&&(j(o)&&(o={mounted:o,updated:o}),o.deep&&ut(r),i.push({dir:o,instance:n,value:r,oldValue:void 0,arg:c,modifiers:a}))}return e}function wt(e,t,n,i){const s=e.dirs,o=t&&t.dirs;for(let r=0;r<s.length;r++){const c=s[r];o&&(c.oldValue=o[r].value);let a=c.dir[i];a&&(dt(),Ge(a,n,8,[e.el,c,e,t]),_t())}}function Au(e,t){if(Se){let n=Se.provides;const i=Se.parent&&Se.parent.provides;i===n&&(n=Se.provides=Object.create(i)),n[e]=t}}function Dn(e,t,n=!1){const i=ms();if(i||zt){let s=zt?zt._context.provides:i?i.parent==null||i.ce?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides:void 0;if(s&&e in s)return s[e];if(arguments.length>1)return n&&j(t)?t.call(i&&i.proxy):t}}const wu=Symbol.for("v-scx"),Ou=()=>Dn(wu);function we(e,t,n){return qo(e,t,n)}function qo(e,t,n=re){const{immediate:i,deep:s,flush:o,once:r}=n,c=xe({},n),a=t&&i||!t&&o!=="post";let l;if(bn){if(o==="sync"){const v=Ou();l=v.__watcherHandles||(v.__watcherHandles=[])}else if(!a){const v=()=>{};return v.stop=it,v.resume=it,v.pause=it,v}}const p=Se;c.call=(v,w,I)=>Ge(v,p,w,I);let _=!1;o==="post"?c.scheduler=v=>{Ie(v,p&&p.suspense)}:o!=="sync"&&(_=!0,c.scheduler=(v,w)=>{w?v():us(v)}),c.augmentJob=v=>{t&&(v.flags|=4),_&&(v.flags|=2,p&&(v.id=p.uid,v.i=p))};const h=ku(e,t,c);return bn&&(l?l.push(h):a&&h()),h}function Pu(e,t,n){const i=this.proxy,s=de(e)?e.includes(".")?Wo(i,e):()=>i[e]:e.bind(i,i);let o;j(t)?o=t:(o=t.handler,n=t);const r=Rn(this),c=qo(s,o.bind(i),n);return r(),c}function Wo(e,t){const n=t.split(".");return()=>{let i=e;for(let s=0;s<n.length&&i;s++)i=i[n[s]];return i}}const Ru=Symbol("_vte"),li=e=>e.__isTeleport,Fe=Symbol("_leaveCb"),rn=Symbol("_enterCb");function zo(){const e={isMounted:!1,isLeaving:!1,isUnmounting:!1,leavingVNodes:new Map};return en(()=>{e.isMounted=!0}),ir(()=>{e.isUnmounting=!0}),e}const Ne=[Function,Array],Xo={mode:String,appear:Boolean,persisted:Boolean,onBeforeEnter:Ne,onEnter:Ne,onAfterEnter:Ne,onEnterCancelled:Ne,onBeforeLeave:Ne,onLeave:Ne,onAfterLeave:Ne,onLeaveCancelled:Ne,onBeforeAppear:Ne,onAppear:Ne,onAfterAppear:Ne,onAppearCancelled:Ne},Jo=e=>{const t=e.subTree;return t.component?Jo(t.component):t},Eu={name:"BaseTransition",props:Xo,setup(e,{slots:t}){const n=ms(),i=zo();return()=>{const s=t.default&&_s(t.default(),!0),o=s&&s.length?Zo(s):n.subTree?se():void 0;if(!o)return;const r=Z(e),{mode:c}=r;if(i.isLeaving)return bi(o);const a=Yn(o);if(!a)return bi(o);let l=yn(a,r,i,n,_=>l=_);a.type!==Ee&&Ft(a,l);let p=n.subTree&&Yn(n.subTree);if(p&&p.type!==Ee&&!St(p,a)&&Jo(n).type!==Ee){let _=yn(p,r,i,n);if(Ft(p,_),c==="out-in"&&a.type!==Ee)return i.isLeaving=!0,_.afterLeave=()=>{i.isLeaving=!1,n.job.flags&8||n.update(),delete _.afterLeave,p=void 0},bi(o);c==="in-out"&&a.type!==Ee?_.delayLeave=(h,v,w)=>{const I=Qo(i,p);I[String(p.key)]=p,h[Fe]=()=>{v(),h[Fe]=void 0,delete l.delayedLeave,p=void 0},l.delayedLeave=()=>{w(),delete l.delayedLeave,p=void 0}}:p=void 0}else p&&(p=void 0);return o}}};function Zo(e){let t=e[0];if(e.length>1){for(const n of e)if(n.type!==Ee){t=n;break}}return t}const Su=Eu;function Qo(e,t){const{leavingVNodes:n}=e;let i=n.get(t.type);return i||(i=Object.create(null),n.set(t.type,i)),i}function yn(e,t,n,i,s){const{appear:o,mode:r,persisted:c=!1,onBeforeEnter:a,onEnter:l,onAfterEnter:p,onEnterCancelled:_,onBeforeLeave:h,onLeave:v,onAfterLeave:w,onLeaveCancelled:I,onBeforeAppear:W,onAppear:Y,onAfterAppear:G,onAppearCancelled:F}=t,A=String(e.key),N=Qo(n,e),K=(V,X)=>{V&&Ge(V,i,9,X)},me=(V,X)=>{const $=X[1];K(V,X),H(V)?V.every(f=>f.length<=1)&&$():V.length<=1&&$()},pe={mode:r,persisted:c,beforeEnter(V){let X=a;if(!n.isMounted)if(o)X=W||a;else return;V[Fe]&&V[Fe](!0);const $=N[A];$&&St(e,$)&&$.el[Fe]&&$.el[Fe](),K(X,[V])},enter(V){if(N[A]===e)return;let X=l,$=p,f=_;if(!n.isMounted)if(o)X=Y||l,$=G||p,f=F||_;else return;let x=!1;V[rn]=q=>{x||(x=!0,q?K(f,[V]):K($,[V]),pe.delayedLeave&&pe.delayedLeave(),V[rn]=void 0)};const z=V[rn].bind(null,!1);X?me(X,[V,z]):z()},leave(V,X){const $=String(e.key);if(V[rn]&&V[rn](!0),n.isUnmounting)return X();K(h,[V]);let f=!1;V[Fe]=z=>{f||(f=!0,X(),z?K(I,[V]):K(w,[V]),V[Fe]=void 0,N[$]===e&&delete N[$])};const x=V[Fe].bind(null,!1);N[$]=e,v?me(v,[V,x]):x()},clone(V){const X=yn(V,t,n,i,s);return s&&s(X),X}};return pe}function bi(e){if(pi(e))return e=kt(e),e.children=null,e}function Yn(e){if(!pi(e))return li(e.type)&&e.children?Zo(e.children):e;if(e.component)return e.component.subTree;const{shapeFlag:t,children:n}=e;if(n){if(t&16)return n[0];if(t&32&&j(n.default))return n.default()}}function Ft(e,t){if(e.shapeFlag&6&&e.component){e.transition=t;const n=e.component.subTree;Ft(li(n.type)&&Yn(n)||n,t)}else e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function _s(e,t=!1,n){let i=[],s=0;for(let o=0;o<e.length;o++){let r=e[o];const c=n==null?r.key:String(n)+String(r.key!=null?r.key:o);r.type===ke?(r.patchFlag&128&&s++,i=i.concat(_s(r.children,t,c))):(t||r.type!==Ee)&&i.push(c!=null?kt(r,{key:c}):r)}if(s>1)for(let o=0;o<i.length;o++)i[o].patchFlag=-2;return i}function ot(e,t){return j(e)?xe({name:e.name},t,{setup:e}):e}function er(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Ss(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const Kn=new WeakMap;function _n(e,t,n,i,s=!1){if(H(e)){e.forEach((I,W)=>_n(I,t&&(H(t)?t[W]:t),n,i,s));return}if(fn(i)&&!s){i.shapeFlag&512&&i.type.__asyncResolved&&i.component.subTree.component&&_n(e,t,n,i.component.subTree);return}const o=i.shapeFlag&4?fi(i.component):i.el,r=s?null:o,{i:c,r:a}=e,l=t&&t.r,p=c.refs===re?c.refs={}:c.refs,_=c.setupState,h=Z(_),v=_===re?mo:I=>Ss(p,I)?!1:ee(h,I),w=(I,W)=>!(W&&Ss(p,W));if(l!=null&&l!==a){if(Is(t),de(l))p[l]=null,v(l)&&(_[l]=null);else if(Oe(l)){const I=t;w(l,I.k)&&(l.value=null),I.k&&(p[I.k]=null)}}if(j(a))Pn(a,c,12,[r,p]);else{const I=de(a),W=Oe(a);if(I||W){const Y=()=>{if(e.f){const G=I?v(a)?_[a]:p[a]:w()||!e.k?a.value:p[e.k];if(s)H(G)&&Zi(G,o);else if(H(G))G.includes(o)||G.push(o);else if(I)p[a]=[o],v(a)&&(_[a]=p[a]);else{const F=[o];w(a,e.k)&&(a.value=F),e.k&&(p[e.k]=F)}}else I?(p[a]=r,v(a)&&(_[a]=r)):W&&(w(a,e.k)&&(a.value=r),e.k&&(p[e.k]=r))};if(r){const G=()=>{Y(),Kn.delete(e)};G.id=-1,Kn.set(e,G),Ie(G,n)}else Is(e),Y()}}}function Is(e){const t=Kn.get(e);t&&(t.flags|=8,Kn.delete(e))}oi().requestIdleCallback;oi().cancelIdleCallback;const fn=e=>!!e.type.__asyncLoader,pi=e=>e.type.__isKeepAlive;function Iu(e,t){tr(e,"a",t)}function Cu(e,t){tr(e,"da",t)}function tr(e,t,n=Se){const i=e.__wdc||(e.__wdc=()=>{let s=n;for(;s;){if(s.isDeactivated)return;s=s.parent}return e()});if(ui(t,i,n),n){let s=n.parent;for(;s&&s.parent;)pi(s.parent.vnode)&&$u(i,t,n,s),s=s.parent}}function $u(e,t,n,i){const s=ui(t,e,i,!0);Gt(()=>{Zi(i[t],s)},n)}function ui(e,t,n=Se,i=!1){if(n){const s=n[e]||(n[e]=[]),o=t.__weh||(t.__weh=(...r)=>{dt();const c=Rn(n),a=Ge(t,n,e,r);return c(),_t(),a});return i?s.unshift(o):s.push(o),o}}const gt=e=>(t,n=Se)=>{(!bn||e==="sp")&&ui(e,(...i)=>t(...i),n)},Mu=gt("bm"),en=gt("m"),Nu=gt("bu"),nr=gt("u"),ir=gt("bum"),Gt=gt("um"),Fu=gt("sp"),Du=gt("rtg"),Bu=gt("rtc");function Hu(e,t=Se){ui("ec",e,t)}const Gu=Symbol.for("v-ndc");function Dt(e,t,n,i){let s;const o=n,r=H(e);if(r||de(e)){const c=r&&Mt(e);let a=!1,l=!1;c&&(a=!Be(e),l=ft(e),e=ri(e)),s=new Array(e.length);for(let p=0,_=e.length;p<_;p++)s[p]=t(a?l?Jt(Ke(e[p])):Ke(e[p]):e[p],p,void 0,o)}else if(typeof e=="number"){s=new Array(e);for(let c=0;c<e;c++)s[c]=t(c+1,c,void 0,o)}else if(ne(e))if(e[Symbol.iterator])s=Array.from(e,(c,a)=>t(c,a,void 0,o));else{const c=Object.keys(e);s=new Array(c.length);for(let a=0,l=c.length;a<l;a++){const p=c[a];s[a]=t(e[p],p,a,o)}}else s=[];return s}const Hi=e=>e?br(e)?fi(e):Hi(e.parent):null,gn=xe(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Hi(e.parent),$root:e=>Hi(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>or(e),$forceUpdate:e=>e.f||(e.f=()=>{us(e.update)}),$nextTick:e=>e.n||(e.n=ps.bind(e.proxy)),$watch:e=>Pu.bind(e)}),Ai=(e,t)=>e!==re&&!e.__isScriptSetup&&ee(e,t),Vu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:i,data:s,props:o,accessCache:r,type:c,appContext:a}=e;if(t[0]!=="$"){const h=r[t];if(h!==void 0)switch(h){case 1:return i[t];case 2:return s[t];case 4:return n[t];case 3:return o[t]}else{if(Ai(i,t))return r[t]=1,i[t];if(s!==re&&ee(s,t))return r[t]=2,s[t];if(ee(o,t))return r[t]=3,o[t];if(n!==re&&ee(n,t))return r[t]=4,n[t];Gi&&(r[t]=0)}}const l=gn[t];let p,_;if(l)return t==="$attrs"&&Ae(e.attrs,"get",""),l(e);if((p=c.__cssModules)&&(p=p[t]))return p;if(n!==re&&ee(n,t))return r[t]=4,n[t];if(_=a.config.globalProperties,ee(_,t))return _[t]},set({_:e},t,n){const{data:i,setupState:s,ctx:o}=e;return Ai(s,t)?(s[t]=n,!0):i!==re&&ee(i,t)?(i[t]=n,!0):ee(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:i,appContext:s,props:o,type:r}},c){let a;return!!(n[c]||e!==re&&c[0]!=="$"&&ee(e,c)||Ai(t,c)||ee(o,c)||ee(i,c)||ee(gn,c)||ee(s.config.globalProperties,c)||(a=r.__cssModules)&&a[c])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:ee(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function Cs(e){return H(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}let Gi=!0;function Uu(e){const t=or(e),n=e.proxy,i=e.ctx;Gi=!1,t.beforeCreate&&$s(t.beforeCreate,e,"bc");const{data:s,computed:o,methods:r,watch:c,provide:a,inject:l,created:p,beforeMount:_,mounted:h,beforeUpdate:v,updated:w,activated:I,deactivated:W,beforeDestroy:Y,beforeUnmount:G,destroyed:F,unmounted:A,render:N,renderTracked:K,renderTriggered:me,errorCaptured:pe,serverPrefetch:V,expose:X,inheritAttrs:$,components:f,directives:x,filters:z}=t;if(l&&ju(l,i,null),r)for(const ue in r){const ce=r[ue];j(ce)&&(i[ue]=ce.bind(n))}if(s){const ue=s.call(n,n);ne(ue)&&(e.data=cs(ue))}if(Gi=!0,o)for(const ue in o){const ce=o[ue],bt=j(ce)?ce.bind(n,n):j(ce.get)?ce.get.bind(n,n):it,En=!j(ce)&&j(ce.set)?ce.set.bind(n):it,At=te({get:bt,set:En});Object.defineProperty(i,ue,{enumerable:!0,configurable:!0,get:()=>At.value,set:qe=>At.value=qe})}if(c)for(const ue in c)sr(c[ue],i,n,ue);if(a){const ue=j(a)?a.call(n):a;Reflect.ownKeys(ue).forEach(ce=>{Au(ce,ue[ce])})}p&&$s(p,e,"c");function le(ue,ce){H(ce)?ce.forEach(bt=>ue(bt.bind(n))):ce&&ue(ce.bind(n))}if(le(Mu,_),le(en,h),le(Nu,v),le(nr,w),le(Iu,I),le(Cu,W),le(Hu,pe),le(Bu,K),le(Du,me),le(ir,G),le(Gt,A),le(Fu,V),H(X))if(X.length){const ue=e.exposed||(e.exposed={});X.forEach(ce=>{Object.defineProperty(ue,ce,{get:()=>n[ce],set:bt=>n[ce]=bt,enumerable:!0})})}else e.exposed||(e.exposed={});N&&e.render===it&&(e.render=N),$!=null&&(e.inheritAttrs=$),f&&(e.components=f),x&&(e.directives=x),V&&er(e)}function ju(e,t,n=it){H(e)&&(e=Vi(e));for(const i in e){const s=e[i];let o;ne(s)?"default"in s?o=Dn(s.from||i,s.default,!0):o=Dn(s.from||i):o=Dn(s),Oe(o)?Object.defineProperty(t,i,{enumerable:!0,configurable:!0,get:()=>o.value,set:r=>o.value=r}):t[i]=o}}function $s(e,t,n){Ge(H(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,n)}function sr(e,t,n,i){let s=i.includes(".")?Wo(n,i):()=>n[i];if(de(e)){const o=t[e];j(o)&&we(s,o)}else if(j(e))we(s,e.bind(n));else if(ne(e))if(H(e))e.forEach(o=>sr(o,t,n,i));else{const o=j(e.handler)?e.handler.bind(n):t[e.handler];j(o)&&we(s,o,e)}}function or(e){const t=e.type,{mixins:n,extends:i}=t,{mixins:s,optionsCache:o,config:{optionMergeStrategies:r}}=e.appContext,c=o.get(t);let a;return c?a=c:!s.length&&!n&&!i?a=t:(a={},s.length&&s.forEach(l=>qn(a,l,r,!0)),qn(a,t,r)),ne(t)&&o.set(t,a),a}function qn(e,t,n,i=!1){const{mixins:s,extends:o}=t;o&&qn(e,o,n,!0),s&&s.forEach(r=>qn(e,r,n,!0));for(const r in t)if(!(i&&r==="expose")){const c=Yu[r]||n&&n[r];e[r]=c?c(e[r],t[r]):t[r]}return e}const Yu={data:Ms,props:Ns,emits:Ns,methods:an,computed:an,beforeCreate:Pe,created:Pe,beforeMount:Pe,mounted:Pe,beforeUpdate:Pe,updated:Pe,beforeDestroy:Pe,beforeUnmount:Pe,destroyed:Pe,unmounted:Pe,activated:Pe,deactivated:Pe,errorCaptured:Pe,serverPrefetch:Pe,components:an,directives:an,watch:qu,provide:Ms,inject:Ku};function Ms(e,t){return t?e?function(){return xe(j(e)?e.call(this,this):e,j(t)?t.call(this,this):t)}:t:e}function Ku(e,t){return an(Vi(e),Vi(t))}function Vi(e){if(H(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function Pe(e,t){return e?[...new Set([].concat(e,t))]:t}function an(e,t){return e?xe(Object.create(null),e,t):t}function Ns(e,t){return e?H(e)&&H(t)?[...new Set([...e,...t])]:xe(Object.create(null),Cs(e),Cs(t??{})):t}function qu(e,t){if(!e)return t;if(!t)return e;const n=xe(Object.create(null),e);for(const i in t)n[i]=Pe(e[i],t[i]);return n}function rr(){return{app:null,config:{isNativeTag:mo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Wu=0;function zu(e,t){return function(i,s=null){j(i)||(i=xe({},i)),s!=null&&!ne(s)&&(s=null);const o=rr(),r=new WeakSet,c=[];let a=!1;const l=o.app={_uid:Wu++,_component:i,_props:s,_container:null,_context:o,_instance:null,version:wd,get config(){return o.config},set config(p){},use(p,..._){return r.has(p)||(p&&j(p.install)?(r.add(p),p.install(l,..._)):j(p)&&(r.add(p),p(l,..._))),l},mixin(p){return o.mixins.includes(p)||o.mixins.push(p),l},component(p,_){return _?(o.components[p]=_,l):o.components[p]},directive(p,_){return _?(o.directives[p]=_,l):o.directives[p]},mount(p,_,h){if(!a){const v=l._ceVNode||Te(i,s);return v.appContext=o,h===!0?h="svg":h===!1&&(h=void 0),e(v,p,h),a=!0,l._container=p,p.__vue_app__=l,fi(v.component)}},onUnmount(p){c.push(p)},unmount(){a&&(Ge(c,l._instance,16),e(null,l._container),delete l._container.__vue_app__)},provide(p,_){return o.provides[p]=_,l},runWithContext(p){const _=zt;zt=l;try{return p()}finally{zt=_}}};return l}}let zt=null;const Xu=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${je(t)}Modifiers`]||e[`${Ht(t)}Modifiers`];function Ju(e,t,...n){if(e.isUnmounted)return;const i=e.vnode.props||re;let s=n;const o=t.startsWith("update:"),r=o&&Xu(i,t.slice(7));r&&(r.trim&&(s=n.map(p=>de(p)?p.trim():p)),r.number&&(s=n.map(es)));let c,a=i[c=xi(t)]||i[c=xi(je(t))];!a&&o&&(a=i[c=xi(Ht(t))]),a&&Ge(a,e,6,s);const l=i[c+"Once"];if(l){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,Ge(l,e,6,s)}}const Zu=new WeakMap;function cr(e,t,n=!1){const i=n?Zu:t.emitsCache,s=i.get(e);if(s!==void 0)return s;const o=e.emits;let r={},c=!1;if(!j(e)){const a=l=>{const p=cr(l,t,!0);p&&(c=!0,xe(r,p))};!n&&t.mixins.length&&t.mixins.forEach(a),e.extends&&a(e.extends),e.mixins&&e.mixins.forEach(a)}return!o&&!c?(ne(e)&&i.set(e,null),null):(H(o)?o.forEach(a=>r[a]=null):xe(r,o),ne(e)&&i.set(e,r),r)}function di(e,t){return!e||!ni(t)?!1:(t=t.slice(2),t=t==="Once"?t:t.replace(/Once$/,""),ee(e,t[0].toLowerCase()+t.slice(1))||ee(e,Ht(t))||ee(e,t))}function Fs(e){const{type:t,vnode:n,proxy:i,withProxy:s,propsOptions:[o],slots:r,attrs:c,emit:a,render:l,renderCache:p,props:_,data:h,setupState:v,ctx:w,inheritAttrs:I}=e,W=jn(e);let Y,G;try{if(n.shapeFlag&4){const A=s||i,N=A;Y=tt(l.call(N,A,p,_,v,h,w)),G=c}else{const A=t;Y=tt(A.length>1?A(_,{attrs:c,slots:r,emit:a}):A(_,null)),G=t.props?c:Qu(c)}}catch(A){Nt.length=0,ai(A,e,1),Y=Te(Ee)}let F=Y;if(G&&I!==!1){const A=Object.keys(G),{shapeFlag:N}=F;A.length&&N&7&&(o&&A.some(ii)&&(G=ed(G,o)),F=kt(F,G,!1,!0))}if(n.dirs&&(F=kt(F,null,!1,!0),F.dirs=F.dirs?F.dirs.concat(n.dirs):n.dirs),n.transition){const A=li(F.type)&&Yn(F)||F;Ft(A,n.transition)}return Y=F,jn(W),Y}const Qu=e=>{let t;for(const n in e)(n==="class"||n==="style"||ni(n))&&((t||(t={}))[n]=e[n]);return t},ed=(e,t)=>{const n={};for(const i in e)(!ii(i)||!(i.slice(9)in t))&&(n[i]=e[i]);return n};function td(e,t,n){const{props:i,children:s,component:o}=e,{props:r,children:c,patchFlag:a}=t,l=o.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&a>=0){if(a&1024)return!0;if(a&16)return i?Ds(i,r,l):!!r;if(a&8){const p=t.dynamicProps;for(let _=0;_<p.length;_++){const h=p[_];if(ar(r,i,h)&&!di(l,h))return!0}}}else return(s||c)&&(!c||!c.$stable)?!0:i===r?!1:i?r?Ds(i,r,l):!0:!!r;return!1}function Ds(e,t,n){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let s=0;s<i.length;s++){const o=i[s];if(ar(t,e,o)&&!di(n,o))return!0}return!1}function ar(e,t,n){const i=e[n],s=t[n];return n==="style"&&ne(i)&&ne(s)?!ts(i,s):i!==s}function nd({vnode:e,parent:t,suspense:n},i){for(;t;){const s=t.subTree;if(s.suspense&&s.suspense.activeBranch===e&&(s.suspense.vnode.el=s.el=i,e=s),s===e)(e=t.vnode).el=i,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=i)}const lr={},pr=()=>Object.create(lr),ur=e=>Object.getPrototypeOf(e)===lr;function id(e,t,n,i=!1){const s={},o=pr();e.propsDefaults=Object.create(null),dr(e,t,s,o);for(const r in e.propsOptions[0])r in s||(s[r]=void 0);n?e.props=i?s:_u(s):e.type.props?e.props=s:e.props=o,e.attrs=o}function sd(e,t,n,i){const{props:s,attrs:o,vnode:{patchFlag:r}}=e,c=Z(s),[a]=e.propsOptions;let l=!1;if((i||r>0)&&!(r&16)){if(r&8){const p=e.vnode.dynamicProps;for(let _=0;_<p.length;_++){let h=p[_];if(di(e.emitsOptions,h))continue;const v=t[h];if(a)if(ee(o,h))v!==o[h]&&(o[h]=v,l=!0);else{const w=je(h);s[w]=Ui(a,c,w,v,e,!1)}else v!==o[h]&&(o[h]=v,l=!0)}}}else{dr(e,t,s,o)&&(l=!0);let p;for(const _ in c)(!t||!ee(t,_)&&((p=Ht(_))===_||!ee(t,p)))&&(a?n&&(n[_]!==void 0||n[p]!==void 0)&&(s[_]=Ui(a,c,_,void 0,e,!0)):delete s[_]);if(o!==c)for(const _ in o)(!t||!ee(t,_))&&(delete o[_],l=!0)}l&&pt(e.attrs,"set","")}function dr(e,t,n,i){const[s,o]=e.propsOptions;let r=!1,c;if(t)for(let a in t){if(pn(a))continue;const l=t[a];let p;s&&ee(s,p=je(a))?!o||!o.includes(p)?n[p]=l:(c||(c={}))[p]=l:di(e.emitsOptions,a)||(!(a in i)||l!==i[a])&&(i[a]=l,r=!0)}if(o){const a=Z(n),l=c||re;for(let p=0;p<o.length;p++){const _=o[p];n[_]=Ui(s,a,_,l[_],e,!ee(l,_))}}return r}function Ui(e,t,n,i,s,o){const r=e[n];if(r!=null){const c=ee(r,"default");if(c&&i===void 0){const a=r.default;if(r.type!==Function&&!r.skipFactory&&j(a)){const{propsDefaults:l}=s;if(n in l)i=l[n];else{const p=Rn(s);i=l[n]=a.call(null,t),p()}}else i=a;s.ce&&s.ce._setProp(n,i)}r[0]&&(o&&!c?i=!1:r[1]&&(i===""||i===Ht(n))&&(i=!0))}return i}const od=new WeakMap;function _r(e,t,n=!1){const i=n?od:t.propsCache,s=i.get(e);if(s)return s;const o=e.props,r={},c=[];let a=!1;if(!j(e)){const p=_=>{a=!0;const[h,v]=_r(_,t,!0);xe(r,h),v&&c.push(...v)};!n&&t.mixins.length&&t.mixins.forEach(p),e.extends&&p(e.extends),e.mixins&&e.mixins.forEach(p)}if(!o&&!a)return ne(e)&&i.set(e,Kt),Kt;if(H(o))for(let p=0;p<o.length;p++){const _=je(o[p]);Bs(_)&&(r[_]=re)}else if(o)for(const p in o){const _=je(p);if(Bs(_)){const h=o[p],v=r[_]=H(h)||j(h)?{type:h}:xe({},h),w=v.type;let I=!1,W=!0;if(H(w))for(let Y=0;Y<w.length;++Y){const G=w[Y],F=j(G)&&G.name;if(F==="Boolean"){I=!0;break}else F==="String"&&(W=!1)}else I=j(w)&&w.name==="Boolean";v[0]=I,v[1]=W,(I||ee(v,"default"))&&c.push(_)}}const l=[r,c];return ne(e)&&i.set(e,l),l}function Bs(e){return e[0]!=="$"&&!pn(e)}const fs=e=>e==="_"||e==="_ctx"||e==="$stable",gs=e=>H(e)?e.map(tt):[tt(e)],rd=(e,t,n)=>{if(t._n)return t;const i=ds((...s)=>gs(t(...s)),n);return i._c=!1,i},fr=(e,t,n)=>{const i=e._ctx;for(const s in e){if(fs(s))continue;const o=e[s];if(j(o))t[s]=rd(s,o,i);else if(o!=null){const r=gs(o);t[s]=()=>r}}},gr=(e,t)=>{const n=gs(t);e.slots.default=()=>n},mr=(e,t,n)=>{for(const i in t)(n||!fs(i))&&(e[i]=t[i])},cd=(e,t,n)=>{const i=e.slots=pr();if(e.vnode.shapeFlag&32){const s=t._;s?(mr(i,t,n),n&&To(i,"_",s,!0)):fr(t,i)}else t&&gr(e,t)},ad=(e,t,n)=>{const{vnode:i,slots:s}=e;let o=!0,r=re;if(i.shapeFlag&32){const c=t._;c?n&&c===1?o=!1:mr(s,t,n):(o=!t.$stable,fr(t,s)),r=t}else t&&(gr(e,t),r={default:1});if(o)for(const c in s)!fs(c)&&r[c]==null&&delete s[c]},Ie=_d;function ld(e){return pd(e)}function pd(e,t){const n=oi();n.__VUE__=!0;const{insert:i,remove:s,patchProp:o,createElement:r,createText:c,createComment:a,setText:l,setElementText:p,parentNode:_,nextSibling:h,setScopeId:v=it,insertStaticContent:w}=e,I=(u,d,m,L=null,T=null,k=null,R=void 0,P=null,O=!!d.dynamicChildren)=>{if(u===d)return;u&&!St(u,d)&&(L=Sn(u),qe(u,T,k,!0),u=null),d.patchFlag===-2&&(O=!1,d.dynamicChildren=null);const{type:y,ref:B,shapeFlag:C}=d;switch(y){case _i:W(u,d,m,L);break;case Ee:Y(u,d,m,L);break;case Bn:u==null&&G(d,m,L,R);break;case ke:f(u,d,m,L,T,k,R,P,O);break;default:C&1?N(u,d,m,L,T,k,R,P,O):C&6?x(u,d,m,L,T,k,R,P,O):(C&64||C&128)&&y.process(u,d,m,L,T,k,R,P,O,nn)}B!=null&&T?_n(B,u&&u.ref,k,d||u,!d):B==null&&u&&u.ref!=null&&_n(u.ref,null,k,u,!0)},W=(u,d,m,L)=>{if(u==null)i(d.el=c(d.children),m,L);else{const T=d.el=u.el;d.children!==u.children&&l(T,d.children)}},Y=(u,d,m,L)=>{u==null?i(d.el=a(d.children||""),m,L):d.el=u.el},G=(u,d,m,L)=>{[u.el,u.anchor]=w(u.children,d,m,L,u.el,u.anchor)},F=({el:u,anchor:d},m,L)=>{let T;for(;u&&u!==d;)T=h(u),i(u,m,L),u=T;i(d,m,L)},A=({el:u,anchor:d})=>{let m;for(;u&&u!==d;)m=h(u),s(u),u=m;s(d)},N=(u,d,m,L,T,k,R,P,O)=>{if(d.type==="svg"?R="svg":d.type==="math"&&(R="mathml"),u==null)K(d,m,L,T,k,R,P,O);else{const y=u.el&&u.el._isVueCE?u.el:null;try{y&&y._beginPatch(),V(u,d,T,k,R,P,O)}finally{y&&y._endPatch()}}},K=(u,d,m,L,T,k,R,P)=>{let O,y;const{props:B,shapeFlag:C,transition:D,dirs:U}=u;if(O=u.el=r(u.type,k,B&&B.is,B),C&8?p(O,u.children):C&16&&pe(u.children,O,null,L,T,wi(u,k),R,P),U&&wt(u,null,L,"created"),me(O,u,u.scopeId,R,L),B){for(const oe in B)oe!=="value"&&!pn(oe)&&o(O,oe,null,B[oe],k,L);"value"in B&&o(O,"value",null,B.value,k),(y=B.onVnodeBeforeMount)&&Je(y,L,u)}U&&wt(u,null,L,"beforeMount");const J=ud(T,D);J&&D.beforeEnter(O),i(O,d,m),((y=B&&B.onVnodeMounted)||J||U)&&Ie(()=>{try{y&&Je(y,L,u),J&&D.enter(O),U&&wt(u,null,L,"mounted")}finally{}},T)},me=(u,d,m,L,T)=>{if(m&&v(u,m),L)for(let k=0;k<L.length;k++)v(u,L[k]);if(T){let k=T.subTree;if(d===k||kr(k.type)&&(k.ssContent===d||k.ssFallback===d)){const R=T.vnode;me(u,R,R.scopeId,R.slotScopeIds,T.parent)}}},pe=(u,d,m,L,T,k,R,P,O=0)=>{for(let y=O;y<u.length;y++){const B=u[y]=P?lt(u[y]):tt(u[y]);I(null,B,d,m,L,T,k,R,P)}},V=(u,d,m,L,T,k,R)=>{const P=d.el=u.el;let{patchFlag:O,dynamicChildren:y,dirs:B}=d;O|=u.patchFlag&16;const C=u.props||re,D=d.props||re;let U;if(m&&Ot(m,!1),(U=D.onVnodeBeforeUpdate)&&Je(U,m,d,u),B&&wt(d,u,m,"beforeUpdate"),m&&Ot(m,!0),y&&(!u.dynamicChildren||u.dynamicChildren.length!==y.length)&&(O=0,R=!1,y=null),(C.innerHTML&&D.innerHTML==null||C.textContent&&D.textContent==null)&&p(P,""),y?X(u.dynamicChildren,y,P,m,L,wi(d,T),k):R||ce(u,d,P,null,m,L,wi(d,T),k,!1),O>0){if(O&16)$(P,C,D,m,T);else if(O&2&&C.class!==D.class&&o(P,"class",null,D.class,T),O&4&&o(P,"style",C.style,D.style,T),O&8){const J=d.dynamicProps;for(let oe=0;oe<J.length;oe++){const ie=J[oe],ve=C[ie],Le=D[ie];(Le!==ve||ie==="value")&&o(P,ie,ve,Le,T,m)}}O&1&&u.children!==d.children&&p(P,d.children)}else!R&&y==null&&$(P,C,D,m,T);((U=D.onVnodeUpdated)||B)&&Ie(()=>{U&&Je(U,m,d,u),B&&wt(d,u,m,"updated")},L)},X=(u,d,m,L,T,k,R)=>{for(let P=0;P<d.length;P++){const O=u[P],y=d[P],B=O.el&&(O.type===ke||!St(O,y)||O.shapeFlag&198)?_(O.el):m;I(O,y,B,null,L,T,k,R,!0)}},$=(u,d,m,L,T)=>{if(d!==m){if(d!==re)for(const k in d)!pn(k)&&!(k in m)&&o(u,k,d[k],null,T,L);for(const k in m){if(pn(k))continue;const R=m[k],P=d[k];R!==P&&k!=="value"&&o(u,k,P,R,T,L)}"value"in m&&o(u,"value",d.value,m.value,T)}},f=(u,d,m,L,T,k,R,P,O)=>{const y=d.el=u?u.el:c(""),B=d.anchor=u?u.anchor:c("");let{patchFlag:C,dynamicChildren:D,slotScopeIds:U}=d;U&&(P=P?P.concat(U):U),u==null?(i(y,m,L),i(B,m,L),pe(d.children||[],m,B,T,k,R,P,O)):C>0&&C&64&&D&&u.dynamicChildren&&u.dynamicChildren.length===D.length?(X(u.dynamicChildren,D,m,T,k,R,P),(d.key!=null||T&&d===T.subTree)&&vr(u,d,!0)):ce(u,d,m,B,T,k,R,P,O)},x=(u,d,m,L,T,k,R,P,O)=>{d.slotScopeIds=P,u==null?d.shapeFlag&512?T.ctx.activate(d,m,L,R,O):z(d,m,L,T,k,R,O):q(u,d,O)},z=(u,d,m,L,T,k,R)=>{const P=u.component=xd(u,L,T);if(pi(u)&&(P.ctx.renderer=nn),kd(P,!1,R),P.asyncDep){if(T&&T.registerDep(P,le,R),!u.el){const O=P.subTree=Te(Ee);Y(null,O,d,m),u.placeholder=O.el}}else le(P,u,d,m,T,k,R)},q=(u,d,m)=>{const L=d.component=u.component;if(td(u,d,m))if(L.asyncDep&&!L.asyncResolved){ue(L,d,m);return}else L.next=d,L.update();else d.el=u.el,L.vnode=d},le=(u,d,m,L,T,k,R)=>{const P=()=>{if(u.isMounted){let{next:C,bu:D,u:U,parent:J,vnode:oe}=u;{const ze=hr(u);if(ze){C&&(C.el=oe.el,ue(u,C,R)),ze.asyncDep.then(()=>{Ie(()=>{u.isUnmounted||y()},T)});return}}let ie=C,ve;Ot(u,!1),C?(C.el=oe.el,ue(u,C,R)):C=oe,D&&Fn(D),(ve=C.props&&C.props.onVnodeBeforeUpdate)&&Je(ve,J,C,oe),Ot(u,!0);const Le=Fs(u),We=u.subTree;u.subTree=Le,I(We,Le,_(We.el),Sn(We),u,T,k),C.el=Le.el,ie===null&&nd(u,Le.el),U&&Ie(U,T),(ve=C.props&&C.props.onVnodeUpdated)&&Ie(()=>Je(ve,J,C,oe),T)}else{let C;const{el:D,props:U}=d,{bm:J,m:oe,parent:ie,root:ve,type:Le}=u,We=fn(d);Ot(u,!1),J&&Fn(J),!We&&(C=U&&U.onVnodeBeforeMount)&&Je(C,ie,d),Ot(u,!0);{ve.ce&&ve.ce._hasShadowRoot()&&ve.ce._injectChildStyle(Le,u.parent?u.parent.type:void 0);const ze=u.subTree=Fs(u);I(null,ze,m,L,u,T,k),d.el=ze.el}if(oe&&Ie(oe,T),!We&&(C=U&&U.onVnodeMounted)){const ze=d;Ie(()=>Je(C,ie,ze),T)}(d.shapeFlag&256||ie&&fn(ie.vnode)&&ie.vnode.shapeFlag&256)&&u.a&&Ie(u.a,T),u.isMounted=!0,d=m=L=null}};u.scope.on();const O=u.effect=new wo(P);u.scope.off();const y=u.update=O.run.bind(O),B=u.job=O.runIfDirty.bind(O);B.i=u,B.id=u.uid,O.scheduler=()=>us(B),Ot(u,!0),y()},ue=(u,d,m)=>{d.component=u;const L=u.vnode.props;u.vnode=d,u.next=null,sd(u,d.props,L,m),ad(u,d.children,m),dt(),Es(u),_t()},ce=(u,d,m,L,T,k,R,P,O=!1)=>{const y=u&&u.children,B=u?u.shapeFlag:0,C=d.children,{patchFlag:D,shapeFlag:U}=d;if(D>0){if(D&128){En(y,C,m,L,T,k,R,P,O);return}else if(D&256){bt(y,C,m,L,T,k,R,P,O);return}}U&8?(B&16&&tn(y,T,k),C!==y&&p(m,C)):B&16?U&16?En(y,C,m,L,T,k,R,P,O):tn(y,T,k,!0):(B&8&&p(m,""),U&16&&pe(C,m,L,T,k,R,P,O))},bt=(u,d,m,L,T,k,R,P,O)=>{u=u||Kt,d=d||Kt;const y=u.length,B=d.length,C=Math.min(y,B);let D;for(D=0;D<C;D++){const U=d[D]=O?lt(d[D]):tt(d[D]);I(u[D],U,m,null,T,k,R,P,O)}y>B?tn(u,T,k,!0,!1,C):pe(d,m,L,T,k,R,P,O,C)},En=(u,d,m,L,T,k,R,P,O)=>{let y=0;const B=d.length;let C=u.length-1,D=B-1;for(;y<=C&&y<=D;){const U=u[y],J=d[y]=O?lt(d[y]):tt(d[y]);if(St(U,J))I(U,J,m,null,T,k,R,P,O);else break;y++}for(;y<=C&&y<=D;){const U=u[C],J=d[D]=O?lt(d[D]):tt(d[D]);if(St(U,J))I(U,J,m,null,T,k,R,P,O);else break;C--,D--}if(y>C){if(y<=D){const U=D+1,J=U<B?d[U].el:L;for(;y<=D;)I(null,d[y]=O?lt(d[y]):tt(d[y]),m,J,T,k,R,P,O),y++}}else if(y>D)for(;y<=C;)qe(u[y],T,k,!0),y++;else{const U=y,J=y,oe=new Map;for(y=J;y<=D;y++){const Ce=d[y]=O?lt(d[y]):tt(d[y]);Ce.key!=null&&oe.set(Ce.key,y)}let ie,ve=0;const Le=D-J+1;let We=!1,ze=0;const sn=new Array(Le);for(y=0;y<Le;y++)sn[y]=0;for(y=U;y<=C;y++){const Ce=u[y];if(ve>=Le){qe(Ce,T,k,!0);continue}let Xe;if(Ce.key!=null)Xe=oe.get(Ce.key);else for(ie=J;ie<=D;ie++)if(sn[ie-J]===0&&St(Ce,d[ie])){Xe=ie;break}Xe===void 0?qe(Ce,T,k,!0):(sn[Xe-J]=y+1,Xe>=ze?ze=Xe:We=!0,I(Ce,d[Xe],m,null,T,k,R,P,O),ve++)}const Ls=We?dd(sn):Kt;for(ie=Ls.length-1,y=Le-1;y>=0;y--){const Ce=J+y,Xe=d[Ce],bs=d[Ce+1],As=Ce+1<B?bs.el||xr(bs):L;sn[y]===0?I(null,Xe,m,As,T,k,R,P,O):We&&(ie<0||y!==Ls[ie]?At(Xe,m,As,2):ie--)}}},At=(u,d,m,L,T=null)=>{const{el:k,type:R,transition:P,children:O,shapeFlag:y}=u;if(y&6){At(u.component.subTree,d,m,L);return}if(y&128){u.suspense.move(d,m,L);return}if(y&64){R.move(u,d,m,nn);return}if(R===ke){i(k,d,m);for(let C=0;C<O.length;C++)At(O[C],d,m,L);i(u.anchor,d,m);return}if(R===Bn){F(u,d,m);return}if(L!==2&&y&1&&P)if(L===0)P.persisted&&!k[Fe]?i(k,d,m):(P.beforeEnter(k),i(k,d,m),Ie(()=>P.enter(k),T));else{const{leave:C,delayLeave:D,afterLeave:U}=P,J=()=>{u.ctx.isUnmounted?s(k):i(k,d,m)},oe=()=>{const ie=k._isLeaving||!!k[Fe];k._isLeaving&&k[Fe](!0),P.persisted&&!ie?J():C(k,()=>{J(),U&&U()})};D?D(k,J,oe):oe()}else i(k,d,m)},qe=(u,d,m,L=!1,T=!1)=>{const{type:k,props:R,ref:P,children:O,dynamicChildren:y,shapeFlag:B,patchFlag:C,dirs:D,cacheIndex:U,memo:J}=u;if(C===-2&&(T=!1),P!=null&&(dt(),_n(P,null,m,u,!0),_t()),U!=null&&(d.renderCache[U]=void 0),B&256){d.ctx.deactivate(u);return}const oe=B&1&&D,ie=!fn(u);let ve;if(ie&&(ve=R&&R.onVnodeBeforeUnmount)&&Je(ve,d,u),B&6)Cp(u.component,m,L);else{if(B&128){u.suspense.unmount(m,L);return}oe&&wt(u,null,d,"beforeUnmount"),B&64?u.type.remove(u,d,m,nn,L):y&&!y.hasOnce&&(k!==ke||C>0&&C&64)?tn(y,d,m,!1,!0):(k===ke&&C&384||!T&&B&16)&&tn(O,d,m),L&&ys(u)}const Le=J!=null&&U==null;(ie&&(ve=R&&R.onVnodeUnmounted)||oe||Le)&&Ie(()=>{ve&&Je(ve,d,u),oe&&wt(u,null,d,"unmounted"),Le&&(u.el=null)},m)},ys=u=>{const{type:d,el:m,anchor:L,transition:T}=u;if(d===ke){Ip(m,L);return}if(d===Bn){A(u);return}const k=()=>{s(m),T&&!T.persisted&&T.afterLeave&&T.afterLeave()};if(u.shapeFlag&1&&T&&!T.persisted){const{leave:R,delayLeave:P}=T,O=()=>R(m,k);P?P(u.el,k,O):O()}else k()},Ip=(u,d)=>{let m;for(;u!==d;)m=h(u),s(u),u=m;s(d)},Cp=(u,d,m)=>{const{bum:L,scope:T,job:k,subTree:R,um:P,m:O,a:y}=u;Hs(O),Hs(y),L&&Fn(L),T.stop(),k&&(k.flags|=8,qe(R,u,d,m)),P&&Ie(P,d),Ie(()=>{u.isUnmounted=!0},d)},tn=(u,d,m,L=!1,T=!1,k=0)=>{for(let R=k;R<u.length;R++)qe(u[R],d,m,L,T)},Sn=u=>{if(u.shapeFlag&6)return Sn(u.component.subTree);if(u.shapeFlag&128)return u.suspense.next();const d=h(u.anchor||u.el),m=d&&d[Ru];return m?h(m):d};let hi=!1;const Ts=(u,d,m)=>{let L;u==null?d._vnode&&(qe(d._vnode,null,null,!0),L=d._vnode.component):I(d._vnode||null,u,d,null,null,null,m),d._vnode=u,hi||(hi=!0,Es(L),jo(),hi=!1)},nn={p:I,um:qe,m:At,r:ys,mt:z,mc:pe,pc:ce,pbc:X,n:Sn,o:e};return{render:Ts,hydrate:void 0,createApp:zu(Ts)}}function wi({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function Ot({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function ud(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function vr(e,t,n=!1){const i=e.children,s=t.children;if(H(i)&&H(s))for(let o=0;o<i.length;o++){const r=i[o];let c=s[o];c.shapeFlag&1&&!c.dynamicChildren&&((c.patchFlag<=0||c.patchFlag===32)&&(c=s[o]=lt(s[o]),c.el=r.el),!n&&c.patchFlag!==-2&&vr(r,c)),c.type===_i&&(c.patchFlag===-1&&(c=s[o]=lt(c)),c.el=r.el),c.type===Ee&&!c.el&&(c.el=r.el)}}function dd(e){const t=e.slice(),n=[0];let i,s,o,r,c;const a=e.length;for(i=0;i<a;i++){const l=e[i];if(l!==0){if(s=n[n.length-1],e[s]<l){t[i]=s,n.push(i);continue}for(o=0,r=n.length-1;o<r;)c=o+r>>1,e[n[c]]<l?o=c+1:r=c;l<e[n[o]]&&(o>0&&(t[i]=n[o-1]),n[o]=i)}}for(o=n.length,r=n[o-1];o-- >0;)n[o]=r,r=t[r];return n}function hr(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:hr(t)}function Hs(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function xr(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?xr(t.subTree):null}const kr=e=>e.__isSuspense;function _d(e,t){t&&t.pendingBranch?H(e)?t.effects.push(...e):t.effects.push(e):Lu(e)}const ke=Symbol.for("v-fgt"),_i=Symbol.for("v-txt"),Ee=Symbol.for("v-cmt"),Bn=Symbol.for("v-stc"),Nt=[];let Me=null;function E(e=!1){Nt.push(Me=e?null:[])}function yr(){Nt.pop(),Me=Nt[Nt.length-1]||null}let Tn=1;function Wn(e,t=!1){Tn+=e,e<0&&Me&&t&&(Me.hasOnce=!0)}function Tr(e){return e.dynamicChildren=Tn>0?Me||Kt:null,yr(),Tn>0&&Me&&Me.push(e),e}function M(e,t,n,i,s,o){return Tr(g(e,t,n,i,s,o,!0))}function Ve(e,t,n,i,s){return Tr(Te(e,t,n,i,s,!0))}function zn(e){return e?e.__v_isVNode===!0:!1}function St(e,t){return e.type===t.type&&e.key===t.key}const Lr=({key:e})=>e??null,Hn=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?de(e)||Oe(e)||j(e)?{i:De,r:e,k:t,f:!!n}:e:null);function g(e,t=null,n=null,i=0,s=null,o=e===ke?0:1,r=!1,c=!1){const a={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Lr(t),ref:t&&Hn(t),scopeId:Ko,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:s,dynamicChildren:null,appContext:null,ctx:De};return c?(Xn(a,n),o&128&&e.normalize(a)):n&&(a.shapeFlag|=de(n)?8:16),Tn>0&&!r&&Me&&(a.patchFlag>0||o&6)&&a.patchFlag!==32&&Me.push(a),a}const Te=fd;function fd(e,t=null,n=null,i=0,s=null,o=!1){if((!e||e===Gu)&&(e=Ee),zn(e)){const c=kt(e,t,!0);return n&&Xn(c,n),Tn>0&&!o&&Me&&(c.shapeFlag&6?Me[Me.indexOf(e)]=c:Me.push(c)),c.patchFlag=-2,c}if(bd(e)&&(e=e.__vccOpts),t){t=gd(t);let{class:c,style:a}=t;c&&!de(c)&&(t.class=fe(c)),ne(a)&&(ls(a)&&!H(a)&&(a=xe({},a)),t.style=He(a))}const r=de(e)?1:kr(e)?128:li(e)?64:ne(e)?4:j(e)?2:0;return g(e,t,n,i,s,r,o,!0)}function gd(e){return e?ls(e)||ur(e)?xe({},e):e:null}function kt(e,t,n=!1,i=!1){const{props:s,ref:o,patchFlag:r,children:c,transition:a}=e,l=t?md(s||{},t):s,p={__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Lr(l),ref:t&&t.ref?n&&o?H(o)?o.concat(Hn(t)):[o,Hn(t)]:Hn(t):o,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:c,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==ke?r===-1?16:r|16:r,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:a,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&kt(e.ssContent),ssFallback:e.ssFallback&&kt(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return a&&i&&Ft(p,a.clone(p)),p}function It(e=" ",t=0){return Te(_i,null,e,t)}function Oi(e,t){const n=Te(Bn,null,e);return n.staticCount=t,n}function se(e="",t=!1){return t?(E(),Ve(Ee,null,e)):Te(Ee,null,e)}function tt(e){return e==null||typeof e=="boolean"?Te(Ee):H(e)?Te(ke,null,e.slice()):zn(e)?lt(e):Te(_i,null,String(e))}function lt(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:kt(e)}function Xn(e,t){let n=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(H(t))n=16;else if(typeof t=="object")if(i&65){const s=t.default;s&&(s._c&&(s._d=!1),Xn(e,s()),s._c&&(s._d=!0));return}else{n=32;const s=t._;!s&&!ur(t)?t._ctx=De:s===3&&De&&(De.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else if(j(t)){if(i&65){Xn(e,{default:t});return}t={default:t,_ctx:De},n=32}else t=String(t),i&64?(n=16,t=[It(t)]):n=8;e.children=t,e.shapeFlag|=n}function md(...e){const t={};for(let n=0;n<e.length;n++){const i=e[n];for(const s in i)if(s==="class")t.class!==i.class&&(t.class=fe([t.class,i.class]));else if(s==="style")t.style=He([t.style,i.style]);else if(ni(s)){const o=t[s],r=i[s];r&&o!==r&&!(H(o)&&o.includes(r))?t[s]=o?[].concat(o,r):r:r==null&&o==null&&!ii(s)&&(t[s]=r)}else s!==""&&(t[s]=i[s])}return t}function Je(e,t,n,i=null){Ge(e,t,7,[n,i])}const vd=rr();let hd=0;function xd(e,t,n){const i=e.type,s=(t?t.appContext:e.appContext)||vd,o={uid:hd++,vnode:e,type:i,parent:t,appContext:s,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Wp(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(s.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:_r(i,s),emitsOptions:cr(i,s),emit:null,emitted:null,propsDefaults:re,inheritAttrs:i.inheritAttrs,ctx:re,data:re,props:re,attrs:re,slots:re,refs:re,setupState:re,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=Ju.bind(null,o),e.ce&&e.ce(o),o}let Se=null;const ms=()=>Se||De;let Jn,Ln;{const e=oi(),t=(n,i)=>{let s;return(s=e[n])||(s=e[n]=[]),s.push(i),o=>{s.length>1?s.forEach(r=>r(o)):s[0](o)}};Jn=t("__VUE_INSTANCE_SETTERS__",n=>Se=n),Ln=t("__VUE_SSR_SETTERS__",n=>bn=n)}const Rn=e=>{const t=Se;return Jn(e),e.scope.on(),()=>{e.scope.off(),Jn(t)}},Gs=()=>{Se&&Se.scope.off(),Jn(null)};function br(e){return e.vnode.shapeFlag&4}let bn=!1;function kd(e,t=!1,n=!1){t&&Ln(t);const{props:i,children:s}=e.vnode,o=br(e);id(e,i,o,t),cd(e,s,n||t);const r=o?yd(e,t):void 0;return t&&Ln(!1),r}function yd(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,Vu);const{setup:i}=n;if(i){dt();const s=e.setupContext=i.length>1?Ld(e):null,o=Rn(e),r=Pn(i,e,0,[e.props,s]),c=ho(r);if(_t(),o(),(c||e.sp)&&!fn(e)&&er(e),c){if(r.then(Gs,Gs),t)return r.then(a=>{Ln(!0);try{Vs(e,a,t)}finally{Ln(!1)}}).catch(a=>{ai(a,e,0)});e.asyncDep=r}else Vs(e,r)}else Ar(e)}function Vs(e,t,n){j(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:ne(t)&&(e.setupState=Go(t)),Ar(e)}function Ar(e,t,n){const i=e.type;e.render||(e.render=i.render||it);{const s=Rn(e);dt();try{Uu(e)}finally{_t(),s()}}}const Td={get(e,t){return Ae(e,"get",""),e[t]}};function Ld(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,Td),slots:e.slots,emit:e.emit,expose:t}}function fi(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(Go(fu(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in gn)return gn[n](e)},has(t,n){return n in t||n in gn}})):e.proxy}function bd(e){return j(e)&&"__vccOpts"in e}const te=(e,t)=>hu(e,t,bn);function Ad(e,t,n){try{Wn(-1);const i=arguments.length;return i===2?ne(t)&&!H(t)?zn(t)?Te(e,null,[t]):Te(e,t):Te(e,null,t):(i>3?n=Array.prototype.slice.call(arguments,2):i===3&&zn(n)&&(n=[n]),Te(e,t,n))}finally{Wn(1)}}const wd="3.5.41";/**
* @vue/runtime-dom v3.5.41
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ji;const Us=typeof window<"u"&&window.trustedTypes;if(Us)try{ji=Us.createPolicy("vue",{createHTML:e=>e})}catch{}const wr=ji?e=>ji.createHTML(e):e=>e,Od="http://www.w3.org/2000/svg",Pd="http://www.w3.org/1998/Math/MathML",at=typeof document<"u"?document:null,js=at&&at.createElement("template"),Rd={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,i)=>{const s=t==="svg"?at.createElementNS(Od,e):t==="mathml"?at.createElementNS(Pd,e):n?at.createElement(e,{is:n}):at.createElement(e);return e==="select"&&i&&i.multiple!=null&&s.setAttribute("multiple",i.multiple),s},createText:e=>at.createTextNode(e),createComment:e=>at.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>at.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,i,s,o){const r=n?n.previousSibling:t.lastChild;if(s&&(s===o||s.nextSibling))for(;t.insertBefore(s.cloneNode(!0),n),!(s===o||!(s=s.nextSibling)););else{js.innerHTML=wr(i==="svg"?`<svg>${e}</svg>`:i==="mathml"?`<math>${e}</math>`:e);const c=js.content;if(i==="svg"||i==="mathml"){const a=c.firstChild;for(;a.firstChild;)c.appendChild(a.firstChild);c.removeChild(a)}t.insertBefore(c,n)}return[r?r.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},vt="transition",cn="animation",Zt=Symbol("_vtc"),Or={name:String,type:String,css:{type:Boolean,default:!0},duration:[String,Number,Object],enterFromClass:String,enterActiveClass:String,enterToClass:String,appearFromClass:String,appearActiveClass:String,appearToClass:String,leaveFromClass:String,leaveActiveClass:String,leaveToClass:String},Pr=xe({},Xo,Or),Ed=e=>(e.displayName="Transition",e.props=Pr,e),Sd=Ed((e,{slots:t})=>Ad(Su,Rr(e),t)),Pt=(e,t=[])=>{H(e)?e.forEach(n=>n(...t)):e&&e(...t)},Ys=e=>e?H(e)?e.some(t=>t.length>1):e.length>1:!1;function Rr(e){const t={};for(const f in e)f in Or||(t[f]=e[f]);if(e.css===!1)return t;const{name:n="v",type:i,duration:s,enterFromClass:o=`${n}-enter-from`,enterActiveClass:r=`${n}-enter-active`,enterToClass:c=`${n}-enter-to`,appearFromClass:a=o,appearActiveClass:l=r,appearToClass:p=c,leaveFromClass:_=`${n}-leave-from`,leaveActiveClass:h=`${n}-leave-active`,leaveToClass:v=`${n}-leave-to`}=e,w=Id(s),I=w&&w[0],W=w&&w[1],{onBeforeEnter:Y,onEnter:G,onEnterCancelled:F,onLeave:A,onLeaveCancelled:N,onBeforeAppear:K=Y,onAppear:me=G,onAppearCancelled:pe=F}=t,V=(f,x,z,q)=>{f._enterCancelled=q,ht(f,x?p:c),ht(f,x?l:r),z&&z()},X=(f,x)=>{f._isLeaving=!1,ht(f,_),ht(f,v),ht(f,h),x&&x()},$=f=>(x,z)=>{const q=f?me:G,le=()=>V(x,f,z);Pt(q,[x,le]),Ks(()=>{ht(x,f?a:o),Ze(x,f?p:c),Ys(q)||qs(x,i,I,le)})};return xe(t,{onBeforeEnter(f){Pt(Y,[f]),Ze(f,o),Ze(f,r)},onBeforeAppear(f){Pt(K,[f]),Ze(f,a),Ze(f,l)},onEnter:$(!1),onAppear:$(!0),onLeave(f,x){f._isLeaving=!0;const z=()=>X(f,x);Ze(f,_),f._enterCancelled?(Ze(f,h),Yi(f)):(Yi(f),Ze(f,h)),Ks(()=>{f._isLeaving&&(ht(f,_),Ze(f,v),Ys(A)||qs(f,i,W,z))}),Pt(A,[f,z])},onEnterCancelled(f){V(f,!1,void 0,!0),Pt(F,[f])},onAppearCancelled(f){V(f,!0,void 0,!0),Pt(pe,[f])},onLeaveCancelled(f){X(f),Pt(N,[f])}})}function Id(e){if(e==null)return null;if(ne(e))return[Pi(e.enter),Pi(e.leave)];{const t=Pi(e);return[t,t]}}function Pi(e){return Hp(e)}function Ze(e,t){t.split(/\s+/).forEach(n=>n&&e.classList.add(n)),(e[Zt]||(e[Zt]=new Set)).add(t)}function ht(e,t){t.split(/\s+/).forEach(i=>i&&e.classList.remove(i));const n=e[Zt];n&&(n.delete(t),n.size||(e[Zt]=void 0))}function Ks(e){requestAnimationFrame(()=>{requestAnimationFrame(e)})}let Cd=0;function qs(e,t,n,i){const s=e._endId=++Cd,o=()=>{s===e._endId&&i()};if(n!=null)return setTimeout(o,n);const{type:r,timeout:c,propCount:a}=Er(e,t);if(!r)return i();const l=r+"end";let p=0;const _=()=>{e.removeEventListener(l,h),o()},h=v=>{v.target===e&&++p>=a&&_()};setTimeout(()=>{p<a&&_()},c+1),e.addEventListener(l,h)}function Er(e,t){const n=window.getComputedStyle(e),i=w=>(n[w]||"").split(", "),s=i(`${vt}Delay`),o=i(`${vt}Duration`),r=Ws(s,o),c=i(`${cn}Delay`),a=i(`${cn}Duration`),l=Ws(c,a);let p=null,_=0,h=0;t===vt?r>0&&(p=vt,_=r,h=o.length):t===cn?l>0&&(p=cn,_=l,h=a.length):(_=Math.max(r,l),p=_>0?r>l?vt:cn:null,h=p?p===vt?o.length:a.length:0);const v=p===vt&&/\b(?:transform|all)(?:,|$)/.test(i(`${vt}Property`).toString());return{type:p,timeout:_,propCount:h,hasTransform:v}}function Ws(e,t){for(;e.length<t.length;)e=e.concat(e);return Math.max(...t.map((n,i)=>zs(n)+zs(e[i])))}function zs(e){return e==="auto"?0:Number(e.slice(0,-1).replace(",","."))*1e3}function Yi(e){return(e?e.ownerDocument:document).body.offsetHeight}function $d(e,t,n){const i=e[Zt];i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const Xs=Symbol("_vod"),Sr=Symbol("_vsh"),Md=Symbol(""),Nd=/(?:^|;)\s*display\s*:/;function Fd(e,t,n){const i=e.style,s=de(n);let o=!1;if(n&&!s){if(t)if(de(t))for(const r of t.split(";")){const c=r.slice(0,r.indexOf(":")).trim();n[c]==null&&ln(i,c,"")}else for(const r in t)n[r]==null&&ln(i,r,"");for(const r in n){r==="display"&&(o=!0);const c=n[r];c!=null?Bd(e,r,!de(t)&&t?t[r]:void 0,c)||ln(i,r,c):ln(i,r,"")}}else if(s){if(t!==n){const r=i[Md];r&&(n+=";"+r),i.cssText=n,o=Nd.test(n)}}else t&&e.removeAttribute("style");Xs in e&&(e[Xs]=o?i.display:"",e[Sr]&&(i.display="none"))}const Js=/\s*!important$/;function ln(e,t,n){if(H(n))n.forEach(i=>ln(e,t,i));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const i=Dd(e,t);Js.test(n)?e.setProperty(Ht(i),n.replace(Js,""),"important"):e[i]=n}}const Zs=["Webkit","Moz","ms"],Ri={};function Dd(e,t){const n=Ri[t];if(n)return n;let i=je(t);if(i!=="filter"&&i in e)return Ri[t]=i;i=yo(i);for(let s=0;s<Zs.length;s++){const o=Zs[s]+i;if(o in e)return Ri[t]=o}return t}function Bd(e,t,n,i){return e.tagName==="TEXTAREA"&&(t==="width"||t==="height")&&de(i)&&n===i}const Qs="http://www.w3.org/1999/xlink";function eo(e,t,n,i,s,o=Kp(t)){i&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(Qs,t.slice(6,t.length)):e.setAttributeNS(Qs,t,n):n==null||o&&!Lo(n)?e.removeAttribute(t):e.setAttribute(t,o?"":st(n)?String(n):n)}function to(e,t,n,i,s){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?wr(n):n);return}const o=e.tagName;if(t==="value"&&o!=="PROGRESS"&&!o.includes("-")){const c=o==="OPTION"?e.getAttribute("value")||"":e.value,a=n==null?e.type==="checkbox"?"on":"":String(n);(c!==a||!("_value"in e))&&(e.value=a),n==null&&e.removeAttribute(t),e._value=n;return}let r=!1;if(n===""||n==null){const c=typeof e[t];c==="boolean"?n=Lo(n):n==null&&c==="string"?(n="",r=!0):c==="number"&&(n=0,r=!0)}try{e[t]=n}catch{}r&&e.removeAttribute(s||t)}function jt(e,t,n,i){e.addEventListener(t,n,i)}function Hd(e,t,n,i){e.removeEventListener(t,n,i)}const no=Symbol("_vei");function Gd(e,t,n,i,s=null){const o=e[no]||(e[no]={}),r=o[t];if(i&&r)r.value=i;else{const[c,a]=jd(t);if(i){const l=o[t]=qd(i,s);jt(e,c,l,a)}else r&&(Hd(e,c,r,a),o[t]=void 0)}}const Vd=/(Once|Passive|Capture)$/,Ud=/^on:?(?:Once|Passive|Capture)$/;function jd(e){let t,n;for(;(n=e.match(Vd))&&!Ud.test(e);)t||(t={}),e=e.slice(0,e.length-n[1].length),t[n[1].toLowerCase()]=!0;return[e[2]===":"?e.slice(3):Ht(e.slice(2)),t]}let Ei=0;const Yd=Promise.resolve(),Kd=()=>Ei||(Yd.then(()=>Ei=0),Ei=Date.now());function qd(e,t){const n=i=>{if(!i._vts)i._vts=Date.now();else if(i._vts<=n.attached)return;const s=n.value;if(H(s)){const o=i.stopImmediatePropagation;i.stopImmediatePropagation=()=>{o.call(i),i._stopped=!0};const r=s.slice(),c=[i];for(let a=0;a<r.length&&!i._stopped;a++){const l=r[a];l&&Ge(l,t,5,c)}}else Ge(s,t,5,[i])};return n.value=e,n.attached=Kd(),n}const io=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,Wd=(e,t,n,i,s,o)=>{const r=s==="svg";t==="class"?$d(e,i,r):t==="style"?Fd(e,n,i):ni(t)?ii(t)||Gd(e,t,n,i,o):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):zd(e,t,i,r))?(to(e,t,i),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&eo(e,t,i,r,o,t!=="value")):e._isVueCE&&(Xd(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!de(i)))?to(e,je(t),i,o,t):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),eo(e,t,i,r))};function zd(e,t,n,i){if(i)return!!(t==="innerHTML"||t==="textContent"||t in e&&io(t)&&j(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const s=e.tagName;if(s==="IMG"||s==="VIDEO"||s==="CANVAS"||s==="SOURCE")return!1}return io(t)&&de(n)?!1:t in e}function Xd(e,t){const n=e._def.props;if(!n)return!1;const i=je(t);return Array.isArray(n)?n.some(s=>je(s)===i):Object.keys(n).some(s=>je(s)===i)}const Ir=new WeakMap,Cr=new WeakMap,Zn=Symbol("_moveCb"),so=Symbol("_enterCb"),Jd=e=>(delete e.props.mode,e),Zd=Jd({name:"TransitionGroup",props:xe({},Pr,{tag:String,moveClass:String}),setup(e,{slots:t}){const n=ms(),i=zo();let s,o;return nr(()=>{if(!s.length)return;const r=e.moveClass||`${e.name||"v"}-move`;if(!i_(s[0].el,n.vnode.el,r)){s=[];return}s.forEach(e_),s.forEach(t_);const c=s.filter(n_);Yi(n.vnode.el),c.forEach(a=>{const l=a.el,p=l.style;Ze(l,r),p.transform=p.webkitTransform=p.transitionDuration="";const _=l[Zn]=h=>{h&&h.target!==l||(!h||h.propertyName.endsWith("transform"))&&(l.removeEventListener("transitionend",_),l[Zn]=null,ht(l,r))};l.addEventListener("transitionend",_)}),s=[]}),()=>{const r=Z(e),c=Rr(r);let a=r.tag||ke;if(s=[],o)for(let l=0;l<o.length;l++){const p=o[l];p.el&&p.el instanceof Element&&!p.el[Sr]&&(s.push(p),Ft(p,yn(p,c,i,n)),Ir.set(p,$r(p.el)))}o=t.default?_s(t.default()):[];for(let l=0;l<o.length;l++){const p=o[l];p.key!=null&&Ft(p,yn(p,c,i,n))}return Te(a,null,o)}}}),Qd=Zd;function e_(e){const t=e.el;t[Zn]&&t[Zn](),t[so]&&t[so]()}function t_(e){Cr.set(e,$r(e.el))}function n_(e){const t=Ir.get(e),n=Cr.get(e),i=t.left-n.left,s=t.top-n.top;if(i||s){const o=e.el,r=o.style,c=o.getBoundingClientRect();let a=1,l=1;return o.offsetWidth&&(a=c.width/o.offsetWidth),o.offsetHeight&&(l=c.height/o.offsetHeight),(!Number.isFinite(a)||a===0)&&(a=1),(!Number.isFinite(l)||l===0)&&(l=1),Math.abs(a-1)<.01&&(a=1),Math.abs(l-1)<.01&&(l=1),r.transform=r.webkitTransform=`translate(${i/a}px,${s/l}px)`,r.transitionDuration="0s",e}}function $r(e){const t=e.getBoundingClientRect();return{left:t.left,top:t.top}}function i_(e,t,n){const i=e.cloneNode(),s=e[Zt];s&&s.forEach(c=>{c.split(/\s+/).forEach(a=>a&&i.classList.remove(a))}),n.split(/\s+/).forEach(c=>c&&i.classList.add(c)),i.style.display="none";const o=t.nodeType===1?t:t.parentNode;o.appendChild(i);const{hasTransform:r}=Er(i);return o.removeChild(i),r}const oo=e=>{const t=e.props["onUpdate:modelValue"]||!1;return H(t)?n=>Fn(t,n):t};function s_(e){e.target.composing=!0}function ro(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const Mn=Symbol("_assign"),Nn=Symbol("_initialValue");function Si(e,t,n){return t&&(e=e.trim()),n&&(e=es(e)),e}const o_={created(e,{modifiers:{lazy:t,trim:n,number:i}},s){e.parentNode&&(e.type==="text"?e[Nn]=e.defaultValue.replace(/[\r\n]/g,""):e.type==="textarea"&&(e[Nn]=e.defaultValue.replace(/\r\n?/g,`
`))),e[Mn]=oo(s);const o=i||s.props&&s.props.type==="number";jt(e,t?"change":"input",r=>{r.target.composing||e[Mn](Si(e.value,n,o))}),(n||o)&&jt(e,"change",()=>{e.value=Si(e.value,n,o)}),t||(jt(e,"compositionstart",s_),jt(e,"compositionend",ro),jt(e,"change",ro))},mounted(e,{value:t,modifiers:{trim:n,number:i}}){const s=t??"",o=e[Nn];delete e[Nn],o!==void 0&&(e.type==="text"||e.type==="textarea")&&e.value!==o?e[Mn](Si(e.value,n,i)):e.value=s},beforeUpdate(e,{value:t,oldValue:n,modifiers:{lazy:i,trim:s,number:o}},r){if(e[Mn]=oo(r),e.composing)return;const c=(o||e.type==="number")&&!/^0\d/.test(e.value)?es(e.value):e.value,a=t??"";if(c===a)return;const l=e.getRootNode();(l instanceof Document||l instanceof ShadowRoot)&&l.activeElement===e&&e.type!=="range"&&(i&&t===n||s&&e.value.trim()===a)||(e.value=a)}},r_=["ctrl","shift","alt","meta"],c_={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>r_.some(n=>e[`${n}Key`]&&!t.includes(n))},Ue=(e,t)=>{if(!e)return e;const n=e._withMods||(e._withMods={}),i=t.join(".");return n[i]||(n[i]=(s,...o)=>{for(let r=0;r<t.length;r++){const c=c_[t[r]];if(c&&c(s,t))return}return e(s,...o)})},a_=xe({patchProp:Wd},Rd);let co;function l_(){return co||(co=ld(a_))}const p_=(...e)=>{const t=l_().createApp(...e),{mount:n}=t;return t.mount=i=>{const s=d_(i);if(!s)return;const o=t._component;!j(o)&&!o.render&&!o.template&&(o.template=s.innerHTML),s.nodeType===1&&(s.textContent="");const r=n(s,!1,u_(s));return s instanceof Element&&(s.removeAttribute("v-cloak"),s.setAttribute("data-v-app","")),r},t};function u_(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function d_(e){return de(e)?document.querySelector(e):e}const Qt={MIN:0,MAX:100},mn={BASE_DECAY:3,PRESSURE_COEF:2,RECORDER_RELIEF:3,INITIATIVE_COST_BASE:1,INITIATIVE_COST_STEP:1},Gn={T1:50,T2:30,T3:15},ao={DEFAULT:8,PANIC:4},Ki={DESTROY_EVIDENCE_CAP:-20,HUSH_MONEY_EVIDENCE_CAP:30},ct={EV_WEIGHT:5,OPINION_BASE:30,OPINION_EV_COEF:2,OPINION_NEG_COST:8,COMPOSURE_FIXED:60,RISK_BASE:50,RISK_EV_RELIEF:2,RISK_NEG_ADD:10,TRUE_EV_MIN:15},Ii={PLAYBOOK_EVIDENCE:5,NOTARY_RISK:-5,CALM_BREATH_COMPOSURE:30};function vn(e){return Math.min(Qt.MAX,Math.max(Qt.MIN,e))}function vs(e){return{...e,flags:new Set(e.flags),items:new Set(e.items)}}function __(e,t,n,i){let s=n;return t.items.has("item_calm_breathing")&&e.tag==="BREATH"&&(s={...s,composure:Ii.CALM_BREATH_COMPOSURE}),t.items.has("item_hr_playbook")&&i===3&&e.initiative===3&&(s={...s,evidence:(s.evidence??0)+Ii.PLAYBOOK_EVIDENCE}),t.items.has("item_notary_habit")&&i===4&&e.initiative===3&&(s={...s,risk:(s.risk??0)+Ii.NOTARY_RISK}),s}function f_(e){return e.tag==="PHYSICAL"?{forcedEnding:e.next}:null}function g_(e,t){switch(t){case"G_NEG_DESTROYED_EVIDENCE":e.evidenceCap=Qt.MAX+Ki.DESTROY_EVIDENCE_CAP;break;case"G_NEG_HUSH_MONEY":e.evidence=Math.min(e.evidence,Ki.HUSH_MONEY_EVIDENCE_CAP);break}}function lo(e,t,n=1,i=0){const s=vs(e),o=__(t,s,t.effects??{},n),r=["evidence","opinion","composure","risk"];for(const c of r){const a=o[c];a!==void 0&&(s[c]+=a)}if(t.initiative>=2&&t.tag!=="BREATH"){const c=(t.initiative-1)*(mn.INITIATIVE_COST_BASE+mn.INITIATIVE_COST_STEP*Math.floor(i/2));s.composure-=c}s.evidence>s.evidenceCap&&(s.evidence=s.evidenceCap);for(const c of r)s[c]=vn(s[c]);for(const c of o.addFlags??[])s.flags.add(c),g_(s,c);for(const c of o.removeFlags??[])s.flags.delete(c);for(const c of o.addItems??[])s.items.add(c);return s.turn+=1,s}function m_(e,t){const n=vs(e),i=mn.BASE_DECAY+t.pressure*mn.PRESSURE_COEF,s=n.items.has("item_recorder")?mn.RECORDER_RELIEF:0;return n.composure=vn(n.composure-i+s),n}class _e extends Error{constructor(t){super(t),this.name="ContentError"}}function Mr(e,t){return{evidence:e.evidence,opinion:e.opinion,composure:e.composure,risk:e.risk,dEvidence:e.evidence-t.evidence,dOpinion:e.opinion-t.opinion,dComposure:e.composure-t.composure,dRisk:e.risk-t.risk,flags:e.flags,items:e.items,turn:e.turn}}const v_=new Set(["evidence","opinion","composure","risk","dEvidence","dOpinion","dComposure","dRisk","turn"]);function h_(e){const t=[];let n=0;for(;n<e.length;){const i=e[n];if(i===" "||i==="	"||i===`
`||i==="\r"){n+=1;continue}if(i>="0"&&i<="9"){let r=n;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:Number(e.slice(n,r))}),n=r;continue}if(/[A-Za-z_]/.test(i)){let r=n;for(;r<e.length&&/[A-Za-z0-9_]/.test(e[r]);)r+=1;t.push({t:"id",v:e.slice(n,r)}),n=r;continue}if(i==="'"||i==='"'){let r=n+1;for(;r<e.length&&e[r]!==i;)r+=1;if(r>=e.length)throw new _e(`unterminated string in condition: ${e}`);t.push({t:"str",v:e.slice(n+1,r)}),n=r+1;continue}const s=e.slice(n,n+2);if(s==="&&"||s==="||"||s===">="||s==="<="||s==="=="||s==="!="){t.push({t:"op",v:s}),n+=2;continue}const o=e[n+1];if(i==="-"&&o!==void 0&&o>="0"&&o<="9"&&(t.length===0||t[t.length-1].t==="op")){let r=n+1;for(;r<e.length&&e[r]>="0"&&e[r]<="9";)r+=1;t.push({t:"num",v:-Number(e.slice(n+1,r))}),n=r;continue}if(i===">"||i==="<"||i==="!"||i==="("||i===")"){t.push({t:"op",v:i}),n+=1;continue}throw new _e(`illegal character '${i}' in condition: ${e}`)}return t}class x_{constructor(t){ye(this,"pos",0);this.tokens=t}peek(){return this.tokens[this.pos]}next(){const t=this.tokens[this.pos];if(t===void 0)throw new _e("unexpected end of condition");return this.pos+=1,t}eatOp(t){const n=this.next();if(n.t!=="op"||n.v!==t)throw new _e(`expected '${t}', got '${n.t==="op"?n.v:n.t}'`)}parse(){const t=this.parseOr();if(this.pos!==this.tokens.length){const n=this.peek();throw new _e(`unexpected trailing token '${n?n.t==="op"?n.v:n.t:"?"}'`)}return t}parseOr(){let t=this.parseAnd();for(;this.matchOp("||");)t={kind:"binary",op:"||",left:t,right:this.parseAnd()};return t}parseAnd(){let t=this.parseCompare();for(;this.matchOp("&&");)t={kind:"binary",op:"&&",left:t,right:this.parseCompare()};return t}parseCompare(){const t=this.parseUnary(),n=this.peek();return n!==void 0&&n.t==="op"&&[">=",">","<=","<","==","!="].includes(n.v)?(this.pos+=1,{kind:"compare",op:n.v,left:t,right:this.parseUnary()}):t}parseUnary(){return this.matchOp("!")?{kind:"unary",op:"!",operand:this.parseUnary()}:this.parseAtom()}parseAtom(){const t=this.next();if(t.t==="num")return{kind:"num",value:t.v};if(t.t==="str")throw new _e("string literal only allowed as function argument");if(t.t==="op"&&t.v==="("){const n=this.parseOr();return this.eatOp(")"),n}if(t.t==="id"){if(t.v==="has"||t.v==="hasItem"){this.eatOp("(");const n=this.next();if(n.t!=="str")throw new _e(`'${t.v}' expects a quoted string argument`);return this.eatOp(")"),{kind:"call",fn:t.v,arg:n.v}}if(!v_.has(t.v))throw new _e(`unknown identifier '${t.v}' in condition`);return{kind:"var",name:t.v}}throw new _e(`unexpected operator '${t.v}' in condition`)}matchOp(t){const n=this.peek();return n!==void 0&&n.t==="op"&&n.v===t?(this.pos+=1,!0):!1}}const po=new Map;function k_(e){const t=po.get(e);if(t!==void 0)return t;const n=new x_(h_(e)).parse();return po.set(e,n),n}function Yt(e,t){switch(e.kind){case"num":return e.value!==0;case"var":return Nr(e.name,t)!==0;case"call":return e.fn==="has"?t.flags.has(e.arg):t.items.has(e.arg);case"unary":return!Yt(e.operand,t);case"binary":return e.op==="&&"?Yt(e.left,t)&&Yt(e.right,t):Yt(e.left,t)||Yt(e.right,t);case"compare":{const n=uo(e.left,t),i=uo(e.right,t);switch(e.op){case">=":return n>=i;case">":return n>i;case"<=":return n<=i;case"<":return n<i;case"==":return n===i;case"!=":return n!==i}}}}function uo(e,t){if(e.kind==="num")return e.value;if(e.kind==="var")return Nr(e.name,t);throw new _e("comparison operands must be numbers")}function Nr(e,t){switch(e){case"evidence":return t.evidence;case"opinion":return t.opinion;case"composure":return t.composure;case"risk":return t.risk;case"dEvidence":return t.dEvidence;case"dOpinion":return t.dOpinion;case"dComposure":return t.dComposure;case"dRisk":return t.dRisk;case"turn":return t.turn;default:throw new _e(`unknown identifier '${e}'`)}}function Fr(e,t){return e.trim()==="true"?!0:Yt(k_(e),t)}function y_(e){return e<Gn.T3||e<Gn.T2?2:e<Gn.T1?1:0}function T_(e,t){const n=i=>{let s=0;const o=`${t}/${i}`;for(let r=0;r<o.length;r+=1)s=Math.imul(s,31)+o.charCodeAt(r)|0;return(s>>>1&2147483647)/2147483648};return[...e].sort((i,s)=>n(i.id)-n(s.id))}function _o(e,t,n=new Set){const i=e.options.filter(c=>c.oncePerNode===!0&&n.has(c.id)?!1:c.requires===void 0?!0:Fr(c.requires,Mr(t,L_))),s=y_(t.composure),r=e.impulsePool.filter(c=>t.composure<c.unlockBelow).slice(0,s);return T_([...i,...r],e.id)}const L_={evidence:0,opinion:0,composure:0,risk:0};function b_(e,t){return t.composure<Gn.T3?ao.PANIC:e.timer??ao.DEFAULT}function A_(e,t,n){if(t.flags.has("FORCED_F")){const s=e.endings.find(o=>o.condition==="FORCED");if(s===void 0)throw new _e(`level ${e.id} has FORCED_F state but no FORCED ending`);return s}const i=Mr(t,n);for(const s of e.endings)if(s.condition!=="FORCED"&&Fr(s.condition,i))return s;throw new _e(`level ${e.id}: no ending condition matched (missing 'true' fallback?)`)}const w_="__END__";function Ci(e){return e.type==="choice"}class hs{constructor(t,n){ye(this,"nodeMap");ye(this,"endingMap");ye(this,"initMeter");ye(this,"current");ye(this,"currentNodeId");ye(this,"usedThisVisit",new Set);this.level=t,this.nodeMap=new Map(t.nodes.map(i=>[i.id,i])),this.endingMap=new Map(t.endings.map(i=>[i.id,i])),this.initMeter=t.initState,this.current=this.buildInitialState(n),this.currentNodeId=t.entryNode}buildInitialState(t){const n=new Set([...t.flags].filter(o=>o.startsWith("G_"))),i=n.has("G_NEG_DESTROYED_EVIDENCE")?Qt.MAX+Ki.DESTROY_EVIDENCE_CAP:Qt.MAX,s=n.has("G_NEG_ASSAULT")?15:0;return{evidence:this.level.initState.evidence,opinion:this.level.initState.opinion,composure:this.level.initState.composure,risk:this.level.initState.risk+s,flags:n,items:new Set(t.items),turn:0,evidenceCap:i}}get state(){return this.current}start(){return this.advanceFrom(this.currentNodeId)}choose(t){const n=this.getNode(this.currentNodeId);if(!Ci(n))throw new _e(`choose() called on non-choice node ${n.id} in level ${this.level.id}`);const s=_o(n,this.current,this.usedThisVisit).find(o=>o.id===t);if(s===void 0)throw new _e(`option '${t}' not available at node ${n.id} (level ${this.level.id})`);return this.applyChoice(n,s)}timeout(){const t=this.getNode(this.currentNodeId);if(!Ci(t))throw new _e(`timeout() called on non-choice node ${t.id} in level ${this.level.id}`);const n=t.options.find(i=>i.id===t.timeoutOption);if(n===void 0)throw new _e(`timeoutOption '${t.timeoutOption}' not found in node ${t.id}`);return this.applyChoice(t,n)}getNode(t){const n=this.nodeMap.get(t);if(n===void 0)throw new _e(`node not found: ${t} (level ${this.level.id})`);return n}applyChoice(t,n){const i=f_(n);return i!==null?(this.current=lo(this.current,n,this.level.act,t.pressure),this.current.flags.add("FORCED_F"),this.current.flags.add("G_NEG_ASSAULT"),this.finishWith(i.forcedEnding)):(n.oncePerNode===!0&&this.usedThisVisit.add(n.id),this.current=lo(this.current,n,this.level.act,t.pressure),this.current=m_(this.current,t),this.advanceFrom(n.next))}advanceFrom(t){if(t===w_)return this.finishWith(null);let n=t;for(let i=0;i<O_;i+=1){const s=this.endingMap.get(n);if(s!==void 0)return this.finishWith(s.id);const o=this.getNode(n);return Ci(o)?(n!==this.currentNodeId&&(this.usedThisVisit=new Set),this.currentNodeId=o.id,{type:"options",options:_o(o,this.current,this.usedThisVisit),timer:b_(o,this.current),timeoutOptionId:o.timeoutOption,prompt:o.prompt,pressure:o.pressure,nodeId:o.id}):(this.currentNodeId=o.id,{type:"node",node:o})}throw new _e(`node chain too deep at ${n} (level ${this.level.id})`)}proceed(){const t=this.getNode(this.currentNodeId);if(t.next===void 0)throw new _e(`node ${t.id} has no next (level ${this.level.id})`);return this.advanceFrom(t.next)}finishWith(t){const n=t!==null?this.endingMap.get(t):void 0;if(t!==null&&n===void 0)throw new _e(`ending not found: ${t} (level ${this.level.id})`);const i=vs(this.current);return{type:"ending",ending:n!==void 0?n:A_(this.level,this.current,this.initMeter),state:i}}static simulate(t,n,i){const s=new hs(t,n);let o=s.start(),r=0;for(;;){if(o.type==="ending")return{rank:o.ending.rank,state:o.state};if(o.type==="node"){o=s.proceed();continue}if(o.type==="options"){const c=i[r];if(r+=1,c===void 0)throw new _e(`simulate path exhausted at node in level ${t.id}`);o=s.choose(c);continue}}}}const O_=200,Dr="poju_shilu_save_v1";function qi(){return{version:1,flags:[],items:[],levelResults:{},cards:[],settings:{mode:"NORMAL",sound:!0}}}const Qn=globalThis.localStorage,Br=typeof Qn<"u"&&Qn!==null;function P_(){if(!Br)return qi();const e=Qn.getItem(Dr);return e===null?qi():JSON.parse(e)}function R_(e){Br&&Qn.setItem(Dr,JSON.stringify(e))}const E_={L01:{flag:"G_EV_SUBWAY",minRank:["S","A"]},L02:{flag:"G_EV_ELEVATOR",minRank:["S","A"]},L03:{flag:"G_EV_MALL",minRank:["S","A"]},L04:{flag:"G_EV_NIGHTWALK",minRank:["S","A"]},L05:{flag:"G_EV_GYM",minRank:["S","A"]},L06:{flag:"G_EV_BETROTHAL",minRank:["S","A"]},L07:{flag:"G_EV_TRANSFER",minRank:["S","A"]},L08:{flag:"G_EV_PATERNITY",minRank:["S","A"]},L09:{flag:"G_EV_PRESERVATION",minRank:["S","A"]},L10:{flag:"G_EV_PROTECTION_ORDER",minRank:["S","A"]},L11:{flag:"G_EV_HR_WRITTEN",minRank:["S","A"]},L12:{flag:"G_EV_EMAIL_CHAIN",minRank:["S","A"]},L13:{flag:"G_EV_FULL_AUDIO",minRank:["S","A"]},L14:{flag:"G_EV_SUSPENSION",minRank:["S","A"]},L15:{flag:"G_EV_EXTORTION",minRank:["S","A"]},L16:{flag:"G_EV_ORIGINAL_CLIP",minRank:["S","A"]},L17:{flag:"G_EV_DOXX_NOTARY",minRank:["S","A"]},L18:{flag:"G_EV_LIVE_RECORD",minRank:["S","A"]},L19:{flag:"G_EV_PLATFORM",minRank:["S","A"]}},S_={L02:"G_NEG_DESTROYED_EVIDENCE",L07:"G_NEG_HUSH_MONEY",L10:"L10_VIOLATED",L13:"G_NEG_APOLOGY_LETTER",L17:"G_NEG_DOXXED_BACK"};function I_(e,t){switch(e){case"L01":return t==="S"||t==="A"?["item_recorder"]:[];case"L02":return["item_shen_card"];case"L08":return t==="S"?["item_calm_breathing"]:[];case"L11":return t==="S"||t==="A"?["item_hr_playbook"]:[];case"L16":return t==="S"||t==="A"?["item_notary_habit"]:[];default:return[]}}function C_(e,t,n,i,s){const o={...e,flags:[...e.flags],items:[...e.items],levelResults:{...e.levelResults},cards:[...e.cards]},r=new Set(o.flags);for(const v of i.flags)v.startsWith("G_")&&r.add(v);const c=E_[t];if(c!==void 0&&c.minRank.includes(n.rank)){const v=S_[t];v!==void 0&&(r.has(v)||i.flags.has(v))||r.add(c.flag)}const a=I_(t,n.rank),l=new Set(o.items);for(const v of a)l.add(v);n.unlock!==void 0&&!o.cards.includes(n.unlock)&&o.cards.push(n.unlock);const p=s==null?void 0:s.now,_={S:5,A:4,B:3,C:2,F:1},h=o.levelResults[t];return h===void 0||_[n.rank]>_[h.rank]?o.levelResults[t]={rank:n.rank,endingId:n.id,ts:p}:_[n.rank]<_[h.rank]&&(o.levelResults[t]={...h,lastRank:n.rank,lastEndingId:n.id,lastTs:p}),o.flags=[...r].filter(v=>v.startsWith("G_")),o.items=[...l],o}const $_={G_NEG_ASSAULT:40,G_NEG_DOXXED_BACK:35,G_NEG_DESTROYED_EVIDENCE:30,G_NEG_APOLOGY_LETTER:25,G_NEG_HUSH_MONEY:20,G_NEG_LIED:15,G_NEG_FLED:10};function Hr(e){return e.startsWith("G_NEG_")}function Gr(e){let t=0;for(const n of e)n.startsWith("G_EV_")&&(t+=1);return t}function Wi(e){let t=0;for(const n of e)Hr(n)&&(t+=1);return t}function M_(e){const t=new Set(e.flags),n=Gr(t),s=[...t].filter(Hr).reduce((o,r)=>o+($_[r]??0),0);return{evidence:vn(n*ct.EV_WEIGHT-s),opinion:vn(ct.OPINION_BASE+n*ct.OPINION_EV_COEF-Wi(t)*ct.OPINION_NEG_COST),composure:ct.COMPOSURE_FIXED,risk:vn(ct.RISK_BASE-n*ct.RISK_EV_RELIEF+Wi(t)*ct.RISK_NEG_ADD),flags:t,items:new Set(e.items),turn:0,evidenceCap:Qt.MAX}}function N_(e,t){const n=Gr(new Set(e.flags)),i=Wi(new Set(e.flags));return n>=ct.TRUE_EV_MIN&&i===0&&t==="S"?"TRUE":t==="S"||t==="A"?"WIN":"COSTLY"}const Vr="L01",Ur="第01关 · 地铁三分钟",jr=1,Yr={evidence:20,opinion:50,composure:80,risk:10},Kr=["hero","npc_l01_woman","crowd","officer_lin"],qr="n_01",Wr="card_law_L01",zr=["T1","T2"],Xr=[{id:"n_01",type:"cutscene",pressure:1,script:`三点十四分，三号线。车厢是满的，不算挤。
列车进站前一次急刹，所有人往前倾了半步。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L03_F"}],G_={id:ac,title:lc,act:pc,initState:uc,cast:dc,entryNode:_c,lawyerCard:fc,satireTargets:gc,nodes:mc,endings:vc},V_=Object.freeze(Object.defineProperty({__proto__:null,act:pc,cast:dc,default:G_,endings:vc,entryNode:_c,id:ac,initState:uc,lawyerCard:fc,nodes:mc,satireTargets:gc,title:lc},Symbol.toStringTag,{value:"Module"})),hc="L04",xc="第04关 · 深夜同行",kc=1,yc={evidence:20,opinion:35,composure:55,risk:35},Tc=["hero","npc_l04_woman","officer_lin","crowd"],Lc="n_01",bc="card_law_L04",Ac=["T1","T3"],wc=[{id:"n_01",type:"cutscene",pressure:1,script:`十一点四十，出地铁 C 口。加了四个小时班，你只想快点到家。
...
——情绪也是一种预算。这一次，你在它身上透支了。`,unlock:"card_L10_F"}],tf={id:ba,title:Aa,act:wa,initState:Oa,cast:Pa,entryNode:Ra,lawyerCard:Ea,satireTargets:Sa,nodes:Ia,endings:Ca},nf=Object.freeze(Object.defineProperty({__proto__:null,act:wa,cast:Pa,default:tf,endings:Ca,entryNode:Ra,id:ba,initState:Oa,lawyerCard:Ea,nodes:Ia,satireTargets:Sa,title:Aa},Symbol.toStringTag,{value:"Module"})),$a="L11",Ma="第11关 · 面试第七问",Na=3,Fa={evidence:20,opinion:40,composure:45,risk:20},Da=["hero","npc_l11_hr","shen_li"],Ba="n_01",Ha="card_law_L11",Ga=["T3","T5"],Va=[{id:"n_01",type:"cutscene",pressure:1,script:`终面，第四十分钟。前六个问题答得都不错。
...
划掉了。`,unlock:"card_L20_F"}],Tf={id:mp,title:vp,act:hp,initState:xp,cast:kp,entryNode:yp,lawyerCard:Tp,satireTargets:Lp,nodes:bp,endings:Ap},Lf=Object.freeze(Object.defineProperty({__proto__:null,act:hp,cast:kp,default:Tf,endings:Ap,entryNode:yp,id:mp,initState:xp,lawyerCard:Tp,nodes:bp,satireTargets:Lp,title:vp},Symbol.toStringTag,{value:"Module"})),bf=Object.assign({"../../content/levels/L01.json":D_,"../../content/levels/L02.json":H_,"../../content/levels/L03.json":V_,"../../content/levels/L04.json":j_,"../../content/levels/L05.json":K_,"../../content/levels/L06.json":W_,"../../content/levels/L07.json":X_,"../../content/levels/L08.json":Z_,"../../content/levels/L09.json":ef,"../../content/levels/L10.json":nf,"../../content/levels/L11.json":of,"../../content/levels/L12.json":cf,"../../content/levels/L13.json":lf,"../../content/levels/L14.json":uf,"../../content/levels/L15.json":_f,"../../content/levels/L16.json":gf,"../../content/levels/L17.json":vf,"../../content/levels/L18.json":xf,"../../content/levels/L19.json":yf,"../../content/levels/L20.json":Lf}),Ct=Object.values(bf).map(e=>e.default).sort((e,t)=>e.id.localeCompare(t.id)),Af="破局实录",wf="开发预览 · M3 前置切片",Of={evidence:"证据",opinion:"舆论",composure:"情绪",risk:"风险"},Pf={hero:"陈屿",shen_li:"沈骊",officer_lin:"林昭",zhou_you:"周攸",he_song:"贺松",crowd:"围观者",narrator:"",npc_l01_woman:"红衣女子",npc_l02_woman:"住户女子",npc_l03_woman:"路人女子",npc_l03_daughter:"念念",npc_l04_woman:"报警人",npc_l05_woman:"女子",npc_l05_manager:"值班经理",npc_l05_witness:"目击大哥",npc_l06_girlfriend:"前女友",npc_l06_mother:"她母亲",npc_l07_ex:"前女友",npc_l08_wife:"妻子",npc_l08_mother:"岳母",npc_l08_child:"孩子",npc_l09_wife:"妻子",npc_l09_cousin:"表哥",npc_l10_exwife:"前妻",npc_l10_child:"女儿",npc_l10_teacher:"班主任",npc_l11_hr:"HR",npc_l12_colleague:"同事",npc_l12_boss:"部门老板",npc_l13_hr:"HR",npc_l13_complainant:"投诉人",npc_l14_hr:"HR 总监",npc_l14_director:"总监",npc_l15_broker:"中介",npc_l15_hr:"HR",npc_l16_account:"商务",npc_l17_father:"父亲",npc_l17_hr:"HR",npc_l18_streamer:"主播",npc_l19_moderator:"版务",npc_l19_pr:"公关",npc_l20_judge:"审判长",npc_l20_lawyer:"对方律师"},Rf={1:"第一幕 · 流量即真相",2:"第二幕 · 亲密关系的账",3:"第三幕 · 职场的规则",4:"第四幕 · 收网"},Ef={tapToContinue:"点击继续",secondsUnit:"s",endingTitle:"结局",restart:"再玩一次",nextLevel:"下一关",levelSelect:"选择关卡",lockedLevel:"未解锁",rankNames:{S:"名场面",A:"稳住了",B:"有惊无险",C:"勉强收场",F:"翻车"},finalMeters:"最终仪表",disclaimer:"本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。",progressLabel:"进度",soundToggle:"M",studyIntro:"测试开始前\\n请输入现场编号（如 P01）\\n\\n然后独立游玩前五关\\n过程中不会有任何提示\\n做完自动出现数据回收",studyPidPlaceholder:"现场编号",studyStart:"开始",studyDoneTitle:"第一幕完成",studyCopy:"导出数据（JSON）",studySummaryHeader:"参与者 {p} · {n} 次游玩",studySummaryLine:"{lv}: {rank}「{title}」 用时{s}秒 抉择{c}次 重玩{r}",stanceLow:"稳住",stanceHigh:"顶回去",pileALabel:"这条",pileBLabel:"那条",pileListHint:"选一个",swipeHint:"左右滑动选择 · 点按也可以",settlePhase1:"结算中",settleStampS:"教科书式破局",settleStampA:"稳稳落地",settleStampB:"有惊无险",settleStampC:"伤敌自伤",settleStampF:"满盘皆输",settleMetersTitle:"终局面",teachingHintComposure:"提示：在对方施压下稳住情绪，是达成最高评级的关键。",settleReplay:"本关重打",settleNext:"下一关",lawyerCardTitle:"【沈骊说】案情法律与应对实务复盘",lawyerCardBadge:"核心普法",lawyerCardBtn:"查看沈律师专业点评与法条依据",lawyerModalHeader:"沈骊律师 · 案情实务备忘录",lawyerModalClose:"已掌握破局要点",appTagline:"你不需要嘴更毒，你只需要比对手更懂规则",startAdventure:"开始破局",continueAdventure:"继续破局",recapTitle:"关键因果复盘",costComposure:"情绪",gainBreath:"平复呼吸",dangerImpulse:"冲动失控风险",containsOptions:"内含 {n} 项应对",duelHeader:"危机对峙 · 抉择时刻",stanceCounter:"取证反制",stanceRebuttal:"拍案驳斥",stanceEvidence:"锁定证据",stanceHold:"稳守不自证",stanceBreath:"平复呼吸",stanceImpulse:"冲动失控",stanceNegotiate:"据理交涉",btnLog:"笔录",btnAuto:"自动",btnSkip:"快进",btnHide:"隐藏",backlogTitle:"案情对话笔录",backlogEmpty:"暂无历史笔录",tapToRestore:"点击任意处恢复界面",autoPlaying:"自动播放中",finaleTrue:"真结局 · 收网",finaleWin:"终局 · 胜诉",finaleCostly:"终局 · 惨胜",resumePrompt:"继续作答",timeoutNotice:"超时未决 · 系统替你选了"},Sf={L01:{label:"地铁三号线",hue:205,motif:"subway"},L02:{label:"住宅电梯",hue:220,motif:"elevator"},L03:{label:"商场中庭",hue:35,motif:"mall"},L04:{label:"深夜街道",hue:235,motif:"street"},L05:{label:"健身房",hue:15,motif:"gym"},L06:{label:"两家饭桌",hue:28,motif:"table"},L07:{label:"出租屋",hue:200,motif:"room"},L08:{label:"客厅",hue:40,motif:"room"},L09:{label:"民政局外",hue:210,motif:"office"},L10:{label:"学校门口",hue:45,motif:"street"},L11:{label:"面试间",hue:215,motif:"office"},L12:{label:"开放工位",hue:210,motif:"office"},L13:{label:"会议室",hue:220,motif:"office"},L14:{label:"总监办公室",hue:225,motif:"office"},L15:{label:"写字楼楼下",hue:200,motif:"street"},L16:{label:"剪辑室",hue:260,motif:"studio"},L17:{label:"家中",hue:30,motif:"room"},L18:{label:"直播间后台",hue:320,motif:"studio"},L19:{label:"平台工单页",hue:190,motif:"office"},L20:{label:"法院走廊",hue:210,motif:"court"}},If={calm:["前排","吃瓜","蹲后续","录下来了","别急，等反转","让子弹飞一会儿"],tense:["什么情况？?","有人认识吗","这女的厉害","这男的稳住啊","报警了吗","快报警","别拍了先帮个忙啊","主播别切","全网都在看"],hot:["热搜第一预定","已经录屏了","传到群里了","反转了反转了","坐等打脸","这瓜保熟","直播间炸了","三分钟了还在吵"]},Cf={hero:210,shen_li:280,officer_lin:195,zhou_you:150,he_song:350,npc_l01_woman:350,npc_l02_woman:330,npc_l03_woman:320,npc_l03_daughter:45,npc_l04_woman:160,npc_l05_woman:340,npc_l05_manager:30,npc_l05_witness:200,npc_l06_girlfriend:315,npc_l06_mother:280,npc_l07_ex:300,npc_l08_wife:330,npc_l08_mother:275,npc_l08_child:50,npc_l09_wife:320,npc_l09_cousin:25,npc_l10_exwife:310,npc_l10_child:55,npc_l10_teacher:165,npc_l11_hr:220,npc_l12_colleague:145,npc_l12_boss:25,npc_l13_hr:215,npc_l13_complainant:345,npc_l14_hr:225,npc_l14_director:20,npc_l15_broker:40,npc_l15_hr:218,npc_l16_account:35,npc_l17_father:205,npc_l17_hr:222,npc_l18_streamer:325,npc_l19_moderator:195,npc_l19_pr:285,crowd:0},$f={appTitle:Af,appSub:wf,meters:Of,speakerNames:Pf,actNames:Rf,ui:Ef,scenes:Sf,danmaku:If,speakerHues:Cf},ge=$f;function Rt(e){const t=ge.ui[e];return typeof t=="string"?t:""}function xs(e){return!e||e==="null"?"":ge.speakerNames[e]??e}function ei(e){return ge.speakerHues[e]??220}function wp(e){return ge.scenes[e]??{label:"",hue:210,motif:"room"}}const Mf={class:"hud"},Nf={class:"label"},Ff={class:"icon","aria-hidden":"true"},Df={class:"bar"},Bf={class:"val-wrap"},Hf={class:"num"},Gf=ot({__name:"MeterHud",props:{state:{}},setup(e){const t=e;let n=0;const i=Q({evidence:null,opinion:null,composure:null,risk:null}),s={};we(()=>({...t.state}),(c,a)=>{if(!a)return;const l=["evidence","opinion","composure","risk"];for(const p of l){const _=c[p]-a[p];if(_!==0){n+=1;const h=p==="risk"?_<0:_>0;i.value[p]={text:(_>0?"+":"")+_,dir:h?"pos":"neg",key:n},s[p]!==void 0&&clearTimeout(s[p]),s[p]=setTimeout(()=>{i.value[p]=null},1400)}}});const o={evidence:"⚖️",opinion:"📢",composure:"🧘",risk:"⚡"},r=te(()=>[{k:"evidence",kind:"good"},{k:"opinion",kind:"good"},{k:"composure",kind:"good"},{k:"risk",kind:"bad"}].map(({k:a,kind:l})=>({key:a,label:ge.meters[a],value:t.state[a],kind:l})));return(c,a)=>(E(),M("div",Mf,[(E(!0),M(ke,null,Dt(r.value,l=>(E(),M("div",{key:l.key,class:fe(["meter",[l.key,l.kind,{"is-tense":l.key==="composure"&&l.value<30,"is-crisis":l.key==="risk"&&l.value>=70}]])},[g("span",Nf,[g("i",Ff,S(o[l.key]),1),It(S(l.label),1)]),g("div",Df,[g("div",{class:"fill",style:He({width:Math.min(100,Math.max(0,l.value))+"%"})},null,4)]),g("div",Bf,[g("span",Hf,S(l.value),1),Te(Sd,{name:"float"},{default:ds(()=>[i.value[l.key]?(E(),M("span",{key:i.value[l.key].key,class:fe(["delta",i.value[l.key].dir])},S(i.value[l.key].text),3)):se("",!0)]),_:2},1024)])],2))),128))]))}}),mt=(e,t)=>{const n=e.__vccOpts||e;for(const[i,s]of t)n[i]=s;return n},Vf=mt(Gf,[["__scopeId","data-v-f8bd0050"]]);function Uf(e,t){const n=220*Math.pow(2,Math.round(e/30)%12/12);return t==="tense"?{root:n,steps:[0,2,3,5,7,8,10]}:t==="panic"?{root:n,steps:[0,1,3,6,7,9,10]}:{root:n*1.5,steps:[0,2,4,7,9,12,14]}}function fo(e,t){const n=Math.floor(t/e.steps.length),i=(t%e.steps.length+e.steps.length)%e.steps.length;return e.root*Math.pow(2,(e.steps[i]??0)/12+n)}function go(e){let t=e|0;return()=>(t=Math.imul(t,1664525)+1013904223|0,(t>>>8&16777215)/16777216)}class jf{constructor(){ye(this,"ctx",null);ye(this,"master",null);ye(this,"bgmGain",null);ye(this,"sfxGain",null);ye(this,"bgmTimer",null);ye(this,"mood","calm");ye(this,"hue",210);ye(this,"step",0);ye(this,"rnd",go(42));ye(this,"muted",!1)}unlock(){if(this.ctx===null){const t=globalThis.AudioContext;if(t===void 0)return;this.ctx=new t,this.master=this.ctx.createGain(),this.master.gain.value=this.muted?0:.55,this.master.connect(this.ctx.destination),this.bgmGain=this.ctx.createGain(),this.bgmGain.gain.value=.5,this.bgmGain.connect(this.master),this.sfxGain=this.ctx.createGain(),this.sfxGain.gain.value=.9,this.sfxGain.connect(this.master)}this.ctx.state==="suspended"&&this.ctx.resume()}setMuted(t){this.muted=t,this.master!==null&&this.ctx!==null&&this.master.gain.setTargetAtTime(t?0:.55,this.ctx.currentTime,.05)}tone(t,n,i,s,o,r=0){if(this.ctx===null)return;const c=this.ctx.currentTime+r,a=this.ctx.createOscillator(),l=this.ctx.createGain();a.type=s,a.frequency.value=t,l.gain.setValueAtTime(0,c),l.gain.linearRampToValueAtTime(i,c+.012),l.gain.exponentialRampToValueAtTime(1e-4,c+n),a.connect(l),l.connect(o),a.start(c),a.stop(c+n+.05)}pad(t,n){if(this.bgmGain===null||this.ctx===null)return;const i=this.ctx.currentTime,s=this.ctx.createOscillator(),o=this.ctx.createGain(),r=this.ctx.createBiquadFilter();r.type="lowpass",r.frequency.value=900,s.type="sawtooth",s.frequency.value=t/2,o.gain.setValueAtTime(0,i),o.gain.linearRampToValueAtTime(.05,i+n*.3),o.gain.linearRampToValueAtTime(1e-4,i+n),s.connect(r),r.connect(o),o.connect(this.bgmGain),s.start(i),s.stop(i+n+.1)}scene(t,n,i,s){const o=s<15||i>=4?"panic":i>=3||s<40?"tense":"calm";let r=0;for(let c=0;c<t.length;c+=1)r=r*31+t.charCodeAt(c)|0;(o!==this.mood||n!==this.hue)&&(this.mood=o,this.hue=n,this.rnd=go(r),this.step=0)}tick(){if(this.ctx===null||this.bgmGain===null||this.muted)return;const t=Uf(this.hue,this.mood),n=this.step%8,i=this.mood==="calm"?.35:this.mood==="tense"?.55:.75;if(this.rnd()<i){const s=Math.floor(this.rnd()*8),o=fo(t,s);this.tone(o,this.mood==="calm"?.9:.45,.06,this.mood==="calm"?"sine":"triangle",this.bgmGain)}n===0&&this.pad(fo(t,0),this.mood==="calm"?6.4:3.2),this.mood==="panic"&&(n===0||n===4)&&(this.tone(52,.14,.16,"sine",this.bgmGain),this.tone(52,.12,.12,"sine",this.bgmGain,.18)),this.step+=1}sfx(t){if(!(this.ctx===null||this.sfxGain===null||this.muted))switch(t){case"click":this.tone(880,.06,.1,"sine",this.sfxGain);break;case"stamp":this.tone(85,.22,.28,"sine",this.sfxGain),this.tone(220,.12,.18,"triangle",this.sfxGain,.01),this.tone(580,.06,.1,"sine",this.sfxGain,.02);break;case"decision":this.tone(660,.05,.12,"sine",this.sfxGain),this.tone(990,.09,.14,"triangle",this.sfxGain,.02);break;case"drawer":this.tone(440,.08,.06,"triangle",this.sfxGain),this.tone(554,.1,.05,"sine",this.sfxGain,.04);break;case"flash":this.tone(880,.06,.1,"sine",this.sfxGain),this.tone(1320,.12,.12,"sine",this.sfxGain,.04),this.tone(1760,.16,.1,"sine",this.sfxGain,.08);break;case"options":this.tone(523,.08,.09,"sine",this.sfxGain),this.tone(784,.1,.09,"sine",this.sfxGain,.07);break;case"tick":this.tone(1245,.04,.07,"square",this.sfxGain);break;case"ending":{const n=this.sfxGain;n!==null&&[523,659,784,1047].forEach((i,s)=>this.tone(i,.5,.08,"sine",n,s*.13));break}case"bad":{const n=this.sfxGain;n!==null&&[330,294,262,196].forEach((i,s)=>this.tone(i,.35,.09,"triangle",n,s*.15));break}}}startLoop(){if(this.bgmTimer!==null)return;const t=800;typeof setInterval=="function"&&(this.bgmTimer=setInterval(()=>this.tick(),t))}stopLoop(){this.bgmTimer!==void 0&&this.bgmTimer!==null&&(clearInterval(this.bgmTimer),this.bgmTimer=null)}}const he=new jf,Yf={key:0,class:"nameplate"},Kf={class:"np-name"},qf={class:"textbox"},Wf={class:"text"},zf={key:0,class:"next-indicator"},Xf=ot({__name:"StoryBox",props:{speaker:{},text:{},kind:{},autoActive:{type:Boolean,default:!1}},emits:["advance","openLog","toggleAuto","skip","hideUi"],setup(e,{emit:t}){const n=e,i=t,s=ge.ui,o=te(()=>n.speaker&&n.speaker!=="null"?xs(n.speaker):""),r=te(()=>n.speaker?ei(n.speaker):220),c=Q(""),a=te(()=>c.value.length>=n.text.length);let l;function p(v){if(c.value="",l!==void 0&&clearInterval(l),typeof setInterval!="function"){c.value=v;return}let w=0;l=setInterval(()=>{w+=2,c.value=v.slice(0,w),w>=v.length&&l!==void 0&&(clearInterval(l),l=void 0)},26)}we(()=>n.text,v=>p(v),{immediate:!0});function _(){he.sfx("click"),a.value?i("advance"):(c.value=n.text,l!==void 0&&(clearInterval(l),l=void 0))}function h(v){var I,W;const w=(W=(I=v.target)==null?void 0:I.tagName)==null?void 0:W.toLowerCase();w==="input"||w==="textarea"||(v.key===" "||v.key==="Enter"?(v.preventDefault(),_()):v.key==="l"||v.key==="L"?(v.preventDefault(),i("openLog")):v.key==="a"||v.key==="A"?(v.preventDefault(),i("toggleAuto")):(v.key==="h"||v.key==="H")&&(v.preventDefault(),i("hideUi")))}return en(()=>{typeof window<"u"&&window.addEventListener("keydown",h)}),Gt(()=>{l!==void 0&&clearInterval(l),typeof window<"u"&&window.removeEventListener("keydown",h)}),(v,w)=>(E(),M("div",{class:fe(["gal-message-window",e.kind]),style:He({"--h":r.value}),onClick:_},[e.kind==="dialogue"&&o.value?(E(),M("div",Yf,[w[5]||(w[5]=g("span",{class:"np-dot"},null,-1)),g("span",Kf,S(o.value),1)])):se("",!0),g("div",qf,[g("p",Wf,S(c.value),1),a.value?(E(),M("span",zf,"▼")):se("",!0)]),g("div",{class:"quick-bar",onClick:w[4]||(w[4]=Ue(()=>{},["stop"]))},[g("button",{class:"qb-btn",onClick:w[0]||(w[0]=I=>v.$emit("openLog"))},[w[6]||(w[6]=g("i",{class:"qb-icon"},"📜",-1)),It(" "+S(b(s).btnLog),1)]),g("button",{class:fe(["qb-btn",{active:e.autoActive}]),onClick:w[1]||(w[1]=I=>v.$emit("toggleAuto"))},[w[7]||(w[7]=g("i",{class:"qb-icon"},"⚡",-1)),It(" "+S(b(s).btnAuto),1)],2),g("button",{class:"qb-btn",onClick:w[2]||(w[2]=I=>v.$emit("skip"))},[w[8]||(w[8]=g("i",{class:"qb-icon"},"⏩",-1)),It(" "+S(b(s).btnSkip),1)]),g("button",{class:"qb-btn",onClick:w[3]||(w[3]=I=>v.$emit("hideUi"))},[w[9]||(w[9]=g("i",{class:"qb-icon"},"👁",-1)),It(" "+S(b(s).btnHide),1)])])],6))}}),$i=mt(Xf,[["__scopeId","data-v-14ecfe62"]]),Jf={class:"prompt-row"},Zf={class:"prompt-main"},Qf={class:"duel-badge"},e0={class:"duel-title"},t0={key:0,class:"scene-prompt"},n0=["disabled","onClick"],i0={class:"card-meta"},s0={class:"meta-left"},o0={class:"key-badge","aria-hidden":"true"},r0={class:"meta-right"},c0={key:0,class:"opt-tag breath"},a0={key:1,class:"opt-tag warn"},l0={key:2,class:"opt-tag cost"},p0={class:"opt-row"},u0={class:"opt-content"},d0={class:"opt-text"},_0=["aria-label"],f0={class:"resume-text"},g0=ot({__name:"ChoiceLayer",props:{options:{},timer:{},timeoutOptionId:{},prompt:{}},emits:["choose","openLog","timeout"],setup(e,{expose:t,emit:n}){const i=e,s=n,o=ge.ui,r=te(()=>i.prompt??""),c=Q(!1),a=Q(null),l=Q(!1);we(()=>i.options,$=>{var f,x,z;c.value=!1,a.value=null,l.value=!1,String($.__round??"")+$.length+(((f=$[0])==null?void 0:f.id)??""),(z=(x=X.value)==null?void 0:x.scrollTo)==null||z.call(x,{top:0})});function p($){c.value||l.value||(c.value=!0,a.value=$.id,he.sfx("stamp"),he.sfx("decision"),Y(),s("choose",$.id))}const _=Q(i.timer);let h,v=!1,w;function I(){if(!v&&(_.value-=1,_.value<=4&&_.value>0&&he.sfx("tick"),_.value<=0&&(Y(),!c.value))){c.value=!0;const $=i.options.find(f=>f.id===i.timeoutOptionId);$!==void 0&&(s("timeout",$.text),s("choose",$.id))}}function W(){Y(),typeof setInterval=="function"&&(h=setInterval(I,1e3))}function Y(){h!==void 0&&(clearInterval(h),h=void 0)}function G(){v=!0}function F($=!1){$?(v=!1,l.value=!1):l.value=!0}function A(){l.value=!1,v=!1,he.sfx("click")}t({pause:G,resume:F});function N($){var z,q;if(c.value||v||l.value)return;const f=(q=(z=$.target)==null?void 0:z.tagName)==null?void 0:q.toLowerCase();if(f==="input"||f==="textarea")return;const x=parseInt($.key,10);if(!isNaN(x)&&x>=1&&x<=i.options.length){const le=i.options[x-1];le&&($.preventDefault(),p(le))}}en(()=>{W(),w=()=>{v=document.hidden},document.addEventListener("visibilitychange",w),typeof window<"u"&&window.addEventListener("keydown",N)}),Gt(()=>{Y(),document.removeEventListener("visibilitychange",w),typeof window<"u"&&window.removeEventListener("keydown",N)}),we(()=>i.timer,$=>{_.value=$});function K($){return $.unlockBelow!==void 0||$.tag==="PHYSICAL"}function me($){return $.tag==="BREATH"}function pe($){const f=$.initiative??0;return f>=2?f-1:0}function V($){var f;return $.tag==="BREATH"?{label:o.stanceBreath??"",icon:"🧘",kind:"breath"}:K($)?{label:o.stanceImpulse??"",icon:"⚠️",kind:"impulse"}:$.aggression>=2?{label:o.stanceRebuttal??"",icon:"⚡",kind:"rebuttal"}:((f=$.effects)==null?void 0:f.evidence)!==void 0&&$.effects.evidence>0?{label:o.stanceEvidence??"",icon:"🔍",kind:"evidence"}:pe($)>0?{label:o.stanceCounter??"",icon:"💥",kind:"counter"}:{label:o.stanceHold??"",icon:"🛡️",kind:"hold"}}const X=Q(null);return($,f)=>(E(),M("div",{class:fe(["choice-layer",{"clash-panic":_.value<=4}])},[g("div",{ref_key:"listEl",ref:X,class:"scroll"},[g("div",Jf,[g("div",Zf,[g("div",Qf,[f[1]||(f[1]=g("span",{class:"duel-dot"},null,-1)),g("span",e0,S(b(o).duelHeader),1)]),r.value?(E(),M("p",t0,S(r.value),1)):se("",!0)]),g("button",{type:"button",class:"choice-log-btn",onClick:f[0]||(f[0]=x=>$.$emit("openLog"))}," 📜 "+S(b(o).btnLog),1)]),(E(!0),M(ke,null,Dt(e.options,(x,z)=>(E(),M("button",{key:x.id,type:"button",class:fe(["opt",{impulse:K(x),breath:me(x),counter:pe(x)>0||x.aggression>=2,evidence:x.initiative>=2&&pe(x)===0,selected:a.value===x.id}]),disabled:c.value,onClick:q=>p(x)},[g("div",i0,[g("div",s0,[g("span",o0,S(z+1),1),g("span",{class:fe(["stance-badge",V(x).kind])},S(V(x).icon)+" "+S(V(x).label),3)]),g("div",r0,[me(x)?(E(),M("span",c0,"🧘 "+S(b(o).gainBreath),1)):K(x)?(E(),M("span",a0,"⚠️ "+S(b(o).dangerImpulse),1)):pe(x)>0?(E(),M("span",l0,"⚡️ "+S(b(o).costComposure)+" -"+S(pe(x)),1)):se("",!0)])]),g("div",p0,[g("div",u0,[g("span",d0,S(x.text),1)])])],10,n0))),128))],512),g("div",{class:fe(["time",{panic:_.value<=4}]),role:"timer","aria-label":`剩余 ${_.value} 秒`},[g("span",null,S(_.value),1)],10,_0),l.value?(E(),M("div",{key:0,class:"resume-shield",onClick:Ue(A,["stop"])},[g("button",{type:"button",class:"resume-btn",onClick:Ue(A,["stop"])},[f[2]||(f[2]=g("span",{class:"resume-icon"},"▶",-1)),g("span",f0,S(b(o).resumePrompt||"继续作答"),1)])])):se("",!0)],2))}}),m0=mt(g0,[["__scopeId","data-v-91725f96"]]),v0=""+new URL("rank_A-Buk7knaJ.mp4",import.meta.url).href,h0=""+new URL("rank_B-MEHXL8TX.mp4",import.meta.url).href,x0=""+new URL("rank_C-DOkhQSQI.mp4",import.meta.url).href,k0=""+new URL("rank_F-DPh74h1I.mp4",import.meta.url).href,y0=""+new URL("rank_S-BXJbetyP.mp4",import.meta.url).href,T0=[{id:"card_law_L01",level:"L01",body:`【沈骊说】
...
（本内容为情景演绎，不构成法律意见。具体个案请咨询执业律师。）`,disclaimer:"ui.lawyer.disclaimer",riskLevel:"MAX",reviewStatus:"APPROVED",reviewedBy:"外部执业律师（所有者 2026-08-28 转达通过）",reviewedAt:"2026-08-28",citations:[]}],L0=["data-rank"],b0=["src"],A0={class:"stamp"},w0={key:0,class:"finale-badge"},O0={class:"word"},P0={class:"title"},R0={class:"script"},E0={class:"lb-left"},S0={class:"lb-badge"},I0={class:"lb-title"},C0={class:"lb-btn"},$0={class:"meters-card"},M0={class:"mc-title"},N0={class:"bars"},F0={class:"lbl"},D0={class:"track"},B0={class:"num"},H0={key:1,class:"teaching-hint"},G0={class:"th-text"},V0={class:"disclaimer"},U0={class:"acts"},j0={class:"ld-head"},Y0={class:"ld-title-group"},K0={class:"ld-badge"},q0={class:"ld-title"},W0={class:"ld-body"},z0={class:"ld-text"},X0={class:"ld-foot"},J0=ot({__name:"EndingCard",props:{ending:{},state:{},levelId:{default:""},finaleTier:{default:null}},emits:["restart","next"],setup(e,{emit:t}){const n=e,i=Q(1),s=Q(!1),o=Q(!1),r=ge.ui,c=te(()=>["L01","L02","L03","L04","L05"].includes(n.levelId)),a=te(()=>c.value&&n.ending.rank!=="S"&&n.ending.rank!=="A"&&n.state.composure<30),l=te(()=>r["settleStamp"+n.ending.rank]??""),p=te(()=>({TRUE:r.finaleTrue??"",WIN:r.finaleWin??"",COSTLY:r.finaleCostly??""})),_=te(()=>n.levelId==="L20"&&n.finaleTier!==null?p.value[n.finaleTier]??"":""),h=te(()=>{const N=Object.entries(Object.assign({"../../../content/art/endings/rank_A.mp4":v0,"../../../content/art/endings/rank_B.mp4":h0,"../../../content/art/endings/rank_C.mp4":x0,"../../../content/art/endings/rank_F.mp4":k0,"../../../content/art/endings/rank_S.mp4":y0})).find(([K])=>K.endsWith("/rank_"+n.ending.rank+".mp4"));return(N==null?void 0:N[1])??""}),v=te(()=>{const A=T0;if(n.levelId){const N=A.find(K=>K.level===n.levelId);if(N!==void 0)return N}return A.find(N=>n.ending.id.includes(N.level))??A[0]});let w,I;function W(){he.sfx("stamp"),n.ending.rank==="S"||n.ending.rank==="A"?he.sfx("ending"):n.ending.rank==="F"&&he.sfx("bad")}en(()=>{if(typeof setTimeout!="function"){i.value=3;return}w=setTimeout(()=>{i.value=2,W()},1200),I=setTimeout(()=>{i.value=3},2600)}),Gt(()=>{w!==void 0&&clearTimeout(w),I!==void 0&&clearTimeout(I)});function Y(){i.value<2&&W(),w!==void 0&&(clearTimeout(w),w=void 0),I!==void 0&&(clearTimeout(I),I=void 0),i.value=3}function G(A){A.stopPropagation(),he.sfx("drawer"),o.value=!0}function F(A){A.stopPropagation(),he.sfx("click"),o.value=!1}return(A,N)=>(E(),M("div",{class:"cinema","data-rank":e.ending.rank,onClick:Y},[h.value?(E(),M("video",{key:0,class:"bgvid",src:h.value,autoplay:"",muted:"",loop:"",playsinline:"",onCanplay:N[0]||(N[0]=K=>s.value=!0)},null,40,b0)):se("",!0),g("div",{class:fe(["dim",{deeper:i.value>=2}])},null,2),g("div",{class:fe(["stamp-wrap",{show:i.value>=2}])},[g("div",A0,[_.value?(E(),M("span",w0,S(_.value),1)):se("",!0),g("span",O0,S(l.value),1)])],2),g("div",{class:fe(["sheet",{show:i.value>=3}])},[g("h2",P0,S(e.ending.title),1),g("p",R0,S(e.ending.script),1),v.value?(E(),M("div",{key:0,class:"lawyer-bar",onClick:Ue(G,["stop"])},[g("div",E0,[g("span",S0,S(b(r).lawyerCardBadge),1),g("span",I0,S(b(r).lawyerCardTitle),1)]),g("span",C0,[It(S(b(r).lawyerCardBtn)+" ",1),N[4]||(N[4]=g("i",{class:"arr"},"›",-1))])])):se("",!0),g("div",$0,[g("div",M0,S(b(r).settleMetersTitle),1),g("div",N0,[(E(),M(ke,null,Dt(["evidence","opinion","composure","risk"],K=>g("div",{key:K,class:"bar"},[g("span",F0,S(b(ge).meters[K]),1),g("span",D0,[g("i",{style:He({width:Math.min(100,e.state[K])+"%"}),class:fe(K)},null,6)]),g("span",B0,S(e.state[K]),1)])),64))])]),a.value?(E(),M("div",H0,[N[5]||(N[5]=g("span",{class:"th-bulb"},"💡",-1)),g("span",G0,S(b(r).teachingHintComposure),1)])):se("",!0),g("p",V0,S(b(ge).ui.disclaimer),1),g("div",U0,[g("button",{onClick:N[1]||(N[1]=Ue(K=>A.$emit("restart"),["stop"]))},S(b(r).settleReplay),1),g("button",{class:"primary",onClick:N[2]||(N[2]=Ue(K=>A.$emit("next"),["stop"]))},S(b(r).settleNext),1)])],2),o.value&&v.value?(E(),M("div",{key:1,class:"lawyer-mask",onClick:Ue(F,["stop"])},[g("div",{class:"lawyer-drawer",onClick:N[3]||(N[3]=Ue(()=>{},["stop"]))},[g("header",j0,[g("div",Y0,[g("span",K0,S(b(r).lawyerCardBadge),1),g("span",q0,S(b(r).lawyerModalHeader),1)]),g("button",{class:"ld-close",onClick:Ue(F,["stop"])},"✕")]),g("div",W0,[g("div",z0,S(v.value.body),1)]),g("footer",X0,[g("button",{class:"ld-ok",onClick:Ue(F,["stop"])},S(b(r).lawyerModalClose),1)])])])):se("",!0)],8,L0))}}),Z0=mt(J0,[["__scopeId","data-v-145d16ad"]]),Q0={class:"select"},eg={class:"sel-header"},tg={class:"header-top"},ng={class:"app-title"},ig={class:"tagline"},sg={class:"hero-cta-wrap"},og={class:"cta-left"},rg={class:"cta-txt-group"},cg={class:"cta-action"},ag={class:"cta-sub"},lg={class:"list"},pg={key:0,class:"act-title"},ug={class:"act-levels"},dg=["onClick"],_g={class:"tid"},fg={class:"ttitle"},gg={class:"foot"},mg=ot({__name:"LevelSelect",props:{levels:{},best:{}},emits:["pick"],setup(e){const t=e,n=ge.ui,i=c=>c===void 0?"":"r"+c,s=te(()=>{var c;for(const a of t.levels)if(!t.best[a.id])return a.id;return((c=t.levels[0])==null?void 0:c.id)??"L01"}),o=te(()=>Object.keys(t.best).length>0),r=te(()=>{const c={};for(const a of t.levels)(c[a.act]??(c[a.act]=[])).push(a);return Object.entries(c).map(([a,l])=>({act:Number(a),name:ge.actNames[a]??"",levels:l}))});return(c,a)=>(E(),M("div",Q0,[g("header",eg,[g("div",tg,[g("h1",ng,S(b(ge).appTitle),1),a[1]||(a[1]=g("span",{class:"version-tag"},"M3 切片",-1))]),g("p",ig,S(b(n).appTagline),1),g("div",sg,[g("button",{class:"hero-cta",onClick:a[0]||(a[0]=l=>c.$emit("pick",s.value))},[g("div",og,[a[2]||(a[2]=g("span",{class:"play-btn"},"▶",-1)),g("div",rg,[g("span",cg,S(o.value?b(n).continueAdventure:b(n).startAdventure),1),g("span",ag,"进入 "+S(s.value),1)])]),a[3]||(a[3]=g("span",{class:"cta-arrow"},"›",-1))])])]),g("div",lg,[(E(!0),M(ke,null,Dt(r.value,l=>(E(),M("div",{key:l.act,class:"act-section"},[l.name?(E(),M("div",pg,S(l.name),1)):se("",!0),g("div",ug,[(E(!0),M(ke,null,Dt(l.levels,p=>(E(),M("button",{key:p.id,class:"level-btn",onClick:_=>c.$emit("pick",p.id)},[g("span",_g,S(p.id),1),g("span",fg,S(p.title),1),g("span",{class:fe(["badge",i(e.best[p.id])])},S(e.best[p.id]??"·"),3)],8,dg))),128))])]))),128))]),g("footer",gg,S(b(ge).ui.disclaimer),1)]))}}),vg=mt(mg,[["__scopeId","data-v-e1c5f01f"]]),hg=""+new URL("L01-BJmHDizO.png",import.meta.url).href,xg=""+new URL("L02-Cgrrfiit.png",import.meta.url).href,kg=""+new URL("L03-Dhb-92UY.png",import.meta.url).href,yg=""+new URL("L04-Dxn6iz_R.png",import.meta.url).href,Tg=""+new URL("L05-BCX3gD5-.png",import.meta.url).href,Lg=""+new URL("L06-DPfiJfY4.png",import.meta.url).href,bg=""+new URL("L07-DgpRWPjk.png",import.meta.url).href,Ag=""+new URL("L08-HGz_P2cJ.png",import.meta.url).href,wg=""+new URL("L09-VpgvEvrb.png",import.meta.url).href,Og=""+new URL("L10-D_mOdB4H.png",import.meta.url).href,Pg=""+new URL("L11-BXLJJDeb.png",import.meta.url).href,Rg=""+new URL("L12-DemYAPsM.png",import.meta.url).href,Eg=""+new URL("L13-Dn-DLBYO.png",import.meta.url).href,Sg=""+new URL("L14-BLDD-heh.png",import.meta.url).href,Ig=""+new URL("L15-BVYsTDdi.png",import.meta.url).href,Cg=""+new URL("L16-kHk4EBk-.png",import.meta.url).href,$g=""+new URL("L17-BomGMZbR.png",import.meta.url).href,Mg=""+new URL("L18-B2bLjWIc.png",import.meta.url).href,Ng=""+new URL("L19-DHpwxvAB.png",import.meta.url).href,Fg=""+new URL("L20-CyAYX9HG.png",import.meta.url).href,Dg=["src"],Bg={key:1,class:"photo-shade"},Hg={key:2,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Gg={key:3,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Vg={key:4,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Ug={key:5,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},jg={key:6,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Yg={key:7,class:"art",viewBox:"0 0 400 600",preserveAspectRatio:"xMidYMid slice"},Kg={class:"tag"},qg=ot({__name:"SceneBackdrop",props:{levelId:{},pressure:{}},setup(e){const t=e,n=Object.assign({"../../../content/art/scenes/L01.png":hg,"../../../content/art/scenes/L02.png":xg,"../../../content/art/scenes/L03.png":kg,"../../../content/art/scenes/L04.png":yg,"../../../content/art/scenes/L05.png":Tg,"../../../content/art/scenes/L06.png":Lg,"../../../content/art/scenes/L07.png":bg,"../../../content/art/scenes/L08.png":Ag,"../../../content/art/scenes/L09.png":wg,"../../../content/art/scenes/L10.png":Og,"../../../content/art/scenes/L11.png":Pg,"../../../content/art/scenes/L12.png":Rg,"../../../content/art/scenes/L13.png":Eg,"../../../content/art/scenes/L14.png":Sg,"../../../content/art/scenes/L15.png":Ig,"../../../content/art/scenes/L16.png":Cg,"../../../content/art/scenes/L17.png":$g,"../../../content/art/scenes/L18.png":Mg,"../../../content/art/scenes/L19.png":Ng,"../../../content/art/scenes/L20.png":Fg}),i=Q("");we(()=>t.levelId,c=>{const a=Object.entries(n).find(([l])=>l.endsWith("/"+c+".png"));i.value=a!==void 0?a[1]:""},{immediate:!0});const s=te(()=>wp(t.levelId)),o=te(()=>{const c=s.value.hue,a=8+Math.round(t.pressure*.8);return{background:`radial-gradient(120% 70% at 50% 18%, hsl(${c} 32% ${a+10}%) 0%, hsl(${c} 38% ${a}%) 45%, hsl(${c} 45% ${Math.max(4,a-4)}%) 100%)`}}),r=te(()=>s.value.motif);return(c,a)=>(E(),M("div",{class:"backdrop",style:He(o.value)},[i.value?(E(),M("img",{key:0,class:"photo",src:i.value,alt:""},null,8,Dg)):se("",!0),i.value?(E(),M("div",Bg)):se("",!0),r.value==="subway"?(E(),M("svg",Hg,[...a[0]||(a[0]=[Oi('<rect x="40" y="80" width="320" height="180" rx="14" class="win" data-v-b08529d1></rect><rect x="52" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="132" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="212" y="92" width="70" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="292" y="92" width="56" height="156" rx="4" class="win2" data-v-b08529d1></rect><rect x="0" y="300" width="400" height="10" class="rail" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',7)])])):r.value==="elevator"?(E(),M("svg",Gg,[...a[1]||(a[1]=[g("rect",{x:"120",y:"60",width:"160",height:"440",rx:"6",class:"door"},null,-1),g("line",{x1:"200",y1:"60",x2:"200",y2:"500",class:"seam"},null,-1),g("circle",{cx:"200",cy:"530",r:"12",class:"lamp"},null,-1),g("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="street"?(E(),M("svg",Vg,[...a[2]||(a[2]=[Oi('<line x1="60" y1="0" x2="60" y2="380" class="pole" data-v-b08529d1></line><rect x="48" y="380" width="24" height="8" rx="3" class="lamp" data-v-b08529d1></rect><rect x="0" y="430" width="400" height="6" class="rail" data-v-b08529d1></rect><rect x="0" y="470" width="400" height="4" class="rail dim" data-v-b08529d1></rect><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):r.value==="court"?(E(),M("svg",Ug,[...a[3]||(a[3]=[g("rect",{x:"80",y:"120",width:"240",height:"90",rx:"4",class:"win"},null,-1),g("rect",{x:"100",y:"300",width:"200",height:"14",rx:"3",class:"desk"},null,-1),g("rect",{x:"60",y:"380",width:"280",height:"10",rx:"3",class:"desk dim"},null,-1),g("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])):r.value==="studio"?(E(),M("svg",jg,[...a[4]||(a[4]=[Oi('<rect x="40" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><rect x="230" y="90" width="130" height="80" rx="6" class="win" data-v-b08529d1></rect><circle cx="200" cy="260" r="8" class="lamp" data-v-b08529d1></circle><line x1="200" y1="0" x2="200" y2="252" class="pole thin" data-v-b08529d1></line><line x1="0" y1="560" x2="400" y2="560" class="floor" data-v-b08529d1></line>',5)])])):(E(),M("svg",Yg,[...a[5]||(a[5]=[g("rect",{x:"50",y:"110",width:"140",height:"100",rx:"6",class:"win"},null,-1),g("rect",{x:"220",y:"110",width:"130",height:"70",rx:"6",class:"win dim"},null,-1),g("line",{x1:"0",y1:"560",x2:"400",y2:"560",class:"floor"},null,-1)])])),g("div",Kg,S(s.value.label),1)],4))}}),Wg=mt(qg,[["__scopeId","data-v-b08529d1"]]),zg={class:"danmaku","aria-hidden":"true"},Xg=ot({__name:"DanmakuLayer",props:{pressure:{},active:{type:Boolean}},setup(e){const t=e,n=Q([]);let i=0,s;function o(){return t.pressure>=4?ge.danmaku.hot:t.pressure>=3?ge.danmaku.tense:ge.danmaku.calm}function r(){if(!t.active)return;const c=o();if(c.length===0)return;const a=c[Math.floor(Math.random()*c.length)]??"";n.value.push({id:i+=1,text:a,lane:Math.floor(Math.random()*4),speed:t.pressure>=4?7+Math.random()*3:10+Math.random()*4,bold:Math.random()<.25}),n.value.length>14&&(n.value=n.value.slice(-14))}return typeof setInterval=="function"&&(s=setInterval(r,t.pressure>=4?900:1800),we(()=>t.pressure,()=>{})),Gt(()=>{s!==void 0&&clearInterval(s)}),(c,a)=>(E(),M("div",zg,[Te(Qd,{name:"fly"},{default:ds(()=>[(E(!0),M(ke,null,Dt(n.value,l=>(E(),M("span",{key:l.id,class:fe(["line",{bold:l.bold}]),style:He({top:12+l.lane*34+"px","--dur":l.speed+"s"})},S(l.text),7))),128))]),_:1})]))}}),Jg=mt(Xg,[["__scopeId","data-v-55cd0013"]]),Zg=""+new URL("he_song-DAGlX_4O.png",import.meta.url).href,Qg=""+new URL("hero-BAfbz0Vs.png",import.meta.url).href,e1=""+new URL("npc_l01_woman-DSDWwEL8.png",import.meta.url).href,t1=""+new URL("npc_l02_woman-qXhWvPKu.png",import.meta.url).href,n1=""+new URL("npc_l03_daughter-Dt2TiO8f.png",import.meta.url).href,i1=""+new URL("npc_l03_woman-BQ3wIsYH.png",import.meta.url).href,s1=""+new URL("npc_l04_woman-CZQbIvDG.png",import.meta.url).href,o1=""+new URL("npc_l05_manager-Ce6F9DQj.png",import.meta.url).href,r1=""+new URL("npc_l05_woman-BXLOsOGn.png",import.meta.url).href,c1=""+new URL("npc_l06_girlfriend-CrncpSA3.png",import.meta.url).href,a1=""+new URL("npc_l06_mother-BJuBbFLU.png",import.meta.url).href,l1=""+new URL("npc_l07_ex-CEJAEgFV.png",import.meta.url).href,p1=""+new URL("npc_l08_child-Bm0Rde6F.png",import.meta.url).href,u1=""+new URL("npc_l08_mother-tu98VogT.png",import.meta.url).href,d1=""+new URL("npc_l08_wife-Cy9DZe9m.png",import.meta.url).href,_1=""+new URL("npc_l09_wife-CJUlJISq.png",import.meta.url).href,f1=""+new URL("npc_l10_exwife-D0NJtWQK.png",import.meta.url).href,g1=""+new URL("npc_l11_hr-Dqx_GpDt.png",import.meta.url).href,m1=""+new URL("npc_l12_boss-nYTyR_X5.png",import.meta.url).href,v1=""+new URL("npc_l12_colleague-BD3ntBZW.png",import.meta.url).href,h1=""+new URL("npc_l13_hr-Dovjb9V8.png",import.meta.url).href,x1=""+new URL("npc_l14_director-B-efKLNg.png",import.meta.url).href,k1=""+new URL("npc_l14_hr-DRiqQqX2.png",import.meta.url).href,y1=""+new URL("npc_l15_broker-CqY8iI1Q.png",import.meta.url).href,T1=""+new URL("npc_l15_hr-CSF8zzWx.png",import.meta.url).href,L1=""+new URL("npc_l16_account-D825uOC6.png",import.meta.url).href,b1=""+new URL("npc_l17_father-jYHQ9zlG.png",import.meta.url).href,A1=""+new URL("npc_l17_hr-D3pAIKo4.png",import.meta.url).href,w1=""+new URL("npc_l18_streamer-CYlpG6aq.png",import.meta.url).href,O1=""+new URL("npc_l19_moderator-CoZr2C0k.png",import.meta.url).href,P1=""+new URL("npc_l19_pr-Do-3PPx1.png",import.meta.url).href,R1=""+new URL("officer_lin-Bduk5y-m.png",import.meta.url).href,E1=""+new URL("shen_li-Bd_DLpmj.png",import.meta.url).href,S1=""+new URL("zhou_you-DSERK5v3.png",import.meta.url).href,I1={key:0,class:"duo","aria-hidden":"true"},C1=["src"],$1={key:1,class:"pt",viewBox:"0 0 120 160"},M1=["src","alt"],N1={key:1,class:"pt",viewBox:"0 0 120 160"},F1={class:"nm"},D1=ot({__name:"PortraitSlot",props:{speaker:{},visible:{type:Boolean}},setup(e){const t=e,n=Object.assign({"../../../content/art/characters/he_song.png":Zg,"../../../content/art/characters/hero.png":Qg,"../../../content/art/characters/npc_l01_woman.png":e1,"../../../content/art/characters/npc_l02_woman.png":t1,"../../../content/art/characters/npc_l03_daughter.png":n1,"../../../content/art/characters/npc_l03_woman.png":i1,"../../../content/art/characters/npc_l04_woman.png":s1,"../../../content/art/characters/npc_l05_manager.png":o1,"../../../content/art/characters/npc_l05_woman.png":r1,"../../../content/art/characters/npc_l06_girlfriend.png":c1,"../../../content/art/characters/npc_l06_mother.png":a1,"../../../content/art/characters/npc_l07_ex.png":l1,"../../../content/art/characters/npc_l08_child.png":p1,"../../../content/art/characters/npc_l08_mother.png":u1,"../../../content/art/characters/npc_l08_wife.png":d1,"../../../content/art/characters/npc_l09_wife.png":_1,"../../../content/art/characters/npc_l10_exwife.png":f1,"../../../content/art/characters/npc_l11_hr.png":g1,"../../../content/art/characters/npc_l12_boss.png":m1,"../../../content/art/characters/npc_l12_colleague.png":v1,"../../../content/art/characters/npc_l13_hr.png":h1,"../../../content/art/characters/npc_l14_director.png":x1,"../../../content/art/characters/npc_l14_hr.png":k1,"../../../content/art/characters/npc_l15_broker.png":y1,"../../../content/art/characters/npc_l15_hr.png":T1,"../../../content/art/characters/npc_l16_account.png":L1,"../../../content/art/characters/npc_l17_father.png":b1,"../../../content/art/characters/npc_l17_hr.png":A1,"../../../content/art/characters/npc_l18_streamer.png":w1,"../../../content/art/characters/npc_l19_moderator.png":O1,"../../../content/art/characters/npc_l19_pr.png":P1,"../../../content/art/characters/officer_lin.png":R1,"../../../content/art/characters/shen_li.png":E1,"../../../content/art/characters/zhou_you.png":S1});function i(h){if(h===null)return{url:"",ok:!1};const v=Object.entries(n).find(([w])=>w.endsWith("/"+h+".png"));return v!==void 0?{url:v[1],ok:!0}:{url:"",ok:!1}}const s=i("hero"),o=ei("hero"),r=te(()=>t.speaker===null||t.speaker==="hero"?null:t.speaker),c=te(()=>i(r.value)),a=te(()=>ei(r.value??"")),l=te(()=>r.value===null?"":xs(r.value)),p=Q(!1);we(()=>t.speaker,()=>{p.value=!1});const _=te(()=>t.speaker==="hero");return(h,v)=>e.visible?(E(),M("div",I1,[g("div",{class:fe(["who hero",{talking:_.value}]),style:He({"--h":b(o)})},[b(s).ok?(E(),M("img",{key:0,class:"pt art",src:b(s).url,alt:""},null,8,C1)):(E(),M("svg",$1,[...v[1]||(v[1]=[g("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])]))],6),r.value?(E(),M("div",{key:0,class:fe(["who guest",{talking:!0}]),style:He({"--h":a.value})},[c.value.ok&&!p.value?(E(),M("img",{key:0,class:"pt art",src:c.value.url,alt:l.value,onError:v[0]||(v[0]=w=>p.value=!0)},null,40,M1)):(E(),M("svg",N1,[...v[2]||(v[2]=[g("path",{d:"M60 22 a20 20 0 1 1 -0.1 0 M28 160 C28 118 40 96 60 96 C80 96 92 118 92 160 Z"},null,-1)])])),g("span",F1,S(l.value),1)],4)):se("",!0)])):se("",!0)}}),B1=mt(D1,[["__scopeId","data-v-286bf6bf"]]),H1={class:"backlog-panel"},G1={class:"bl-header"},V1={class:"bl-title-group"},U1={class:"bl-title"},j1={key:0,class:"bl-empty"},Y1={key:0,class:"bl-speaker"},K1={class:"bl-sp-name"},q1={class:"bl-text"},W1={class:"bl-footer"},z1=ot({__name:"BacklogModal",props:{history:{}},emits:["close"],setup(e,{emit:t}){const n=t,i=ge.ui,s=Q(null);function o(){ps(()=>{s.value&&(s.value.scrollTop=s.value.scrollHeight)})}function r(c){c.key==="Escape"&&n("close")}return en(()=>{o(),typeof window<"u"&&window.addEventListener("keydown",r)}),Gt(()=>{typeof window<"u"&&window.removeEventListener("keydown",r)}),(c,a)=>(E(),M("div",{class:"backlog-mask",onClick:a[2]||(a[2]=Ue(l=>c.$emit("close"),["self"]))},[g("div",H1,[g("header",G1,[g("div",V1,[a[3]||(a[3]=g("span",{class:"bl-badge"},"LOG",-1)),g("h3",U1,S(b(i).backlogTitle),1)]),g("button",{class:"bl-close",onClick:a[0]||(a[0]=l=>c.$emit("close"))},"✕")]),g("div",{ref_key:"scrollRef",ref:s,class:"bl-list"},[e.history.length===0?(E(),M("div",j1,S(b(i).backlogEmpty),1)):se("",!0),(E(!0),M(ke,null,Dt(e.history,(l,p)=>(E(),M("div",{key:p,class:fe(["bl-item",l.kind]),style:He({"--h":l.speaker?b(ei)(l.speaker):220})},[l.kind==="dialogue"&&l.speaker?(E(),M("div",Y1,[g("span",K1,S(b(xs)(l.speaker)),1)])):se("",!0),g("p",q1,S(l.text),1)],6))),128))],512),g("footer",W1,[g("button",{class:"bl-confirm-btn",onClick:a[1]||(a[1]=l=>c.$emit("close"))},S(b(i).lawyerModalClose),1)])])]))}}),X1=mt(z1,[["__scopeId","data-v-00bd7ed1"]]),J1={class:"stage"},Z1={key:2,class:"topbar"},Q1={class:"lv-title"},em={key:3,class:"study-entry"},tm={class:"sub"},nm=["placeholder"],im=["disabled"],sm={key:4,class:"study-done"},om={class:"sum"},rm={key:1,class:"story"},cm={key:8,class:"timeout-toast"},am={class:"tt-label"},lm={class:"tt-text"},pm={name:"App"},um=ot({...pm,props:{ctx:{}},setup(e){const n=e.ctx;we(n.event,f=>{f!==null&&f.type==="ending"&&(n.settle(),he.sfx(f.ending.rank==="S"||f.ending.rank==="A"?"ending":"bad"))}),we(n.event,f=>{var z,q,le;if(f===null)return;const x=wp(((z=n.current.value)==null?void 0:z.id)??"L01").hue;f.type==="node"?he.scene(((q=n.current.value)==null?void 0:q.id)??"L01",x,f.node.pressure??0,n.meters.value.composure):f.type==="options"&&(he.sfx("options"),he.scene(((le=n.current.value)==null?void 0:le.id)??"L01",x,3,n.meters.value.composure))});const i=Q(0),s=Q(null),o=Q(null);we(n.event,f=>{if(f===null){i.value=0,s.value=null,o.value=null;return}if(f.type==="node"){i.value=f.node.pressure??0;const x="speaker"in f.node?f.node.speaker:null;s.value=x!=null&&String(x)!=="null"&&String(x).trim()!==""?String(x):null,s.value!==null&&(o.value=s.value)}else f.type==="options"&&(i.value=f.options.length>0?i.value:0,s.value=null)});const r=te(()=>{const f=n.meters.value.composure;return f>=50||n.screen.value!=="level"?{opacity:0}:{opacity:(.25+(50-f)/50*.55).toFixed(2),animation:f<15?"throb 1.1s ease-in-out infinite":"none"}}),c=te(()=>n.screen.value==="level"),a=Q(""),l=te(()=>n.STUDY_LEVELS.every(f=>{try{return n.studySummary().includes(f)}catch{return!1}}));function p(){const f=n.studyExport();typeof navigator<"u"&&navigator.clipboard!==void 0&&navigator.clipboard.writeText(f);const x=new Blob([f],{type:"application/json"}),z=document.createElement("a");z.href=URL.createObjectURL(x),z.download=`study-${a.value||"anon"}.json`,z.click()}const _=Q(!1),h=te(()=>_.value?"x":"m");function v(){_.value=!_.value,he.setMuted(_.value)}function w(){he.unlock(),he.startLoop()}document.addEventListener("pointerdown",w,{once:!0});const I=te(()=>n.current.value?n.current.value.id:"L01"),W=Q([]),Y=Q(!1),G=Q(!1),F=Q(!1);let A;const N=Q(null);function K(){var f;he.sfx("drawer"),Y.value=!0,(f=N.value)==null||f.pause()}function me(){var f;he.sfx("click"),Y.value=!1,(f=N.value)==null||f.resume()}function pe(){if(!F.value)return;A!==void 0&&clearTimeout(A);const f=n.event.value;if(f===null||f.type!=="node")return;const x="text"in f.node?String(f.node.text).length:20,z=Math.max(1800,x*55);A=setTimeout(()=>{var q;F.value&&((q=n.event.value)==null?void 0:q.type)==="node"&&n.advance()},z)}we(F,f=>{f?pe():A!==void 0&&(clearTimeout(A),A=void 0)}),we(n.event,f=>{if(f===null){A!==void 0&&clearTimeout(A);return}f.type==="node"?("script"in f.node&&f.node.script?W.value.push({speaker:null,text:String(f.node.script),kind:"cutscene"}):"speaker"in f.node&&f.node.text&&f.node.speaker!=null&&String(f.node.speaker)!=="null"?W.value.push({speaker:String(f.node.speaker),text:String(f.node.text),kind:"dialogue"}):"text"in f.node&&f.node.text&&W.value.push({speaker:null,text:String(f.node.text),kind:"cutscene"}),pe()):f.type==="options"?(A!==void 0&&(clearTimeout(A),A=void 0),Y.value&&ps(()=>{var x;return(x=N.value)==null?void 0:x.pause()})):f.type==="ending"&&A!==void 0&&(clearTimeout(A),A=void 0)});const V=Q(null);let X;function $(f){V.value=f,he.sfx("bad"),X!==void 0&&clearTimeout(X),X=setTimeout(()=>{V.value=null},2200)}return we(I,()=>{W.value=[],F.value=!1,Y.value=!1,G.value=!1,s.value=null,o.value=null,i.value=0,A!==void 0&&clearTimeout(A)}),(f,x)=>{var z;return E(),M("div",J1,[c.value?(E(),Ve(Wg,{key:0,"level-id":I.value,pressure:i.value},null,8,["level-id","pressure"])):se("",!0),c.value&&((z=b(n).event.value)==null?void 0:z.type)!=="ending"?(E(),Ve(Jg,{key:1,pressure:i.value,active:c.value},null,8,["pressure","active"])):se("",!0),c.value?(E(),M("header",Z1,[g("button",{class:"back",onClick:x[0]||(x[0]=q=>b(n).toSelect())},"‹"),g("span",Q1,S(b(n).banner.value),1),g("button",{class:fe(["mute",{off:_.value}]),onClick:x[1]||(x[1]=q=>v())},S(h.value),3)])):se("",!0),b(n).studyOn&&b(n).studyScreen.value==="entry"?(E(),M("div",em,[g("h1",null,S(b(ge).appTitle),1),g("p",tm,S(b(Rt)("studyIntro")),1),bu(g("input",{"onUpdate:modelValue":x[2]||(x[2]=q=>a.value=q),class:"pid",placeholder:b(Rt)("studyPidPlaceholder"),maxlength:"8"},null,8,nm),[[o_,a.value]]),g("button",{class:"go",disabled:a.value.trim().length===0,onClick:x[3]||(x[3]=q=>b(n).studyBegin(a.value.trim()))},S(b(Rt)("studyStart")),9,im)])):b(n).studyOn&&b(n).studyScreen.value==="done"&&l.value?(E(),M("div",sm,[g("h2",null,S(b(Rt)("studyDoneTitle")),1),g("pre",om,S(b(n).studySummary()),1),g("button",{class:"go",onClick:p},S(b(Rt)("studyCopy")),1)])):b(n).screen.value==="select"?(E(),Ve(vg,{key:5,levels:b(n).studyOn?b(Ct).filter(q=>b(n).STUDY_LEVELS.includes(q.id)):b(Ct),best:b(n).best.value,onPick:b(n).startLevel},null,8,["levels","best","onPick"])):b(n).event.value?(E(),M(ke,{key:6},[b(n).event.value.type!=="ending"?(E(),Ve(Vf,{key:0,state:b(n).meters.value},null,8,["state"])):se("",!0),Te(B1,{speaker:s.value??o.value,visible:b(n).event.value.type!=="ending"&&(s.value??o.value)!==null},null,8,["speaker","visible"]),G.value?(E(),M("div",{key:2,class:"restore-hud-trigger",onClick:x[16]||(x[16]=q=>G.value=!1)},[g("span",null,S(b(Rt)("tapToRestore")),1)])):(E(),M("div",rm,[b(n).event.value.type==="node"&&"script"in b(n).event.value.node?(E(),Ve($i,{key:0,kind:"cutscene",text:String(b(n).event.value.node.script??""),"auto-active":F.value,onAdvance:x[4]||(x[4]=q=>b(n).advance()),onOpenLog:K,onToggleAuto:x[5]||(x[5]=q=>F.value=!F.value),onSkip:x[6]||(x[6]=q=>b(n).advance()),onHideUi:x[7]||(x[7]=q=>G.value=!0)},null,8,["text","auto-active"])):b(n).event.value.type==="node"&&"speaker"in b(n).event.value.node&&b(n).event.value.node.speaker!=null&&String(b(n).event.value.node.speaker)!=="null"&&String(b(n).event.value.node.speaker).trim()!==""?(E(),Ve($i,{key:1,kind:"dialogue",speaker:String(b(n).event.value.node.speaker),text:String(b(n).event.value.node.text??""),"auto-active":F.value,onAdvance:x[8]||(x[8]=q=>b(n).advance()),onOpenLog:K,onToggleAuto:x[9]||(x[9]=q=>F.value=!F.value),onSkip:x[10]||(x[10]=q=>b(n).advance()),onHideUi:x[11]||(x[11]=q=>G.value=!0)},null,8,["speaker","text","auto-active"])):b(n).event.value.type==="node"&&"text"in b(n).event.value.node?(E(),Ve($i,{key:2,kind:"cutscene",text:String(b(n).event.value.node.text??""),"auto-active":F.value,onAdvance:x[12]||(x[12]=q=>b(n).advance()),onOpenLog:K,onToggleAuto:x[13]||(x[13]=q=>F.value=!F.value),onSkip:x[14]||(x[14]=q=>b(n).advance()),onHideUi:x[15]||(x[15]=q=>G.value=!0)},null,8,["text","auto-active"])):b(n).event.value.type==="options"?(E(),Ve(m0,{key:3,ref_key:"choiceLayerRef",ref:N,options:b(n).event.value.options,timer:b(n).event.value.timer,"timeout-option-id":b(n).event.value.timeoutOptionId,prompt:b(n).event.value.prompt??"",onChoose:b(n).choose,onTimeout:$,onOpenLog:K},null,8,["options","timer","timeout-option-id","prompt","onChoose"])):b(n).event.value.type==="ending"?(E(),Ve(Z0,{key:4,"level-id":I.value,ending:b(n).event.value.ending,state:b(n).event.value.state,"finale-tier":b(n).finaleTier.value,onRestart:b(n).restart,onNext:b(n).nextLevel},null,8,["level-id","ending","state","finale-tier","onRestart","onNext"])):se("",!0)]))],64)):se("",!0),Y.value?(E(),Ve(X1,{key:7,history:W.value,onClose:me},null,8,["history"])):se("",!0),V.value?(E(),M("div",cm,[g("span",am,S(b(Rt)("timeoutNotice")),1),g("span",lm,"「"+S(V.value)+"」",1)])):se("",!0),c.value?(E(),M("div",{key:9,class:"vignette",style:He(r.value)},null,4)):se("",!0)])}}}),Op="poju-study-v1",dm=()=>typeof location<"u"&&new URLSearchParams(location.search).get("study")==="1";function Lt(){if(typeof localStorage>"u")return{sessionId:"",participant:"",startedAt:0,runs:[]};const e=localStorage.getItem(Op);return e===null?{sessionId:"",participant:"",startedAt:0,runs:[]}:JSON.parse(e)}function gi(e){typeof localStorage<"u"&&localStorage.setItem(Op,JSON.stringify(e))}function _m(e){const t={sessionId:`S-${performance.now().toString(36)}`,participant:e,startedAt:performance.now(),runs:[]};return mi=t,gi(t),t}function fm(e,t,n){const i={level:t,startedAt:performance.now(),endedAt:0,totalMs:0,choices:[],endingRank:"",endingTitle:"",finalMeters:{evidence:0,opinion:0,composure:0,risk:0},replayed:n},s=mi??Lt();return s.runs.push(i),gi(s),i}let zi=0,Pp="",mi=null;function ti(e){zi=performance.now(),Pp=e}function gm(e,t,n,i,s){e.choices.push({level:n,nodeId:Pp,optionId:i,ms:zi>0?performance.now()-zi:0,meters:{...s}});const o=mi??Lt();gi(o)}function mm(e,t,n,i,s){e.endedAt=performance.now(),e.totalMs=e.endedAt-e.startedAt,e.endingRank=n,e.endingTitle=i,e.finalMeters={...s},gi(mi??Lt())}function vm(){return JSON.stringify(Lt(),null,2)}function hm(){const e=Lt(),n=[ge.ui.studySummaryHeader.replace("{p}",e.participant).replace("{n}",String(e.runs.length))],i=new Map;for(const s of e.runs){const o=i.get(s.level)??[];o.push(s),i.set(s.level,o)}for(const[s,o]of[...i.entries()].sort()){const r=o[0],c=Math.round(r.totalMs/1e3),a=ge.ui.studySummaryLine;n.push(a.replace("{lv}",s).replace("{rank}",r.endingRank).replace("{title}",r.endingTitle).replace("{s}",String(c)).replace("{c}",String(r.choices.length)).replace("{r}",o.length>1?"Y":"N"))}return n.join(`
`)}const An=Q("select"),yt=ci(null),$e=ci(null),Bt=Q(P_()),Rp=Q(""),vi=ci(null),ks=Q({evidence:0,opinion:0,composure:0,risk:0}),Ep=Q(null),Tt=dm(),Xi=["L01","L02","L03","L04","L05"],Sp=Q("entry"),wn=ci(null),xm=Q(0);function km(e){Bt.value=qi(),_m(e),Sp.value="done",Xt("L01")}function Xt(e){const t=Ct.find(s=>s.id===e)??null;if(t===null)return;yt.value=t,Rp.value=t.title;let n=t;if(e==="L20"&&!Tt){const s=M_(Bt.value);n={...t,initState:{evidence:s.evidence,opinion:s.opinion,composure:s.composure,risk:s.risk}}}const i=new hs(n,Bt.value);if(vi.value=i,$e.value=i.start(),ks.value={...i.state},An.value="level",Tt){const s=Lt(),o=s.runs.some(r=>r.level===e&&r.endingRank!=="");wn.value=fm(s,e,o),ti("entry")}}function ym(){const e=vi.value;e!==null&&($e.value=e.proceed(),Tt&&$e.value.type==="node"&&ti(String($e.value.node.id)),Tt&&$e.value.type==="options"&&$e.value.nodeId!==void 0&&ti($e.value.nodeId))}function Tm(e){const t=vi.value;t!==null&&($e.value=t.choose(e),ks.value={...t.state},Tt&&wn.value!==null&&yt.value!==null&&(gm(wn.value,Lt(),yt.value.id,e,t.state),$e.value.type==="options"&&$e.value.nodeId!==void 0&&ti($e.value.nodeId)))}function Lm(){const e=vi.value,t=yt.value,n=$e.value;if(e===null||t===null||n===null||n.type!=="ending")return;if(Tt){wn.value!==null&&mm(wn.value,Lt(),n.ending.rank,n.ending.title,e.state),xm.value+=1;return}const i=C_(Bt.value,t.id,n.ending,n.state,{now:0});Bt.value=i,R_(i),t.id==="L20"&&(Ep.value=N_(i,n.ending.rank))}function bm(){yt.value!==null&&Xt(yt.value.id)}function Am(){const e=yt.value;if(e===null)return;if(Tt){const o=Xi.indexOf(e.id),r=o>=0?Xi[o+1]:void 0;if(r===void 0){An.value="select";return}Xt(r);return}const t=Ct.findIndex(o=>o.id===e.id),n=Ct.find(o=>!(o.id in Bt.value.levelResults)),i=n!==void 0?Ct.findIndex(o=>o.id===n.id):-1;if(n!==void 0&&i>t+1){Xt(n.id);return}const s=Ct[t+1];if(s===void 0){An.value="select";return}Xt(s.id)}function wm(){An.value="select"}const Om=te(()=>{const e={};for(const[t,n]of Object.entries(Bt.value.levelResults))e[t]=n.rank;return e}),Pm={screen:An,current:yt,event:$e,banner:Rp,best:Om,meters:ks,finaleTier:Ep,startLevel:Xt,advance:ym,choose:Tm,settle:Lm,restart:bm,nextLevel:Am,toSelect:wm,studyOn:Tt,STUDY_LEVELS:Xi,studyScreen:Sp,studyBegin:km,studyExport:()=>vm(),studySummary:()=>hm()},Rm=p_(um,{ctx:Pm});Rm.mount("#app");
