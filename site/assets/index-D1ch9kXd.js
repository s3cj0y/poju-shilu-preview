...
你说好。心里想的是：其实他喊了「让一让」的。`,unlock:"card_L01_S"},{id:"e_a_rank",rank:"A",condition:"risk<=30 && evidence>=60 && composure>=15",title:"干净脱身",script:`监控当庭放完，法庭很安静。
...
一、先解围，再论对错。让孩子脱离抓拽、检查有没有伤，是监护人的第一动作；
　　道歉可以给，但道歉的对象是「无心之失」，不是「猥亵」——措辞就是定性，
　　书面道歉里出现的每一个词，将来都可能被裁出来用。
二、监控要在第一时间请店家保留。公共场所监控存在覆盖周期，
　　拖过三天，一秒和一分五十秒就都没了。
三、调解是自愿的，不是必答题。三次调解不是「给足面子就该答应」——
　　接受与拒绝都是你的权利，谈崩不丢人，带着屈辱条件的和解才丢人。
四、八周岁以下的孩子是无民事行为能力人，法律上不存在「猥亵的故意」。
　　无心之失该担的责（当日的医药费、真诚的当面道歉）担起来；
　　「精神损害」的举证责任在她——谁主张，谁举证，这条河的桥得她自己搭。
五、对方动手抓拽孩子，超出合理限度：孩子的伤情照片、病历、时间戳，另案主张。
　　监护权不因孩子「惹事在先」而打折。
六、手机拍的是你孩子。未成年人肖像与隐私受法律保护——
　　你有权要求平台打码、下架，这不是恩赐，是法定义务。

至于以网暴对网暴——
你把她的照片挂上网的那一刻，你就从「给孩子讨定性的人」，
变成了「另一个制造流量漩涡的人」。法庭帮不了这样的你。
